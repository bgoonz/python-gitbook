! function(t) {
    ...
    }, n.p = "https://codesandbox.io/", n(n.s = "../../node_modules/thread-loader/dist/cjs.js?!./node_modules/babel-loader/lib/index.js?!./src/embed/components/Content/Monaco/workers/fetch-dependency-typings.js")
}({
            ...
            var o = {
                resolve: function() {
                    for (var t, o = "", i = !1, a = arguments.length - 1; a >= -1 && !i; a--) {
                        var c;
                        a >= 0 ? c = arguments[a] : (void 0 === t && (t = e.cwd()), c = t), n(c), 0 !== c.length && (o = c + "/" + o, i = 47 === c.charCodeAt(0))
                    }
                ...
                normalize: function(t) {
                    ...
                    return 0 !== (t = r(t, !e)).length || e || (t = "."), t.length > 0 && o && (t += "/"), e ? "/" + t : t
                },
                ...
                relative: function(t, e) {
                    ...
                    for (var i = t.length, a = i - r, c = 1; c < e.length && 47 === e.charCodeAt(c); ++c);
                    for (var u = e.length - c, s = a < u ? a : u, l = -1, f = 0; f <= s; ++f) {
                        if (f === s) {
                            if (u > s) {
                    ...
                    return d.length > 0 ? d + e.slice(c + l) : (c += l, 47 === e.charCodeAt(c) && ++c, e.slice(c))
                },
                ...
                dirname: function(t) {
                    if (n(t), 0 === t.length) return ".";
                    for (var e = t.charCodeAt(0), r = 47 === e, o = -1, i = !0, a = t.length - 1; a >= 1; --a)
                ...
                basename: function(t, e) {
                    ...
                    if (void 0 !== e && e.length > 0 && e.length <= t.length) {
                        ...
                        for (r = t.length - 1; r >= 0; --r) {
                            ...
                            } else -1 === u && (a = !1, u = r + 1), c >= 0 && (s === e.charCodeAt(c) ? -1 === --c && (i = r) : (c = -1, i = u))
                        }
                ...
                extname: function(t) {
                    n(t);
                    for (var e = -1, r = 0, o = -1, i = !0, a = 0, c = t.length - 1; c >= 0; --c) {
                        var u = t.charCodeAt(c);
                        if (47 !== u) - 1 === o && (i = !1, o = c + 1), 46 === u ? -1 === e ? e = c : 1 !== a && (a = 1) : -1 !== e && (a = -1);
                        else if (!i) {
                            r = c + 1;
                            break
                        }
                    }
                    return -1 === e || -1 === o || 0 === a || 1 === a && e === o - 1 && e === r + 1 ? "" : t.slice(e, o)
                },
                format: function(t) {
                ...
                parse: function(t) {
                    ...
                    for (var a = -1, c = 0, u = -1, s = !0, l = t.length - 1, f = 0; l >= r; --l)
                        if (47 !== (o = t.charCodeAt(l))) - 1 === u && (s = !1, u = l + 1), 46 === o ? -1 === a ? a = l : 1 !== f && (f = 1) : -1 !== a && (f = -1);
                        else if (!s) {
                        c = l + 1;
                        break
                    }
                    return -1 === a || -1 === u || 0 === f || 1 === f && a === u - 1 && a === c + 1 ? -1 !== u && (e.base = e.name = 0 === c && i ? t.slice(1, u) : t.slice(c, u)) : (0 === c && i ? (e.name = t.slice(1, a), e.base = t.slice(1, u)) : (e.name = t.slice(c, a), e.base = t.slice(c, u)), e.ext = t.slice(a, u)), c > 0 ? e.dir = t.slice(0, c - 1) : i && (e.dir = "/"), e
                },
                sep: "/",
                delimiter: ":",
                win32: null,
    ...
    "../../node_modules/thread-loader/dist/cjs.js?!./node_modules/babel-loader/lib/index.js?!./src/embed/components/Content/Monaco/workers/fetch-dependency-typings.js": function(t, e, n) {
        "use strict";
        n.r(e);
        var r = n("../../node_modules/@babel/runtime/regenerator/index.js"),
            ...
            u = n.n(c);
        self.importScripts(["https://cdnjs.cloudflare.com/ajax/libs/typescript/2.7.2/typescript.min.js"]);
        var s = "https://cdn.jsdelivr.net/",
            ...
            p = function(t, e, n) {
                return d("".concat(s, "npm/@types/").concat(t.replace("@", "").replace(/\//g, "__"), "/index.d.ts")).then((function(e) {
            ...
            m = function(t, e) {
                var n = "/".concat(e);
                return t["".concat(n, ".d.ts")] ? "".concat(e, ".d.ts") : t["".concat(n, ".ts")] ? "".concat(e, ".ts") : t[n] ? e : t["".concat(n, "/index.d.ts")] ? "".concat(e, "/index.d.ts") : e
            },
            g = function t(e, n, r, o, i) {
                var a = u.a.join("node_modules", n, r);
                return o[a] ? null : d("".concat(e, "/").concat(r)).then((function(c) {
                    return o[a] ? null : (f(a, c, o), Promise.all(function(t, e) {
                        var n = [],
                            r = self.ts.createSourceFile(t, e, self.ts.ScriptTarget.Latest, !0, self.ts.ScriptKind.TS);
                        return self.ts.forEachChild(r, (function(t) {
                            switch (t.kind) {
                                case self.ts.SyntaxKind.ImportDeclaration:
                                    n.push(t.moduleSpecifier.text);
                                    break;
                                case self.ts.SyntaxKind.ExportDeclaration:
                                    t.moduleSpecifier && n.push(t.moduleSpecifier.text)
                            }
                        })), n
        ...
        function y(t, e, n) {
            var r = "https://data.jsdelivr.com/v1/package/npm/".concat(t, "@").concat(e, "/flat");
            return d(r).then((function(t) {
                ...
                var o = function(t, e) {
                    ...
                    i = o(r.files, /\.d\.ts$/);
                if (0 === i.length && (i = o(r.files, /\.ts$/)), 0 === i.length) throw new Error("No inline typings found.");
                return Promise.all(i.map((function(r) {
                    return d("https://cdn.jsdelivr.net/npm/".concat(t, "@").concat(e).concat(r)).then((function(e) {
        ...
        function w(t, e, n) {
            ...
            return d("".concat(r, "/package.json")).then((function(t) {
                return JSON.parse(t)
            })).then((function(o) {
                var i = o.typings || o.types;
                if (i) return f("node_modules/".concat(t, "/package.json"), JSON.stringify(o), n),
                    function(t, e, n) {
                        return d("https://data.jsdelivr.com/v1/package/npm/".concat(t, "@").concat(e, "/flat")).then((function(t) {
                            return JSON.parse(t)
                        })).then((function(t) {
        ...
        function b() {
            return (b = a()(o.a.mark((function t(e) {
                var n, r;
                return o.a.wrap((function(t) {
                    for (;;) switch (t.prev = t.next) {
                        case 0:
                            return n = {}, r = Object.keys(e), t.next = 4, Promise.all(r.map(function() {
                                var t = a()(o.a.mark((function t(r) {
                                    var i;
                                    return o.a.wrap((function(t) {
                                        for (;;) switch (t.prev = t.next) {
                                            case 0:
                                                ...
                                                return l.push(r), t.next = 5, d("https://data.jsdelivr.com/v1/package/resolve/npm/".concat(r, "@").concat(e[r])).then((function(t) {
                                                    return JSON.parse(t)
                                                })).then((function(t) {
                                                    return t.version
                                                }));
                                            case 5:
                                                return i = t.sent, t.next = 8, w(r, i, n).catch((function() {
                                                    return y(r, i, n).catch((function() {
                                                        return p(r, 0, n)
                                                    }))
                                                }));
                                            case 8:
