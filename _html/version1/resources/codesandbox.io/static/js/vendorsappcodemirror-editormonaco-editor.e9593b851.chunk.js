(this.csbJsonP = this.csbJsonP || []).push([
    ["vendors~app~codemirror-editor~monaco-editor"], {
        ...
        "../../node_modules/downshift/dist/downshift.esm.js": function(e, t, n) {
            "use strict";
            var o = n("../../node_modules/@babel/runtime/helpers/esm/objectWithoutPropertiesLoose.js"),
            ...
            function p(e, t) {
                if (e.clientHeight < e.scrollHeight || e.clientWidth < e.scrollWidth) {
                    ...
                    return c(n.overflowY, t) || c(n.overflowX, t) || function(e) {
                        var t = function(e) {
            ...
            function h(e, t, n, o, i, r, s, u) {
                return r < e && s > t || r > e && s < t ? 0 : r <= e && u <= n || s >= t && u >= n ? r - e - o : s > t && u < n || r < e && u > n ? s - t + i : 0
            }
            var f = 0;
            ...
            function v(e, t) {
                null !== e && function(e, t) {
                    ...
                    for (var a = document.scrollingElement || document.documentElement, l = [], c = e; d(c) && u(c);) {
                        if ((c = c.parentNode) === a) {
                            l.push(c);
                            break
                        }
                        c === document.body && p(c) && !p(document.documentElement) || p(c, s) && l.push(c)
                    }
                    for (var f = window.visualViewport ? visualViewport.width : innerWidth, g = window.visualViewport ? visualViewport.height : innerHeight, m = window.scrollX || pageXOffset, v = window.scrollY || pageYOffset, I = e.getBoundingClientRect(), b = I.height, y = I.width, S = I.top, w = I.right, O = I.bottom, x = I.left, H = "start" === o || "nearest" === o ? S : "end" === o ? O : S + b / 2, j = "center" === i ? x + y / 2 : "end" === i ? w : x, C = [], E = 0; E < l.length; E++) {
                        var D = l[E],
                            ...
                            k = M.bottom,
                            R = M.left;
                        if ("if-needed" === n && S >= 0 && x >= 0 && O <= g && w <= f && S >= A && O <= k && x >= R && w <= T) return C;
                        var V = getComputedStyle(D),
                            ...
                            W = 0,
                            U = 0,
                            F = "offsetWidth" in D ? D.offsetWidth - D.clientWidth - K - L : 0,
                            q = "offsetHeight" in D ? D.offsetHeight - D.clientHeight - B - N : 0;
                        if (a === D) W = "start" === o ? H : "end" === o ? H - g : "nearest" === o ? h(v, v + g, g, B, N, v + H, v + H + b, b) : H - g / 2, U = "start" === i ? j : "center" === i ? j - f / 2 : "end" === i ? j - f : h(m, m + f, f, K, L, m + j, m + j + y, y), W = Math.max(0, W + v), U = Math.max(0, U + m);
                        else {
                            W = "start" === o ? H - A - B : "end" === o ? H - k + N + q : "nearest" === o ? h(A, k, P, B, N + q, H, H + b, b) : H - (A + P / 2) + q / 2, U = "start" === i ? j - R - K : "center" === i ? j - (R + _ / 2) + F / 2 : "end" === i ? j - T + L + F : h(R, T, _, K, L + F, j, j + y, y);
                            var z = D.scrollLeft,
                                X = D.scrollTop;
                            H += X - (W = Math.max(0, Math.min(X + W, D.scrollHeight - P + q))), j += z - (U = Math.max(0, Math.min(z + U, D.scrollWidth - _ + F)))
                        }
                        C.push({
                            el: D,
                            top: W,
            ...
            function T(e, t, n, o) {
                return void 0 === o && (o = !0), t.some((function(t) {
                ...
                B = function() {
                    var e = function(e) {
                        function t(t) {
                            ...
                            n.id = n.props.id || "downshift-" + w(), n.menuId = n.props.menuId || n.id + "-menu", n.labelId = n.props.labelId || n.id + "-label", n.inputId = n.props.inputId || n.id + "-input", n.getItemId = n.props.getItemId || function(e) {
                                return n.id + "-item-" + e
                                ...
                                void 0 === e && (e = n.props.defaultHighlightedIndex), void 0 === t && (t = {}), t = E(t), n.internalSetState(Object(i.default)({
                                    highlightedIndex: e
                                }, t))
                                ...
                                t = E(t), n.internalSetState(Object(i.default)({
                                    isOpen: n.props.defaultIsOpen,
                                    highlightedIndex: n.props.defaultHighlightedIndex,
                                    selectedItem: e,
                                ...
                                var o, r, s = {},
                                    u = "function" === typeof e;
                                return !u && e.hasOwnProperty("inputValue") && n.props.onInputValueChange(e.inputValue, Object(i.default)({}, n.getStateAndHelpers(), {}, e)), n.setState((function(t) {
                                    t = n.getState(t);
                                    var a = u ? e(t) : e;
                                    a = n.props.stateReducer(t, a), o = a.hasOwnProperty("selectedItem");
                                    var l = {},
                                        d = {};
                                    return o && a.selectedItem !== t.selectedItem && (r = a.selectedItem), a.type = a.type || 0, Object.keys(a).forEach((function(e) {
                                        t[e] !== a[e] && (s[e] = a[e]), "type" !== e && (d[e] = a[e], M(n.props, e) || (l[e] = a[e]))
                                    })), u && a.hasOwnProperty("inputValue") && n.props.onInputValueChange(a.inputValue, Object(i.default)({}, n.getStateAndHelpers(), {}, a)), l
                                }), (function() {
                                    g(t)(), Object.keys(s).length > 1 && n.props.onStateChange(s, n.getStateAndHelpers()), o && n.props.onSelect(e.selectedItem, n.getStateAndHelpers()), void 0 !== r && n.props.onChange(r, n.getStateAndHelpers()), n.props.onUserAction(s, n.getStateAndHelpers())
                                }))
                                ...
                                n.getRootProps.called = !0, n.getRootProps.refKey = d, n.getRootProps.suppressRefError = u;
                                var h = n.getState().isOpen;
                                return Object(i.default)(((r = {})[d] = S(c, n.rootRef), r.role = "combobox", r["aria-expanded"] = h, r["aria-haspopup"] = "listbox", r["aria-owns"] = h ? n.menuId : null, r["aria-labelledby"] = n.labelId, r), p)
                            }, n.keyDownHandlers = {
                                ArrowDown: function(e) {
                                    ...
                                    if (e.preventDefault(), this.getState().isOpen) {
                                        ...
                                        if (e > 0) {
                                            var n = _(1, t.getState().highlightedIndex, e, (function(e) {
                                ...
                                Enter: function(e) {
                                    ...
                                    if (n && null != o) {
                                        ...
                                        if (null == i || r && r.hasAttribute("disabled")) return;
                            ...
                            }, n.buttonKeyDownHandlers = Object(i.default)({}, n.keyDownHandlers, {
                                " ": function(e) {
                                    e.preventDefault(), this.toggleMenu({
                                        type: 12
                                    })
                                }
                            }), n.inputKeyDownHandlers = Object(i.default)({}, n.keyDownHandlers, {
                                Home: function(e) {
                                    var t = this;
                                    e.preventDefault();
                                ...
                                var t = e,
                                    ...
                                    u = t.onKeyUp,
                                    a = t.onBlur,
                                    l = Object(o.default)(t, ["onClick", "onPress", "onKeyDown", "onKeyUp", "onBlur"]),
                                    d = n.getState().isOpen,
                                    c = {
                                ...
                                var t = P(e);
                                n.buttonKeyDownHandlers[t] && n.buttonKeyDownHandlers[t].call(Object(r.a)(n), e)
                                ...
                                var t = e,
                                    ...
                                    u = t.onChange,
                                    a = t.onInput,
                                    l = (t.onChangeText, Object(o.default)(t, ["onKeyDown", "onBlur", "onChange", "onInput", "onChangeText"])),
                                    d = {};
                                var c, p = n.getState(),
                                    h = p.inputValue,
                                    f = p.isOpen,
                                    g = p.highlightedIndex;
                                l.disabled || ((c = {}).onChange = y(u, a, n.inputHandleChange), c.onKeyDown = y(r, n.inputHandleKeyDown), c.onBlur = y(s, n.inputHandleBlur), d = c);
                                return Object(i.default)({
                                    "aria-autocomplete": "list",
                                    "aria-activedescendant": f && "number" === typeof g && g >= 0 ? n.getItemId(g) : null,
                                ...
                                var t = P(e);
                                t && n.inputKeyDownHandlers[t] && n.inputKeyDownHandlers[t].call(Object(r.a)(n), e)
                                ...
                                var s = (void 0 === t ? {} : t).suppressRefError,
                                    ...
                                    c = a.ref,
                                    p = Object(o.default)(a, ["refKey", "ref"]);
                                return n.getMenuProps.called = !0, n.getMenuProps.refKey = d, n.getMenuProps.suppressRefError = u, Object(i.default)(((r = {})[d] = S(c, n.menuRef), r.role = "listbox", r["aria-labelledby"] = p && p["aria-label"] ? null : n.labelId, r.id = n.menuId, r), p)
                                ...
                                var r = e,
                                    ...
                                    d = r.item,
                                    c = void 0 === d ? void 0 : d,
                                    p = Object(o.default)(r, ["onMouseMove", "onMouseDown", "onClick", "onPress", "index", "item"]);
                                void 0 === l ? (n.items.push(c), l = n.items.indexOf(c)) : n.items[l] = c;
                                var h = a,
                                    f = ((t = {
                                        onMouseMove: y(s, (function() {
                                            l !== n.getState().highlightedIndex && (n.setHighlightedIndex(l, {
                                                type: 2
                                ...
                                void 0 === e && (e = {}), e = E(e), n.internalSetState((function(t) {
                                ...
                                void 0 === e && (e = {}), e = E(e), n.internalSetState((function(t) {
                                    ...
                                    i && n.getItemCount() > 0 && "number" === typeof r && n.setHighlightedIndex(r, e), g(t)()
                                }))
                                ...
                                var e = n.getState(),
                                    ...
                                    o = n.getItemCount(),
                                    r = n.props.getA11yStatusMessage(Object(i.default)({
                                        itemToString: n.props.itemToString,
                                        previousResultCount: n.previousResultCount,
                                        resultCount: o,
                                        highlightedItem: t
                                    }, e));
                                n.previousResultCount = o, R(r, n.props.environment.document)
                            }), 200);
                            var s = n.props,
                            ...
                            return null != I.selectedItem && void 0 === n.props.initialInputValue && (I.inputValue = n.props.itemToString(I.selectedItem)), n.state = I, n
                        }
                        Object(s.a)(t, e);
                        var n = t.prototype;
                        return n.internalClearTimeouts = function() {
                            ...
                            var t = function() {
                                ...
                                n = function(t) {
                                    e.isMouseDown = !1, !T(t.target, [e._rootNode, e._menuNode], e.props.environment.document) && e.getState().isOpen && e.reset({
                                        type: 1
                                    }, (function() {
                                ...
                                r = function(t) {
                                    var n = T(t.target, [e._rootNode, e._menuNode], e.props.environment.document, !1);
                            ...
                            s.addEventListener("mousedown", t), s.addEventListener("mouseup", n), s.addEventListener("touchstart", o), s.addEventListener("touchmove", i), s.addEventListener("touchend", r), this.cleanup = function() {
                                e.internalClearTimeouts(), e.updateStatus.cancel(), s.removeEventListener("mousedown", t), s.removeEventListener("mouseup", n), s.removeEventListener("touchstart", o), s.removeEventListener("touchmove", i), s.removeEventListener("touchend", r)
                            }
                            ...
                            M(this.props, "selectedItem") && this.props.selectedItemChanged(e.selectedItem, this.props.selectedItem) && this.internalSetState({
                                type: 15,
                            ...
                            return t ? this.getRootProps.called || this.props.suppressRefError ? t : H(t) ? Object(l.cloneElement)(t, this.getRootProps(j(t))) : void 0 : null
                        }, t
                    }(l.Component);
            ...
            a.a.array.isRequired, a.a.func, a.a.func, a.a.func, a.a.bool, a.a.number, a.a.number, a.a.number, a.a.bool, a.a.bool, a.a.bool, a.a.any, a.a.any, a.a.any, a.a.string, a.a.string, a.a.string, a.a.func, a.a.string, a.a.func, a.a.func, a.a.func, a.a.func, a.a.func, a.a.shape({
            ...
            a.a.array.isRequired, a.a.func, a.a.func, a.a.func, a.a.bool, a.a.number, a.a.number, a.a.number, a.a.bool, a.a.bool, a.a.bool, a.a.any, a.a.any, a.a.any, a.a.string, a.a.string, a.a.string, a.a.string, a.a.string, a.a.string, a.a.func, a.a.string, a.a.string, a.a.func, a.a.func, a.a.func, a.a.func, a.a.func, a.a.func, a.a.shape({
                addEventListener: a.a.func,
                removeEventListener: a.a.func,
                document: a.a.shape({
                    getElementById: a.a.func,
        ...
        "../../node_modules/lodash-es/_isIterateeCall.js": function(e, t, n) {
            ...
            t.a = function(e, t, n) {
                ...
                var u = typeof t;
                return !!("number" == u ? Object(i.a)(n) && Object(r.a)(t, n.length) : "string" == u && t in n) && Object(o.a)(n[t], e)
            }
        },
        "../../node_modules/lodash-es/_overRest.js": function(e, t, n) {
            ...
            t.a = function(e, t, n) {
                return t = i(void 0 === t ? e.length - 1 : t, 0),
                    function() {
                        for (var r = arguments, s = -1, u = i(r.length - t, 0), a = Array(u); ++s < u;) a[s] = r[t + s];
                        s = -1;
        ...
        "../../node_modules/lodash-es/sortBy.js": function(e, t, n) {
            ...
            var a = function(e, t) {
                ...
                d = a((function(e, t) {
                    if (null == e) return [];
                    var n = t.length;
                    return n > 1 && Object(l.a)(e, t[0], t[1]) ? t = [] : n > 2 && Object(l.a)(t[0], t[1], t[2]) && (t = [t[0]]), Object(i.a)(e, Object(o.a)(t, 1), [])
                }));
            t.a = d
        }
    }
