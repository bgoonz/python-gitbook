(this.csbJsonP = this.csbJsonP || []).push([
    ["default~app~embed~sandbox"], {
        "../../standalone-packages/codesandbox-browserfs/dist/shims/fs.js": function(e, t) {
                ...
                function(e) {
                    ...
                    var a = function(e, t, n, o) {
                        ...
                        u = function() {
                            function e(e, t, n) {
                                var o = this;
                                this.type = e, this.handleMessage = t, this.target = n, this.outgoingMessages = new Set, this._messageListener = function(e) {
                                    return a(o, void 0, void 0, (function() {
                                        var t, n, o;
                                        return l(this, (function(s) {
                                            switch (s.label) {
                                                case 0:
                                                    return (t = e.data).$type !== this.getTypeId() || this.outgoingMessages.has(t.$id) ? [2] : [4, this.handleMessage(t.$data)];
                                                case 1:
                                                    return n = s.sent(), o = {
                                                        ...
                                                        $data: n,
                                                        $id: t.$id
                                                    }, e.source ? e.source.postMessage(o, "*") : this._postMessage(o), [2]
                                            }
                                        }))
                                    }))
                                }, this.createConnection(), this.internalId = c(), this.isWorker = "Worker" === function(e) {
                                    try {
                            ...
                            return e.prototype.getTypeId = function() {
                                ...
                                return new Promise((function(n) {
                                    ...
                                    var r = function(e) {
                                        var s = e.data;
                                        s.$type === t.getTypeId() && s.$id === o && s.$originId !== t.internalId && (n(s.$data), self.removeEventListener("message", r))
                                    };
                                    self.addEventListener("message", r), t._postMessage(s)
                                }))
                            }, e.prototype._postMessage = function(e) {
                                this.isWorker || "undefined" !== typeof DedicatedWorkerGlobalScope && this.target instanceof DedicatedWorkerGlobalScope ? this.target.postMessage(e) : this.target.postMessage(e, "*")
                            }, e
                        }();
                    var d = Object.freeze({
                        show: function(e, t, n) {
                            return void 0 === t && (t = "notice"), void 0 === n && (n = 2), {
                                type: "action",
                                action: "notification",
                                title: e,
                                notificationType: t,
                    ...
                    var h = {
                        ...
                        b = "undefined" !== typeof e && "https://codesandbox.io" || "https://codesandbox.io",
                        g = function() {
                        ...
                        j = new Map;
                    var y, x = "undefined" === typeof window || !!(window.location && window.location.href.indexOf("?standalone") > -1) || !window.opener && window.parent === window || !!(window.location && window.location.href.indexOf(b) > -1),
                        _ = !1,
                        ...
                        S = function(e) {
                            var t;
                            "register-frame" !== e.data.type || O || (w = e.data.origin, O = null !== (t = e.data.id) && void 0 !== t ? t : null, _ || (y(), _ = !0), self.removeEventListener("message", S))
                        };
                            ...
                            null !== O && (t.$id = O), E(t),
                                function(e) {
                                    ...
                                    j.forEach((function(e, n) {
                                        n && n.postMessage && n.postMessage(g(g({}, t), {
                                            codesandbox: !0
                                        }), e)
                                    }))
                                }(t), x || null === w && "initialized" !== e.type || (window.opener ? window.opener.postMessage(t, null === w ? "*" : w) : window.parent.postMessage(t, null === w ? "*" : w))
                        }
                    }
                    ...
                    function U(e) {
                        if (("initialized" === e.data.type || x) && (_ = !0), _) {
                            var t = e.data;
                            !t || !t.codesandbox || null !== w && e.origin !== w || null != t.$id && null !== O && O !== t.$id || E(t, e.source)
                        }
                    }

                    function A(e, t, n) {
                        j.set(e, t), e.postMessage({
                            type: "register-frame",
                    ...
                    "undefined" !== typeof window && window.addEventListener("message", U)
            ...
            var o = function() {
                var e = {
                        ...
                        parse: function(e) {
                            ...
                            s.push(u), "function" === typeof this.yy.parseError && (this.parseError = this.yy.parseError);
                            for (var p, m, f, h, b, g, j, y, x, _, v = {};;) {
                                if (f = n[n.length - 1], this.defaultActions[f] ? h = this.defaultActions[f] : (null == p && (p = d()), h = r[f] && r[f][p]), "undefined" === typeof h || !h.length || !h[0]) {
                                    if (!c) {
                                        for (g in x = [], r[f]) this.terminals_[g] && g > 2 && x.push("'" + this.terminals_[g] + "'");
                                        var w = "";
                                        w = this.lexer.showPosition ? "Parse error on line " + (a + 1) + ":\n" + this.lexer.showPosition() + "\nExpecting " + x.join(", ") + ", got '" + this.terminals_[p] + "'" : "Parse error on line " + (a + 1) + ": Unexpected " + (1 == p ? "end of input" : "'" + (this.terminals_[p] || p) + "'"), this.parseError(w, {
                                    ...
                                    if (3 == c) {
                                        ...
                                        l = this.lexer.yyleng, i = this.lexer.yytext, a = this.lexer.yylineno, u = this.lexer.yylloc, p = d()
                                    }
                                    for (; !(2..toString() in r[f]);) {
                                        if (0 == f) throw new Error(w || "Parsing halted.");
                                        _ = 1, n.length = n.length - 2 * _, o.length = o.length - _, s.length = s.length - _, f = n[n.length - 1]
                                    }
                                    m = p, p = 2, h = r[f = n[n.length - 1]] && r[f][2], c = 3
                                }
                                if (h[0] instanceof Array && h.length > 1) throw new Error("Parse Error: multiple actions possible at state: " + f + ", token: " + p);
                                switch (h[0]) {
                                    case 1:
                                        n.push(p), o.push(this.lexer.yytext), s.push(this.lexer.yylloc), n.push(h[1]), p = null, m ? (p = m, m = null) : (l = this.lexer.yyleng, i = this.lexer.yytext, a = this.lexer.yylineno, u = this.lexer.yylloc, c > 0 && c--);
                                        break;
                                    case 2:
                                        if (j = this.productions_[h[1]][1], v.$ = o[o.length - j], v._$ = {
                                                first_line: s[s.length - (j || 1)].first_line,
                                                last_line: s[s.length - 1].last_line,
                                                first_column: s[s.length - (j || 1)].first_column,
                                                last_column: s[s.length - 1].last_column
                                            }, "undefined" !== typeof(b = this.performAction.call(v, i, l, a, this.yy, h[1], o, s))) return b;
                                        j && (n = n.slice(0, -1 * j * 2), o = o.slice(0, -1 * j), s = s.slice(0, -1 * j)), n.push(this.productions_[h[1]][0]), o.push(v.$), s.push(v._$), y = r[n[n.length - 2]][n[n.length - 1]], n.push(y);
                                        break;
                                    case 3:
                                        return !0
                                }
                    ...
                    t = function() {
                        var e = {
                            ...
                            next: function() {
                                ...
                                for (var r = this._currentRules(), i = 0; i < r.length && (!(n = this._input.match(this.rules[r[i]])) || t && !(n[0].length > t[0].length) || (t = n, o = i, this.options.flex)); i++);
                                return t ? ((s = t[0].match(/\n.*/g)) && (this.yylineno += s.length), this.yylloc = {
                                    first_line: this.yylloc.last_line,
                                    last_line: this.yylineno + 1,
                                    first_column: this.yylloc.last_column,
                                    last_column: s ? s[s.length - 1].length - 1 : this.yylloc.last_column + t[0].length
        ...
        "../common/lib/load-dynamic-polyfills.js": function(e, t, n) {
            ...
            t.default = function() {
                const e = [];
                return (a.default() || "undefined" === typeof Object.entries) && e.push(Promise.resolve().then(() => r(n("../../node_modules/@babel/polyfill/lib/index.js")))), "undefined" === typeof Error.captureStackTrace && e.push(Promise.resolve().then(() => r(n("../../node_modules/error-polyfill/index.js")))), Promise.all(e)
            }
        },
        ...
        "../common/lib/sandbox/modules.js": function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.inDirectory = t.resolveDirectoryWrapped = t.resolveModuleWrapped = t.findCurrentModule = t.findMainModule = t.isMainModule = t.getChildren = t.getDirectoryPath = t.getModulePath = t.resolveModule = t.getModulesInDirectory = t.getModulesAndDirectoriesInDirectory = t.resolveDirectory = void 0;
            ...
            function c(e, t, n, o) {
                ...
                let s = e,
                    r = o;
                s.startsWith("{{sandboxRoot}}") && (r = void 0, s = e.replace("{{sandboxRoot}}/", "./"));
                const i = s.replace(/^.\//, "").split("/").filter(Boolean),
                    c = i.reduce((e, t, o) => {
                        ...
                        const r = n.filter(t => t.directoryShortid == e).find(e => a(e.title, t, []));
            ...
            function u(e, t, n, o) {
                if (!e) return l("");
                let s = e;
                s.startsWith("{{sandboxRoot}}") && (s = e.replace("{{sandboxRoot}}/", "./"));
            ...
            t.resolveDirectory = c, t.getModulesAndDirectoriesInDirectory = function(e, t, n) {
                const {
                    path: o
                } = e, s = o + "/";
                return {
                    removedModules: t.filter(e => e.path.startsWith(s)),
                    removedDirectories: n.filter(t => t.path.startsWith(s) && t !== e)
                }
            }, t.getModulesInDirectory = u, t.resolveModule = (e, t, n, o, s = ["js", "jsx", "json"]) => {
                const {
                    modules: r,
                    lastPath: i,
                    splitPath: c,
                    foundDirectoryShortid: d
                } = u(e, t, n, o), p = r.find(e => a(e.title, i, s));
                if (p) return p;
                const m = n.filter(e => e.directoryShortid == d).find(e => a(e.title, i, s));
                if (m) {
                    const n = t.find(e => e.directoryShortid == m.shortid && a(e.title, "index", s));
                    return null == n && l(e), n
                }
                if ("" === c[c.length - 1]) {
            ...
            t.getModulePath = (e, t, n) => p(e, 0, t, n), t.getDirectoryPath = (e, t, n) => p(t, 0, t, n), t.getChildren = s.default((e = [], t = [], n) => [...t.filter(e => e.directoryShortid === n), ...e.filter(e => e.directoryShortid === n)], (e, t, n) => n + e.map(e => e.id + e.title + e.directoryShortid).join(",") + t.map(e => e.id + e.title + e.directoryShortid).join(",")), t.isMainModule = (e, n, o, s = "index.js") => t.getModulePath(n, o, e.id).replace("/", "") === s, t.findMainModule = e => {
                ...
                return i || e.find(e => e.id === o) || e.find(e => e.shortid === o) || s
            ...
            t.inDirectory = s.default((e, t, n) => {
                ...
                return !1
            }, (e, t, n) => t + n + e.map(e => e.id + e.title + e.directoryShortid).join(","))
        },
        "../common/lib/templates/adonis.js": function(e, t, n) {
            ...
            t.default = new s.default("adonis", "AdonisJs", "https://adonisjs.com/", "github/adonisjs/adonis-starter-codesandbox", r.decorateSelector(() => "#fff"), {
        ...
        "../common/lib/templates/angular.js": function(e, t, n) {
            ...
            class l extends r.default {
                getEntries(e) {
                    ...
                    try {
                        if (e["angular-config"].generated) {
                            ...
                            t = t.concat(function(e) {
                                ...
                                if (e) {
                                    ...
                                    n && n.root && n.main && t.push(s.absolute(s.join(n.root, n.main)))
                                }
                                return t
                            }(n))
                        } else {
                            ...
                            t = t.concat(function(e) {
                                ...
                                if (e) {
                                    ...
                                    if (o && o.architect) {
                                        ...
                                        e.options.main && t.push(s.absolute(s.join(o.root, e.options.main)))
                                    }
                                }
                                return t
                            }(n))
                        ...
                        console.warn(`${e["angular-config"].path} is malformed: ${n.message}`)
                    }
                    return e.package.parsed && e.package.parsed.main && t.push(s.absolute(e.package.parsed.main)), t.push("/src/main.ts"), t.push("/main.ts"), t
                }
                getHTMLEntries(e) {
                    let t = [];
                    if (e["angular-config"].generated) {
                        if (e["angular-cli"]) {
                            ...
                            t = t.concat(function(e) {
                                if (e) {
                                    ...
                                    if (t && t.root && t.index) return [s.absolute(s.join(t.root, t.index))]
                                }
                                return []
                            }(n))
                        }
                        ...
                        t = t.concat(function(e) {
                            if (e) {
                                ...
                                if (n && n.architect) {
                                    ...
                                    if (e && null != n.root && e.options && e.options.index) return [s.absolute(s.join(n.root, e.options.index))]
                                }
                            }
                            return []
                        }(n))
            ...
            t.default = new l("angular-cli", "Angular", "https://github.com/angular/angular", "angular", a.decorateSelector(() => "#DD0031"), {
                extraConfigurations: {
        ...
        "../common/lib/templates/apollo-server.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js");
            t.default = new s.default("apollo", "Apollo", "https://www.apollographql.com/docs/apollo-server/", "apollo-server", r.decorateSelector(() => "#c4198b"), {
                staticDeployment: !1,
        ...
        "../common/lib/templates/babel.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js"),
                i = o(n("../common/lib/templates/configuration/index.js"));
            t.default = new s.default("babel-repl", "Babel", "https://github.com/@babel/core", "babel", r.decorateSelector(() => "#F5DA55"), {
                extraConfigurations: {
        ...
        "../common/lib/templates/configuration/angular-cli/index.js": function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
        ...
        "../common/lib/templates/configuration/angular-json/index.js": function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
        ...
        "../common/lib/templates/configuration/babel-transpiler/index.js": function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
        ...
        "../common/lib/templates/configuration/babelrc/index.js": function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
                    ...
                    getDefaultCode: (e, t) => {
                        ...
                        try {
                            const e = t("/package.json"),
                                r = JSON.parse(e.code || "");
                            n = o.isBabel7(r.dependencies, r.devDependencies), i = s.isPreact10(r.dependencies, r.devDependencies)
                        } catch (a) {
                            console.error(a)
                        }
                        if ("preact-cli" === e) return i ? JSON.stringify({
                            presets: ["env", "typescript"],
                            plugins: ["syntax-dynamic-import", "transform-object-assign", ["proposal-decorators", {
                                    legacy: !0
                                }],
                                ["proposal-class-properties", {
                                    loose: !0
                                }], "proposal-object-rest-spread", "babel-plugin-macros", ["transform-react-jsx", {
                                    pragma: "h",
                                    pragmaFrag: "Fragment"
                                }],
                                ["jsx-pragmatic", {
                        ...
                        if ("vue-cli" === e) return n ? JSON.stringify({
                            presets: [
                                ["env", {
                                    modules: !1,
                                    targets: {
                            ...
                            plugins: ["@vue/babel-plugin-jsx", "@babel/plugin-syntax-dynamic-import", ["@babel/plugin-proposal-decorators", {
                        ...
                        if ("parcel" === e) {
                            ...
                            if (i) try {
                                ...
                                Object.keys(r).forEach(n => {
                                    (e.dependencies && e.dependencies[n] || e.devDependencies && e.devDependencies[n]) && (t = r[n])
                                }), null !== t && o.push(["transform-react-jsx", {
                                    pragma: t
                                }])
                            } catch (a) {}
                        ...
                        return "cxjs" === e ? n ? JSON.stringify({
                            presets: ["env"],
        ...
        "../common/lib/templates/configuration/custom-codesandbox/index.js": function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
        ...
        "../common/lib/templates/configuration/index.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/configuration/package-json/index.js")),
                ...
                f = o(n("../common/lib/templates/configuration/babel-transpiler/index.js")),
                h = o(n("../common/lib/templates/configuration/custom-codesandbox/index.js")),
                b = {
                    babelrc: a.default,
        ...
        "../common/lib/templates/configuration/jsconfig/index.js": function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
            const o = {
                ...
                getDefaultCode: (e, t) => JSON.stringify({
                    compilerOptions: {
                        baseUrl: "."
                    }
                }, null, 2),
        ...
        "../common/lib/templates/configuration/netlify/index.js": function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
        ...
        "../common/lib/templates/configuration/package-json/index.js": function(e, t, n) {
            "use strict";
            var o = this && this.__importDefault || function(e) {
                return e && e.__esModule ? e : {
                    default: e
        ...
        "../common/lib/templates/configuration/parse.js": function(e, t, n) {
            ...
            function a(e, t) {
                return "title" in e ? e.title.includes(t) : "path" in e && e.path.includes(t)
            }
            t.default = function(e, t, n, o) {
                ...
                for (let d = 0; d < c.length; d++) {
                    ...
                    if (b) try {
                        let e;
                        e = m && a(m, "toml") ? s.default(b) : m && a(m, "tsconfig.json") ? r.parse(b.replace(/\\"|"(?:\\"|[^"])*"|(\/\/.*|\/\*[\s\S]*?\*\/)/g, (e, t) => t ? "" : e)) : r.parse(b), l[f.type] = Object.assign(Object.assign({}, h), {
                            parsed: e
                        })
                    } catch (u) {
        ...
        "../common/lib/templates/configuration/prettierRC/index.js": function(e, t, n) {
            "use strict";
            var o = this && this.__importDefault || function(e) {
                return e && e.__esModule ? e : {
                    default: e
            ...
            const s = o(n("../common/lib/prettify-default-config.js")),
                r = {
                    ...
                    generateFileFromState: e => JSON.stringify(Object.assign(Object.assign({}, s.default), e || {}), null, 2),
                    schema: "https://raw.githubusercontent.com/SchemaStore/schemastore/master/src/schemas/json/prettierrc.json"
                };
            t.default = r
        },
        "../common/lib/templates/configuration/sandbox/index.js": function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
        ...
        "../common/lib/templates/configuration/tsconfig/index.js": function(e, t, n) {
            "use strict";
            Object.defineProperty(t, "__esModule", {
                value: !0
            });
            const o = {
                ...
                s = {
                    ...
                    getDefaultCode: (e, t) => {
                        if ("create-react-app-typescript" === e) return JSON.stringify({
                            compilerOptions: {
                                outDir: "build/dist",
                                module: "esnext",
                                target: "es5",
                        ...
                        if ("parcel" === e) {
                            ...
                            if (s) try {
                                ...
                                Object.keys(o).forEach(e => {
                                    (t.dependencies && t.dependencies[e] || t.devDependencies && t.devDependencies[e]) && (n = o[e])
                                }), null !== n && (e.compilerOptions.jsx = "react", e.compilerOptions.jsxFactory = n)
                            } catch (n) {}
                            return JSON.stringify(e, null, 2)
                        }
                        return "nest" === e ? JSON.stringify({
                            compilerOptions: {
                                module: "commonjs",
                                declaration: !0,
                                noImplicitAny: !1,
                        ...
                        }, null, 2) : "@dojo/cli-create-app" === e ? JSON.stringify({
                            compilerOptions: {
                                declaration: !1,
                                experimentalDecorators: !0,
                                jsx: "react",
        ...
        "../common/lib/templates/custom.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js"),
                i = o(n("../common/lib/templates/configuration/index.js"));
            t.default = new s.default("custom", "Custom", "https://codesandbox.io", "custom", r.decorateSelector(() => "#F5DA55"), {
                extraConfigurations: {
        ...
        "../common/lib/templates/cxjs.js": function(e, t, n) {
            ...
            t.default = new a("cxjs", "CxJS", "https://cxjs.io/", "github/codaxy/cxjs-codesandbox-template", r.decorateSelector(() => "#11689f"), {
                showOnHomePage: !0,
                showCube: !1,
                extraConfigurations: {
                    "/.babelrc": i.default.babelrc,
        ...
        "../common/lib/templates/docusaurus.js": function(e, t, n) {
            ...
            t.DocusaurusTemplate = i, t.default = new i("docusaurus", "Docusaurus", "https://docusaurus.io/", "github/facebook/docusaurus/tree/master/examples/classic", r.decorateSelector(() => "#3ECC5F"), {
                mainFile: [],
                distDir: "build",
                showOnHomePage: !0
            })
        ...
        "../common/lib/templates/dojo.js": function(e, t, n) {
            ...
            t.DojoTemplate = a, t.default = new a("@dojo/cli-create-app", "Dojo", "https://github.com/dojo/cli-create-app", "github/dojo/dojo-codesandbox-template", r.decorateSelector(() => "#D3471C"), {
                showOnHomePage: !0,
                showCube: !1,
                distDir: "output/dist",
                isTypescript: !0,
        ...
        "../common/lib/templates/ember.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js");
            t.default = new s.default("ember", "Ember", "https://emberjs.com/", "github/NullVoxPopuli/ember-new-output/tree/stable", r.decorateSelector(() => "#E04E39"), {
                showOnHomePage: !0,
                main: !1,
                staticDeployment: !1
            })
        ...
        "../common/lib/templates/esmodule-react.js": function(e, t, n) {
            ...
            t.default = new i.ReactTemplate("esm-react", "React - ESModules", "https://github.com/facebookincubator/create-react-app", "esm-react", s.decorateSelector(() => "#61DAFB"), {
                showOnHomePage: !1,
                popular: !1,
                main: !1,
        ...
        "../common/lib/templates/gatsby.js": function(e, t, n) {
            ...
            t.default = new a("gatsby", "Gatsby", "https://www.gatsbyjs.org/", "github/gatsbyjs/gatsby-starter-default", r.decorateSelector(() => "#8C65B3"), {
                extraConfigurations: {
                    "/.babelrc": i.default.babelrc
                },
                distDir: "public",
        ...
        "../common/lib/templates/gridsome.js": function(e, t, n) {
            ...
            t.default = new i("gridsome", "Gridsome", "https://gridsome.org/", "github/SaraVieira/gridsome-starter-codesandbox", r.decorateSelector(() => "#00a672"), {
                distDir: "dist",
        ...
        "../common/lib/templates/helpers/is-server.js": function(e, t, n) {
            ...
            const o = ["adonis", "apollo", "ember", "gatsby", "gridsome", "marko", "mdx-deck", "nest", "next", "node", "nuxt", "quasar", "sapper", "styleguidist", "unibit", "vuepress", "docusaurus"];
        ...
        "../common/lib/templates/helpers/react-template.js": function(e, t, n) {
            ...
            class r extends s.default {
                ...
                getDefaultOpenedFiles(e) {
                    let t = [];
                    return t.push("/src/App.js"), t.push("/src/App.tsx"), t = t.concat(this.getEntries(e)), t
                }
            }
            t.ReactTemplate = r
        },
        "../common/lib/templates/index.js": function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.unibit = t.quasar = t.mdxDeck = t.docusaurus = t.vuepress = t.gridsome = t.styleguidist = t.staticTemplate = t.ember = t.nest = t.sapper = t.vue = t.svelte = t.reason = t.reactTs = t.react = t.preact = t.parcel = t.dojo = t.cxjs = t.babel = t.esmReact = t.node = t.nuxt = t.next = t.marko = t.gatsby = t.apollo = t.custom = t.angular = t.adonis = void 0;
            ...
            t.esmReact = C.default, t.default = function(e) {
                switch (e) {
                    case s.default.name:
                        return s.default;
                    case w.default.name:
        ...
        "../common/lib/templates/marko.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js");
            t.default = new s.default("marko", "Marko", "https://markojs.com/", "github/nm123github/marko-codesandbox", r.decorateSelector(() => "#f5ac00"), {
                showOnHomePage: !0,
                main: !1,
                staticDeployment: !1
            })
        ...
        "../common/lib/templates/mdx-deck.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js");
            t.default = new s.default("mdx-deck", "MDX Deck", "https://github.com/jxnblk/mdx-deck", "github/jxnblk/mdx-deck/tree/master/templates/basic", r.decorateSelector(() => "#FAD961"), {
                distDir: "dist",
                mainFile: ["deck.mdx"],
                showOnHomePage: !0,
                githubPagesDeploy: !1
        ...
        "../common/lib/templates/nest.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js"),
                i = o(n("../common/lib/templates/configuration/index.js"));
            t.default = new s.default("nest", "Nest", "https://nestjs.com/", "github/nestjs/typescript-starter", r.decorateSelector(() => "#ed2945"), {
                extraConfigurations: {
                    "/tsconfig.json": i.default.tsconfig
                },
        ...
        "../common/lib/templates/next.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js"),
                i = o(n("../common/lib/templates/configuration/index.js"));
            t.default = new s.default("next", "Next.js", "https://nextjs.org/", "github/zeit/next.js/tree/master/examples/hello-world", r.decorateSelector(() => "#ffffff"), {
                extraConfigurations: {
                    "/.babelrc": i.default.babelrc
                },
                distDir: "out",
        ...
        "../common/lib/templates/node.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js");
            t.default = new s.default("node", "Node", "https://codesandbox.io/docs/environment#container-environment", "node", r.decorateSelector(() => "#66cc33"), {
                showOnHomePage: !0,
                main: !0,
                staticDeployment: !1,
                popular: !0,
        ...
        "../common/lib/templates/nuxt.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js"),
                i = o(n("../common/lib/templates/configuration/index.js"));
            t.default = new s.default("nuxt", "Nuxt.js", "https://nuxtjs.org/", "github/nuxt/codesandbox-nuxt", r.decorateSelector(() => "#3B8070"), {
                extraConfigurations: {
                    "/.babelrc": i.default.babelrc
                },
                distDir: "dist",
        ...
        "../common/lib/templates/parcel.js": function(e, t, n) {
            ...
            class l extends r.default {
                getEntries(e) {
                    const t = [];
                    return "undefined" !== typeof document && "/" !== document.location.pathname && t.push(document.location.pathname), t.push(e.package && e.package.parsed && e.package.parsed.main && s.absolute(e.package.parsed.main)), t.push("/index.html"), t.push("/src/index.html"), t.filter(Boolean)
                }
                getDefaultOpenedFiles(e) {
                    let t = [];
                    return t.push("/index.js"), t.push("/src/index.js"), t.push("/index.ts"), t.push("/src/index.ts"), t = t.concat(this.getEntries(e)), t
                }
            }
            t.ParcelTemplate = l, t.default = new l("parcel", "Vanilla", "https://parceljs.org/", "vanilla", i.decorateSelector(() => "#dfb07a"), {
                showOnHomePage: !0,
                showCube: !0,
                extraConfigurations: {
        ...
        "../common/lib/templates/preact.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js"),
                i = o(n("../common/lib/templates/configuration/index.js"));
            t.default = new s.default("preact-cli", "Preact", "https://github.com/developit/preact-cli", "preact", r.decorateSelector(() => "#AD78DC"), {
                showOnHomePage: !0,
                extraConfigurations: {
                    "/.babelrc": i.default.babelrc
                },
        ...
        "../common/lib/templates/quasar.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js");
            t.default = new s.default("quasar", "Quasar", "https://quasar-framework.org/", "github/quasarframework/quasar-codesandbox", r.decorateSelector(() => "#43A4F2"), {
                mainFile: ["/src/pages/Index.vue"],
                showOnHomePage: !0,
                staticDeployment: !1
            })
        ...
        "../common/lib/templates/react-ts.js": function(e, t, n) {
            ...
            const s = n("../common/lib/utils/decorate-selector.js"),
                ...
                i = o(n("../common/lib/templates/configuration/index.js"));
            t.default = new r.ReactTemplate("create-react-app-typescript", "React + TS", "https://github.com/wmonk/create-react-app-typescript", "react-ts", s.decorateSelector(() => "#009fff"), {
                isTypescript: !0,
                showOnHomePage: !1,
                extraConfigurations: {
                    "/tsconfig.json": i.default.tsconfig
        ...
        "../common/lib/templates/react.js": function(e, t, n) {
            ...
            const s = n("../common/lib/utils/decorate-selector.js"),
                r = o(n("../common/lib/templates/configuration/index.js")),
                i = n("../common/lib/templates/helpers/react-template.js");
            t.default = new i.ReactTemplate("create-react-app", "React", "https://github.com/facebookincubator/create-react-app", "new", s.decorateSelector(() => "#61DAFB"), {
                showOnHomePage: !0,
                popular: !0,
                main: !0,
                mainFile: ["/src/index.js", "/src/index.tsx", "/src/index.ts"],
        ...
        "../common/lib/templates/reason.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js");
            t.default = new s.default("reason", "Reason", "https://reasonml.github.io/reason-react/en/", "reason", r.decorateSelector(() => "#CB5747"), {
                showOnHomePage: !0,
                main: !1,
                staticDeployment: !1,
        ...
        "../common/lib/templates/sapper.js": function(e, t, n) {
            ...
            t.default = new r.default("sapper", "Sapper", "https://sapper.svelte.dev/", "github/codesandbox-app/sapper-template", i.decorateSelector(() => "#159497"), {
                extraConfigurations: {
        ...
        "../common/lib/templates/static.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js");
            t.default = new s.default("static", "Static", "https://developer.mozilla.org/en-US/docs/Learn/HTML", "github/codesandbox-app/static-template", r.decorateSelector(() => "#3AA855"), {
                showOnHomePage: !0,
                distDir: "./",
                main: !1,
                mainFile: ["/index.html"]
        ...
        "../common/lib/templates/styleguidist.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js"),
                i = o(n("../common/lib/templates/configuration/index.js"));
            t.default = new s.default("styleguidist", "Styleguidist", "https://react-styleguidist.js.org/", "github/styleguidist/example", r.decorateSelector(() => "#25d8fc"), {
                extraConfigurations: {
                    "/.babelrc": i.default.babelrc
                },
                distDir: "styleguide",
        ...
        "../common/lib/templates/svelte.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js");
            t.default = new s.default("svelte", "Svelte", "https://svelte.dev", "svelte", r.decorateSelector(() => "#FF3E00"), {
                showOnHomePage: !0,
                showCube: !1,
                distDir: "public",
                mainFile: ["/app.svelte"]
        ...
        "../common/lib/templates/template.js": function(e, t, n) {
            ...
            t.default = class {
                    ...
                    this.alterDeploymentData = e => {
                        const t = e.files.find(e => "package.json" === e.file),
                            ...
                            o = Object.assign(Object.assign({}, n), {
                                devDependencies: Object.assign(Object.assign({}, n.devDependencies), {
                                    serve: "^10.1.1"
                                }),
                        ...
                        return Object.assign(Object.assign({}, e), {
                            files: [...e.files.filter(e => "package.json" !== e.file), {
                                file: "package.json",
                                data: JSON.stringify(o, null, 2)
                            }]
                        })
                    }, this.name = e, this.niceName = t, this.url = n, this.shortid = o, this.color = s, this.popular = r.popular || !1, this.isServer = i.isServer(this.name), this.main = r.main || !1, this.showOnHomePage = r.showOnHomePage || !1, this.distDir = r.distDir || "build", this.configurationFiles = Object.assign(Object.assign({}, a), r.extraConfigurations || {}), this.isTypescript = r.isTypescript || !1, this.externalResourcesEnabled = null == r.externalResourcesEnabled || r.externalResourcesEnabled, this.mainFile = r.mainFile, this.staticDeployment = r.staticDeployment, this.githubPagesDeploy = r.githubPagesDeploy, this.backgroundColor = r.backgroundColor, this.showCube = null == r.showCube || r.showCube, this.defaultOpenedFile = r.defaultOpenedFile || []
                }
                ...
                getEntries(e) {
                    var t;
                    return [(null === (t = e.package) || void 0 === t ? void 0 : t.parsed) && this.getMainFromPackage(e.package.parsed), ...this.mainFile || [], "/index." + (this.isTypescript ? "ts" : "js"), "/src/index." + (this.isTypescript ? "ts" : "js"), "/src/index.ts", "/src/index.tsx", "/src/index.js", "/src/pages/index.js", "/src/pages/index.vue", "/index.js", "/index.ts", "/index.tsx", "/README.md", "/package.json"].filter(e => e)
                }
                getDefaultOpenedFiles(e) {
        ...
        "../common/lib/templates/unibit.js": function(e, t, n) {
            ...
            const s = o(n("../common/lib/templates/template.js")),
                r = n("../common/lib/utils/decorate-selector.js");
            t.default = new s.default("unibit", "Unibit", "https://www.stackbit.com", "github/stackbithq/stackbit-theme-universal/tree/master/", r.decorateSelector(() => "#3EB0FD"), {
                distDir: "public",
                popular: !0,
                mainFile: ["README.md"],
                showOnHomePage: !0,
        ...
        "../common/lib/templates/vue.js": function(e, t, n) {
            ...
            t.default = new a("vue-cli", "Vue", "https://github.com/vuejs/vue-cli", "vue", r.decorateSelector(() => "#41B883"), {
                showOnHomePage: !0,
                extraConfigurations: {
                    "/.babelrc": i.default.babelrc,
                    "/tsconfig.json": i.default.tsconfig
        ...
        "../common/lib/templates/vuepress.js": function(e, t, n) {
            ...
            t.VuePressTemplate = i, t.default = new i("vuepress", "VuePress", "https://vuepress.vuejs.org/", "github/vicbergquist/codesandbox-vuepress", r.decorateSelector(() => "#4abf8a"), {
                mainFile: [],
        ...
        "../common/lib/utils/ci.js": function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.formatVersion = t.CSB_PKG_PROTOCOL = void 0, t.CSB_PKG_PROTOCOL = /https:\/\/pkg(-staging)?\.csb.dev/, t.formatVersion = e => {
        ...
        "../common/lib/utils/debug.js": function(e, t, n) {
            ...
            t.default = (() => {
                if ("undefined" === typeof document || !document.location.search.includes("debug")) {
                    const e = o.getGlobal();
                    return t => n => {
                        if ("object" === typeof e.Raven) try {
        ...
        "../common/lib/utils/decorate-selector.js": function(e, t, n) {
            ...
            const s = o(n("../common/node_modules/memoize-one/esm/index.js")),
                ...
                i = ["negate", "lighten", "darken", "saturate", "desaturate", "greyscale", "whiten", "blacken", "clearer", "opaquer", "rotate"];
            t.decorateSelector = e => (i.forEach(n => {
                e[n] = s.default((...o) => t.decorateSelector(((e, t, ...n) => (...o) => r.default(e(...o))[t](...n).rgbString())(e, n, ...o)))
            }), e)
        },
        ...
        "../common/lib/utils/global.js": function(e, t, n) {
            ...
            t.commonPostMessage = function(e) {
                "undefined" !== typeof Window ? r.postMessage(e, o.protocolAndHost()) : r.postMessage(e)
            }
        },
        "../common/lib/utils/is-babel-7.js": function(e, t, n) {
            ...
            t.isBabel7 = function(e = {}, t = {}) {
                ...
                return "typescript" in t && !e["@angular/core"] || !! function(e, t) {
                    const n = e["react-scripts"] || t["react-scripts"];
                    return !!n && (/^[a-z]/.test(n) || s.default.intersects(n, "^2.0.0") || s.default.intersects(n, "^3.0.0") || s.default.intersects(n, "^4.0.0"))
                }(e, t)
            }
        },
        ...
        "../common/lib/utils/path.js": function(e, t, n) {
            ...
            (function(e) {
                Object.defineProperty(t, "__esModule", {
                    value: !0
                }), t.relative = t.resolve = t.extname = t.absolute = t.basename = t.dirname = t.join = t.normalize = t.isAbsolute = void 0;
                const n = /^(\/?|)([\s\S]*?)((?:\.{1,2}|[^/]+?|)(\.[^./]*|))(?:[/]*)$/;
                ...
                function o(e, t) {
                    ...
                    for (let o = 0; o < e.length; o += 1) {
                        const s = e[o];
                        s && "." !== s && (".." === s ? n.length && ".." !== n[n.length - 1] ? n.pop() : t && n.push("..") : n.push(s))
                    }
                    return n
                }
                ...
                function r(e) {
                    const t = s(e),
                        n = e && "/" === e[e.length - 1];
                    let r = e;
                    return r = o(r.split("/"), !t).join("/"), r || t || (r = "."), r && n && (r += "/"), (t ? "/" : "") + r
                }
                ...
                t.isAbsolute = s, t.normalize = r, t.join = function(...e) {
                    let t = "";
                    for (let n = 0; n < e.length; n += 1) {
                        const o = e[n];
                        if ("string" !== typeof o) throw new TypeError("Arguments to path.join must be strings");
                        o && (t += t ? "/" + o : o)
                    }
                    return r(t)
                    ...
                    if (t.length > 0) {
                        if (o.substr(o.length - t.length) === t) return o.substr(0, o.length - t.length)
                    }
                    return o
                }, t.absolute = function(e) {
                    return e.startsWith("/") ? e : e.startsWith("./") ? e.replace("./", "/") : "/" + e
                    ...
                    for (let i = e.length - 1; i >= 0; --i) {
                        ...
                        if (47 !== a) - 1 === o && (s = !1, o = i + 1), 46 === a ? -1 === t ? t = i : 1 !== r && (r = 1) : -1 !== t && (r = -1);
                        else if (!s) {
                            n = i + 1;
                            break
                        }
                    }
                    return -1 === t || -1 === o || 0 === r || 1 === r && t === o - 1 && t === n + 1 ? "" : e.slice(t, o)
        ...
        "../common/lib/utils/slugify.js": function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                const t = "\xe0\xe1\xe4\xe2\xe8\xe9\xeb\xea\xec\xed\xef\xee\xf2\xf3\xf6\xf4\xf9\xfa\xfc\xfb\xf1\xe7\xdf\xff\u0153\xe6\u0155\u015b\u0144\u1e55\u1e83\u01f5\u01f9\u1e3f\u01d8\u1e8d\u017a\u1e27\xb7/_,:;",
                    n = new RegExp(t.split("").join("|"), "g");
                return e.toString().toLowerCase().replace(/\s+/g, "-").replace(n, e => "aaaaeeeeiiiioooouuuuncsyoarsnpwgnmuxzh------".charAt(t.indexOf(e))).replace(/&/g, "-and-").replace(/[^\w\-]+/g, "").replace(/\-\-+/g, "-").replace(/^-+/, "").replace(/-+$/, "")
            }
        },
        "../common/lib/utils/url-generator.js": function(e, t, n) {
            ...
            const l = /(https?:\/\/)?((www.)?)github.com/,
                ...
                d = (e, ...t) => e[0] + t.map((t, n) => `${encodeURIComponent(t)}${e[n+1]}`).join("");
            ...
            const p = e => d `github/${e.username}/${e.repo}/tree/${e.branch}/` + e.path;
            t.editorUrl = () => "/s/", t.sandboxUrl = e => {
                if (e.git) {
                    const {
                        git: n
                    } = e;
                ...
                return e.alias ? `${t.editorUrl()}${e.alias}` : `${t.editorUrl()}${e.id}`
            }, t.embedUrl = e => {
                if (e.git) {
                    const {
                        git: t
            ...
            t.frameUrl = (e, n = "", {
                useFallbackDomain: o = !1,
                port: s
            } = {}) => {
                const r = 0 === n.indexOf("/") ? n.substr(1) : n,
                    a = i.isServer(e.template);
                let l = t.host();
                return !("https://" + l in u) || o || a || (l = u["https://" + l].split("//")[1]), `${location.protocol}//${e.id}${s?"-"+s:""}.${a?"sse.":""}${l}/${r}`
            }, t.forkSandboxUrl = e => t.sandboxUrl(e) + "/fork", t.signInPageUrl = e => {
                let t = "/signin";
                return e && (t += "?continue=" + e), t
            }, t.signInUrl = (e = !1) => "/auth/github" + (e ? "?scope=user:email,public_repo" : ""), t.signInVercelUrl = () => "/auth/vercel", t.profileUrl = e => "/u/" + e, t.dashboardUrl = () => "/dashboard", t.exploreUrl = () => "/explore", t.teamOverviewUrl = e => "/dashboard/teams/" + e, t.profileSandboxesUrl = (e, n) => `${t.profileUrl(e)}/sandboxes${n?"/"+n:""}`, t.profileLikesUrl = (e, n) => `${t.profileUrl(e)}/likes${n?"/"+n:""}`, t.githubRepoUrl = ({
                repo: e,
                branch: t,
                username: n,
                path: o
            }) => d `https://github.com/${n}/${e}/tree/${t}/` + o, t.optionsToParameterizedUrl = e => {
                const t = Object.keys(e).sort().filter(t => e[t]).map(t => `${encodeURIComponent(t)}=${encodeURIComponent(e[t])}`).join("&");
                return t ? "?" + t : ""
            }, t.gitHubToSandboxUrl = e => e.replace(l, "/s/github").replace(c, ""), t.gitHubToSandboxBetaUrl = e => e.replace(l, "/github").replace(c, "").replace(/\/tree\//, "/"), t.searchUrl = e => "/search" + (e ? "?query=" + e : ""), t.patronUrl = () => "/patron", t.curatorUrl = () => "/curator", t.tosUrl = () => "/legal/terms", t.privacyUrl = () => "/legal/privacy", t.getSandboxId = function() {
                const e = "https://codesandbox.io";
                let t;
                if ([e, u[e]].filter(Boolean).forEach(e => {
                        const n = e.replace(/https?:\/\//, "").replace(/\./g, "\\."),
                            o = new RegExp("(.*)\\." + n),
                            s = document.location.host.match(o);
                        s && (t = s[1])
                    }), !t) throw new Error("Can't detect sandbox ID from the current URL");
                return t
        ...
        "../common/lib/utils/url-generator/dashboard.js": function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                value: !0
            }), t.discoverSearch = t.discover = t.search = t.createTeam = t.teamInvite = t.permissionSettings = t.registrySettings = t.settings = t.home = t.liked = t.shared = t.deleted = t.recents = t.templates = t.alwaysOn = t.repos = t.drafts = t.beta = t.allSandboxes = t.ALL_SANDBOXES_URL_PREFIX = t.DASHBOARD_URL_PREFIX = void 0, t.DASHBOARD_URL_PREFIX = "/dashboard", t.ALL_SANDBOXES_URL_PREFIX = t.DASHBOARD_URL_PREFIX + "/all", t.allSandboxes = (e, n) => o(`${t.ALL_SANDBOXES_URL_PREFIX}${function(e){return e.split("/").map(e=>e.split(" ").map(encodeURIComponent).join(" ")).join("/")}(e)}`, n), t.beta = () => t.DASHBOARD_URL_PREFIX + "/beta", t.drafts = e => o(t.DASHBOARD_URL_PREFIX + "/drafts", e), t.repos = e => o(t.DASHBOARD_URL_PREFIX + "/repositories", e), t.alwaysOn = e => o(t.DASHBOARD_URL_PREFIX + "/always-on", e), t.templates = e => o(t.DASHBOARD_URL_PREFIX + "/templates", e), t.recents = e => o(t.DASHBOARD_URL_PREFIX + "/recent", e), t.deleted = e => o(t.DASHBOARD_URL_PREFIX + "/deleted", e), t.shared = e => o(t.DASHBOARD_URL_PREFIX + "/shared", e), t.liked = e => o(t.DASHBOARD_URL_PREFIX + "/liked", e), t.home = e => o(t.DASHBOARD_URL_PREFIX + "/home", e), t.settings = e => o(t.DASHBOARD_URL_PREFIX + "/settings", e), t.registrySettings = e => o(t.DASHBOARD_URL_PREFIX + "/settings/npm-registry", e), t.permissionSettings = e => o(t.DASHBOARD_URL_PREFIX + "/settings/permissions", e), t.teamInvite = e => o(t.DASHBOARD_URL_PREFIX + "/settings/invite", e), t.createTeam = e => o(t.DASHBOARD_URL_PREFIX + "/settings/new", e), t.search = (e, n) => {
                let s = o(t.DASHBOARD_URL_PREFIX + "/search", n);
                return s.includes("?") ? s += "&" : s += "?", s += "query=" + e, s
            }, t.discover = (e, n) => o(n ? `${t.DASHBOARD_URL_PREFIX}/discover/${n}` : t.DASHBOARD_URL_PREFIX + "/discover", e), t.discoverSearch = (e, n) => {
        ...
        "./config/polyfills.js": function(e, t, n) {
            ...
            "undefined" === typeof Promise && (n("./node_modules/promise/lib/rejection-tracking.js").enable(), o.Promise = n("./node_modules/promise/lib/es6-extensions.js")), n("../../node_modules/whatwg-fetch/fetch.js"), o.cosmiconfig = {}, o.prettier = {}, o.jsdom = {
                JSDOM: {
                    fragment: function(e) {
            ...
            }, n("../../node_modules/core-js/fn/array/find.js"), n("../../node_modules/core-js/fn/array/from.js"), n("../../node_modules/core-js/fn/object/assign.js"), n("../../node_modules/core-js/fn/symbol/index.js")
        },
        "./config/stubs/lru-cache.js": function(e, t, n) {
            "use strict";
            e.exports = g;
            var o, s = n("../../node_modules/pseudomap/map.js"),
                r = n("../../node_modules/node-libs-browser/node_modules/util/util.js"),
                i = n("./node_modules/yallist/yallist.js"),
                a = (o = "function" === typeof Symbol ? function(e) {
                    return Symbol(e)
                } : function(e) {
                    return "_" + e
                })("max"),
            ...
            function g(e) {
                ...
                var n = e.length || b;
                "function" !== typeof n && (n = b), this[c] = n, this[u] = e.stale || !1, this[d] = e.maxAge || 0, this[p] = e.dispose, this[m] = e.noDisposeOnSet || !1, this.reset()
            }

            function j(e, t, n, o) {
                var s = n.value;
                x(e, s) && (v(e, n), e[u] || (s = void 0)), s && t.call(o, s.value, s.key, e)
            }
            ...
            function y(e, t, n) {
                ...
                if (o) {
                    var s = o.value;
                    x(e, s) ? (v(e, o), e[u] || (s = void 0)) : n && e[f].unshiftNode(o), s && (s = s.value)
                }
                return s
            }
            ...
            function v(e, t) {
                if (t) {
                    var n = t.value;
                    e[p] && e[p](n.key, n.value), e[l] -= n.length, e[h].delete(n.key), e[f].removeNode(t)
                }
            }

            function w(e, t, n, o, s) {
                this.key = e, this.value = t, this.length = n, this.now = o, this.maxAge = s || 0
            }
            Object.defineProperty(g.prototype, "max", {
                set: function(e) {
                    (!e || "number" !== typeof e || e <= 0) && (e = 1 / 0), this[a] = e, _(this)
                },
                get: function() {
                    return this[a]
                },
                ...
                set: function(e) {
                    (!e || "number" !== typeof e || e < 0) && (e = 0), this[d] = e, _(this)
                },
                get: function() {
                    return this[d]
                },
                ...
                set: function(e) {
                    "function" !== typeof e && (e = b), e !== this[c] && (this[c] = e, this[l] = 0, this[f].forEach((function(e) {
                ...
                }), this), this[h] = new s, this[f] = new i, this[l] = 0
                ...
                var i = this[d];
                i && (o && (n += ","), n += "\n  maxAge: " + r.inspect(i, t), o = !0);
                var p = this[c];
                p && p !== b && (o && (n += ","), n += "\n  length: " + r.inspect(this[l], t), o = !0);
                var m = !1;
                return this[f].forEach((function(e) {
                    ...
                    e.maxAge !== i && (a.maxAge = e.maxAge), p !== b && (a.length = e.length), x(this, e) && (a.stale = !0), a = r.inspect(a, t).split("\n").join("\n  "), n += s + " => " + a
                })), (m || o) && (n += "\n"), n += "}"
                ...
                if (this[h].has(e)) {
                    ...
                    return this[p] && (this[m] || this[p](e, r.value)), r.now = o, r.maxAge = n, r.value = t, this[l] += s - r.length, r.length = s, this.get(e), _(this), !0
                }
                var i = new w(e, t, s, o, n);
                return i.length > this[a] ? (this[p] && this[p](e, t), !1) : (this[l] += i.length, this[f].unshift(i), this[h].set(e, this[f].head), _(this), !0)
