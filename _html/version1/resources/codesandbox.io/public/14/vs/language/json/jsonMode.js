...
define("vs/language/json/workerManager", ["require", "exports"], function(e, t) {
        ...
        var c = monaco.Promise,
            n = function() {
                ...
                return e.prototype._stopWorker = function() {
                    ...
                    return this._lastUsedTime = Date.now(), this._client || (this._worker = monaco.editor.createWebWorker({
                    ...
                    for (var t, e, n, r, o, i = this, a = [], s = 0; s < arguments.length; s++) a[s] = arguments[s];
                    return e = this._getClient().then(function(e) {
                        t = e
                    }).then(function(e) {
    ...
    function(e) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            if (Z.number(e) && Z.number(t) && Z.number(n) && Z.number(r)) return {
                start: a.create(e, t),
                end: a.create(n, r)
            };
            ...
            var t = e;
            return Z.defined(t) && r.is(t.range) && (Z.string(t.uri) || Z.undefined(t.uri))
            ...
            var t = e;
            return Z.number(t.red) && Z.number(t.green) && Z.number(t.blue) && Z.number(t.alpha)
            ...
            var t = e;
            return Z.string(t.label) && (Z.undefined(t.textEdit) || C.is(t)) && (Z.undefined(t.additionalTextEdits) || Z.typedArray(t.additionalTextEdits, C.is))
        }, (l = t.FoldingRangeKind || (t.FoldingRangeKind = {})).Comment = "comment", l.Imports = "imports", l.Region = "region", (g = t.FoldingRange || (t.FoldingRange = {})).create = function(e, t, n, r, o) {
            var i = {
                startLine: e,
                endLine: t
            };
            return Z.defined(n) && (i.startCharacter = n), Z.defined(r) && (i.endCharacter = r), Z.defined(o) && (i.kind = o), i
        }, g.is = function(e) {
            var t = e;
            return Z.number(t.startLine) && Z.number(t.startLine) && (Z.undefined(t.startCharacter) || Z.number(t.startCharacter)) && (Z.undefined(t.endCharacter) || Z.number(t.endCharacter)) && (Z.undefined(t.kind) || Z.string(t.kind))
        }, (p = h = t.DiagnosticRelatedInformation || (t.DiagnosticRelatedInformation = {})).create = function(e, t) {
            return {
                location: e,
                message: t
            }
        ...
        }, (m = t.DiagnosticSeverity || (t.DiagnosticSeverity = {})).Error = 1, m.Warning = 2, m.Information = 3, m.Hint = 4, (y = v = t.Diagnostic || (t.Diagnostic = {})).create = function(e, t, n, r, o, i) {
            var a = {
                range: e,
                message: t
            };
            return Z.defined(n) && (a.severity = n), Z.defined(r) && (a.code = r), Z.defined(o) && (a.source = o), Z.defined(i) && (a.relatedInformation = i), a
        }, y.is = function(e) {
            var t = e;
            return Z.defined(t) && r.is(t.range) && Z.string(t.message) && (Z.number(t.severity) || Z.undefined(t.severity)) && (Z.number(t.code) || Z.string(t.code) || Z.undefined(t.code)) && (Z.string(t.source) || Z.undefined(t.source)) && (Z.undefined(t.relatedInformation) || Z.typedArray(t.relatedInformation, h.is))
        ...
        }, (T = E = t.TextDocumentEdit || (t.TextDocumentEdit = {})).create = function(e, t) {
            return {
                textDocument: e,
                edits: t
            }
            ...
            var t = e;
            return t && (void 0 !== t.changes || void 0 !== t.documentChanges) && (void 0 === t.documentChanges || Z.typedArray(t.documentChanges, E.is))
        };
        var S, A, x, O, I, M, j, K, L, P, D, N, R, F, V = function() {
                function e(e) {
                    this.edits = e
                }
                ...
                return Object.defineProperty(e.prototype, "edit", {
                    ...
                    if (A.is(e)) {
                        ...
                        if (!(r = this._textEditChanges[t.uri])) {
                            ...
                            this._workspaceEdit.documentChanges.push(n), r = new V(o), this._textEditChanges[t.uri] = r
                        }
                        return r
                    }
                    if (this._workspaceEdit || (this._workspaceEdit = {
                    ...
                    if (!(r = this._textEditChanges[e])) {
                        var o = [];
                        this._workspaceEdit.changes[e] = o, r = new V(o), this._textEditChanges[e] = r
                    }
                    return r
                }, e
            }();
        t.WorkspaceChange = W, (S = t.TextDocumentIdentifier || (t.TextDocumentIdentifier = {})).create = function(e) {
            return {
                uri: e
            }
        }, S.is = function(e) {
        ...
        }, (x = A = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {})).create = function(e, t) {
            return {
                uri: e,
                version: t
            }
        ...
        }, (O = t.TextDocumentItem || (t.TextDocumentItem = {})).create = function(e, t, n, r) {
            return {
                uri: e,
                languageId: t,
                version: n,
        ...
        }, (M = I = t.MarkupKind || (t.MarkupKind = {})).PlainText = "plaintext", M.Markdown = "markdown", (j = I = t.MarkupKind || (t.MarkupKind = {})).is = function(e) {
            var t = e;
        ...
        }, (L = t.CompletionItemKind || (t.CompletionItemKind = {})).Text = 1, L.Method = 2, L.Function = 3, L.Constructor = 4, L.Field = 5, L.Variable = 6, L.Class = 7, L.Interface = 8, L.Module = 9, L.Property = 10, L.Unit = 11, L.Value = 12, L.Enum = 13, L.Keyword = 14, L.Snippet = 15, L.Color = 16, L.File = 17, L.Reference = 18, L.Folder = 19, L.EnumMember = 20, L.Constant = 21, L.Struct = 22, L.Event = 23, L.Operator = 24, L.TypeParameter = 25, (P = t.InsertTextFormat || (t.InsertTextFormat = {})).PlainText = 1, P.Snippet = 2, (t.CompletionItem || (t.CompletionItem = {})).create = function(e) {
            return {
                label: e
            }
        ...
        }, (N = D = t.MarkedString || (t.MarkedString = {})).fromPlainText = function(e) {
            ...
            var t = e;
            return Z.objectLiteral(t) && (K.is(t.contents) || D.is(t.contents) || Z.typedArray(t.contents, D.is)) && (void 0 === e.range || r.is(e.range))
            ...
            return Z.defined(t) && (o.documentation = t), Z.defined(n) ? o.parameters = n : o.parameters = [], o
        ...
        }, (F = t.SymbolKind || (t.SymbolKind = {})).File = 1, F.Module = 2, F.Namespace = 3, F.Package = 4, F.Class = 5, F.Method = 6, F.Property = 7, F.Field = 8, F.Constructor = 9, F.Enum = 10, F.Interface = 11, F.Function = 12, F.Variable = 13, F.Constant = 14, F.String = 15, F.Number = 16, F.Boolean = 17, F.Array = 18, F.Object = 19, F.Key = 20, F.Null = 21, F.EnumMember = 22, F.Struct = 23, F.Event = 24, F.Operator = 25, F.TypeParameter = 26, (t.SymbolInformation || (t.SymbolInformation = {})).create = function(e, t, n, r, o) {
            var i = {
                name: e,
                kind: t,
                location: {
        ...
        var U, q, B, H, z, J, Y = function() {};
        t.DocumentSymbol = Y, (U = Y = t.DocumentSymbol || (t.DocumentSymbol = {})).create = function(e, t, n, r, o, i) {
            var a = {
                name: e,
                detail: t,
                kind: n,
            ...
            var t = e;
            return t && Z.string(t.name) && Z.string(t.detail) && Z.number(t.kind) && r.is(t.range) && r.is(t.selectionRange) && (void 0 === t.deprecated || Z.boolean(t.deprecated)) && (void 0 === t.children || Array.isArray(t.children))
        }, t.DocumentSymbol = Y, (q = t.CodeActionKind || (t.CodeActionKind = {})).QuickFix = "quickfix", q.Refactor = "refactor", q.RefactorExtract = "refactor.extract", q.RefactorInline = "refactor.inline", q.RefactorRewrite = "refactor.rewrite", q.Source = "source", q.SourceOrganizeImports = "source.organizeImports", (B = t.CodeActionContext || (t.CodeActionContext = {})).create = function(e, t) {
            var n = {
                diagnostics: e
            };
            ...
            var t = e;
            return Z.defined(t) && Z.typedArray(t.diagnostics, v.is) && (void 0 === t.only || Z.typedArray(t.only, Z.string))
        }, (H = t.CodeAction || (t.CodeAction = {})).create = function(e, t, n) {
            var r = {
                title: e
            };
            return b.is(t) ? r.command = t : r.edit = t, void 0 !== n && (r.kind = n), r
        }, H.is = function(e) {
            var t = e;
            return t && Z.string(t.title) && (void 0 === t.diagnostics || Z.typedArray(t.diagnostics, v.is)) && (void 0 === t.kind || Z.string(t.kind)) && (void 0 !== t.edit || void 0 !== t.command) && (void 0 === t.command || b.is(t.command)) && (void 0 === t.edit || w.is(t.edit))
            ...
            var t = e;
            return Z.defined(t) && r.is(t.range) && (Z.undefined(t.command) || b.is(t.command))
        }, (J = t.FormattingOptions || (t.FormattingOptions = {})).create = function(e, t) {
            return {
                tabSize: e,
                insertSpaces: t
            }
        ...
        var G, $, Q, X = function() {};
        t.DocumentLink = X, (G = X = t.DocumentLink || (t.DocumentLink = {})).create = function(e, t, n) {
            return {
                range: e,
                target: t,
                data: n
            ...
            var t = e;
            return Z.defined(t) && r.is(t.range) && (Z.undefined(t.target) || Z.string(t.target))
        }, t.DocumentLink = X, t.EOL = ["\n", "\r\n", "\r"], ($ = t.TextDocument || (t.TextDocument = {})).create = function(e, t, n, r) {
            return new ne(e, t, n, r)
        }, $.is = function(e) {
            var t = e;
            return !!(Z.defined(t) && Z.string(t.uri) && (Z.undefined(t.languageId) || Z.string(t.languageId)) && Z.number(t.lineCount) && Z.func(t.getText) && Z.func(t.positionAt) && Z.func(t.offsetAt))
            ...
            return n
        }, (Q = t.TextDocumentSaveReason || (t.TextDocumentSaveReason = {})).Manual = 1, Q.AfterDelay = 2, Q.FocusOut = 3;
        var Z, ee, te, ne = function() {
            function e(e, t, n, r) {
        ...
        ee = Z || (Z = {}), te = Object.prototype.toString, ee.defined = function(e) {
            return void 0 !== e
        ...
        return e
    }), define("vs/language/json/languageFeatures", ["require", "exports", "vscode-languageserver-types"], function(e, t, i) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        });
        ...
        var n = monaco.Range,
            r = function() {
                function e(e, t, n) {
                    ...
                    var o = function(e) {
                            var t, n = e.getModeId();
                            n === r._languageId && (r._listener[e.uri.toString()] = e.onDidChangeContent(function() {
                    ...
                    this._disposables.push(monaco.editor.onDidCreateModel(o)), this._disposables.push(monaco.editor.onWillDisposeModel(function(e) {
                        i(e), r._resetSchema(e.uri)
                    })), this._disposables.push(monaco.editor.onDidChangeModelLanguage(function(e) {
                        i(e.model), o(e.model), r._resetSchema(e.model.uri)
                    })), this._disposables.push(n.onDidChange(function(e) {
                ...
                return e.prototype.dispose = function() {
                    ...
                    this._worker(r).then(function(e) {
                        return e.doValidation(r.toString()).then(function(e) {
                            ...
                            n.getModeId() === o && monaco.editor.setModelMarkers(n, o, t)
                        })
        ...
        var f = function() {
            ...
            return Object.defineProperty(e.prototype, "triggerCharacters", {
                ...
                var r = e.uri;
                return b(n, this._worker(r).then(function(e) {
                    ...
                    if (e) {
                        var t = e.items.map(function(e) {
                            ...
                            return e.textEdit && (t.range = s(e.textEdit.range), t.insertText = e.textEdit.newText), e.insertTextFormat === i.InsertTextFormat.Snippet && (t.insertText = {
                                value: t.insertText
                            }), t
                        });
                        return {
        ...
        var g = function() {
            ...
            return e.prototype.provideDocumentSymbols = function(e, t) {
                var n = e.uri;
                return b(t, this._worker(n).then(function(e) {
        ...
        var m = function() {
            ...
            return e.prototype.provideDocumentRangeFormattingEdits = function(e, t, n, r) {
                var o = e.uri;
                return b(r, this._worker(o).then(function(e) {
        ...
        var v = function() {
            ...
            return e.prototype.provideDocumentColors = function(e, t) {
                ...
                var r = e.uri;
                return b(n, this._worker(r).then(function(e) {
                    return e.getColorPresentations(r.toString(), t.color, a(t.range))
                }).then(function(e) {
                    if (e) return e.map(function(e) {
                        var t = {
                            label: e.label
                        };
                        return e.textEdit && (t.textEdit = u(e.textEdit)), e.additionalTextEdits && (t.additionalTextEdits = e.additionalTextEdits.map(u)), t
                    })
                }))
            }, e
        }();
        ...
        var y = function() {
            ...
            return e.prototype.provideFoldingRanges = function(e, t, n) {
                var r = e.uri;
                return b(n, this._worker(r).then(function(e) {
        ...
        function b(e, t) {
            return t.cancel && e.onCancellationRequested(function() {
                return t.cancel()
            }), t
        }
    ...
    function(e) {
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            function t() {
                ...
                if (l(e)) {
                    for (; a++, r += String.fromCharCode(e), l(e = i.charCodeAt(a)););
                    return c = 15
                }
                if (g(e)) return a++, r += String.fromCharCode(e), 13 === e && 10 === i.charCodeAt(a) && (a++, r += "\n"), c = 14;
                switch (e) {
                    case 123:
                        return a++, c = 1;
                    case 125:
                    ...
                    case 45:
                        if (r += String.fromCharCode(e), ++a === o || !h(i.charCodeAt(a))) return c = 16;
                    case 48:
                    case 49:
                    case 50:
                    case 51:
    ...
    function(e) {
        ...
        t.format = function(r, e, t) {
            var n, o, i, a, s;
            if (e) {
                for (a = e.offset, s = a + e.length, i = a; 0 < i && !S(r, i - 1);) i--;
                for (var c = s; c < r.length && !S(r, c);) c++;
                o = r.substring(i, c), n = function(e, t) {
            ...
            function y(e, t, n) {
                !h && t < s && a < n && r.substring(t, n) !== e && v.push({
                    offset: t,
                    length: n - t,
                    content: e
                })
            ...
            for (; 17 !== b;) {
                for (var C = g.getTokenOffset() + g.getTokenLength() + i, _ = m(), E = ""; !d && (12 === _ || 13 === _);) y(" ", C, g.getTokenOffset() + i), C = g.getTokenOffset() + g.getTokenLength() + i, E = 12 === _ ? p() : "", _ = m();
                if (2 === _) 1 !== b && (l--, E = p());
    ...
    function(e) {
        ...
        function f(e, t, n) {
            ...
            function y(e, t, n) {
                if (void 0 === t && (t = []), void 0 === n && (n = []), h(e), 0 < t.length + n.length)
                    ...
                    case 3:
                        return function() {
                            ...
                            for (var e = !1; 4 !== o.getToken() && 17 !== o.getToken();) {
                                if (5 === o.getToken()) {
                                    if (e || y(4, [], []), l(","), v(), 4 === o.getToken() && m) break
                                } else e && y(6, [], []);
                                k() || y(4, [], [4, 5]), e = !0
                            }
                    ...
                    case 1:
                        return function() {
                            ...
                            for (var e = !1; 2 !== o.getToken() && 17 !== o.getToken();) {
                                if (5 === o.getToken()) {
                                    if (e || y(4, [], []), l(","), v(), 2 === o.getToken() && m) break
                                } else e && y(6, [], []);
                                (10 !== o.getToken() ? (y(3, [], [2, 5]), 0) : (b(!1), 6 === o.getToken() ? (l(":"), v(), k() || y(4, [], [2, 5])) : y(5, [], [2, 5]), 1)) || y(4, [], [2, 5]), e = !0
                            }
            ...
            return v(), 17 === o.getToken() || (k() ? (17 !== o.getToken() && y(9, [], []), !0) : (y(4, [], []), !1))
        }
        ...
        t.getLocation = function(e, o) {
                ...
                f(e, {
                    ...
                    onSeparator: function(e, t, n) {
                        ...
                        if (":" === e && s && "property" === s.type) s.colonOffset = t, u = !1, s = void 0;
                            ...
                            var r = i[i.length - 1];
                            "number" == typeof r ? i[i.length - 1] = r + 1 : (u = !0, i[i.length - 1] = ""), s = void 0
                        }
                    }
                })
            } catch (e) {
            ...
            if ("property" === t.parent.type) {
                ...
                var o = t.parent.children.indexOf(t); - 1 !== o && n.push(o)
            }
            return n
        ...
        }, t.contains = s, t.findNodeAtOffset = function e(t, n, r) {
            ...
            do {
                switch (r = o.getPosition(), n = o.scan()) {
                    ...
                    case 13:
                    case 17:
                        a !== r && i.push(e.substring(a, r)), void 0 !== t && i.push(o.getTokenValue().replace(/[^\r\n]/g, t)), a = o.getPosition()
                }
            } while (17 !== n);
            return i.join("")
        }
    ...
    function(e) {
        ...
        function r(e, t, n, r, o) {
            for (var i, a = k.parseTree(e, []), s = void 0, c = void 0; 0 < t.length && (c = t.pop(), void 0 === (s = k.findNodeAtLocation(a, t)) && void 0 !== n);) "string" == typeof c ? ((i = {})[c] = n, n = i) : n = [n];
            if (s) {
                if ("object" === s.type && "string" == typeof c && Array.isArray(s.children)) {
                    ...
                    if (void 0 !== u) {
                        if (void 0 === n) {
                            ...
                            else if (d = s.offset + 1, 1 < s.children.length) l = s.children[1].offset;
                            return C(e, {
                                offset: d,
                                length: l - d,
                                content: ""
                ...
                if ("array" === s.type && "number" == typeof c && Array.isArray(s.children)) {
                    ...
                    if (void 0 === n && 0 <= s.children.length) {
                        var m = c,
                            v = s.children[m];
                        p = void 0;
                        if (1 === s.children.length) p = {
                            offset: s.offset + 1,
                            length: s.length - 2,
                            content: ""
                        };
                        else if (s.children.length - 1 === m) {
                            var y, b = (y = s.children[m - 1]).offset + y.length;
                            p = {
                                offset: b,
        ...
        function C(e, t, n) {
            ...
            for (var a = u.format(r, {
                    offset: o,
                    length: i - o
                }, n), s = a.length - 1; 0 <= s; s--) {
                var c = a[s];
                r = f(r, c), o = Math.min(o, c.offset), i = Math.max(i, c.offset + c.length), i += c.content.length - c.length
            }
            return [{
                offset: o,
        ...
        }, t.setProperty = r, t.applyEdit = f, t.isWS = function(e, t) {
            return -1 !== "\r\n \t".indexOf(e.charAt(t))
        }
    }),
    function(e) {
        ...
        return e
    }), define("vs/language/json/tokenization", ["require", "exports", "jsonc-parser"], function(e, g, h) {
        "use strict";
                ...
                tokenize: function(e, t, n, r) {
                    return function(e, t, n, r, o) {
                        ...
                        for (c = {
                            ...
                            if (d === r + u.getPosition()) throw new Error("Scanner did not advance, next 3 characters are: " + t.substr(u.getPosition(), 3));
                            ...
                            c.endState = new p(n.getStateData(), u.getTokenError(), f), c.tokens.push({
                                startIndex: d,
                                scopes: l
                            })
                        }
        ...
        }, g.TOKEN_DELIM_OBJECT = "delimiter.bracket.json", g.TOKEN_DELIM_ARRAY = "delimiter.array.json", g.TOKEN_DELIM_COLON = "delimiter.colon.json", g.TOKEN_DELIM_COMMA = "delimiter.comma.json", g.TOKEN_VALUE_BOOLEAN = "keyword.json", g.TOKEN_VALUE_NULL = "keyword.json", g.TOKEN_VALUE_STRING = "string.value.json", g.TOKEN_VALUE_NUMBER = "number.json", g.TOKEN_PROPERTY_NAME = "string.key.json", g.TOKEN_COMMENT_BLOCK = "comment.block.json", g.TOKEN_COMMENT_LINE = "comment.line.json";
        var p = function() {
            function t(e, t, n) {
            ...
            return t.prototype.clone = function() {
                ...
                return e === this || !!(e && e instanceof t) && (this.scanError === e.scanError && this.lastWasColon === e.lastWasColon)
    ...
    }), define("vs/language/json/jsonMode", ["require", "exports", "./workerManager", "./languageFeatures", "./tokenization"], function(e, t, i, a, s) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
            ...
            var r = function() {
                ...
                o = e.languageId;
            t.push(monaco.languages.registerCompletionItemProvider(o, new a.CompletionAdapter(r))), t.push(monaco.languages.registerHoverProvider(o, new a.HoverAdapter(r))), t.push(monaco.languages.registerDocumentSymbolProvider(o, new a.DocumentSymbolAdapter(r))), t.push(monaco.languages.registerDocumentFormattingEditProvider(o, new a.DocumentFormattingEditProvider(r))), t.push(monaco.languages.registerDocumentRangeFormattingEditProvider(o, new a.DocumentRangeFormattingEditProvider(r))), t.push(new a.DiagnosticsAdapter(o, r, e)), t.push(monaco.languages.setTokensProvider(o, s.createTokenizationSupport(!0))), t.push(monaco.languages.setLanguageConfiguration(o, c)), t.push(monaco.languages.registerColorProvider(o, new a.DocumentColorAdapter(r))), t.push(monaco.languages.registerFoldingRangeProvider(o, new a.FoldingRangeAdapter(r)))
        };
        var c = {
