 ...
 *-----------------------------------------------------------------------------*/
define("vs/language/html/workerManager", ["require", "exports"], function(e, t) {
        "use strict";
        ...
        var s = monaco.Promise,
            n = function() {
                ...
                return e.prototype._stopWorker = function() {
                    ...
                    for (var t, e, n, r, i, o = this, a = [], u = 0; u < arguments.length; u++) a[u] = arguments[u];
                    return e = this._getClient().then(function(e) {
                        ...
                        return t
                    }), i = new s(function(e, t) {
                        n = e, r = t
                    }, function() {}), e.then(n, r), i
                }, e
            }();
        t.WorkerManager = n
    }),
    function(e) {
        ...
        Object.defineProperty(t, "__esModule", {
        ...
        }, (g = t.FoldingRangeKind || (t.FoldingRangeKind = {})).Comment = "comment", g.Imports = "imports", g.Region = "region", (f = t.FoldingRange || (t.FoldingRange = {})).create = function(e, t, n, r, i) {
            var o = {
                startLine: e,
                endLine: t
            };
            return Z.defined(n) && (o.startCharacter = n), Z.defined(r) && (o.endCharacter = r), Z.defined(i) && (o.kind = i), o
        }, f.is = function(e) {
            var t = e;
        ...
        }, (h = m = t.DiagnosticRelatedInformation || (t.DiagnosticRelatedInformation = {})).create = function(e, t) {
            return {
                location: e,
                message: t
            }
        ...
        }, (p = t.DiagnosticSeverity || (t.DiagnosticSeverity = {})).Error = 1, p.Warning = 2, p.Information = 3, p.Hint = 4, (y = v = t.Diagnostic || (t.Diagnostic = {})).create = function(e, t, n, r, i, o) {
            var a = {
                range: e,
                message: t
            };
            return Z.defined(n) && (a.severity = n), Z.defined(r) && (a.code = r), Z.defined(i) && (a.source = i), Z.defined(o) && (a.relatedInformation = o), a
        }, y.is = function(e) {
            var t = e;
            return Z.defined(t) && r.is(t.range) && Z.string(t.message) && (Z.number(t.severity) || Z.undefined(t.severity)) && (Z.number(t.code) || Z.string(t.code) || Z.undefined(t.code)) && (Z.string(t.source) || Z.undefined(t.source)) && (Z.undefined(t.relatedInformation) || Z.typedArray(t.relatedInformation, m.is))
        ...
        }, (I = x = t.TextDocumentEdit || (t.TextDocumentEdit = {})).create = function(e, t) {
            return {
                textDocument: e,
                edits: t
            }
            ...
            var t = e;
            return t && (void 0 !== t.changes || void 0 !== t.documentChanges) && (void 0 === t.documentChanges || Z.typedArray(t.documentChanges, x.is))
        };
        var D, E, S, T, M, F, K, R, P, A, L, O, j, W, H = function() {
                function e(e) {
                    this.edits = e
                }
                ...
                return Object.defineProperty(e.prototype, "edit", {
                    ...
                    if (E.is(e)) {
                        ...
                        if (!(r = this._textEditChanges[t.uri])) {
                            ...
                            this._workspaceEdit.documentChanges.push(n), r = new H(i), this._textEditChanges[t.uri] = r
                        }
                        return r
                    }
                    if (this._workspaceEdit || (this._workspaceEdit = {
                    ...
                    if (!(r = this._textEditChanges[e])) {
                        var i = [];
                        this._workspaceEdit.changes[e] = i, r = new H(i), this._textEditChanges[e] = r
                    }
                    return r
                }, e
            }();
        t.WorkspaceChange = V, (D = t.TextDocumentIdentifier || (t.TextDocumentIdentifier = {})).create = function(e) {
            return {
                uri: e
            }
        }, D.is = function(e) {
        ...
        }, (S = E = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {})).create = function(e, t) {
            return {
                uri: e,
                version: t
            }
        ...
        }, (T = t.TextDocumentItem || (t.TextDocumentItem = {})).create = function(e, t, n, r) {
            return {
                uri: e,
                languageId: t,
                version: n,
        ...
        }, (F = M = t.MarkupKind || (t.MarkupKind = {})).PlainText = "plaintext", F.Markdown = "markdown", (K = M = t.MarkupKind || (t.MarkupKind = {})).is = function(e) {
            var t = e;
        ...
        }, (P = t.CompletionItemKind || (t.CompletionItemKind = {})).Text = 1, P.Method = 2, P.Function = 3, P.Constructor = 4, P.Field = 5, P.Variable = 6, P.Class = 7, P.Interface = 8, P.Module = 9, P.Property = 10, P.Unit = 11, P.Value = 12, P.Enum = 13, P.Keyword = 14, P.Snippet = 15, P.Color = 16, P.File = 17, P.Reference = 18, P.Folder = 19, P.EnumMember = 20, P.Constant = 21, P.Struct = 22, P.Event = 23, P.Operator = 24, P.TypeParameter = 25, (A = t.InsertTextFormat || (t.InsertTextFormat = {})).PlainText = 1, A.Snippet = 2, (t.CompletionItem || (t.CompletionItem = {})).create = function(e) {
            return {
                label: e
            }
        ...
        }, (O = L = t.MarkedString || (t.MarkedString = {})).fromPlainText = function(e) {
            ...
            var t = e;
            return Z.objectLiteral(t) && (R.is(t.contents) || L.is(t.contents) || Z.typedArray(t.contents, L.is)) && (void 0 === e.range || r.is(e.range))
            ...
            return Z.defined(t) && (i.documentation = t), Z.defined(n) ? i.parameters = n : i.parameters = [], i
        }, (j = t.DocumentHighlightKind || (t.DocumentHighlightKind = {})).Text = 1, j.Read = 2, j.Write = 3, (t.DocumentHighlight || (t.DocumentHighlight = {})).create = function(e, t) {
            var n = {
                range: e
            };
            return Z.number(t) && (n.kind = t), n
        }, (W = t.SymbolKind || (t.SymbolKind = {})).File = 1, W.Module = 2, W.Namespace = 3, W.Package = 4, W.Class = 5, W.Method = 6, W.Property = 7, W.Field = 8, W.Constructor = 9, W.Enum = 10, W.Interface = 11, W.Function = 12, W.Variable = 13, W.Constant = 14, W.String = 15, W.Number = 16, W.Boolean = 17, W.Array = 18, W.Object = 19, W.Key = 20, W.Null = 21, W.EnumMember = 22, W.Struct = 23, W.Event = 24, W.Operator = 25, W.TypeParameter = 26, (t.SymbolInformation || (t.SymbolInformation = {})).create = function(e, t, n, r, i) {
            var o = {
                name: e,
                kind: t,
                location: {
        ...
        var N, q, U, z, B, Q, $ = function() {};
        t.DocumentSymbol = $, (N = $ = t.DocumentSymbol || (t.DocumentSymbol = {})).create = function(e, t, n, r, i, o) {
            var a = {
                name: e,
                detail: t,
                kind: n,
        ...
        }, t.DocumentSymbol = $, (q = t.CodeActionKind || (t.CodeActionKind = {})).QuickFix = "quickfix", q.Refactor = "refactor", q.RefactorExtract = "refactor.extract", q.RefactorInline = "refactor.inline", q.RefactorRewrite = "refactor.rewrite", q.Source = "source", q.SourceOrganizeImports = "source.organizeImports", (U = t.CodeActionContext || (t.CodeActionContext = {})).create = function(e, t) {
            var n = {
                diagnostics: e
            };
        ...
        }, (Q = t.FormattingOptions || (t.FormattingOptions = {})).create = function(e, t) {
            return {
                tabSize: e,
                insertSpaces: t
            }
        ...
        var G, J, X, Y = function() {};
        t.DocumentLink = Y, (G = Y = t.DocumentLink || (t.DocumentLink = {})).create = function(e, t, n) {
            return {
                range: e,
                target: t,
                data: n
            ...
            for (var n = e.getText(), r = function e(t, n) {
                ...
                }), i = n.length, o = r.length - 1; 0 <= o; o--) {
                var a = r[o],
                    u = e.offsetAt(a.range.start),
                    s = e.offsetAt(a.range.end);
                if (!(s <= i)) throw new Error("Ovelapping edit");
                n = n.substring(0, u) + a.newText + n.substring(s, n.length), i = u
            }
            return n
        }, (X = t.TextDocumentSaveReason || (t.TextDocumentSaveReason = {})).Manual = 1, X.AfterDelay = 2, X.FocusOut = 3;
        ...
        return e
    }), define("vs/language/html/languageFeatures", ["require", "exports", "vscode-languageserver-types"], function(e, t, i) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        });
        var n = monaco.Range,
            r = function() {
                function e(e, t, n) {
                    ...
                    this._disposables.push(monaco.editor.onDidCreateModel(i)), this._disposables.push(monaco.editor.onWillDisposeModel(function(e) {
                        o(e)
                ...
                return e.prototype.dispose = function() {
                    ...
                    this._worker(n).then(function(e) {
                        return e.doValidation(n.toString()).then(function(e) {
                            ...
                            monaco.editor.setModelMarkers(monaco.editor.getModel(n), r, t)
                        })
        ...
        var d = function() {
            ...
            return Object.defineProperty(e.prototype, "triggerCharacters", {
                ...
                var r = e.uri;
                return v(n, this._worker(r).then(function(e) {
                    ...
                    if (e) {
                        var t = e.items.map(function(e) {
                            ...
                            return e.textEdit && (t.range = u(e.textEdit.range), t.insertText = e.textEdit.newText), e.insertTextFormat === i.InsertTextFormat.Snippet && (t.insertText = {
                                value: t.insertText
                            }), t
                        });
                        return {
        ...
        var g = function() {
            ...
            return e.prototype.provideLinks = function(e, t) {
                var n = e.uri;
                return v(t, this._worker(n).then(function(e) {
        ...
        var h = function() {
            ...
            return e.prototype.provideDocumentRangeFormattingEdits = function(e, t, n, r) {
                var i = e.uri;
                return v(r, this._worker(i).then(function(e) {
    ...
    }), define("vs/language/html/htmlMode", ["require", "exports", "./workerManager", "./languageFeatures"], function(e, t, i, o) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
