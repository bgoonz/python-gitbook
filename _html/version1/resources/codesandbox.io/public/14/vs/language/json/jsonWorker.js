...
! function(e) {
    ...
    Object.defineProperty(t, "__esModule", {
        ...
        if (Y.number(e) && Y.number(t) && Y.number(r) && Y.number(n)) return {
            start: a.create(e, t),
            end: a.create(r, n)
        };
        ...
        var t = e;
        return Y.defined(t) && n.is(t.range) && (Y.string(t.uri) || Y.undefined(t.uri))
        ...
        var t = e;
        return Y.number(t.red) && Y.number(t.green) && Y.number(t.blue) && Y.number(t.alpha)
    }, (f = t.ColorInformation || (t.ColorInformation = {})).create = function(e, t) {
        return {
            range: e,
            color: t
        }
    ...
    }, (l = t.ColorPresentation || (t.ColorPresentation = {})).create = function(e, t, r) {
        return {
            label: e,
            textEdit: t,
        ...
        var t = e;
        return Y.string(t.label) && (Y.undefined(t.textEdit) || S.is(t)) && (Y.undefined(t.additionalTextEdits) || Y.typedArray(t.additionalTextEdits, S.is))
    }, (d = t.FoldingRangeKind || (t.FoldingRangeKind = {})).Comment = "comment", d.Imports = "imports", d.Region = "region", (p = t.FoldingRange || (t.FoldingRange = {})).create = function(e, t, r, n, o) {
        var i = {
            startLine: e,
            endLine: t
        };
        return Y.defined(r) && (i.startCharacter = r), Y.defined(n) && (i.endCharacter = n), Y.defined(o) && (i.kind = o), i
    }, p.is = function(e) {
        var t = e;
        return Y.number(t.startLine) && Y.number(t.startLine) && (Y.undefined(t.startCharacter) || Y.number(t.startCharacter)) && (Y.undefined(t.endCharacter) || Y.number(t.endCharacter)) && (Y.undefined(t.kind) || Y.string(t.kind))
    ...
    }, (g = t.DiagnosticSeverity || (t.DiagnosticSeverity = {})).Error = 1, g.Warning = 2, g.Information = 3, g.Hint = 4, (y = v = t.Diagnostic || (t.Diagnostic = {})).create = function(e, t, r, n, o, i) {
        var a = {
            range: e,
            message: t
        };
        return Y.defined(r) && (a.severity = r), Y.defined(n) && (a.code = n), Y.defined(o) && (a.source = o), Y.defined(i) && (a.relatedInformation = i), a
    }, y.is = function(e) {
        var t = e;
        return Y.defined(t) && n.is(t.range) && Y.string(t.message) && (Y.number(t.severity) || Y.undefined(t.severity)) && (Y.number(t.code) || Y.string(t.code) || Y.undefined(t.code)) && (Y.string(t.source) || Y.undefined(t.source)) && (Y.undefined(t.relatedInformation) || Y.typedArray(t.relatedInformation, h.is))
    ...
    }, (T = j = t.TextDocumentEdit || (t.TextDocumentEdit = {})).create = function(e, t) {
        return {
            textDocument: e,
            edits: t
        }
        ...
        var t = e;
        return t && (void 0 !== t.changes || void 0 !== t.documentChanges) && (void 0 === t.documentChanges || Y.typedArray(t.documentChanges, j.is))
    };
    var O, k, E, I, P, w, N, M, V, _, D, F, R, L, q = function() {
            function e(e) {
                this.edits = e
            }
        ...
        W = function() {
            function e(r) {
                var n = this;
                this._textEditChanges = Object.create(null), r && ((this._workspaceEdit = r).documentChanges ? r.documentChanges.forEach(function(e) {
                    var t = new q(e.edits);
                    n._textEditChanges[e.textDocument.uri] = t
                }) : r.changes && Object.keys(r.changes).forEach(function(e) {
            ...
            return Object.defineProperty(e.prototype, "edit", {
                ...
                if (k.is(e)) {
                    ...
                    if (!(n = this._textEditChanges[t.uri])) {
                        ...
                        this._workspaceEdit.documentChanges.push(r), n = new q(o), this._textEditChanges[t.uri] = n
                    }
                    return n
                }
                if (this._workspaceEdit || (this._workspaceEdit = {
                ...
                if (!(n = this._textEditChanges[e])) {
                    var o = [];
                    this._workspaceEdit.changes[e] = o, n = new q(o), this._textEditChanges[e] = n
                }
                return n
            }, e
        }();
    t.WorkspaceChange = W, (O = t.TextDocumentIdentifier || (t.TextDocumentIdentifier = {})).create = function(e) {
        return {
            uri: e
        }
    }, O.is = function(e) {
    ...
    }, (E = k = t.VersionedTextDocumentIdentifier || (t.VersionedTextDocumentIdentifier = {})).create = function(e, t) {
        return {
            uri: e,
            version: t
        }
    ...
    }, (I = t.TextDocumentItem || (t.TextDocumentItem = {})).create = function(e, t, r, n) {
        return {
            uri: e,
            languageId: t,
            version: r,
        ...
        var t = e;
        return Y.defined(t) && Y.string(t.uri) && Y.string(t.languageId) && Y.number(t.version) && Y.string(t.text)
    }, (w = P = t.MarkupKind || (t.MarkupKind = {})).PlainText = "plaintext", w.Markdown = "markdown", (N = P = t.MarkupKind || (t.MarkupKind = {})).is = function(e) {
        var t = e;
    ...
    }, (V = t.CompletionItemKind || (t.CompletionItemKind = {})).Text = 1, V.Method = 2, V.Function = 3, V.Constructor = 4, V.Field = 5, V.Variable = 6, V.Class = 7, V.Interface = 8, V.Module = 9, V.Property = 10, V.Unit = 11, V.Value = 12, V.Enum = 13, V.Keyword = 14, V.Snippet = 15, V.Color = 16, V.File = 17, V.Reference = 18, V.Folder = 19, V.EnumMember = 20, V.Constant = 21, V.Struct = 22, V.Event = 23, V.Operator = 24, V.TypeParameter = 25, (_ = t.InsertTextFormat || (t.InsertTextFormat = {})).PlainText = 1, _.Snippet = 2, (t.CompletionItem || (t.CompletionItem = {})).create = function(e) {
        return {
            label: e
        }
    ...
    }, (F = D = t.MarkedString || (t.MarkedString = {})).fromPlainText = function(e) {
        ...
        var t = e;
        return Y.objectLiteral(t) && (M.is(t.contents) || D.is(t.contents) || Y.typedArray(t.contents, D.is)) && (void 0 === e.range || n.is(e.range))
        ...
        return Y.defined(t) && (o.documentation = t), Y.defined(r) ? o.parameters = r : o.parameters = [], o
    }, (R = t.DocumentHighlightKind || (t.DocumentHighlightKind = {})).Text = 1, R.Read = 2, R.Write = 3, (t.DocumentHighlight || (t.DocumentHighlight = {})).create = function(e, t) {
        var r = {
            range: e
        };
        return Y.number(t) && (r.kind = t), r
    }, (L = t.SymbolKind || (t.SymbolKind = {})).File = 1, L.Module = 2, L.Namespace = 3, L.Package = 4, L.Class = 5, L.Method = 6, L.Property = 7, L.Field = 8, L.Constructor = 9, L.Enum = 10, L.Interface = 11, L.Function = 12, L.Variable = 13, L.Constant = 14, L.String = 15, L.Number = 16, L.Boolean = 17, L.Array = 18, L.Object = 19, L.Key = 20, L.Null = 21, L.EnumMember = 22, L.Struct = 23, L.Event = 24, L.Operator = 25, L.TypeParameter = 26, (t.SymbolInformation || (t.SymbolInformation = {})).create = function(e, t, r, n, o) {
        var i = {
            name: e,
            kind: t,
            location: {
    ...
    var $, K, U, B, J, H, z = function() {};
    t.DocumentSymbol = z, ($ = z = t.DocumentSymbol || (t.DocumentSymbol = {})).create = function(e, t, r, n, o, i) {
        var a = {
            name: e,
            detail: t,
            kind: r,
        ...
        var t = e;
        return t && Y.string(t.name) && Y.string(t.detail) && Y.number(t.kind) && n.is(t.range) && n.is(t.selectionRange) && (void 0 === t.deprecated || Y.boolean(t.deprecated)) && (void 0 === t.children || Array.isArray(t.children))
    }, t.DocumentSymbol = z, (K = t.CodeActionKind || (t.CodeActionKind = {})).QuickFix = "quickfix", K.Refactor = "refactor", K.RefactorExtract = "refactor.extract", K.RefactorInline = "refactor.inline", K.RefactorRewrite = "refactor.rewrite", K.Source = "source", K.SourceOrganizeImports = "source.organizeImports", (U = t.CodeActionContext || (t.CodeActionContext = {})).create = function(e, t) {
        var r = {
            diagnostics: e
        };
        ...
        var t = e;
        return Y.defined(t) && Y.typedArray(t.diagnostics, v.is) && (void 0 === t.only || Y.typedArray(t.only, Y.string))
    }, (B = t.CodeAction || (t.CodeAction = {})).create = function(e, t, r) {
        var n = {
            title: e
        };
        return b.is(t) ? n.command = t : n.edit = t, void 0 !== r && (n.kind = r), n
    }, B.is = function(e) {
        var t = e;
        return t && Y.string(t.title) && (void 0 === t.diagnostics || Y.typedArray(t.diagnostics, v.is)) && (void 0 === t.kind || Y.string(t.kind)) && (void 0 !== t.edit || void 0 !== t.command) && (void 0 === t.command || b.is(t.command)) && (void 0 === t.edit || A.is(t.edit))
        ...
        var t = e;
        return Y.defined(t) && n.is(t.range) && (Y.undefined(t.command) || b.is(t.command))
    }, (H = t.FormattingOptions || (t.FormattingOptions = {})).create = function(e, t) {
        return {
            tabSize: e,
            insertSpaces: t
        }
    ...
    var G, Q, Z, X = function() {};
    t.DocumentLink = X, (G = X = t.DocumentLink || (t.DocumentLink = {})).create = function(e, t, r) {
        return {
            range: e,
            target: t,
            data: r
        ...
        var t = e;
        return Y.defined(t) && n.is(t.range) && (Y.undefined(t.target) || Y.string(t.target))
    }, t.DocumentLink = X, t.EOL = ["\n", "\r\n", "\r"], (Q = t.TextDocument || (t.TextDocument = {})).create = function(e, t, r, n) {
        return new re(e, t, r, n)
    }, Q.is = function(e) {
        var t = e;
        return !!(Y.defined(t) && Y.string(t.uri) && (Y.undefined(t.languageId) || Y.string(t.languageId)) && Y.number(t.lineCount) && Y.func(t.getText) && Y.func(t.positionAt) && Y.func(t.offsetAt))
    }, Q.applyEdits = function(e, t) {
        for (var r = e.getText(), n = function e(t, r) {
    ...
    var Y, ee, te, re = function() {
        function e(e, t, r, n) {
            this._uri = e, this._languageId = t, this._version = r, this._content = n, this._lineOffsets = null
        }
    ...
    ee = Y || (Y = {}), te = Object.prototype.toString, ee.defined = function(e) {
        return void 0 !== e
    ...
    function(e) {
        ...
        function d(e) {
            return 32 === e || 9 === e || 11 === e || 12 === e || 160 === e || 5760 === e || 8192 <= e && e <= 8203 || 8239 === e || 8287 === e || 12288 === e || 65279 === e
        }
        ...
        Object.defineProperty(t, "__esModule", {
            ...
            function t() {
                ...
                if (d(e)) {
                    for (; a++, n += String.fromCharCode(e), d(e = i.charCodeAt(a)););
                    return c = 15
                }
                if (p(e)) return a++, n += String.fromCharCode(e), 13 === e && 10 === i.charCodeAt(a) && (a++, n += "\n"), c = 14;
                switch (e) {
                    case 123:
                        return a++, c = 1;
                    case 125:
                    ...
                    case 47:
                        ...
                        if (42 === i.charCodeAt(a + 1)) {
                            a += 2;
                            for (var r = !1; a < o;) {
                                if (42 === i.charCodeAt(a) && a + 1 < o && 47 === i.charCodeAt(a + 1)) {
                                    a += 2, r = !0;
                                    break
                                }
                                a++
                    ...
                    case 45:
                        if (n += String.fromCharCode(e), ++a === o || !h(i.charCodeAt(a))) return c = 16;
                    case 48:
                    case 49:
                    case 50:
                    case 51:
                    ...
                    case 57:
                        return n += function() {
                            ...
                            if (a < i.length && 46 === i.charCodeAt(a)) {
                                if (!(++a < i.length && h(i.charCodeAt(a)))) return u = 3, i.substring(e, a);
                                for (a++; a < i.length && h(i.charCodeAt(a));) a++
                            }
                            var t = a;
                            if (a < i.length && (69 === i.charCodeAt(a) || 101 === i.charCodeAt(a)))
                                if ((++a < i.length && 43 === i.charCodeAt(a) || 45 === i.charCodeAt(a)) && a++, a < i.length && h(i.charCodeAt(a))) {
                                    for (a++; a < i.length && h(i.charCodeAt(a));) a++;
                                    t = a
                                } else u = 3;
    ...
    function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            var t = e(require, exports);
            void 0 !== t && (module.exports = t)
        } else "function" == typeof define && define.amd && define("jsonc-parser/impl/format", ["require", "exports", "./scanner"], e)
    }(function(e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        t.format = function(n, e, t) {
            ...
            if (e) {
                ...
                o = n.substring(i, c), r = function(e, t) {
            ...
            function y(e, t, r) {
                !h && t < s && a < r && n.substring(t, r) !== e && v.push({
                    offset: t,
                    length: r - t,
                    content: e
                })
            ...
            for (; 17 !== b;) {
                for (var S = p.getTokenOffset() + p.getTokenLength() + i, C = g(), j = ""; !l && (12 === C || 13 === C);) y(" ", S, p.getTokenOffset() + i), S = p.getTokenOffset() + p.getTokenLength() + i, j = 12 === C ? m() : "", C = g();
                if (2 === C) 1 !== b && (d--, j = m());
    ...
    function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            var t = e(require, exports);
            void 0 !== t && (module.exports = t)
        } else "function" == typeof define && define.amd && define("jsonc-parser/impl/parser", ["require", "exports", "./scanner"], e)
    }(function(e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        function f(e, t, r) {
                    ...
                    case 1:
                        return function() {
                            ...
                            for (var e = !1; 2 !== o.getToken() && 17 !== o.getToken();) {
                                ...
                                (10 !== o.getToken() ? (y(3, [], [2, 5]), 0) : (b(!1), 6 === o.getToken() ? (d(":"), v(), x() || y(4, [], [2, 5])) : y(5, [], [2, 5]), 1)) || y(4, [], [2, 5]), e = !0
                            }
            ...
            return v(), 17 === o.getToken() || (x() ? (17 !== o.getToken() && y(9, [], []), !0) : (y(4, [], []), !1))
        }
        ...
        t.getLocation = function(e, o) {
            ...
            function n(e, t, r, n) {
                c.value = e, c.offset = t, c.length = r, c.type = n, c.colonOffset = void 0, s = c
            }
            try {
                f(e, {
                    ...
                    onSeparator: function(e, t, r) {
                        ...
                        if (":" === e && s && "property" === s.type) s.colonOffset = t, u = !1, s = void 0;
                            ...
                            var n = i[i.length - 1];
                            "number" == typeof n ? i[i.length - 1] = n + 1 : (u = !0, i[i.length - 1] = ""), s = void 0
                        }
                    }
                })
            } catch (e) {
            ...
            if ("property" === t.parent.type) {
                ...
                var o = t.parent.children.indexOf(t); - 1 !== o && r.push(o)
            }
            return r
        ...
        }, t.contains = s, t.findNodeAtOffset = function e(t, r, n) {
        ...
        }, t.visit = f, t.stripComments = function(e, t) {
            var r, n, o = S.createScanner(e),
                i = [],
                a = 0;
            do {
                switch (n = o.getPosition(), r = o.scan()) {
                    ...
                    case 13:
                    case 17:
                        a !== n && i.push(e.substring(a, n)), void 0 !== t && i.push(o.getTokenValue().replace(/[^\r\n]/g, t)), a = o.getPosition()
                }
            } while (17 !== r);
            return i.join("")
        }
    ...
    function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            var t = e(require, exports);
            void 0 !== t && (module.exports = t)
        } else "function" == typeof define && define.amd && define("jsonc-parser/impl/edit", ["require", "exports", "./format", "./parser"], e)
    }(function(e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
        ...
        function n(e, t, r, n, o) {
            for (var i, a = x.parseTree(e, []), s = void 0, c = void 0; 0 < t.length && (c = t.pop(), void 0 === (s = x.findNodeAtLocation(a, t)) && void 0 !== r);) "string" == typeof c ? ((i = {})[c] = r, r = i) : r = [r];
            if (s) {
                if ("object" === s.type && "string" == typeof c && Array.isArray(s.children)) {
                    ...
                    if (void 0 !== u) {
                        if (void 0 === r) {
                            ...
                            else if (l = s.offset + 1, 1 < s.children.length) d = s.children[1].offset;
                            return S(e, {
                                offset: l,
                                length: d - l,
                                content: ""
                    ...
                    var p = JSON.stringify(c) + ": " + JSON.stringify(r),
                        h = o ? o(s.children.map(function(e) {
                ...
                if ("array" === s.type && "number" == typeof c && Array.isArray(s.children)) {
                    if (-1 === c) {
                        p = "" + JSON.stringify(r), m = void 0;
                        if (0 === s.children.length) m = {
                            offset: s.offset + 1,
                            length: 0,
                            content: p
                        };
                        else m = {
                            offset: (y = s.children[s.children.length - 1]).offset + y.length,
                            length: 0,
                            content: "," + p
                        };
                        return S(e, m, n)
                    ...
                    if (void 0 === r && 0 <= s.children.length) {
                        var g = c,
                            v = s.children[g];
                        m = void 0;
                        if (1 === s.children.length) m = {
                            offset: s.offset + 1,
                            length: s.length - 2,
                            content: ""
                        };
                        else if (s.children.length - 1 === g) {
                            var y, b = (y = s.children[g - 1]).offset + y.length;
                            m = {
                                offset: b,
                ...
                throw new Error("Can not add " + ("number" != typeof c ? "index" : "property") + " to parent of type " + s.type)
            }
        ...
        function S(e, t, r) {
            ...
            for (var a = u.format(n, {
                    offset: o,
                    length: i - o
                }, r), s = a.length - 1; 0 <= s; s--) {
                var c = a[s];
                n = f(n, c), o = Math.min(o, c.offset), i = Math.max(i, c.offset + c.length), i += c.content.length - c.length
            }
            return [{
                offset: o,
        ...
        }, t.setProperty = n, t.applyEdit = f, t.isWS = function(e, t) {
            return -1 !== "\r\n \t".indexOf(e.charAt(t))
        }
    }),
    function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            var t = e(require, exports);
            void 0 !== t && (module.exports = t)
        } else "function" == typeof define && define.amd && define("jsonc-parser/main", ["require", "exports", "./impl/format", "./impl/edit", "./impl/scanner", "./impl/parser"], e)
    }(function(e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
    ...
    function(e) {
        if ("object" == typeof module && "object" == typeof module.exports) {
            var t = e(require, exports);
            void 0 !== t && (module.exports = t)
        } else "function" == typeof define && define.amd && define("vscode-json-languageservice/utils/objects", ["require", "exports"], e)
    }(function(e, t) {
        "use strict";
        Object.defineProperty(t, "__esModule", {
            value: !0
    ...
    function(e) {
        ...
        Object.defineProperty(t, "__esModule", {
            value: !0
        }), t.loadMessageBundle = n, t.config = function(e) {
            return n
        }
...
! function(e) {
    ...
    var o, d = "/",
        ...
        u = function() {
            function r(e, t, r, n, o) {
                "object" == typeof e ? (this.scheme = e.scheme || "", this.authority = e.authority || "", this.path = e.path || "", this.query = e.query || "", this.fragment = e.fragment || "") : (this.scheme = e || "", this.authority = t || "", this.path = function(e, t) {
                    ...
                    return t
                }(this.scheme, r || ""), this.query = n || "", this.fragment = o || "", function(e) {
            ...
            return r.isUri = function(e) {
                return e instanceof r || !!e && ("string" == typeof e.authority && "string" == typeof e.fragment && "string" == typeof e.path && "string" == typeof e.query && "string" == typeof e.scheme)
                ...
                var t = e.scheme,
                    ...
                    o = e.query,
                    i = e.fragment;
                return void 0 === t ? t = this.scheme : null === t && (t = ""), void 0 === r ? r = this.authority : null === r && (r = ""), void 0 === n ? n = this.path : null === n && (n = ""), void 0 === o ? o = this.query : null === o && (o = ""), void 0 === i ? i = this.fragment : null === i && (i = ""), t === this.scheme && r === this.authority && n === this.path && o === this.query && i === this.fragment ? this : new f(t, r, n, o, i)
            }, r.parse = function(e) {
                var t = c.exec(e);
                return t ? new f(t[2] || "", decodeURIComponent(t[4] || ""), decodeURIComponent(t[5] || ""), decodeURIComponent(t[7] || ""), decodeURIComponent(t[9] || "")) : new f("", "", "", "", "")
            }, r.file = function(e) {
                var t = "";
                if (n && (e = e.replace(/\\/g, d)), e[0] === d && e[1] === d) {
                    var r = e.indexOf(d, 2); - 1 === r ? (t = e.substring(2), e = d) : (t = e.substring(2, r), e = e.substring(r) || d)
                }
        ...
        f = function(t) {
            ...
            return __extends(e, t), Object.defineProperty(e.prototype, "fsPath", {
                ...
                return void 0 === e && (e = !1), e ? g(this, !0) : (this._formatted || (this._formatted = g(this, !1)), this._formatted)
        ...
        l = ((o = {})[58] = "%3A", o[47] = "%2F", o[63] = "%3F", o[35] = "%23", o[91] = "%5B", o[93] = "%5D", o[64] = "%40", o[33] = "%21", o[36] = "%24", o[38] = "%26", o[39] = "%27", o[40] = "%28", o[41] = "%29", o[42] = "%2A", o[43] = "%2B", o[44] = "%2C", o[59] = "%3B", o[61] = "%3D", o[32] = "%20", o);
    ...
    function p(e, t) {
        for (var r = void 0, n = -1, o = 0; o < e.length; o++) {
            ...
            if (97 <= i && i <= 122 || 65 <= i && i <= 90 || 48 <= i && i <= 57 || 45 === i || 46 === i || 95 === i || 126 === i || t && 47 === i) - 1 !== n && (r += encodeURIComponent(e.substring(n, o)), n = -1), void 0 !== r && (r += e.charAt(o));
                ...
                var a = l[i];
                void 0 !== a ? (-1 !== n && (r += encodeURIComponent(e.substring(n, o)), n = -1), r += a) : -1 === n && (n = o)
            }
        }
    ...
    function h(e) {
        for (var t = void 0, r = 0; r < e.length; r++) {
            ...
            35 === n || 63 === n ? (void 0 === t && (t = e.substr(0, r)), t += l[n]) : void 0 !== t && (t += e[r])
        }
        return void 0 !== t ? t : e
    }
    ...
    function m(e) {
        var t;
        return t = e.authority && 1 < e.path.length && "file" === e.scheme ? "//" + e.authority + e.path : 47 === e.path.charCodeAt(0) && (65 <= e.path.charCodeAt(1) && e.path.charCodeAt(1) <= 90 || 97 <= e.path.charCodeAt(1) && e.path.charCodeAt(1) <= 122) && 58 === e.path.charCodeAt(2) ? e.path[1].toLowerCase() + e.path.substr(2) : e.path, n && (t = t.replace(/\//g, "\\")), t
    }
    ...
    function g(e, t) {
        ...
        if (o && (n += o, n += ":"), (i || "file" === o) && (n += d, n += d), i) {
            ...
            if (-1 !== u) {
                var f = i.substr(0, u);
                i = i.substr(u + 1), -1 === (u = f.indexOf(":")) ? n += r(f, !1) : (n += r(f.substr(0, u), !1), n += ":", n += r(f.substr(u + 1), !1)), n += "@"
            } - 1 === (u = (i = i.toLowerCase()).indexOf(":")) ? n += r(i, !1) : (n += r(i.substr(0, u), !1), n += i.substr(u))
        }
        if (a) {
            if (3 <= a.length && 47 === a.charCodeAt(0) && 58 === a.charCodeAt(2)) 65 <= (l = a.charCodeAt(1)) && l <= 90 && (a = "/" + String.fromCharCode(l + 32) + ":" + a.substr(3));
            else if (2 <= a.length && 58 === a.charCodeAt(1)) {
                var l;
                65 <= (l = a.charCodeAt(0)) && l <= 90 && (a = String.fromCharCode(l + 32) + ":" + a.substr(2))
            }
            n += r(a, !0)
        }
        return s && (n += "?", n += r(s, !1)), c && (n += "#", n += r(c, !1)), n
    }
...
! function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        var t = e(require, exports);
        void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-json-languageservice/parser/jsonParser", ["require", "exports", "jsonc-parser", "../utils/objects", "../jsonLanguageTypes", "vscode-nls", "vscode-uri", "vscode-languageserver-types"], e)
}(function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var C = function(n) {
        ...
        return __extends(e, n), Object.defineProperty(e.prototype, "children", {
            get: function() {
                return this.items
            },
            enumerable: !0,
    ...
    t.ObjectASTNodeImpl = O, t.asSchema = m, (a = t.EnumMatch || (t.EnumMatch = {}))[a.Key = 0] = "Key", a[a.Enum = 1] = "Enum";
    var f = function() {
            function e(e, t) {
        ...
        g = function() {
            ...
            return Object.defineProperty(e.prototype, "schemas", {
                ...
                enumerable: !0,
                configurable: !0
            }), e.prototype.add = function(e) {}, e.prototype.merge = function(e) {}, e.prototype.include = function(e) {
                return !0
            }, e.prototype.newSub = function() {
                return this
            }, e.instance = new e, e
            ...
            return e.prototype.hasProblems = function() {
                ...
                if (!this.enumValueMatch && !e.enumValueMatch && this.enumValues && e.enumValues) {
                    ...
                    for (var t = 0, r = this.problems; t < r.length; t++) {
                        var n = r[t];
                        n.code === y.ErrorCode.EnumValueMismatch && (n.message = x("enumWarning", "Value is not accepted. Valid values: {0}.", this.enumValues.map(function(e) {
    ...
    t.ValidationResult = v, t.newJSONDocument = function(e, t) {
        return void 0 === t && (t = []), new E(e, t, [])
    }, t.getNodeValue = k, t.getNodePath = function(e) {
        return o.getNodePath(e)
    }, t.contains = l;
    var E = function() {
        function e(e, t, r) {
            void 0 === t && (t = []), void 0 === r && (r = []), this.root = e, this.syntaxErrors = t, this.comments = r
        }
        return e.prototype.getNodeFromOffset = function(e, t) {
            ...
            if (this.root && e) {
                var t = new v;
                return I(this.root, e, t, g.instance), t.problems.map(function(e) {
                    var t = b.Range.create(r.positionAt(e.location.offset), r.positionAt(e.location.offset + e.location.length));
            ...
            switch (f.type) {
                case "object":
                    ! function(i, s, c, u) {
                        ...
                        }), Array.isArray(s.required) && s.required.forEach(function(e) {
                            if (!f[e]) {
                                var t = i.parent && "property" === i.parent.type && i.parent.keyNode,
                                    r = t ? {
                                        offset: t.offset,
                                        length: t.length
                                    } : {
                                ...
                                c.problems.push({
                                    ...
                                    message: x("MissingRequiredPropWarning", 'Missing property "{0}".', e)
                                })
                            }
                        });
                        var l = function(e) {
                            for (var t = r.indexOf(e); 0 <= t;) r.splice(t, 1), t = r.indexOf(e)
                        };
                                ...
                                if ("boolean" == typeof t)
                                    if (t) c.propertiesMatches++, c.propertiesValueMatches++;
                                        ...
                                        c.problems.push({
                                            ...
                                            severity: b.DiagnosticSeverity.Warning,
                                            message: s.errorMessage || x("DisallowedExtraPropWarning", "Property {0} is not allowed.", e)
                                        })
                                    }
                            else {
                                var o = new v;
                        ...
                        s.patternProperties && Object.keys(s.patternProperties).forEach(function(i) {
                            var a = new RegExp(i);
                            r.slice(0).forEach(function(e) {
                                if (a.test(e)) {
                                    ...
                                    if (t) {
                                        ...
                                        if ("boolean" == typeof r)
                                            if (r) c.propertiesMatches++, c.propertiesValueMatches++;
                                            else {
                                                var n = t.parent;
                                                c.problems.push({
                                                    location: {
                        ...
                        "object" == typeof s.additionalProperties ? r.forEach(function(e) {
                            var t = f[e];
                            if (t) {
                                var r = new v;
                                I(t, s.additionalProperties, r, u), c.mergePropertyMatch(r)
                            }
                        }) : !1 === s.additionalProperties && 0 < r.length && r.forEach(function(e) {
                            var t = f[e];
                            if (t) {
                                var r = t.parent;
                                c.problems.push({
                        ...
                        s.maxProperties && i.properties.length > s.maxProperties && c.problems.push({
                            location: {
                                offset: i.offset,
                                length: i.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("MaxPropWarning", "Object has more properties than limit of {0}.", s.maxProperties)
                        });
                        s.minProperties && i.properties.length < s.minProperties && c.problems.push({
                            location: {
                                offset: i.offset,
                                length: i.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("MinPropWarning", "Object has fewer properties than the required number of {0}", s.minProperties)
                        });
                        s.dependencies && Object.keys(s.dependencies).forEach(function(t) {
                            var e = f[t];
                            if (e) {
                                var r = s.dependencies[t];
                                if (Array.isArray(r)) r.forEach(function(e) {
                                    f[e] ? c.propertiesValueMatches++ : c.problems.push({
                                        location: {
                                            offset: i.offset,
                                            length: i.length
                                        },
                                        severity: b.DiagnosticSeverity.Warning,
                                        message: x("RequiredDependentPropWarning", "Object is missing property {0} required by property {1}.", e, t)
                                    })
                                });
                                else {
                                    var n = m(r);
                        ...
                        n && i.properties.forEach(function(e) {
                            var t = e.keyNode;
                    ...
                    ! function(i, e, a, s) {
                        if (Array.isArray(e.items)) {
                            ...
                            if (c.forEach(function(e, t) {
                                    var r = m(e),
                                        n = new v,
                                        o = i.items[t];
                                    o ? (I(o, r, n, s), a.mergePropertyMatch(n)) : i.items.length >= c.length && a.propertiesValueMatches++
                                }), i.items.length > c.length)
                                if ("object" == typeof e.additionalItems)
                                    for (var t = c.length; t < i.items.length; t++) {
                                        var r = new v;
                                        I(i.items[t], e.additionalItems, r, s), a.mergePropertyMatch(r)
                                    } else !1 === e.additionalItems && a.problems.push({
                                        location: {
                                            offset: i.offset,
                                            length: i.length
                                        },
                                        severity: b.DiagnosticSeverity.Warning,
                                        message: x("additionalItemsWarning", "Array has too many items according to schema. Expected {0} or fewer.", c.length)
                                    })
                        } else {
                            var n = m(e.items);
                            n && i.items.forEach(function(e) {
                                var t = new v;
                        ...
                        if (o) {
                            ...
                            u || a.problems.push({
                                ...
                                severity: b.DiagnosticSeverity.Warning,
                                message: e.errorMessage || x("requiredItemMissingWarning", "Array does not contain required item.")
                            })
                        }
                        e.minItems && i.items.length < e.minItems && a.problems.push({
                            location: {
                                offset: i.offset,
                                length: i.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("minItemsWarning", "Array has too few items. Expected {0} or more.", e.minItems)
                        });
                        e.maxItems && i.items.length > e.maxItems && a.problems.push({
                            location: {
                                offset: i.offset,
                                length: i.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("maxItemsWarning", "Array has too many items. Expected {0} or fewer.", e.maxItems)
                        });
                        if (!0 === e.uniqueItems) {
                            var f = k(i),
                            ...
                            l && a.problems.push({
                                ...
                                severity: b.DiagnosticSeverity.Warning,
                                message: x("uniqueItemsWarning", "Array has duplicate items.")
                            })
                        }
                    }(f, l, d, p);
                    break;
                case "string":
                    ! function(e, t, r, n) {
                        t.minLength && e.value.length < t.minLength && r.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("minLengthWarning", "String is shorter than the minimum length of {0}.", t.minLength)
                        });
                        t.maxLength && e.value.length > t.maxLength && r.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("maxLengthWarning", "String is longer than the maximum length of {0}.", t.maxLength)
                        });
                        if (t.pattern) {
                            var o = new RegExp(t.pattern);
                            o.test(e.value) || r.problems.push({
                                location: {
                                    offset: e.offset,
                                    length: e.length
                                },
                                severity: b.DiagnosticSeverity.Warning,
                                message: t.patternErrorMessage || t.errorMessage || x("patternWarning", 'String does not match the pattern of "{0}".', t.pattern)
                            })
                        }
                        if (t.format) switch (t.format) {
                            ...
                            case "uri-reference":
                                ...
                                if (e.value) try {
                                    ...
                                    a.scheme || "uri" !== t.format || (i = x("uriSchemeMissing", "URI with a scheme is expected."))
                                } catch (e) {
                                    i = e.message
                                ...
                                i && r.problems.push({
                                    ...
                                    severity: b.DiagnosticSeverity.Warning,
                                    message: t.patternErrorMessage || t.errorMessage || x("uriFormatWarning", "String is not a URI: {0}", i)
                                });
                                break;
                            case "email":
                                e.value.match(u) || r.problems.push({
                                    location: {
                                        offset: e.offset,
                                        length: e.length
                                    },
                                    severity: b.DiagnosticSeverity.Warning,
                                    message: t.patternErrorMessage || t.errorMessage || x("emailFormatWarning", "String is not an e-mail address.")
                                });
                                break;
                            case "color-hex":
                                e.value.match(c) || r.problems.push({
                                    location: {
                                        offset: e.offset,
                                        length: e.length
                                    },
                                    severity: b.DiagnosticSeverity.Warning,
                                    message: t.patternErrorMessage || t.errorMessage || x("colorHexFormatWarning", "Invalid color format. Use #RGB, #RGBA, #RRGGBB or #RRGGBBAA.")
                                })
                        }
                    }(f, l, d);
                    break;
                case "number":
                    ! function(e, t, r, n) {
                        var o = e.value;
                        "number" == typeof t.multipleOf && o % t.multipleOf != 0 && r.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("multipleOfWarning", "Value is not divisible by {0}.", t.multipleOf)
                        });
                        ...
                        "number" == typeof s && o <= s && r.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("exclusiveMinimumWarning", "Value is below the exclusive minimum of {0}.", s)
                        });
                        var c = i(t.maximum, t.exclusiveMaximum);
                        "number" == typeof c && c <= o && r.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("exclusiveMaximumWarning", "Value is above the exclusive maximum of {0}.", c)
                        });
                        var u = a(t.minimum, t.exclusiveMinimum);
                        "number" == typeof u && o < u && r.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("minimumWarning", "Value is below the minimum of {0}.", u)
                        });
                        var f = a(t.maximum, t.exclusiveMaximum);
                        "number" == typeof f && f < o && r.problems.push({
                            location: {
                                offset: e.offset,
                                length: e.length
                            },
                            severity: b.DiagnosticSeverity.Warning,
                            message: x("maximumWarning", "Value is above the maximum of {0}.", f)
                        })
                    }(f, l, d);
                    break;
                case "property":
                ...
                function e(e) {
                    return f.type === e || "integer" === e && "number" === f.type && f.isInteger
                }
                Array.isArray(l.type) ? l.type.some(e) || d.problems.push({
                    location: {
                        offset: f.offset,
                        length: f.length
                    },
                    severity: b.DiagnosticSeverity.Warning,
                    message: l.errorMessage || x("typeArrayMismatchWarning", "Incorrect type. Expected one of {0}.", l.type.join(", "))
                }) : l.type && (e(l.type) || d.problems.push({
                    location: {
                        offset: f.offset,
                        length: f.length
                    },
                    severity: b.DiagnosticSeverity.Warning,
                    message: l.errorMessage || x("typeMismatchWarning", 'Incorrect type. Expected "{0}".', l.type)
                }));
                Array.isArray(l.allOf) && l.allOf.forEach(function(e) {
                    I(f, m(e), d, p)
                });
                var t = m(l.not);
                if (t) {
                    var r = new v,
                        n = p.newSub();
                    I(f, t, r, n), r.hasProblems() || d.problems.push({
                        location: {
                            offset: f.offset,
                            length: f.length
                        },
                        severity: b.DiagnosticSeverity.Warning,
                        message: x("notSchemaWarning", "Matches a schema that is not allowed.")
                        ...
                        if (I(f, t, r, n), r.hasProblems() || a.push(t), s)
                            if (i || r.hasProblems() || s.validationResult.hasProblems()) {
                                ...
                                0 < o ? s = {
                                    ...
                                    validationResult: r,
                                    matchingSchemas: n
                                } : 0 === o && (s.matchingSchemas.merge(n), s.validationResult.mergeEnumValues(r))
                            } else s.matchingSchemas.merge(n), s.validationResult.propertiesMatches += r.propertiesMatches, s.validationResult.propertiesValueMatches += r.propertiesValueMatches;
                        else s = {
                            schema: t,
                            validationResult: r,
                            matchingSchemas: n
                        }
                    }), 1 < a.length && i && d.problems.push({
                        location: {
                            offset: f.offset,
                            length: 1
                        },
                        severity: b.DiagnosticSeverity.Warning,
                        message: x("oneOfWarning", "Matches multiple schemas when only one must validate.")
                    }), null !== s && (d.merge(s.validationResult), d.propertiesMatches += s.validationResult.propertiesMatches, d.propertiesValueMatches += s.validationResult.propertiesValueMatches, p.merge(s.matchingSchemas)), a.length
                };
                ...
                if (Array.isArray(l.enum)) {
                    ...
                    d.enumValues = l.enum, (d.enumValueMatch = a) || d.problems.push({
                        location: {
                            offset: f.offset,
                            length: f.length
                        },
                        ...
                        message: l.errorMessage || x("enumWarning", "Value is not accepted. Valid values: {0}.", l.enum.map(function(e) {
                            return JSON.stringify(e)
                        }).join(", "))
                    })
                }
                if (l.const) {
                    var i = k(f);
                    h.equals(i, l.const) ? d.enumValueMatch = !0 : (d.problems.push({
                        location: {
                            offset: f.offset,
                            length: f.length
                        },
                        severity: b.DiagnosticSeverity.Warning,
                        code: y.ErrorCode.EnumValueMismatch,
                        message: l.errorMessage || x("constWarning", "Value must be {0}.", JSON.stringify(l.const))
                    }), d.enumValueMatch = !1), d.enumValues = [l.const]
                }
                l.deprecationMessage && f.parent && d.problems.push({
                    location: {
    ...
    t.JSONDocument = E, t.parse = function(s, e) {
        var a = [],
            c = -1,
            u = s.getText(),
        ...
        function l() {
            for (;;) {
                ...
                switch (r(), e) {
                    case 12:
                    case 13:
                        Array.isArray(t) && t.push(b.Range.create(s.positionAt(f.getTokenOffset()), s.positionAt(f.getTokenOffset() + f.getTokenLength())));
                        break;
                    case 15:
                    case 14:
                        break;
        ...
        function d(e, t, r, n, o) {
            if (void 0 === o && (o = b.DiagnosticSeverity.Error), 0 === a.length || r !== c) {
        ...
        function r() {
            switch (f.getTokenError()) {
                case 4:
                    return p(x("InvalidUnicode", "Invalid unicode sequence in string."), y.ErrorCode.InvalidUnicode), !0;
                case 5:
                    return p(x("InvalidEscapeCharacter", "Invalid escape character in string."), y.ErrorCode.InvalidEscapeCharacter), !0;
                case 3:
                    return p(x("UnexpectedEndOfNumber", "Unexpected end of number."), y.ErrorCode.UnexpectedEndOfNumber), !0;
                case 1:
                    return p(x("UnexpectedEndOfComment", "Unexpected end of comment."), y.ErrorCode.UnexpectedEndOfComment), !0;
                case 2:
                    return p(x("UnexpectedEndOfString", "Unexpected end of string."), y.ErrorCode.UnexpectedEndOfString), !0;
                case 6:
                    return p(x("InvalidCharacter", "Invalid characters in string. Control characters must be escaped."), y.ErrorCode.InvalidCharacter), !0
            }
            return !1
        }
        ...
        function m(e, t) {
            ...
            if (!n) {
                ...
                p(x("DoubleQuotesExpected", "Property keys must be doublequoted"), y.ErrorCode.Undefined);
                var o = new T(r, f.getTokenOffset(), f.getTokenLength());
                o.value = f.getTokenValue(), n = o, l()
            }
            var i = t[(r.keyNode = n).value];
            if (i ? (d(x("DuplicateKeyWarning", "Duplicate object key"), y.ErrorCode.DuplicateKey, r.keyNode.offset, r.keyNode.offset + r.keyNode.length, b.DiagnosticSeverity.Warning), "object" == typeof i && d(x("DuplicateKeyWarning", "Duplicate object key"), y.ErrorCode.DuplicateKey, i.keyNode.offset, i.keyNode.offset + i.keyNode.length, b.DiagnosticSeverity.Warning), t[n.value] = !0) : t[n.value] = r, 6 === f.getToken()) r.colonOffset = f.getTokenOffset(), l();
            else if (p(x("ColonExpected", "Colon expected"), y.ErrorCode.ColonExpected), 10 === f.getToken() && s.positionAt(n.offset + n.length).line < s.positionAt(f.getTokenOffset()).line) return r.length = n.length, r;
            var a = v(r, n.value);
            return a ? (r.valueNode = a, r.length = a.offset + a.length - r.offset, r) : p(x("ValueExpected", "Value expected"), y.ErrorCode.ValueExpected, r, [], [2, 5])
        }
        ...
        function v(e, t) {
            return function(e) {
                ...
                for (var r = !1; 4 !== f.getToken() && 17 !== f.getToken();) {
                    if (5 === f.getToken()) {
                        r || p(x("ValueExpected", "Value expected"), y.ErrorCode.ValueExpected);
                        var n = f.getTokenOffset();
                        if (l(), 4 === f.getToken()) {
                            r && d(x("TrailingComma", "Trailing comma"), y.ErrorCode.TrailingComma, n, n + 1);
                            continue
                        }
                    } else r && p(x("ExpectedComma", "Expected comma"), y.ErrorCode.CommaExpected);
                    var o = v(t, 0);
                    o ? t.items.push(o) : p(x("PropertyExpected", "Value expected"), y.ErrorCode.ValueExpected, null, [], [4, 5]), r = !0
                }
                return 4 !== f.getToken() ? p(x("ExpectedCloseBracket", "Expected comma or closing bracket"), y.ErrorCode.CommaOrCloseBacketExpected, t) : h(t, !0)
            }(e) || function(e) {
                ...
                for (var n = !1; 2 !== f.getToken() && 17 !== f.getToken();) {
                    if (5 === f.getToken()) {
                        n || p(x("PropertyExpected", "Property expected"), y.ErrorCode.PropertyExpected);
                        var o = f.getTokenOffset();
                        if (l(), 2 === f.getToken()) {
                            n && d(x("TrailingComma", "Trailing comma"), y.ErrorCode.TrailingComma, o, o + 1);
                            continue
                        }
                    } else n && p(x("ExpectedComma", "Expected comma"), y.ErrorCode.CommaExpected);
                    var i = m(t, r);
                    i ? t.properties.push(i) : p(x("PropertyExpected", "Property expected"), y.ErrorCode.PropertyExpected, null, [], [2, 5]), n = !0
                }
                return 2 !== f.getToken() ? p(x("ExpectedCloseBrace", "Expected comma or closing brace"), y.ErrorCode.CommaOrCloseBraceExpected, t) : h(t, !0)
            }(e) || g(e) || function(e) {
                ...
                if (0 === f.getTokenError()) {
                    ...
                    try {
                        var n = JSON.parse(r);
                        if ("number" != typeof n) return p(x("InvalidNumberFormat", "Invalid number format."), y.ErrorCode.Undefined, t);
                        t.value = n
                    } catch (e) {
                        return p(x("InvalidNumberFormat", "Invalid number format."), y.ErrorCode.Undefined, t)
                    }
        ...
        var n = null;
        return 17 !== l() && ((n = v(null)) ? 17 !== f.getToken() && p(x("End of file expected", "End of file expected."), y.ErrorCode.Undefined) : p(x("Invalid symbol", "Expected a JSON object, array or literal."), y.ErrorCode.Undefined)), new E(n, a, t)
    }
}),
function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
...
function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        var t = e(require, exports);
        void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonCompletion", ["require", "exports", "../parser/jsonParser", "jsonc-parser", "../utils/json", "../utils/strings", "vscode-languageserver-types", "vscode-nls"], e)
}(function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var b = e("../parser/jsonParser"),
        ...
        o = function() {
            function e(e, t, r) {
                void 0 === t && (t = []), this.templateVarIdCounter = 0, this.schemaService = e, this.contributions = t, this.promise = r || Promise
            }
            return e.prototype.doResolve = function(e) {
                ...
                var m = this.getCurrentWord(u, p),
                    g = null;
                if (!h || "string" !== h.type && "number" !== h.type && "boolean" !== h.type && "null" !== h.type) {
                    var t = p - m.length;
                ...
                var v = {},
                    y = {
                        add: function(e) {
                            var t = v[e.label];
                            t ? t.documentation || (t.documentation = e.documentation) : (v[e.label] = e, g && (e.textEdit = x.TextEdit.replace(g, e.insertText)), d.items.push(e))
                        },
                ...
                return this.schemaService.getSchemaForResource(u.uri, f).then(function(e) {
                    ...
                    if (h && "string" === h.type) {
                        var i = h.parent;
                        i && "property" === i.type && i.keyNode === h && (n = !i.valueNode, o = i, t = u.getText().substr(h.offset + 1, h.length - 2), i && (h = i.parent))
                    }
                    if (h && "object" === h.type) {
                        ...
                        var a = "";
                        n && (a = l.evaluateSeparatorAfter(u, u.offsetAt(g.end))), e ? l.getPropertyCompletions(e, f, h, n, a, y) : l.getSchemaLessPropertyCompletions(f, h, t, y);
                        var s = b.getNodePath(h);
                        l.contributions.forEach(function(e) {
                            var t = e.collectPropertyCompletions(u.uri, s, m, n, "" === a, y);
                            t && r.push(t)
                        }), !e && 0 < m.length && '"' !== u.getText().charAt(p - m.length - 1) && y.add({
                    ...
                    var c = {};
                    return e ? l.getValueCompletions(e, f, h, p, u, y, c) : l.getSchemaLessValueCompletions(f, h, p, u, y), 0 < l.contributions.length && l.getContributedValueCompletions(f, h, p, u, y, r), l.promise.all(r).then(function() {
                        if (0 === y.getNumberOfProposals()) {
                            var e = p;
                            !h || "string" !== h.type && "number" !== h.type && "boolean" !== h.type && "null" !== h.type || (e = h.offset + h.length);
                    ...
                    if (e.node === r && !e.inverted) {
                        ...
                        n && Object.keys(n).forEach(function(e) {
                            ...
                            if ("object" == typeof t && !t.deprecationMessage && !t.doNotSuggest) {
                                ...
                                c.endsWith(r.insertText, "$1" + i) && (r.command = {
                                    title: "Suggest",
                ...
                if (t.parent)
                    if ("property" === t.parent.type) {
                        ...
                        e.visit(function(e) {
                            return "property" === e.type && e !== t.parent && e.keyNode.value === a && e.valueNode && "object" === e.valueNode.type && i(e.valueNode), !0
                        })
                ...
                var i = this,
                    a = r;
                if (!t || "string" !== t.type && "number" !== t.type && "boolean" !== t.type && "null" !== t.type || (a = t.offset + t.length, t = t.parent), !t) return o.add({
                ...
                if ("property" === t.type && r > t.colonOffset) {
                    var u = t.valueNode;
                    if (u && (r > u.offset + u.length || "object" === u.type || "array" === u.type)) return;
                    var f = t.keyNode.value;
                    e.visit(function(e) {
                        return "property" === e.type && e.keyNode.value === f && e.valueNode && c(e.valueNode), !0
                    }), "$schema" === f && t.parent && !t.parent.parent && this.addDollarSchemaCompletions(s, o)
                }
                if ("array" === t.type)
                    if (t.parent && "property" === t.parent.type) {
                        var l = t.parent.keyNode.value;
                        e.visit(function(e) {
                            return "property" === e.type && e.keyNode.value === l && e.valueNode && "array" === e.valueNode.type && e.valueNode.items.forEach(c), !0
                        })
                ...
                var c = this,
                    ...
                    u = null,
                    f = null;
                if (!n || "string" !== n.type && "number" !== n.type && "boolean" !== n.type && "null" !== n.type || (r = n.offset + n.length, n = (f = n).parent), n) {
                    ...
                    if (n && (null !== u || "array" === n.type)) {
                            ...
                            if (e.node === n && !e.inverted && e.schema) {
                                if ("array" === n.type && e.schema.items)
                                    if (Array.isArray(e.schema.items)) {
                                        ...
                                        t < e.schema.items.length && c.addSchemaValueCompletions(e.schema.items[t], d, a, s)
                        ...
                        }), "$schema" !== u || n.parent || this.addDollarSchemaCompletions(d, a), s.boolean && (this.addBooleanValueCompletion(!0, d, a), this.addBooleanValueCompletion(!1, d, a)), s.null && this.addNullValueCompletion(d, a)
                    }
                } else this.addSchemaValueCompletions(e.schema, "", a, s)
            }, e.prototype.getContributedValueCompletions = function(e, t, r, n, o, i) {
                if (t) {
                    if ("string" !== t.type && "number" !== t.type && "boolean" !== t.type && "null" !== t.type || (t = t.parent), "property" === t.type && r > t.colonOffset) {
                ...
                var o = this;
                "object" == typeof e && (this.addEnumValueCompletions(e, t, r), this.addDefaultValueCompletions(e, t, r), this.collectTypes(e, n), Array.isArray(e.allOf) && e.allOf.forEach(function(e) {
                ...
                Array.isArray(f.defaultSnippets) && f.defaultSnippets.forEach(function(e) {
                    var t, r, n = f.type,
                        o = e.body,
                        i = e.label;
                    if (g(o)) {
                        ...
                        t = h.getInsertTextForSnippetValue(o, l), r = h.getFilterTextForSnippetValue(o), i = i || h.getLabelForSnippetValue(o)
                ...
                }), m || "object" != typeof f.items || Array.isArray(f.items) || this.addDefaultValueCompletions(f.items, l, d, p + 1)
                ...
                if (g(e.const) && r.add({
                    ...
                    for (var n = 0, o = e.enum.length; n < o; n++) {
                        var i = e.enum[n],
                            a = e.description;
                        e.enumDescriptions && n < e.enumDescriptions.length && (a = e.enumDescriptions[n]), r.add({
                            kind: this.getSuggestionKind(e.type),
                ...
                var n = this;
                this.schemaService.getRegisteredSchemaIds(function(e) {
                ...
                var t = JSON.stringify(e);
                return 57 < (t = t.replace(/\$\{\d+:([^}]+)\}|\$\d+/g, "$1")).length ? t.substr(0, 57).trim() + "..." : t
                ...
                return "{}" === r ? "{\n\t$1\n}" + t : "[]" === r ? "[\n\t$1\n]" + t : this.getInsertTextForPlainText(r + t)
            }, e.prototype.getInsertTextForSnippetValue = function(e, t) {
                return r.stringifyObject(e, "", function(e) {
                ...
                if (t) {
                    ...
                    if (t.enum && (i || 1 !== t.enum.length || (i = this.getInsertTextForGuessedValue(t.enum[0], "")), s += t.enum.length), g(t.default) && (i || (i = this.getInsertTextForGuessedValue(t.default, "")), s++), 0 === s) {
                ...
                for (var r = t - 1, n = e.getText(); 0 <= r && -1 === ' \t\n\r\v":{[,]}'.indexOf(n.charAt(r));) r--;
                ...
                for (var n = s.createScanner(t.getText(), !0), o = e.items, i = o.length - 1; 0 <= i; i--) {
                    var a = o[i];
                    if (r > a.offset + a.length) return n.setPosition(a.offset + a.length), 5 === n.scan() && r >= n.getTokenOffset() + n.getTokenLength() ? i + 1 : i;
                ...
                n.setPosition(t);
                for (var o = n.scan(); 17 !== o && n.getTokenOffset() + n.getTokenLength() < r;) o = n.scan();
...
function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        var t = e(require, exports);
        void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonHover", ["require", "exports", "../parser/jsonParser", "vscode-languageserver-types"], e)
}(function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var d = e("../parser/jsonParser"),
        ...
        r = function() {
            ...
            return e.prototype.doHover = function(e, t, s) {
                ...
                if (!c || ("object" === c.type || "array" === c.type) && r > c.offset + 1 && r < c.offset + c.length - 1) return this.promise.resolve(null);
                var n = c;
                if ("string" === c.type) {
                    var o = c.parent;
                    if ("property" === o.type && o.keyNode === c && !(c = o.valueNode)) return this.promise.resolve(null)
                }
                for (var i = p.Range.create(e.positionAt(n.offset), e.positionAt(n.offset + n.length)), u = function(e) {
                        return {
                            contents: e,
                            range: i
                        }
                    }, a = d.getNodePath(c), f = this.contributions.length - 1; 0 <= f; f--) {
                ...
                return this.schemaService.getSchemaForResource(e.uri, s).then(function(e) {
                    if (e) {
                        var t = s.getMatchingSchemas(e.schema, c.offset),
                            ...
                            i = null;
                        t.every(function(e) {
                            if (e.node === c && !e.inverted && e.schema && (r = r || e.schema.title, n = n || e.schema.markdownDescription || h(e.schema.description), e.schema.enum)) {
                                var t = e.schema.enum.indexOf(d.getNodeValue(c));
                                e.schema.markdownEnumDescriptions ? o = e.schema.markdownEnumDescriptions[t] : e.schema.enumDescriptions && (o = h(e.schema.enumDescriptions[t])), o && "string" != typeof(i = e.schema.enum[t]) && (i = JSON.stringify(i))
                            }
                            return !0
                        });
                        var a = "";
                        return r && (a = h(r)), n && (0 < a.length && (a += "\n\n"), a += n), o && (0 < a.length && (a += "\n\n"), a += "`" + h(i) + "`: " + o), u([a])
                    }
                    return null
                })
            }, e
...
function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        var t = e(require, exports);
        void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonValidation", ["require", "exports", "vscode-languageserver-types", "../jsonLanguageTypes", "vscode-nls"], e)
}(function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var m = e("vscode-languageserver-types"),
        ...
        r = function() {
            ...
            return e.prototype.configure = function(e) {
                e && (this.validationEnabled = e.validate, this.commentSeverity = e.allowComments ? void 0 : m.DiagnosticSeverity.Error)
                ...
                var p = [],
                    ...
                    t = function(e) {
                        ...
                        if (e) {
                            if (e.errors.length && f.root) {
                                ...
                                if (o && "$schema" === o.keyNode.value) {
                                    var i = o.valueNode || o,
                                        a = m.Range.create(u.positionAt(i.offset), u.positionAt(i.offset + i.length));
                                    h(m.Diagnostic.create(a, e.errors[0], m.DiagnosticSeverity.Warning, g.ErrorCode.SchemaResolveError))
                                } else {
                                    a = m.Range.create(u.positionAt(n.offset), u.positionAt(n.offset + 1));
                                    h(m.Diagnostic.create(a, e.errors[0], m.DiagnosticSeverity.Warning, g.ErrorCode.SchemaResolveError))
                                }
                            } else {
                        ...
                        if (f.syntaxErrors.forEach(function(e) {
                            ...
                            var c = v("InvalidCommentToken", "Comments are not permitted in JSON.");
                            f.comments.forEach(function(e) {
                                h(m.Diagnostic.create(e, c, r, g.ErrorCode.CommentNotPermitted))
                            })
                        }
                        return p
                    };
                return e ? this.promise.resolve(t(e)) : this.jsonSchemaService.getSchemaForResource(u.uri, f).then(function(e) {
                    return t(e)
                })
            }, e
        }();
...
function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        var t = e(require, exports);
        void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-json-languageservice/utils/colors", ["require", "exports"], e)
}(function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    function s(e) {
        return e < r ? 0 : e <= n ? e - r : (e < i && (e += i - o), i <= e && e <= a ? e - i + 10 : 0)
    }
    t.hexDigit = s, t.colorFromHex = function(e) {
        if ("#" !== e[0]) return null;
        switch (e.length) {
            case 4:
                return {
...
function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        var t = e(require, exports);
        void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonDocumentSymbols", ["require", "exports", "../parser/jsonParser", "../utils/strings", "../utils/colors", "vscode-languageserver-types"], e)
}(function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var l = e("../parser/jsonParser"),
        ...
        r = function() {
            ...
            return e.prototype.findDocumentSymbols = function(a, e) {
                var s = this,
                    t = e.root;
                if (!t) return null;
                var r = a.uri;
                if (("vscode://defaultsettings/keybindings.json" === r || n.endsWith(r.toLowerCase(), "/user/keybindings.json")) && "array" === t.type) {
                    var i = [];
                        ...
                        if ("object" === e.type)
                            for (var t = 0, r = e.properties; t < r.length; t++) {
                                ...
                                if ("key" === n.keyNode.value) {
                                    if (n.valueNode) {
                                        var o = p.Location.create(a.uri, p.Range.create(a.positionAt(e.offset), a.positionAt(e.offset + e.length)));
                                        i.push({
                ...
                var c = function(o, e, i) {
                    return "array" === e.type ? e.items.forEach(function(e) {
                        return c(o, e, i)
                    }) : "object" === e.type && e.properties.forEach(function(e) {
                        var t = p.Location.create(a.uri, p.Range.create(a.positionAt(e.offset), a.positionAt(e.offset + e.length))),
                            r = e.valueNode;
                        if (r) {
                ...
                return this.schemaService.getSchemaForResource(u.uri, f).then(function(e) {
                    ...
                    if (e)
                        for (var r = {}, n = 0, o = f.getMatchingSchemas(e.schema); n < o.length; n++) {
                            var i = o[n];
                            if (!i.inverted && i.schema && ("color" === i.schema.format || "color-hex" === i.schema.format) && i.node && "string" === i.node.type) {
                                var a = String(i.node.offset);
                                if (!r[a]) {
                                    var s = d.colorFromHex(l.getNodeValue(i.node));
                                    if (s) {
                                        var c = p.Range.create(u.positionAt(i.node.offset), u.positionAt(i.node.offset + i.node.length));
                                        t.push({
                                            color: s,
                                            range: c
                                        })
                ...
                return o = 1 === r.alpha ? "#" + u(a) + u(s) + u(c) : "#" + u(a) + u(s) + u(c) + u(Math.round(255 * r.alpha)), i.push({
                    label: o,
        ...
        schemas: {
            "http://json-schema.org/draft-04/schema#": {
                ...
                properties: {
                    ...
                    default: {
                        description: r("schema.json.default", "A default value. Used by suggestions.")
                    },
                    multipleOf: {
                        type: "number",
                        minimum: 0,
...
function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        var t = e(require, exports);
        void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonSchemaService", ["require", "exports", "jsonc-parser", "vscode-uri", "../utils/strings", "../parser/jsonParser", "vscode-nls"], e)
}(function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    var a = e("jsonc-parser"),
        ...
        o = function() {
            function e(e, t, r) {
                this.service = e, this.url = t, r && (this.unresolvedSchema = this.service.promise.resolve(new s(r)))
            }
            return e.prototype.getUnresolvedSchema = function() {
                ...
                var t = this;
                return this.resolvedSchema || (this.resolvedSchema = this.getUnresolvedSchema().then(function(e) {
    ...
    var d = function() {
        ...
        return e.prototype.getSection = function(e) {
            ...
            var o = t.shift();
            if (r.properties && (r.properties[o], 1)) return this.getSectionRecursive(t, r.properties[o]);
            if (r.patternProperties) Object.keys(r.patternProperties).forEach(function(e) {
                if (new RegExp(e).test(o)) return n.getSectionRecursive(t, r.patternProperties[e])
            });
            else {
                if ("object" == typeof r.additionalProperties) return this.getSectionRecursive(t, r.additionalProperties);
                if (o.match("[0-9]+"))
                    if (Array.isArray(r.items)) {
                        var e = parseInt(o, 10);
                        if (!isNaN(e) && r.items[e]) return this.getSectionRecursive(t, r.items[e])
    ...
    var i = function() {
        function e(e, t, r) {
            this.contextService = t, this.requestService = e, this.promiseConstructor = r || Promise, this.callOnDispose = [], this.contributionSchemas = {}, this.contributionAssociations = {}, this.schemasById = {}, this.filePatternAssociations = [], this.filePatternAssociationById = {}, this.registeredSchemasIds = {}
        }
        return e.prototype.getRegisteredSchemaIds = function(r) {
            ...
            return t || (t = new r(e), this.filePatternAssociationById[e] = t, this.filePatternAssociations.push(t)), t
        }, e.prototype.registerExternalSchema = function(e, t, r) {
            var n = this;
            void 0 === t && (t = null);
            var o = this.normalizeId(e);
            return this.registeredSchemasIds[o] = !0, t && t.forEach(function(e) {
            ...
            var r = this;
            for (var e in this.schemasById = {}, this.filePatternAssociations = [], this.filePatternAssociationById = {}, this.registeredSchemasIds = {}, this.contributionSchemas) this.schemasById[e] = this.contributionSchemas[e], this.registeredSchemasIds[e] = !0;
            ...
            if (!this.requestService) {
                var e = l("json.schema.norequestservice", "Unable to load schema from '{0}'. No schema request service available", c(i));
                return this.promise.resolve(new s({}, [e]))
            }
            return this.requestService(i).then(function(e) {
                if (!e) {
                    var t = l("json.schema.nocontent", "Unable to load schema from '{0}': No content.", c(i));
                    return new s({}, [t])
                }
                var r, n = [];
                r = a.parse(e, n);
                var o = n.length ? [l("json.schema.invalidFormat", "Unable to parse content from '{0}': Parse error at offset {1}.", c(i), n[0].offset)] : [];
                return new s(r, o)
            }, function(e) {
                var t = l("json.schema.unabletoload", "Unable to load schema from '{0}': {1}", c(i), e.toString());
                return new s({}, [t])
            })
            ...
            var s = this,
                ...
                u = function(e, t, r, n) {
                    ...
                    else a.push(l("json.schema.invalidref", "$ref '{0}' in '{1}' can not be resolved.", n, r))
                },
                f = function(r, n, o, e) {
                    return i && !/^\w+:\/\/.*/.test(n) && (n = i.resolveRelativePath(n, e)), n = s.normalizeId(n), s.getOrAddSchemaHandle(n).getUnresolvedSchema().then(function(e) {
                        if (e.errors.length) {
                            var t = o ? n + "#" + o : n;
                            a.push(l("json.schema.problemloadingref", "Problems loading reference '{0}': {1}", t, e.errors[0]))
                        }
                ...
                c = function(e, r, n) {
                    ...
                    for (var c = [e], t = [], o = [], i = function(e) {
                            for (; e.$ref;) {
                                var t = e.$ref.split("#", 2);
                                if (delete e.$ref, 0 < t[0].length) return void o.push(f(e, t[0], t[1], n));
                                u(e, r, n, t[1])
                            }! function() {
                            ...
                            }(e.items, e.additionalProperties, e.not, e.contains, e.propertyNames),
                            function() {
                                for (var e = [], t = 0; t < arguments.length; t++) e[t] = arguments[t];
                                for (var r = 0, n = e; r < n.length; r++) {
                                    var o = n[r];
            ...
            if (t && t.root && "object" === t.root.type) {
                ...
                if (0 < r.length) {
                    ...
                    if (n && p.startsWith(n, ".") && this.contextService && (n = this.contextService.resolveRelativePath(n, e)), n) {
                        var o = this.normalizeId(n);
                        return this.getOrAddSchemaHandle(o).getResolvedSchema()
                    }
                }
            }
            for (var i = Object.create(null), a = [], s = 0, c = this.filePatternAssociations; s < c.length; s++) {
                var u = c[s];
            ...
            return 0 < a.length ? this.createCombinedSchema(e, a).getResolvedSchema() : this.promise.resolve(null)
...
function(e) {
    if ("object" == typeof module && "object" == typeof module.exports) {
        var t = e(require, exports);
        void 0 !== t && (module.exports = t)
    } else "function" == typeof define && define.amd && define("vscode-json-languageservice/services/jsonFolding", ["require", "exports", "vscode-languageserver-types", "jsonc-parser", "../jsonLanguageTypes"], e)
}(function(e, t) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    ...
    t.getFoldingRanges = function(e, t) {
            ...
            switch (s) {
                ...
                case 4:
                    ...
                    if (0 < o.length && o[o.length - 1].kind === f) {
                        ...
                        u && l > u.startLine + 1 && i !== u.startLine && (u.endLine = l - 1, c(u), i = u.startLine)
                    }
                    break;
                case 13:
                    var d = e.positionAt(a.getTokenOffset()).line,
                        p = e.positionAt(a.getTokenOffset() + a.getTokenLength()).line;
                    1 === a.getTokenError() && d + 1 < e.lineCount ? a.setPosition(e.offsetAt(A.Position.create(d + 1, 0))) : d < p && (c({
                        startLine: d,
                        endLine: p,
                    ...
                    break;
                case 12:
                    var h = e.getText().substr(a.getTokenOffset(), a.getTokenLength()).match(/^\/\/\s*#(region\b)|(endregion\b)/);
                    if (h)
                        if (l = e.positionAt(a.getTokenOffset()).line, h[1]) u = {
                            startLine: l,
                            endLine: l,
                            kind: k.FoldingRangeKind.Region
                        }, o.push(u);
                        else {
                            for (var m = o.length - 1; 0 <= m && o[m].kind !== k.FoldingRangeKind.Region;) m--;
                            0 <= m && (u = o[m], o.length = m, l > u.startLine && i !== u.startLine && (u.endLine = l, c(u), i = u.startLine))
                        }
            }
            s = a.scan()
        }
        ...
        for (var v = [], y = 0, b = n; y < b.length; y++)(T = b[y]) < 30 && (v[T] = (v[T] || 0) + 1);
        var x = 0,
            S = 0;
        ...
        for (m = 0; m < r.length; m++) {
            var T;
            "number" == typeof(T = n[m]) && (T < S || T === S && x++ < g) && j.push(r[m])
        }
        return j
    }
}),
function(e) {
    ...
    ! function(e) {
    ...
    }(e("./jsonLanguageTypes")), r.getLanguageService = function(e) {
        ...
        return {
            configure: function(e) {
                r.clearExternalSchemas(), e.schemas && e.schemas.forEach(function(e) {
            ...
            format: function(t, e, r) {
                ...
                return g.format(t.getText(), n, i).map(function(e) {
                    return s.TextEdit.replace(s.Range.create(t.positionAt(e.offset), t.positionAt(e.offset + e.length)), e.content)
                })
            }
        }
    }
    ...
    return e
}), define("vs/language/json/jsonWorker", ["require", "exports", "vscode-json-languageservice", "vscode-languageserver-types"], function(e, t, r, o) {
    "use strict";
    Object.defineProperty(t, "__esModule", {
        value: !0
    });
        ...
        i = function() {
            ...
            return e.prototype.doValidation = function(e) {
                ...
                for (var t = 0, r = this._ctx.getMirrorModels(); t < r.length; t++) {
                    var n = r[t];
                    if (n.uri.toString() === e) return o.TextDocument.create(e, this._languageId, n.version, n.getValue())
                }
                return null
            }, e
        }();
    t.JSONWorker = i, t.create = function(e, t) {
        return new i(e, t)
    }
});