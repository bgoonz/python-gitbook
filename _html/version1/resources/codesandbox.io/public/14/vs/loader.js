...
! function(e) {
    var t = function() {
        ...
        }, t.NEXT_ANONYMOUS_ID = 1, t.PERFORMANCE_NOW_PROBED = !1, t.HAS_PERFORMANCE_NOW = !1, t
    }();
    e.Utilities = t
}(AMDLoader || (AMDLoader = {}));
! function(e) {
    ...
    var r = function() {
        function r(e, r) {
            if (this._env = e, this.options = t.mergeConfigurationOptions(r), this._createIgnoreDuplicateModulesMap(), this._createNodeModulesMap(),
...
! function(e) {
    var t = function() {
            ...
            return e.prototype.load = function(e, t, i, s) {
                ...
                this._callbackMap.hasOwnProperty(t) ? this._callbackMap[t].push(a) : (this._callbackMap[t] = [a], this._scriptLoader.load(e, t, function() {
        ...
        r = function() {
            ...
            return e.prototype.attachListeners = function(e, t, r) {
                ...
                o.setAttribute("async", "async"), o.setAttribute("type", "text/javascript"), this.attachListeners(o, r, n), o.setAttribute("src", t);
        ...
        o = function() {
            ...
            return t.prototype._init = function(e) {
                    ...
                    i.prototype._compile = function(t, s) {
                        ...
                        var l = new o._vm.Script(d, u),
                            ...
                            f = function(e) {
                                ...
                                }, r.main = process.mainModule, r.extensions = t._extensions, r.cache = t._cache, r
                            }(this),
                ...
                } else n = e.Utilities.fileUriToFilePath(this._env.isWindows, n), this._fs.readFile(n, {
                    encoding: "utf8"
                }, function(e, a) {
                    if (e) i(e);
                    else {
                        ...
                        if (p = a.charCodeAt(0) === t._BOM ? _ + a.substring(1) + "\n});" : _ + a + "\n});", p = u(p, c), d.nodeCachedDataDir) {
                            ...
                            s._fs.readFile(g, function(e, t) {
                                var d = {
                                    ...
                                    a = s._loadAndEvalScript(r, n, h, p, d, l, o, i);
                                s._processCachedData(r, a, g)
                            })
                        } else s._loadAndEvalScript(r, n, h, p, {
                            filename: h
                        }, l, o, i)
                    }
                })
            }, t.prototype._loadAndEvalScript = function(t, r, n, o, i, s, d, a) {
                s.record(31, r);
                var u = new this._vm.Script(o, i),
                    l = u.runInThisContext(i),
                    c = t.getGlobalAMDDefineFunc(),
                    h = !1,
                    f = function() {
                        return h = !0, c.apply(null, arguments)
                    };
                return f.amd = c.amd, l.call(e.global, t.getGlobalAMDRequireFunc(), f, n, this._path.dirname(r)), s.record(32, r), h ? d() : a(new Error("Didn't receive define call in " + r + "!")), u
...
! function(e) {
    ...
    var n = function() {
            function e() {
                this._nextId = 0, this._strModuleIdToIntModuleId = new Map, this._intModuleIdToStrModuleId = [], this.getModuleId("exports"), this.getModuleId("module"),
                    ...
                    var o = -1,
                        i = function(r) {
                            if (++o >= n.length) t._onLoadError(e, r);
                                ...
                                d.record(10, s), t._scriptLoader.load(t, s, function() {
                                    t._config.isBuild() && (t._buildInfoPath[e] = s), d.record(11, s), t._onLoad(e)
                                }, function(e) {
                                    d.record(12, s), i(e)
                                })
                            }
            ...
            s.prototype._onModuleComplete = function(e) {
                ...
                if (!e.isComplete()) {
                    ...
                    if (f) {
                        ...
                        for (var s = 0, d = f.length; s < d; s++) this._loadPluginDependency(e.exports, f[s])
                    }
                }
            }, s
    }();
...
! function(e) {
    function t() {
        if (void 0 !== e.global.require || "undefined" != typeof require) {
            ...
            if ("function" == typeof t && "function" == typeof t.resolve) {
                ...
                e.global.nodeRequire = i, s.nodeRequire = i, s.__$__nodeRequire = i
            }
        }
        r.isNode && !r.isElectronRenderer ? (module.exports = s, require = s) : (r.isElectronRenderer || (e.global.define = o), e.global.require = s)
    }
    ...
    var i = function(e, t) {
        ...
        s = function() {
            if (1 === arguments.length) {
                if (arguments[0] instanceof Object && !Array.isArray(arguments[0])) return void i(arguments[0]);
    ...
    s.config = i, s.getConfig = function() {
    ...
    }, e.init = t, "function" == typeof e.global.define && e.global.define.amd || (n = new e.ModuleManager(r, e.createScriptLoader(r), o, s, e.Utilities.getHighPerformanceTimestamp()), void 0 !== e.global.require && "function" != typeof e.global.require && s.config(e.global.require), (define = function() {
        return o.apply(null, arguments)
    }).amd = o.amd, "undefined" == typeof doNotInitLoader && t())
}(AMDLoader || (AMDLoader = {}));
