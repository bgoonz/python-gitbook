...
(function() {
    ...
    var data = {
        "resource": {
            ...
            "macros": [{
                ...
                "vtp_setDefaultValue": false,
                "vtp_input": ["macro", 2],
                "vtp_map": ["list", ["map", "key", "true", "value", "Signedin"],
                ...
                "vtp_ignoreCase": true,
                "vtp_map": ["list", ["map", "key", "\/dashboard\/recent", "value", "Dashboard page"],
    ...
    */
        ...
        Fc, Gc, Hc, Ic = function(a, b) {
            ...
            for (f in a)
                if (a.hasOwnProperty(f))
                    if (0 === f.indexOf("vtp_")) d && b && b.Yf && b.Yf(a[f]), e[void 0 !== d ? f : f.substr(4)] = a[f];
        ...
        Jc = function(a, b, c) {
            if (ua(a)) {
                ...
                switch (a[0]) {
                    ...
                    case "map":
                        d = {};
                        for (var l = 1; l < a.length; l += 2) d[Jc(a[l], b, c)] = Jc(a[l + 1], b, c);
                        return d;
                    case "template":
                        d = [];
                    ...
                    case "escape":
                        d = Jc(a[1], b, c);
                        if (Gc && ua(a[1]) && "macro" === a[1][0] && Gc.yi(a)) return Gc.Ni(d);
                        d = String(d);
                        for (var t = 2; t < a.length; t++) Xb[a[t]] && (d = Xb[a[t]](d));
                        return d;
                    case "tag":
                        var u = a[1];
                        if (!xc[u]) throw Error("Unable to resolve tag reference " +
                            u + ".");
                        return d = {
                            dg: a[2],
                            index: u
    ...
    var Pc = {
        bi: function(a, b) {
            b[Wb.$e] && "string" === typeof a && (a = 1 == b[Wb.$e] ? a.toLowerCase() : a.toUpperCase());
    ...
    var Od = function(a) {
        ...
        Wd = function(a, b) {
            ...
            var d = h(b) ? [b] : b,
                e = {};
            c().length !== d.length && Td(d, function(f) {
                var g = c();
    ...
    var re = [],
        ...
        we = function(a) {
            se ? 0 <= a && a < re.length && re[a] && (re[a].disconnect(), re[a] = void 0) : m.clearInterval(a)
        };
    var xe = /:[0-9]+$/,
        ye = function(a, b, c) {
        ...
        Be = function(a, b, c, d, e) {
            ...
            if ("protocol" === b || "port" === b) a.protocol = ze(a.protocol) || ze(m.location.protocol);
            "port" === b ? a.port = String(Number(a.hostname ? a.port : m.location.port) || ("http" == a.protocol ? 80 : "https" == a.protocol ? 443 : "")) : "host" === b &&
                (a.hostname = (a.hostname || m.location.hostname).replace(xe, "").toLowerCase());
            return Ae(a, b, c, d, e)
        },
        Ae = function(a, b, c, d, e) {
            ...
            switch (b) {
                ...
                case "port":
                    ...
                    break;
                case "path":
                    a.pathname || a.hostname || sd("TAGGING",
                        1);
    ...
    var We = function(a) {
        ...
        jf = function(a, b, c) {
            ...
            Promise.all(a.map(function(d) {
                return d.value && gf(d.name) ? hf(d.value).then(function(e) {
                    d.value = e
                }) : Promise.resolve()
            })).then(function() {
                c(a, b)
        ...
        Ye = /[.~]/g,
        lf = {},
        mf = (lf.email = "em", lf.phone_number = "pn", lf.first_name = "fn", lf.last_name = "ln", lf.street = "sa", lf.city = "ct", lf.region = "rg", lf.country = "co", lf.postal_code = "pc", lf.error_code = "ec", lf),
        nf = function(a, b, c) {
            function d(r, v, x) {
                var z = r[v];
                ua(z) || (z = [z]);
            ...
            if ("https:" === m.location.protocol) {
                ...
                var t = a.address || {};
                ua(t) || (t = [t]);
                for (var u = 0; u < t.length; u++) e(t[u], "first_name", af, u), e(t[u], "last_name", af, u), e(t[u], "street", $e, u), e(t[u], "city", $e, u), e(t[u], "postal_code", Ze,
                    u), e(t[u], "region", $e, u), e(t[u], "country", Ze, u);
                jf(g, k, c)
            } else g.push({
                name: "error_code",
                value: "e3",
    ...
    Cf.M = "GTM-T3L6RFK";
    Cf.bd = "910";
    Cf.Pg = "ChEI8JvciQYQ59SVwYKq6M6bARIkAPAkTPCfrb6vjByMzG9ldk/husSqGI5eI7Che9OMOwDp5W6eGgLMWA\x3d\x3d";
    var Ef = {
            __cl: !0,
            __ecl: !0,
            __ehl: !0,
    ...
    var Rf = {},
        ...
        $f = function(a, b) {
            var c, d = 1 !== (void 0 === b ? 2 : b) ? Yf(a) : Sf.get(a);
    ...
    var vh = /^\w+$/,
        ...
        zh = function(a, b) {
            Qd("ad_storage") ? yh() ? a() : Wd(a, "ad_storage") : b ? sd("TAGGING", 3) : Vd(function() {
                zh(a, !0)
            }, ["ad_storage"])
        },
        Bh = function(a) {
        ...
        Ah = function(a) {
            ...
            for (var d = {}, e = 0; e < c.length; d = {
                ...
                if (null != f) {
                    ...
                    p ? (p.timestamp = Math.max(p.timestamp, l), p.labels = Dh(p.labels, n || [])) : b.push({
                        version: k,
                        ra: d.Fc,
                        timestamp: l,
                        labels: n
    ...
    var Hh = function() {
        ...
        Gh = function(a, b, c, d) {
            ...
            if (void 0 !== a && a.match(wh)) switch (b) {
                case void 0:
                    f(a,
                        "aw");
                    break;
    ...
    function Ih(a, b, c, d, e) {
        ...
        if ((void 0 == uh.enable_gbraid_cookie_write ? 0 : uh.enable_gbraid_cookie_write) && !l && a.gb) {
            var q = a.gb[0],
                ...
                u = !1;
            if (!b)
                for (var r = Ah(t), v = 0; v < r.length; v++) r[v].ra === q && r[v].labels && 0 < r[v].labels.length && (u = !0);
            u || f("gb", p(q))
        }
    }
    var Mh = function(a, b) {
                    ...
                    if (void 0 !== xh[f]) {
                        ...
                        if (k) {
                            ...
                            b: {
                                var p = l;
                                if (kg(m))
                                    for (var q = ng(g, B.cookie, void 0, "ad_storage"), t = 0; t < q.length; ++t)
                                        if (Lh(q[t]) > p) {
                                            n = !0;
                                            break b
                                        }
    ...
    function Nh(a) {
        return 3 > a.length || "GCL" !== a[0] && "1" !== a[0] || !/^\d+$/.test(a[1]) || !wh.test(a[2]) ? [] : a
    }
    ...
    function Vh(a, b) {
        Qd(M.D) ? be(M.D) ? a() : Wd(a, M.D) : b ? ud(42) : fe(function() {
            Vh(a, !0)
        }, [M.D])
    }
        ...
        ci = function(a, b) {
            ...
            Vh(function() {
                ...
                var k = Kg[Lg(b.prefix)],
                    l = !1;
                if (k && 0 < d.length)
                    for (var n = N.joined_auid = N.joined_auid || {}, p = 0; p < d.length; p++) {
                        var q = d[p],
                            t = q.ra,
                            u = q.xe,
                            r = (b.prefix || "_gcl") + "." + u + "." + t;
    ...
    var yi = function(a, b) {
        ...
        if (m.Promise) try {
            return c ? pf(c, b).then(function(e) {
                e.qe = d;
                return e
            }) : Promise.resolve({
                xc: "",
    ...
    var Di = new RegExp(/^(.*\.)?(google|youtube|blogger|withgoogle)(\.com?)?(\.[a-z]{2})?\.?$/),
        Ei = {
            cl: ["ecl"],
        ...
        Gi = "google customPixels customScripts html nonGooglePixels nonGoogleScripts nonGoogleIframes".split(" ");
    var Hi = function() {
            var a = !1;
            return a
        },
        Ji = function(a) {
            ...
            return function(g) {
                ...
                var v = !n || t;
                v || !(0 <= wa(l, "sandboxedScripts")) || c && -1 !== wa(c, "sandboxedScripts") || (v = Ba(e, Gi));
                return f[k] = v
            }
        },
        Ii = function() {
    ...
    var sj = function(a) {},
        ...
        xj =
        function() {
            return "&tc=" + xc.filter(function(a) {
                return a
            }).length
        },
        Aj = function() {
        ...
        zj = function() {
            ...
            void 0 === Ej || Fj[Ej] && !Gj && !Hj || (Ij[Ej] || Jj.zi() || 0 >= Kj-- ? (ud(1), Ij[Ej] = !0) : (Jj.Ti(), Db(yj(!0)), Fj[Ej] = !0, Lj = Mj = Nj = Hj = Gj = ""))
        },
        yj = function(a) {
            var b = Ej;
            if (void 0 === b) return "";
            var c = td("GTM"),
                d = td("TAGGING");
            return [Oj, Fj[b] ? "" : "&es=1",
                Pj[b], sj(b), c ? "&u=" + c : "", d ? "&ut=" + d : "", xj(), Gj, Hj, Nj, Mj, wj(a), Lj, "&z=0"
            ].join("")
        },
        Rj = function() {
            Oj = Qj()
    ...
    hb("Trident") || hb("MSIE");
    hb("Edge");
    !hb("Gecko") || -1 != eb.toLowerCase().indexOf("webkit") && !hb("Edge") || hb("Trident") || hb("MSIE") || hb("Edge"); - 1 != eb.toLowerCase().indexOf("webkit") && !hb("Edge") && hb("Mobile");
    hb("Macintosh");
    hb("Windows");
    hb("Linux") || hb("CrOS");
    ...
    var al = function(a, b, c) {
            ...
            if (0 === k)
                if (a.purpose && a.vendor) {
                    ...
                    l = n && "1" === b && a.purposeOneTreatment && ("DE" === a.publisherCC || "CH" === a.publisherCC) ? !0 : n && $k(a.purpose.consents, b)
                } else l = !0;
            else l = 1 === k ? a.purpose &&
                a.vendor ? $k(a.purpose.legitimateInterests, b) && $k(a.vendor.legitimateInterests, void 0 === d ? "755" : d) : !0 : !0;
            return l
        },
        $k = function(a, b) {
            return !(!a || !a[b])
        ...
        Zk = function(a, b, c, d) {
            ...
            if ("function" === typeof a.s.__tcfapi) {
                ...
                if (a.o) {
                    var g = {};
                    a.o.postMessage((g.__tcfapiCall = {
                        command: b,
                        version: 2,
                        callId: f,
                        parameter: d
                                ...
                                for (k in dl)
                                    if (dl.hasOwnProperty(k))
                                        if ("1" === k) {
                                            ...
                                            var p;
                                            var q = l;
                                            !1 === q.gdprApplies ? p = !0 : (void 0 === q.internalErrorState && (q.internalErrorState = Vk(q)), p = "error" === q.cmpStatus || 0 !== q.internalErrorState || "loaded" === q.cmpStatus && ("tcloaded" === q.eventStatus || "useractioncomplete" ===
                                                q.eventStatus) ? !0 : !1);
                                            g["1"] = p ? !1 === l.gdprApplies || "tcunavailable" === l.tcString || void 0 === l.gdprApplies && !n || "string" !== typeof l.tcString || !l.tcString.length ? !0 : al(l, "1", 0) : !1
        ...
        if (a) {
            ...
            if (c) {
                var f = b + a + c,
                    ...
                    k, l, n;
                if (f)
                    for (g = 0, l = f.length - 1; 0 <= l; l--) n = f.charCodeAt(l), g = (g << 6 & 268435455) + n + (n << 14), k = g & 266338304, g = 0 != k ? g ^ k >> 21 : g;
                e = String(g)
            } else e = "0";
            d = e
        } else d = "";
    ...
    function xl(a) {
        ...
        var c = !!a.se,
            ...
            u = Rd();
        if (t || u) u ? fe(function() {
            b();
            be(M.D) || ee(function(r) {
                return b(!0, r.ai)
            }, M.D)
        }, [M.D]) : b()
    }
                ...
                if (d && 1 === Bn(a, b).status) {
                    ...
                    if (ki()) {} else {
                        var g = "/gtag/js?id=" + encodeURIComponent(d.containerId) + "&l=dataLayer&cx=c",
                            k = ("http:" != m.location.protocol ? "https:" : "http:") + ("//www.googletagmanager.com" + g),
                            l = Ik(c, g) || k;
                        Ab(l)
                    }
                }
            ...
            if (d.U) {
                ...
                if (f) {
                    var g = H(c),
                        ...
                        r = yf(xf(zf(wf(vf(uf(tf(sf(rf(g), k), l), n), p), function() {
                            kk(q, t, "2");
                            rn && u()
                        }), function() {
                            kk(q, t, "3");
    ...
    tn.prototype.insert = function(a, b, c) {
        ...
        0 < this.o.length ? this.o.splice(1, 0, new An(a, d, c, b, !1)) : this.o.push(new An(a, d, c, b, !1))
    };
    tn.prototype.flush = function(a) {
        for (var b = this, c = [], d = !1, e = {}; this.o.length;) {
            var f = this.o[0];
            if (f.s) qn ? !f.U || Bn(this, f.U).o ? (f.s = !1, this.o.push(f)) : c.push(f) : (f.s = !1, this.o.push(f)), this.o.shift();
            else {
                switch (f.type) {
                    case "require":
    ...
    var Fn = function(a, b, c) {
            ...
            d["gtm.elementUrl"] = (a.attributes && a.attributes.formaction ? a.formAction : "") || a.action || Nb(a, "href") || a.src || a.code || a.codebase || "";
            return d
        },
        Gn = function(a) {
        ...
        Rn = function(a) {
            if (!Qn) {
                var b = function() {
                    var c = B.body;
                    if (c)
                        if (Pn)(new MutationObserver(function() {
    ...
    var Sn = function(a, b, c) {
        ...
        return {
            createEvent: function(g, k, l) {
                var n = a(),
                    p = n.bg,
                    q = void 0 !== l ? Math.round(l) : void 0 !== k ? Math.round(n.bg * k) : Math.round(n.fi),
    ...
    var oo = {
            ...
            consent: function(a) {
                ...
                if (3 === a.length) {
                    ...
                    var c = Pf(),
                        d = a[1];
                    "default" === d ? (b(), Zd(a[2])) : "update" === d && (b(), ae(a[2], c))
                }
            },
            event: function(a) {
                var b = a[1];
            ...
            set: function(a) {
                var b;
                2 == a.length && Sb(a[1]) ?
                    b = H(a[1]) : 3 == a.length && h(a[1]) && (b = {}, Sb(a[2]) || ua(a[2]) ? b[a[1]] = H(a[2]) : b[a[1]] = a[2]);
                if (b) {
                    b._clear = !0;
                    return b
                }
        ...
        function() {
            ...
            function g() {
                ...
                var A = 0,
                    C = !1,
                    D = function() {
                        C ? A = ip(D, w) : (A = 0, f(), tp("sdl") && !a() && (Fb(u, "scroll", F), Fb(u, "resize", F), Hn("sdl", "init", !1)));
                        C = !1
                    },
                    F = function() {
                        y && z();
            ...
            function n(w) {
                ...
                tp("sdl") ? Jn("sdl", "pending") || (x || (d(), x = !0), G(function() {
                    return f()
                })) : (d(), x = !0, v && (up("sdl"), Hn("sdl", "pending", !0), G(function() {
                    f();
                    if (a()) {
                        var O = g();
                        Eb(u, "scroll", O);
            ...
            (function(w) {
                ...
                w.vtp_triggerStartOption ? n(w) : Wn(function() {
                    n(w)
                })
            })
        }();
    ...
    X.g.f = ["google"],
        function() {
            (function(a) {
                ...
                return b ? a.vtp_component && "URL" != a.vtp_component ? Be(De(String(b)), a.vtp_component, a.vtp_stripWww, a.vtp_defaultPages, a.vtp_queryKey) : mp(String(b)) : String(b)
            })
        }();
    X.g.cl = ["google"],
        function() {
            ...
            (function(b) {
                ...
                if ("QUERY" === d) a: {
                    var g = b[a("vtp_multiQueryKeys").toString()],
                        ...
                        n;g ? ua(k) ? n = k : n = String(k).replace(/\s+/g,
                        "").split(",") : n = [String(k)];
                ...
                else f = Be(e, d, "HOST" == d ? b[a("vtp_stripWww")] : void 0, "PATH" == d ? b[a("vtp_defaultPages")] : void 0, void 0);
                return f
            })
        }();
    X.g.v = ["google"],
        ...
        function() {
            function a(b) {
                ...
                if (!isNaN(b.vtp_interval)) {
                    ...
                    c.Fe = T("self").setInterval(a(c), 0 > Number(b.vtp_interval) ? 0 : Number(b.vtp_interval))
                }
            })
        }();
    X.g.ua = ["google"],
        function() {
                ...
                if (Rd() && !z && !f[r]) {
                    var w = !be(M.I),
                        y = function() {
                            ...
                            A("create", r, F);
                            w && be(M.I) && (w = !1, A(function() {
                                var J = ej().getByName(C);
                                !J || J.get("clientId") === E && O || (D["&gcs"] = ce(), D["&gcu"] = "1", J.set(D), J.send("pageview"))
                            }));
                            A(function() {
                                A.remove(C)
                            })
            ...
            var p = function(r, v, x) {
                ...
                q = function(r) {
                    var v = {};
                    r.vtp_gaSettings && H(Xp(r.vtp_gaSettings.vtp_fieldsToSet, "fieldName", "value"), v);
                ...
                u = function(r) {
                    ...
                    if (sa(E)) {
                        var O = "",
                            J = "";
                        r.vtp_setTrackerName && "string" == typeof r.vtp_trackerName ? "" !== r.vtp_trackerName && (J = r.vtp_trackerName, O = J + ".") : (J = "gtm" + Pf(), O = J + ".");
                        var K = function(oa) {
                            ...
                            L = function(oa, Z) {
                                if (Z)
                                    for (var Ja in Z) Z.hasOwnProperty(Ja) && (c ? D[oa + Ja] = Z[Ja] : K("set", oa + Ja, Z[Ja]))
                            },
                            I = function() {
                                return null
                            },
                        ...
                        if (!c) {
                            ...
                            D._x_19 && D._x_20 && !e[J] && (e[J] = !0, E(lj(J, String(D._x_20))));
                        ...
                        if ("TRACK_EVENT" == r.vtp_trackType) {
                            ...
                            if ("DISPLAY_FEATURES_WITH_REMARKETING_LISTS" == r.vtp_advertisingFeaturesType) {
                                var bj = "_dc_gtm_" + String(r.vtp_trackingId).replace(/[^A-Za-z0-9-]/g, "");
                        ...
                        if (!d) {
                            var jc = r.vtp_useDebugVersion ? "u/analytics_debug.js" : "analytics.js";
                            r.vtp_useInternalVersion && !r.vtp_useDebugVersion && (jc = "internal/" + jc);
                            d = !0;
                            var Fd = Ik(D._x_19, "/analytics.js"),
                                qg = mi("https:", "http:", "//www.google-analytics.com/" + jc, D && !!D.forceSSL);
                            R("analytics.js" === jc && Fd ? Fd : qg, function() {
                                var oa = ej();
    ...
    X.g.ytl = ["google"],
        function() {
            ...
            function d(r, v) {
                if (!r.getAttribute("data-gtm-yt-inspected-" + v.Ve) && (r.setAttribute("data-gtm-yt-inspected-" + v.Ve, "true"), c(r, v.fg))) {
                    r.id || (r.id = a());
                    var x = T("YT"),
                        z = x.get(r.id);
                    ...
                    var w = f(z, v),
                        y = {},
                        A;
                    for (A in w) y.Rb = A, w.hasOwnProperty(y.Rb) && z.addEventListener(y.Rb, function(C) {
                        return function(D) {
            ...
            function e(r) {
                G(function() {
                    function v() {
                        for (var z =
                                x.getElementsByTagName("iframe"), w = z.length, y = 0; y < w; y++) d(z[y], r)
                    }
                    var x = T("document");
                    v();
                    Rn(v)
                ...
                function C(Y) {
                    ...
                    switch (Y) {
                        ...
                        case q.BUFFERING:
                            ...
                            ma = 1 < Math.abs((jp().getTime() - Q) / 1E3 * ba - Aa) ? "seek" : ma || "buffering";
                ...
                function J() {
                    if (V.length && 0 !== ba) {
                        ...
                        x = function() {
                            z = 0;
                            x = E;
                            0 < V.length && V[0].rb === ma.rb && (V.shift(), op(K.createEvent("progress", ma.pg, ma.vg)));
                            J()
                        };
                        z = ip(x, 1E3 * Y)
                    }
            ...
            function n(r) {
                ...
                if (v || x || z || w.length || y.length) {
                    ...
                    if (D) D.ready && D.ready(F);
                        ...
                        G(function() {
                            for (var O = T("document"), J = O.getElementsByTagName("script"), K = J.length, V = 0; V < K; V++) {
                                var L = J[V].getAttribute("src");
                                if (b(L, "iframe_api") || b(L, "player_api")) return
                            }
                            for (var I = O.getElementsByTagName("iframe"), P = I.length, ba = 0; ba < P; ba++)
                                if (!u && c(I[ba], C.fg)) {
            ...
            (function(r) {
                ...
                r.vtp_triggerStartOption ? n(r) : Pi(function() {
                    n(r)
                })
            })
        }();
        ...
        function() {
            ...
            var b, c = {
                ...
                f = function(l, n, p) {
                    ...
                    if (l)
                        for (var t in l)
                            if (!e[t] && l.hasOwnProperty(t) && (p && c[t] || !p && void 0 === c[t])) {
                ...
                g = function(l) {
                    var n = {};
                    l.vtp_gaSettings && H(Xp(l.vtp_gaSettings.vtp_fieldsToSet, "fieldName", "value"), n);
                ...
                k = function(l) {
                    ...
                    var p = g(l),
                        q =
                        gj(l.vtp_functionName);
                    if (sa(q)) {
                        q.r = !0;
                        var t = "",
                            u = "";
                        l.vtp_setTrackerName && "string" === typeof l.vtp_trackerName ? "" !== l.vtp_trackerName && (u = l.vtp_trackerName, t = u + ".") : (u = "gtm" + Pf(), t = u + ".");
                        var r = {
                            name: u
                        };
                        f(p, r, !0);
                        ...
                        f(p, v, !1);
                        var x = encodeURI(mi("https:", "http:", "//www.google-analytics.com/" + (l.vtp_useDebugVersion ? "u/analytics_debug.js" : "analytics.js"), !!p.forceSSL));
                        ...
                        var z = T("dataLayer"),
                            w = z && z.hide;
                        w && (w.end || !0 === w["GTM-T3L6RFK"]) && (w[l.vtp_optimizeContainerId] = !0)
        ...
        function() {
            ...
            function k(u) {
                if ("form" === u.tagName.toLowerCase() && u.elements) {
                    for (var r = 0, v = 0; v < u.elements.length; v++) Mn(u.elements[v]) &&
                        r++;
                    return r
                }
            }
            ...
            var c = function(d) {
                if (B.body) {
                    var e =
                        ...
                        g = f.vi,
                        k = f.onSuccess;
                    if (d.vtp_useIframe) {} else d.vtp_supportDocumentWrite ? b(g, k, e) : a(B.body, Kb(g), k, e)()
                } else ip(function() {
                        c(d)
                    },
                    200)
                        ...
                        if (g && 3 !== f.which && !(f.xi || f.timeStamp && f.timeStamp === d)) {
                            ...
                            if (n.length) {
                                ...
                                if (b(f, g, c) && !k && l && g.href) {
                                    var q = !!xa(String(Nb(g, "rel") || "").split(" "), function(r) {
    ...
    X.g.evl = ["google"],
        function() {
            ...
            function c(f) {
                f.has(d.fc) && (T("self").clearInterval(Number(f.get(d.fc))), f.s(d.fc))
            }
            var d = {
                    fc: "polling-id-",
                    be: "first-on-screen-",
            ...
            (function(f) {
                ...
                function k(z) {
                    ...
                    z.intersectionRatio >= t ? w.has(d.Ib) || b(z, w, q, "ONCE" === r ? function() {
                        ...
                        we(x);
                        if (p && Qn)
                            for (var C = 0; C < Qn.length; C++) Qn[C] === g && Qn.splice(C, 1)
                    } : function() {
                        w.set(d.Ib, "1");
                        c(w)
                    }) : (c(w), "MANY_PER_ELEMENT" === r && w.has(d.Ib) && (w.s(d.Ib), w.s(d.dd)), w.s(d.ad))
                }
    ...
    }, Ws.onHtmlSuccess = Vo.$f(!0), Ws.onHtmlFailure = Vo.$f(!1);
    Ws.dataLayer = Xf;
    ...
    function Ys() {
        ...
        if (b) {
            ...
            Ki = !1;
            Li = 0;
            if ("interactive" == B.readyState && !B.createEventObject || "complete" == B.readyState) Ni();
            else {
    ...
    (function(a) {
        ...
        var f = function() {
                ...
                n || (n = [], m["google.tagmanager.debugui2.queue"] = n, Ab("https://www.googletagmanager.com/debug/bootstrap"));
                var p = {
