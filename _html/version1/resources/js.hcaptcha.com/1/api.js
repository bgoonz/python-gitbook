var hcaptcha = function() {
    ...
    "function" != typeof u.Promise ? u.Promise = r : u.Promise.prototype["finally"] ? u.Promise.allSettled || (u.Promise.allSettled = t) : u.Promise.prototype["finally"] = e;
    var p, f = function() {
        if ("undefined" != typeof self) return self;
        if ("undefined" != typeof window) return window;
        if ("undefined" != typeof global) return global;
    ...
    f.Promise.allSettled || (f.Promise.allSettled = t), Array.prototype.indexOf || (Array.prototype.indexOf = function(e) {
        return function(t, n) {
    ...
    if (window.atob) try {
        ...
        window.atob = function(e) {
            if (e = String(e).replace(/[\t\n\f\r ]+/g, ""), !S.test(e)) throw new TypeError("Failed to execute 'atob' on 'Window': The string to be decoded is not correctly encoded.");
            var t, n, i;
    ...
    var I = [],
        ...
        T = {
            ...
            remove: function(e) {
                for (var t = !1, n = I.length; --n > -1 && !1 === t;) I[n].id === e.id && (t = I[n], I.splice(n, 1));
                return t
            },
            each: function(e) {
            ...
            isValidId: function(e) {
                for (var t = !1, n = -1; ++n < I.length && !1 === t;) I[n].id === e && (t = !0);
                return t
            },
            getByIndex: function(e) {
                for (var t = !1, n = -1; ++n < I.length && !1 === t;) n === e && (t = I[n]);
                return t
            },
            getById: function(e) {
                for (var t = !1, n = -1; ++n < I.length && !1 === t;) I[n].id === e && (t = I[n]);
                return t
            },
    ...
    function N(e, t) {
        for (var n = null, i = null, o = -1, r = !1; ++o < t.length && !r;) {
            n = t[o];
            for (var a = -1; ++a < n.patterns.length && !r;) r = null !== (i = R(e, n.patterns[a]))
        }
    ...
    var W = {
        ...
        U = {
            ...
            sitekey: null,
            a11y_tfe: null,
            pingdom: "safari" === W.Browser.type && "windows" !== W.System.os && "mac" !== W.System.os && "ios" !== W.System.os && "android" !== W.System.os,
    ...
    function H(e) {
        ...
        e.stack && (t.stack_trace = {
            trace: e.stack
        }), Y("report error", "internal", "debug", t), X("internal error", "error", U.file)
    }

    function X(e, t, n) {
        q && window.Raven && Raven.captureMessage(e, {
            level: t,
            logger: n
        })
    }
    ...
    function Y(e, t, n, i) {
        q && window.Raven && Raven.captureBreadcrumb({
            message: e,
            category: t,
            level: n,
            data: i
    ...
    function Q() {
        try {
            ...
            console.error("[hCaptcha] There was an error in your callback."), console.error(qt)
        }
    }
    ...
    var K = {
            eventName: function(e) {
                var t = e;
                return "down" === e || "up" === e || "move" === e || "over" === e || "out" === e ? t = !W.System.mobile || "down" !== e && "up" !== e && "move" !== e ? "mouse" + e : "down" === e ? "touchstart" : "up" === e ? "touchend" : "touchmove" : "enter" === e && (t = "keydown"), t
            },
    ...
    function ne(e) {
        var t = te[e];
        return t || (e in ee ? e : te[e] = function(e) {
    ...
    function re(e, t) {
        ...
        if ("object" == typeof e)
            ...
            for (var o = 0; o < e.length; o++) !0 === ae(n = e[o]) ? re(e, t) : t[t.length] = se(i, n);
    ...
    ie.prototype.createElement = function(e, t) {
    ...
    }, ie.prototype.content = ie.prototype.text, ie.prototype.css = function(e) {
        var t;
        for (var n in e) {
            t = e[n];
            try {
                if ("opacity" !== n && "zIndex" !== n && "fontWeight" !== n && isFinite(t) && parseFloat(t) === t && (t += "px"), "ie" === W.Browser.type && 8 === W.Browser.version && "opacity" === n) this.dom.style.filter = "alpha(opacity=" + 100 * t + ")";
                else {
                    var i = ne(n);
                    this.dom.style[i] = t
                }
        ...
        if ("object" == typeof t && (i = t), i === undefined && (i = {}), o) {
            var a = e.width / e.height,
                s = t,
                h = s / a;
            i.cover && h < n && (s = (h = n) * a), i.contain && h > n && (s = (h = n) * a), r.width = s, r.height = h, i.center && (r.marginLeft = -s / 2, r.marginTop = -h / 2, r.position = "absolute", r.left = "50%", r.top = "50%"), (i.left || i.right) && (r.left = i.left || 0, r.top = i.top || 0)
        }
        "ie" === W.Browser.type && 8 === W.Browser.version ? r.filter = "progid:DXImageTransform.Microsoft.AlphaImageLoader(src='" + e.src + "',sizingMethod='scale')" : (r.background = "url(" + e.src + ")", r.backgroundPosition = "50% 50%", r.backgroundRepeat = "no-repeat", r.backgroundSize = o ? s + "px " + h + "px" : i.cover ? "cover" : i.contain ? "contain" : "100%"), this.css.call(this, r)
    ...
    var he = {
        ...
        de = {
            ...
            getBestTrans: function(e) {
                var t = de.getLocale();
                return t in e ? e[t] : de.getShortLocale(t) in e ? e[de.getShortLocale(t)] : "en" in e ? e.en : null
            },
            getLocale: function() {
                var e = le || window.navigator.userLanguage || window.navigator.language,
                    t = de.getShortLocale(e);
                return "in" === t && (e = "id"), "iw" === t && (e = "he"), "nb" === t && (e = "no"), "ji" === t && (e = "yi"), "zh-CN" === e && (e = "zh"), "jv" === t && (e = "jw"), he[e] ? e : he[t] ? t : "en"
            },
        ...
        fe = "undefined" != typeof XDomainRequest && !("withCredentials" in XMLHttpRequest.prototype);
    ...
    function me(e, t, n) {
        ...
        return i.legacy = i.withCredentials && fe, i.data && ("json" === i.dataType && "object" == typeof i.data && (i.data = JSON.stringify(i.data)), "query" === i.dataType && (i.data = oe(i.data))), n.retry ? G((function() {
            return ge(i)
        }), n.retry) : ge(i)
    }
            ...
            var r, a = function(r) {
                return function() {
                    var a = t.response || t.responseText,
                        ...
                        c = t.readyState;
                    if (4 === c || e.legacy) {
                        if ("error" === r || h >= 400 && h <= 511) return void o({
                            event: "network-error",
                            endpoint: n,
                            state: c,
                            status: h,
                        ...
                        "json" === e.responseType && a && (a = JSON.parse(a)), i({
                            state: c,
                            status: h,
                            body: a,
                            message: s
    ...
    var ye = function(e, t) {
        ...
        we = function(e) {
            if (F.assethost && e.indexOf(U.assetDomain) >= 0) return F.assethost + e.replace(U.assetDomain, "");
    ...
    function _e(e, t) {
        ...
        if (0 === i.indexOf("data:image"))
            for (var o = !1, r = be.length, a = -1; a++ < r && !o;)(o = i.indexOf(be[a]) >= 0) && (n = be[a]);
        ...
        }, this.id = i, this.src = we(i), this.ext = n, this.width = 0, this.height = 0, this.aspect = 0, this.loaded = !1, this.error = !1, this.element = null, this.cb = {
            load: [],
            error: []
        }
    }
    ...
    function Ce(e, t) {
        ...
        t || (t = {}), t.prefix && (n = t.prefix + "/" + e), this.attribs = {
            ...
            async: t.async || null,
            crossOrigin: t.crossOrigin || null
        }, this.id = n, this.src = we(n), this.loaded = !1, this.error = !1, this.element = null, this.cb = {
            load: [],
            error: []
        }
    }
    ...
    function Ee(e, t) {
        var n = e;
        t || (t = {}), t.prefix && (n = t.prefix + "/" + e), this.id = n, this.src = we(n), this.loaded = !1, this.error = !1, this.cb = {
            load: [],
            error: []
        }, this.data = null
    }
    ...
    _e.prototype.load = function() {
        ...
        this.element = new ie(e), this.width = t, this.height = n, this.aspect = t / n, this.loaded = !0, xe(this.cb, "load", this)
        ...
        return new Promise((function(o, r) {
            ...
            e.element = a, a.onerror = function(t) {
                ...
                this.loaded || a.readyState && "loaded" !== a.readyState && "complete" !== a.readyState || (e.loaded = !0, a.onload = a.onreadystatechange = a.onerror = null, document.body.removeChild(a), ke(e.cb, "load", e), o(e))
        ...
        return new Promise((function(i, o) {
            var r = {};
            t.indexOf("json") >= 0 && (r.responseType = "json"), ye(t, r).then((function(t) {
        ...
        Pe = {
            ...
            retrieve: function(e) {
                return new Promise((function(t, n) {
                    for (var i = Oe.length, o = !1, r = null; --i > -1 && !o;) o = -1 !== (r = Oe[i]).id.indexOf(e);
                    if (!o) return t(null);
    ...
    function Ae(e) {
        Ie(this, Me, e.id || "." + e.name), this.state = {
            loaded: !1,
            name: e.name + ".svg",
            prefix: e.prefix || "https://newassets.hcaptcha.com/captcha/v1/ff4a4ed/static/images",
            fill: e.fill,
            width: e.width || 25,
            height: e.height || e.width || 25
        }, this.img = null, (e.autoLoad || e.autoLoad === undefined) && this.load()
    }

    function Le(e, t) {
        this._period = e, this._interval = t, this._date = [], this._data = [], this._prevTimestamp = 0, this._meanPeriod = 0, this._meanCounter = 0
    }
    Be(Me, ie), Me.prototype.initComponent = function(e, t, n) {
        var i = new e(t);
    ...
    }, Be(Ae, Me), Ae.prototype.load = function() {
                ...
                i = function(e) {
                    ...
                    try {
                        ...
                        if (e.touches && e.touches.length >= 1 ? n = e.touches : e.changedTouches && e.changedTouches.length >= 1 && (n = e.changedTouches), n) {
                            for (var o = 0; o < n.length; o++) i = K.eventCoords(n[o]), t.push([n[o].identifier, i.x, i.y]);
                            t.push(Date.now())
                        }
                        return t
                    } catch (Ht) {
    ...
    Je.prototype.record = function(e, t, n, i) {
        if (this._manifest.st = Date.now(), this.state.record.mouse = e === undefined ? this.state.record.mouse : e, this.state.record.touch = n === undefined ? this.state.record.touch : n, this.state.record.keys = t === undefined ? this.state.record.keys : t, this.state.record.motion = i === undefined ? this.state.record.motion : i, !1 === this.state.initRecord) {
            ...
            this.state.record.mouse && (o.addEventListener("mousedown", ze("mousedown", this._recordEvent)), o.addEventListener("mousemove", ze("mousemove", this._recordEvent)), o.addEventListener("mouseup", ze("mouseup", this._recordEvent))), !0 === this.state.record.keys && (o.addEventListener("keyup", Ue("keyup", this._recordEvent)), o.addEventListener("keydown", Ue("keydown", this._recordEvent))), this.state.record.touch && !0 === W.Browser.hasEvent("touchstart", document.body) && (o.addEventListener("touchstart", We("touchstart", this._recordEvent)), o.addEventListener("touchmove", We("touchmove", this._recordEvent)), o.addEventListener("touchend", We("touchend", this._recordEvent))), this.state.record.motion && !0 === W.Browser.hasEvent("devicemotion", window) && o.addEventListener("devicemotion", Fe("devicemotion", this._recordEvent)), this.state.initRecord = !0
        }
        ...
        if (!1 !== this.state.recording) try {
            var n = t[t.length - 1];
            this.state.timeBuffers[e] || (this.state.timeBuffers[e] = new Le(16, 15e3)), this.state.timeBuffers[e].push(n, t)
        } catch (Ht) {
    ...
    function Ve() {
        document.addEventListener ? (document.addEventListener("DOMContentLoaded", Ge), window.addEventListener("load", Ge)) : (document.attachEvent("onreadystatechange", Qe), window.attachEvent("onload", Ge)), Xe = !0
    }

    function Qe() {
        "interactive" !== document.readyState && "loaded" !== document.readyState && "complete" !== document.readyState || Ge()
    }
    ...
    function Ge() {
        ...
        Ye = !0, document.removeEventListener ? (document.removeEventListener("DOMContentLoaded", Ge), window.removeEventListener("load", Ge)) : (document.detachEvent("onreadystatechange", Qe), window.detachEvent("onload", Ge))
    }
    new ie(document);
    ...
    function ot(e, t) {
        ...
        for (n = 0; n < s.length; n++) {
            var h = s[n];
            if (!(!tt(r = h, a = e) || Object.hasOwnProperty.call(a, r) && Object.propertyIsEnumerable.call(a, r))) return;
    ...
    function ft(e) {
        ...
        try {
            for (var i = T.getSession(), o = i.length, r = !1; --o > -1 && !r;)(r = i[o][1] === n.id) && (t = i[o][0])
        } catch (a) {
            t = ""
        }
        return t
    }
    pt.add("contrast", {}), pt.add("grey-red", {
        component: {
            challenge: {
                main: {
                    border: "#6a6a6a"
    ...
    function vt(e, t) {
        ...
        return o.then((function(e) {
            r.promise = "resolve", null !== e && (r.contents = e), gt(n.target, r)
        }))["catch"]((function(e) {
        ...
        for (var t, n, i = -1, o = 0, r = [].concat.apply([], [this.messages, this.incoming, this.waiting]); ++i < r.length;)
            if (r[i].label === e.label) {
                ...
                if (t = r[i], e.error && a.push(e.error), e.contents && a.push(e.contents), e.promise && "create" !== e.promise) {
                    ...
                    for (var s = this.waiting.length, h = !1; --s > -1 && !1 === h;) this.waiting[s].label === t.label && this.waiting[s].lookup === t.lookup && (h = !0, this.waiting.splice(s, 1));
                    continue
                }
    ...
    var wt = {
        ...
        removeChat: function(e) {
            for (var t = !1, n = wt.chats.length; --n > -1 && !1 === t;) e.id === wt.chats[n].id && e.target === wt.chats[n].target && (t = wt.chats[n], wt.chats.splice(n, 1));
            return t
        },
        handle: function(e) {
            var t = e.data;
            if ("string" == typeof t) try {
                ...
                t = JSON.parse(t);
                for (var n, i = wt.chats, o = -1; ++o < i.length;)(n = i[o]).id === t.id && n.respond(t)
            } catch (qt) {
    ...
    function bt(e, t) {
        this.id = e, this.width = null, this.height = null, this.mobile = !1, this.ready = !1, this.listeners = [], this.config = t, this._visible = !1, this._selected = !1, this.$iframe = new ie("iframe"), this._host = U.host || window.location.hostname;
        var n = U.assetUrl;
        F.assethost && (n = F.assethost + U.assetUrl.replace(U.assetDomain, "")), this.$iframe.dom.src = n + "/hcaptcha-challenge.html#id=" + this.id + "&host=" + this._host + (t ? "&" + mt(this.config) : ""), this.$iframe.dom.title = "Main content of the hCaptcha challenge", this.$iframe.dom.frameBorder = 0, this.$iframe.dom.scrolling = "no", this.setupParentContainer(t), this._hasCustomContainer ? (this._hideIframe(), this._parent.appendChild(this.$iframe.dom)) : (this.$container = new ie("div"), this.$wrapper = this.$container.createElement("div"), this.$overlay = this.$container.createElement("div"), this.$arrow = this.$container.createElement("div"), this.$arrow.fg = this.$arrow.createElement("div"), this.$arrow.bg = this.$arrow.createElement("div"), this.style.call(this), this.$wrapper.appendElement(this.$iframe), this._parent.appendChild(this.$container.dom), this.$container.setAttribute("aria-hidden", !0)), this.chat = wt.createChat(this.$iframe.dom, e)
    }
    ...
    function _t(e, t, n) {
        this.id = t, this.response = null, this.location = {
            ...
            offset: null,
            bounding: null
        }, this.config = n, this._ticked = !0, this.$container = e instanceof ie ? e : new ie(e), this._host = U.host || window.location.hostname, this.$iframe = new ie("iframe");
        var i = U.assetUrl;
        F.assethost && (i = F.assethost + U.assetUrl.replace(U.assetDomain, "")), this.$iframe.dom.src = i + "/hcaptcha-checkbox.html#id=" + this.id + "&host=" + this._host + (n ? "&" + mt(this.config) : ""), this.$iframe.dom.title = "widget containing checkbox for hCaptcha security challenge", this.$iframe.dom.tabIndex = this.config.tabindex || 0, this.$iframe.dom.frameBorder = "0", this.$iframe.dom.scrolling = "no", this.config.size && "invisible" === this.config.size && this.$iframe.setAttribute("aria-hidden", "true"), this.$iframe.setAttribute("data-hcaptcha-widget-id", t), this.$iframe.setAttribute("data-hcaptcha-response", ""), this.$container.appendElement(this.$iframe), "off" !== F.recaptchacompat && (this.$textArea0 = this.$container.createElement("textarea", "#g-recaptcha-response-" + t), this.$textArea0.dom.name = "g-recaptcha-response", this.$textArea0.css({
            display: "none"
            ...
            display: "none"
        }), this.chat = wt.createChat(this.$iframe.dom, t), this.clearLoading = this.clearLoading.bind(this)
    }

    function xt(e, t, n) {
        if (!n.sitekey) throw new Ct("Missing sitekey", "https://hcaptcha.com/docs/configuration#jsapi");
        this.id = t, this.visible = !1, this.overflow = {
            override: !1,
            cssUsed: !0,
            value: null,
            scroll: 0
        }, this.onError = null, this.onPass = null, this.onExpire = null, this.onChalExpire = null, this.onOpen = null, this.onClose = null, this._ready = !1, this._active = !1, this._listeners = [], this.config = n, ut.indexOf(n.theme) >= 0 && pt.use(n.theme), this._state = {
            escaped: !1,
            passed: !1,
            expiredChallenge: !1,
            expiredResponse: !1
        }, this._origData = null, this._promise = null, this._responseTimer = null, this.challenge = new bt(t, n), this.checkbox = new _t(e, t, n), this.initChallenge = this.initChallenge.bind(this), this.closeChallenge = this.closeChallenge.bind(this), this.displayChallenge = this.displayChallenge.bind(this), this.getGetCaptchaManifest = this.getGetCaptchaManifest.bind(this)
    }
    ...
    function Et(e, t) {
        ...
        if (a.resolve = i, a.reject = o, n = e ? T.getById(e) : T.getByIndex(0)) qe.setData("exec", !0), r && n.setPromise(a), n.onReady(n.initChallenge, t);
        else if (e) {
    ...
    window.addEventListener ? window.addEventListener("message", wt.handle) : window.attachEvent("onmessage", wt.handle), bt.prototype.setupParentContainer = function(e) {
        ...
        var e = {};
        "ie" !== W.Browser.type || "ie" === W.Browser.type && 8 !== W.Browser.version ? (e.opacity = 0, e.visibility = "hidden") : e.display = "none", this.$iframe.setAttribute("aria-hidden", !0), this.$iframe.css(e)
    }, bt.prototype._showIframe = function() {
        var e = {};
        "ie" !== W.Browser.type || "ie" === W.Browser.type && 8 !== W.Browser.version ? (e.opacity = 1, e.visibility = "visible") : e.display = "block", this.$iframe.removeAttribute("aria-hidden"), this.$iframe.css(e)
        ...
        if (this._hasCustomContainer) this.$iframe.css({
            ...
            "ie" !== W.Browser.type || "ie" === W.Browser.type && 8 !== W.Browser.version ? (t.transition = "opacity 0.15s ease-out", t.opacity = 0, t.visibility = "hidden") : t.display = "none", this.$container.css(t), this.$wrapper.css({
                position: "relative",
                zIndex: 1
            }), this.$overlay.css({
                width: "100%",
        ...
        if (!0 !== this._visible)
            if (this._visible = !0, this._hasCustomContainer) this._showIframe();
                ...
                "ie" !== W.Browser.type || "ie" === W.Browser.type && 8 !== W.Browser.version ? (e.opacity = 1, e.visibility = "visible") : e.display = "block", this.$container.css(e), this.$container.removeAttribute("aria-hidden"), this.$overlay.css({
                    pointerEvents: "auto",
                    cursor: "pointer"
        ...
        "ie" !== W.Browser.type || "ie" === W.Browser.type && 8 !== W.Browser.version ? (t.opacity = 0, t.visibility = "hidden") : t.display = "none", this.$container.css(t), this._hasCustomContainer || this.$overlay.css({
            pointerEvents: "none",
            cursor: "default"
        ...
        if (!this._hasCustomContainer && e) {
            ...
            (c + this.width + t > o || c < 0) && (c = (o - this.width) / 2, a = !0);
            ...
            return u = Math.max(Math.min(u, p), t), this.$container.css({
                ...
                top: u
            }), this.top = d, this.$container.dom.getBoundingClientRect(), h
        }
    }, bt.prototype.destroy = function() {
        this._visible && this.close.call(this), this._hasCustomContainer ? this._parent.removeChild(this.$iframe.dom) : (this._parent.removeChild(this.$container.dom), this.$container = this.$container.__destroy()), this.$iframe = this.$iframe.__destroy(), wt.removeChat(this.chat), this.chat = this.chat.destroy()
        ...
        this.response = e, this.$iframe.dom.setAttribute("data-hcaptcha-response", e), "off" !== F.recaptchacompat && (this.$textArea0.dom.value = e), this.$textArea1.dom.value = e
        ...
        this._ticked && this.reset(), this.$container.removeElement(this.$iframe), this.$container.removeElement(this.$textArea1), "off" !== F.recaptchacompat && (this.$container.removeElement(this.$textArea0), this.$textArea0 = this.$textArea0.__destroy()), this.$textArea1 = this.$textArea1.__destroy(), this.$container = this.$container.__destroy(), this.$iframe = this.$iframe.__destroy(), wt.removeChat(this.chat), this.chat = this.chat.destroy()
        ...
        return e || ((e = Object.create(null)).st = Date.now()), e.v = 1, e.topLevel = qe.getData(), e.session = T.getSession(), e.widgetList = T.getCaptchaIdList(), e.widgetId = this.id, e.href = window.location.href, e.prev = JSON.parse(JSON.stringify(this._state)), e
        ...
        if (this._active) {
            ...
            if (!("ie" === W.Browser.type && 8 === W.Browser.version)) {
                ...
                this.overflow.override = "hidden" === r, this.overflow.override && (this.overflow.cssUsed = "" === document.body.style.overflow && "" === document.body.style.overflowY, this.overflow.cssUsed || (this.overflow.value = "" === r ? "auto" : r), this.overflow.scroll = W.Browser.scrollY(), document.body.style.overflowY = "auto")
            }
        ...
        r.getDimensions(e, t).then((function(e) {
            e && r.size(e.width, e.height, e.mobile), o.location.bounding = o.getBounding(), o.location.offset = o.getOffset(), W.System.mobile && !n || r.position(o.location)
        }))["catch"]((function(e) {
        ...
        var e = this.checkbox,
            t = this.challenge;
        W.System.mobile || (e.location.bounding = e.getBounding(), t.position(e.location))
        ...
        switch (n.setResponse(o), i.close(e.event), n.$iframe.dom.focus(), e.event) {
            case "challenge-escaped":
                this._state.escaped = !0, n.reset(), t.onClose && Q(t.onClose), t._promise && t._promise.reject(new kt("challenge closed", "closed"));
                break;
            case "challenge-expired":
                this._state.expiredChallenge = !0, n.reset(), n.status("hCaptcha window closed due to timeout.", !0), t.onChalExpire && Q(t.onChalExpire), t._promise && t._promise.reject(new kt("challenge expired", "chalExpired"));
                break;
            case "challenge-error":
            case "bundle-error":
            case "network-error":
                n.reset(), "network-error" === e.event && n.status(e.message), this.onError && Q(this.onError, e.message || ""), t._promise && t._promise.reject(new kt(e.message || "", "error"));
                break;
            case "challenge-passed":
                this._state.passed = !0, n.tick(), this.onPass && Q(this.onPass, o), t._promise && t._promise.resolve({
                    response: o,
                    key: ft(this.id)
                    ...
                    try {
                        ...
                        X("Checkbox not present or could not destroy on expiration: " + Ht.message, "error", "global")
                    }
                    t.onExpire && Q(t.onExpire), t._responseTimer = null, t._state.expiredResponse = !0
                }), 1e3 * e.expiration))
        }
        t._promise = null
        ...
        if (this.config.themeConfig && t) {
            ...
            pt.add(n, pt.extend(pt.active(), this.config.themeConfig)), pt.use(n), this.challenge.style()
        }
    ...
    function It(e, t, n) {
        Ie(this, Pt, e), this.handleIn = new Pt(t), this.handleOut = new Pt(n), this.prev = null, this.next = null, this.index = 0
    }
    ...
    function Bt(e) {
        ...
        return new Promise((function(n, i) {
            Pe.retrieve(t).then((function(n) {
                return n || Pe.file(t, {
                    prefix: "https://newassets.hcaptcha.com/captcha/v1/ff4a4ed/static/i18n"
                }).then((function(t) {
    ...
    Be(Ot, ie), Ot.prototype.dimensions = function(e, t) {
        this.css({
            width: e,
            height: t
    ...
    }, Be(It, Pt), It.prototype.set = function(e, t, n) {
    ...
    var Tt = 0,
        jt = ["hl", "custom", "tplinks", "sitekey", "theme", "size", "tabindex", "challenge-container"];
    var Mt = {
        render: function(e, t) {
            if ("string" == typeof e && (e = document.getElementById(e)), e && 1 === e.nodeType)
                if (function(e) {
                    ...
                    if (!1 !== wt.isSupported()) {
                        ...
                        F.endpointOverride && (h.endpoint = F.endpointOverride), null !== F.language && (h.hl = de.getLocale()), F.assethost && (h.assethost = F.assethost), F.imghost && (h.imghost = F.imghost), F.tplinks && (h.tplinks = F.tplinks);
                        for (var c = 0; c < jt.length; c++) {
                            var l = jt[c];
                            l in a && (h[l] = a[l])
                        }
                        if (h.theme = F.theme, a.theme) try {
                            var d = a.theme;
                            "string" == typeof d && (d = JSON.parse(d)), h.themeConfig = d
                        } catch (Ht) {
                            h.theme = d
                        }
                        ...
                        return a.callback && (g.onPass = a.callback), a["expired-callback"] && (g.onExpire = a["expired-callback"]), a["chalexpired-callback"] && (g.onChalExpire = a["chalexpired-callback"]), a["open-callback"] && (g.onOpen = a["open-callback"]), a["close-callback"] && (g.onClose = a["close-callback"]), a["error-callback"] && (g.onError = a["error-callback"]), qe.setData("inv", "invisible" === h.size), g.checkbox.chat.listen("checkbox-selected", (function(e) {
                            ...
                            var e = W.Browser.width(),
                                t = W.Browser.height();
                            g.resize(e, t)
                        })), g.challenge.chat.listen("challenge-closed", g.closeChallenge), g.challenge.chat.answer("get-url", (function(e) {
                    ...
                    J(e, "Your browser is missing or has disabled Cross-Window Messaging. Please <a style='color:inherit;text-decoration:underline; font: inherit' target='_blank' href='https://www.whatismybrowser.com/guides/how-to-update-your-browser/auto'>upgrade your browser</a> or enable it for hCaptcha.com")
            ...
            function v(e, t) {
                ...
                function i(e) {
                    if (e) try {
                        ...
                        X("Failed to update text translation: " + JSON.stringify(qt), "error", "translation")
                    }
                }
                n && Bt(n).then((function() {
                    t ? i(g) : T.each(i)
                }))["catch"]((function(e) {
        ...
        reset: function(e) {
            var t;
            if (e) {
                if (!(t = T.getById(e))) throw Error("[hCaptcha] invalid captcha id: " + e);
                t.reset()
            } else {
                if (!(t = T.getByIndex(0))) throw Error("[hCaptcha] no captchas exist.");
                t.reset()
            }
        },
        remove: function(e) {
        ...
        getResponse: function(e) {
            var t, n;
            if ((n = e ? T.getById(e) : T.getByIndex(0)) && (t = n.checkbox.response || ""), void 0 !== t) return t;
            throw e ? new Error("[hCaptcha] invalid captcha id: " + e) : new Error("[hCaptcha] no captchas exist.")
        },
        getRespKey: ft,
        close: function(e) {
            var t = !1;
            if (!(t = e ? T.getById(e) : T.getByIndex(0))) throw e ? Error("[hCaptcha] invalid captcha id: " + e) : Error("[hCaptcha] no captchas exist.");
            t.closeChallenge({
                event: "challenge-escaped"
            })
        },
        setData: function(e, t) {
            ...
            var n = !1;
            if (!(n = e ? T.getById(e) : T.getByIndex(0))) throw e ? Error("[hCaptcha] invalid captcha id: " + e) : Error("[hCaptcha] no captchas exist.");
    ...
    function zt() {
        ...
        Rt = e / t, Ft(), Mt.nodes.each((function(i) {
            i.visible && i.resize(e, t, n)
        }))
    }

    function Wt(e) {
        e.preventDefault && e.preventDefault(), Ut(), Mt.nodes.each((function(e) {
            e.visible && e.position()
        }))
    }

    function Ut() {
        qe.circBuffPush("xy", [W.Browser.scrollX(), W.Browser.scrollY(), document.documentElement.clientWidth / W.Browser.width(), Date.now()])
    }

    function Ft() {
        qe.circBuffPush("wn", [W.Browser.width(), W.Browser.height(), W.System.dpr(), Date.now()])
    }! function(e) {
        var t = Array.prototype.slice.call(arguments, 1);
        !0 !== Ye && "interactive" !== document.readyState && "loaded" !== document.readyState && "complete" !== document.readyState ? (He.push({
            fn: e,
            args: t
        }), !1 === Xe && Ve()) : setTimeout((function() {
            e(t)
        }), 1)
    }((function() {
        Nt || (! function() {
            ...
            Lt = r.onload || !1, $t = r.render || !1, "off" === r.tplinks && (Dt = "off");
            F.tplinks = Dt, F.language = r.hl || null, r.endpoint && (F.endpointOverride = r.endpoint);
            F.reportapi = r.reportapi || F.reportapi, F.assethost = r.assethost || null, F.imghost = r.imghost || null, F.custom = r.custom || F.custom, F.recaptchacompat = r.recaptchacompat || F.recaptchacompat, U.host = r.host || window.location.hostname, F.language = F.language || window.navigator.userLanguage || window.navigator.language, de.setLocale(F.language), a = r.sentry === undefined || r.sentry, void(q = a), "off" === F.recaptchacompat ? console.log("recaptchacompat disabled") : window.grecaptcha = Jt;
            var a
        }(), function() {
            var e = de.getLocale();
        ...
        }(Mt.render) : "explicit" !== $t && console.log("hcaptcha: invalid render parameter '" + $t + "', using 'explicit' instead."), Lt && setTimeout((function() {
            Q(Lt)
        }), 1), function() {
            try {
                qe.record(), qe.setData("sc", W.Browser.getScreenDimensions()), qe.setData("nv", W.Browser.interrogateNavigator()), qe.setData("dr", document.referrer), Ft(), Ut()
            } catch (qt) {}
        }(), Ke.addEventListener("resize", zt), Ke.addEventListener("scroll", Wt))
    }));
    var Jt = {
        render: Mt.render,
        remove: Mt.remove,
