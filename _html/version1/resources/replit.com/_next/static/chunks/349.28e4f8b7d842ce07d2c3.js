            ...
            e.exports = (() => {
                ...
                var e = {
                                ...
                                M = function(e) {
                                    ...
                                    return n(t, e), Object.defineProperty(t.prototype, "options", {
                                        ...
                                        this._colorManager && (e.colors.forEach((function(e) {
                                            var t = T.rgba.toColor(e.red, e.green, e.blue);
                                        ...
                                        O.body.contains(e) || this._logService.debug("Terminal.open was called on an element that was not attached to the DOM"), this._document = e.ownerDocument, this.element = this._document.createElement("div"), this.element.dir = "ltr", this.element.classList.add("terminal"), this.element.classList.add("xterm"), this.element.setAttribute("tabindex", "0"), this.element.setAttribute("role", "document"), e.appendChild(this.element);
                                        ...
                                        this._renderService = this.register(this._instantiationService.createInstance(E.RenderService, n, this.rows, this.screenElement)), this._instantiationService.setService(L.IRenderService, this._renderService), this.register(this._renderService.onRenderedBufferChange((function(e) {
                                            ...
                                            return t.viewport.syncScrollArea()
                                        }))), this._selectionService = this.register(this._instantiationService.createInstance(f.SelectionService, this.element, this.screenElement)), this._instantiationService.setService(L.ISelectionService, this._selectionService), this.register(this._selectionService.onRequestScrollLines((function(e) {
                            ...
                            var a = r(3787),
                                ...
                                S = function(e) {
                                    function t(t, r, i, n, o, s, c, l, h) {
                                        ...
                                        return u._colors = t, u._element = r, u._screenElement = i, u._viewportElement = n, u._linkifier = o, u._linkifier2 = s, u._charSizeService = c, u._optionsService = l, u._bufferService = h, u._terminalClass = b++, u._rowElements = [], u._rowContainer = document.createElement("div"), u._rowContainer.classList.add("xterm-rows"), u._rowContainer.style.lineHeight = "normal", u._rowContainer.setAttribute("aria-hidden", "true"), u._refreshRowElements(u._bufferService.cols, u._bufferService.rows), u._selectionContainer = document.createElement("div"), u._selectionContainer.classList.add("xterm-selection"), u._selectionContainer.setAttribute("aria-hidden", "true"), u.dimensions = {
                                            scaledCharWidth: 0,
                                            scaledCharHeight: 0,
                                            scaledCellWidth: 0,
                                            scaledCellHeight: 0,
                                            ...
                                            actualCellWidth: 0,
                                            actualCellHeight: 0
                                        }, u._updateDimensions(), u._injectCss(), u._rowFactory = new a.DomRendererRowFactory(document, u._optionsService, u._colors), u._element.classList.add(p + u._terminalClass), u._screenElement.appendChild(u._rowContainer), u._screenElement.appendChild(u._selectionContainer), u._linkifier.onShowLinkUnderline((function(e) {
                                    ...
                                    for (d = 0; d < _; d++) {
                                        ...
                                        if (0 !== p) {
                                            ...
                                            var g = this._workCell.getFgColor(),
                                                ...
                                                S = this._workCell.getBgColorMode(),
                                                m = !!this._workCell.isInverse();
                                            if (m) {
                                                var C = g;
                                                g = b, b = C;
                                                var w = y;
                                ...
                                w = function(e) {
                                    ...
                                    return n(t, e), Object.defineProperty(t.prototype, "onRequestBell", {
                                        ...
                                        var t = this._bufferService.buffer,
                                            r = t.x,
                                            i = t.y;
                                        if (this._logService.debug("parsing data", e), this._parseBuffer.length < e.length && this._parseBuffer.length < S && (this._parseBuffer = new Uint32Array(Math.min(e.length, S))), this._dirtyRowService.clearRange(), e.length > S)
                                        ...
                                        return this._parser.registerDcsHandler(e, new y.DcsHandler(t))
                                    }, t.prototype.addEscHandler = function(e, t) {
                                        ...
                                        if (!m(e.params[0], this._optionsService.options.windowOptions)) return !0;
                                        ...
                                        for (var t, r = {
                                                colors: []
                                            }, i = /(\d+);rgb:([0-9a-f]{2})\/([0-9a-f]{2})\/([0-9a-f]{2})/gi; null !== (t = i.exec(e));) r.colors.push({
                                        ...
                                        return 2 !== e.length ? (this.selectDefaultCharset(), !0) : ("/" === e[0] || this._charsetService.setgCharset(b[e[0]], a.CHARSETS[e[1]] || a.DEFAULT_CHARSET), !0)
                                ...
                                return e.prototype.getNullCell = function(e) {
                                    ...
                                    if (i.length > 0) {
                                        ...
                                        for (v = Math.min(this.lines.maxLength - 1, R + o - 1); v >= 0; v--)
                                            if (D && D.start > k + T) {
                                                for (var O = D.newLines.length - 1; O >= 0; O--) this.lines.set(v--, D.newLines[O]);
                                                v++, L.push({
                                                    index: k + 1,
                                        ...
                                        var M = 0;
                                        for (v = L.length - 1; v >= 0; v--) L[v].index += M, this.lines.onInsertEmitter.fire(L[v]), M += L[v].amount;
                        ...
                        2584: (e, t) => {
                            ...
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                            }), t.C1 = t.C0 = void 0, (i = t.C0 || (t.C0 = {})).NUL = "\0", i.SOH = "\x01", i.STX = "\x02", i.ETX = "\x03", i.EOT = "\x04", i.ENQ = "\x05", i.ACK = "\x06", i.BEL = "\x07", i.BS = "\b", i.HT = "\t", i.LF = "\n", i.VT = "\v", i.FF = "\f", i.CR = "\r", i.SO = "\x0e", i.SI = "\x0f", i.DLE = "\x10", i.DC1 = "\x11", i.DC2 = "\x12", i.DC3 = "\x13", i.DC4 = "\x14", i.NAK = "\x15", i.SYN = "\x16", i.ETB = "\x17", i.CAN = "\x18", i.EM = "\x19", i.SUB = "\x1a", i.ESC = "\x1b", i.FS = "\x1c", i.GS = "\x1d", i.RS = "\x1e", i.US = "\x1f", i.SP = " ", i.DEL = "\x7f", (r = t.C1 || (t.C1 = {})).PAD = "\x80", r.HOP = "\x81", r.BPH = "\x82", r.NBH = "\x83", r.IND = "\x84", r.NEL = "\x85", r.SSA = "\x86", r.ESA = "\x87", r.HTS = "\x88", r.HTJ = "\x89", r.VTS = "\x8a", r.PLD = "\x8b", r.PLU = "\x8c", r.RI = "\x8d", r.SS2 = "\x8e", r.SS3 = "\x8f", r.DCS = "\x90", r.PU1 = "\x91", r.PU2 = "\x92", r.STS = "\x93", r.CCH = "\x94", r.MW = "\x95", r.SPA = "\x96", r.EPA = "\x97", r.SOS = "\x98", r.SGCI = "\x99", r.SCI = "\x9a", r.CSI = "\x9b", r.ST = "\x9c", r.OSC = "\x9d", r.PM = "\x9e", r.APC = "\x9f"
                        },
                        7399: (e, t, r) => {
                            Object.defineProperty(t, "__esModule", {
                                value: !0
                        ...
                        6351: (e, t, r) => {
                            ...
                            var l = function() {
                                ...
                                return e.prototype.hook = function(e) {
                                    ...
                                    var t = !1;
                                    return this._hitLimit ? t = !1 : e && (t = this._handler(this._data, this._params)), this._params = c, this._data = "", this._hitLimit = !1, t
                                }, e
                            }();
                            t.DcsHandler = l
                        },
                            ...
                            var f = function(e) {
                                ...
                                return n(r, e), r.prototype._identifier = function(e, t) {
                                    ...
                                    for (var r = 0, i = 0, n = this.currentState, o = this._oscParser, s = this._dcsParser, a = this._collect, c = this._params, l = this._transitions.table, h = 0; h < t; ++h) {
                                        switch ((i = l[n << 8 | ((r = e[h]) < 160 ? r : u)]) >> 4) {
                                            case 2:
                                                for (var f = h + 1;; ++f) {
                                                    if (f >= t || (r = e[f]) < 32 || r > 126 && r < u) {
                                            ...
                                            case 1:
                                                ...
                                                break;
                                            case 7:
                                                for (var _ = this._csiHandlers[a << 8 | r], d = _ ? _.length - 1 : -1; d >= 0 && !_[d](c); d--);
                                                d < 0 && this._csiHandlerFb(a << 8 | r, c), this.precedingCodepoint = 0;
                                                break;
                                            case 8:
                                                do {
                                                    switch (r) {
                                            ...
                                            case 9:
                                                ...
                                                break;
                                            case 10:
                                                for (var p = this._escHandlers[a << 8 | r], v = p ? p.length - 1 : -1; v >= 0 && !p[v](); v--);
                                            ...
                                            case 13:
                                                for (var g = h + 1;; ++g)
                                                    if (g >= t || 24 === (r = e[g]) || 26 === r || 27 === r || r > 127 && r < u) {
                                                        s.put(e, h, g), h = g - 1;
                                                        break
                                                    }
                                                break;
                            ...
                            var l = String.fromCharCode,
                                h = {
                                    ...
                                    SGR: function(e) {
                                        ...
                                        return "\x1b[<" + c(e, !0) + ";" + e.col + ";" + e.row + t
                                    }
                                },
                                u = function() {
                                    function e(e, t) {
...
//# sourceMappingURL=349.28e4f8b7d842ce07d2c3.js.map