        ...
        "hKI/": function(t, e, n) {
            (function(e) {
                ...
                function O(t, e, r) {
                    ...
                    return e = h(e) || 0, j(r) && (b = !!r.leading, c = (O = "maxWait" in r) ? p(h(r.maxWait) || 0, e) : c, v = "trailing" in r ? !!r.trailing : v), E.cancel = function() {
                        void 0 !== a && clearTimeout(a), s = 0, o = f = i = a = void 0
                    }, E.flush = function() {
                ...
                t.exports = function(t, e, r) {
                    var o = !0,
                        i = !0;
                    if ("function" != typeof t) throw new TypeError(n);
                    return j(r) && (o = "leading" in r ? !!r.leading : o, i = "trailing" in r ? !!r.trailing : i), O(t, e, {
                        leading: o,
                        maxWait: e,
                        trailing: i
                    })
            ...
            function b(t, e) {
                ...
                var c = e || {},
                    ...
                    p = i.a.useMemo((function() {
                        return a ? ("debounce" === a ? f.a : u.a)((function(t) {
                ...
                return i.a.useEffect((function() {
                    var t = new window.ResizeObserver((function(t) {
                        ...
                        if (e) {
                            ...
                            w.current.width === r && w.current.height === o || window.requestAnimationFrame((function() {
                                n.current && d.current({
                                    width: r,
                                    height: o
                                })
                    ...
                    if (y.current && j) return y.current.observe(j),
                        function() {
                            y.current && y.current.unobserve(j), "cancel" in d.current && d.current.cancel()
                        }
                }), [j]), v
            }
        },
