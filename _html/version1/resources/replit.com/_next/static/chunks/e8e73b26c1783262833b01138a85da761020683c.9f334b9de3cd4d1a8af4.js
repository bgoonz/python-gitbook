    ...
    [24], {
            ...
            var r = n("SDrh"),
                ...
                p = function() {
                    ...
                    return t.prototype.addSentryBreadcrumb = function(t) {
                        ...
                        var e;
                        try {
                            e = t.event.target ? Object(u.a)(t.event.target) : Object(u.a)(t.event)
                        } catch (n) {
                            e = "<unknown>"
                        }
                        ...
                        var e = Object(a.e)(),
                            ...
                            s = Object(a.h)(n),
                            c = Object(a.h)(r);
                        s.path || (s = i), i.protocol === c.protocol && i.host === c.host && (r = c.relative), i.protocol === s.protocol && i.host === s.host && (n = s.relative), Object(o.b)().addBreadcrumb({
                            category: "navigation",
                            data: {
                                from: n,
                                to: r
            ...
            var r = n("SDrh"),
                ...
                p = function(t) {
                    ...
                    return Object(r.b)(e, t), e.prototype.sendEvent = function(t) {
                        ...
                        return void 0 !== this.options.fetchParameters && Object.assign(r, this.options.fetchParameters), void 0 !== this.options.headers && (r.headers = this.options.headers), this._buffer.add(new s.a((function(e, o) {
                            u.fetch(t.url, r).then((function(r) {
                                var i = {
        ...
        "6hSO": function(t, e, n) {
                ...
                if (!d[t]) switch (d[t] = !0, t) {
                    case "console":
                        ! function() {
                            ...
                            ["debug", "info", "warn", "error", "log", "assert"].forEach((function(t) {
                                t in f.console && Object(c.c)(f.console, t, (function(e) {
                                    return function() {
                    ...
                    case "dom":
                        ! function() {
                            ...
                            f.document.addEventListener("click", j("click", y.bind(null, "dom")), !1), f.document.addEventListener("keypress", w(y.bind(null, "dom")), !1), ["EventTarget", "Node"].forEach((function(t) {
                                ...
                                e && e.hasOwnProperty && e.hasOwnProperty("addEventListener") && (Object(c.c)(e, "addEventListener", (function(t) {
                                    return function(e, n, r) {
                                        return n && n.handleEvent ? ("click" === e && Object(c.c)(n, "handleEvent", (function(t) {
                                            return function(e) {
                                                return j("click", y.bind(null, "dom"))(e), t.call(this, e)
                                            }
                                        })), "keypress" === e && Object(c.c)(n, "handleEvent", (function(t) {
                                            return function(e) {
                                                return w(y.bind(null, "dom"))(e), t.call(this, e)
                                            }
                                        }))) : ("click" === e && j("click", y.bind(null, "dom"), !0)(this), "keypress" === e && w(y.bind(null, "dom"))(this)), t.call(this, e, n, r)
                                    }
                        ...
                        ! function() {
                            ...
                            Object(c.c)(n, "open", (function(n) {
                                return function() {
                                    ...
                                    return "onreadystatechange" in a && "function" === typeof a.onreadystatechange ? Object(c.c)(a, "onreadystatechange", (function(t) {
                                        return function() {
                                            for (var e = [], n = 0; n < arguments.length; n++) e[n] = arguments[n];
                                ...
                                return function() {
                                    for (var r = [], o = 0; o < arguments.length; o++) r[o] = arguments[o];
                                    return t.push(this), e.push(r), y("xhr", {
                                        args: r,
                                        startTimestamp: Date.now(),
                                        xhr: this
                                    }), n.apply(this, r)
                        ...
                        ! function() {
                            ...
                            Object(c.c)(f, "fetch", (function(t) {
                                return function() {
                                    ...
                                    return y("fetch", Object(o.a)({}, r)), t.apply(f, e).then((function(t) {
                    ...
                    case "history":
                        ! function() {
                            ...
                            }, Object(c.c)(f.history, "pushState", e), Object(c.c)(f.history, "replaceState", e)
                        }();
                        break;
                    case "error":
                        E = f.onerror, f.onerror = function(t, e, n, r, o) {
                            return y("error", {
                                column: r,
                                error: o,
                                line: n,
                    ...
                    case "unhandledrejection":
                        S = f.onunhandledrejection, f.onunhandledrejection = function(t) {
                            return y("unhandledrejection", t), !S || S.apply(this, arguments)
                        };
                        break;
                    default:
            ...
            function y(t, e) {
                var n, r;
                if (t && l[t]) try {
                    for (var i = Object(o.d)(l[t] || []), s = i.next(); !s.done; s = i.next()) {
                        var c = s.value;
                        try {
                            c(e)
                        } catch (p) {
            ...
            function j(t, e, n) {
                return void 0 === n && (n = !1),
                    function(r) {
                        _ = void 0, r && g !== r && (g = r, O && clearTimeout(O), n ? O = setTimeout((function() {
                            e({
                                event: r,
                                name: t
                            })
            ...
            function w(t) {
                return function(e) {
                    ...
                    var r = n && n.tagName;
                    r && ("INPUT" === r || "TEXTAREA" === r || n.isContentEditable) && (_ || j("input", t)(e), clearTimeout(_), _ = setTimeout((function() {
                        _ = void 0
                    }), 1e3))
                }
            }
            ...
            var r = n("SDrh"),
                ...
                c = function() {
                    ...
                    return t.prototype.isReady = function() {
                        ...
                        })), t) : s.a.reject(new a.a("Not adding Promise due to buffer limit reached."))
                        ...
                        return new s.a((function(n) {
                            ...
                            s.a.all(e._buffer).then((function() {
                                clearTimeout(r), n(!0)
                            })).then(null, (function() {
                                n(!0)
                            }))
                ...
                f = function() {
                    function t(t) {
                        this.options = t, this._buffer = new c(30), this._rateLimits = {}, this._api = new o.a(this.options.dsn), this.url = this._api.getStoreEndpointWithUrlEncodedAuth()
                    }
                    return t.prototype.sendEvent = function(t) {
                        throw new a.a("Transport Class has to implement `sendEvent` method")
                    }, t.prototype.close = function(t) {
                        ...
                        this._handleRateLimit(r) && u.a.warn("Too many requests, backing off until: " + this._disabledUntil(e)), s !== i.a.Success ? a(n) : o({
                            status: s
                        })
                        ...
                        var e, n, o, i, a = Date.now(),
                            s = t["x-sentry-rate-limits"],
                            c = t["retry-after"];
                        if (s) {
                            try {
                                for (var u = Object(r.d)(s.trim().split(",")), f = u.next(); !f.done; f = u.next()) {
                                    var l = f.value.split(":", 2),
                                        d = parseInt(l[0], 10),
                                        h = 1e3 * (isNaN(d) ? 60 : d);
                                    try {
                                        for (var v = (o = void 0, Object(r.d)(l[1].split(";"))), y = v.next(); !y.done; y = v.next()) {
                                            var b = y.value;
                        ...
                        return !!c && (this._rateLimits.all = new Date(a + Object(p.g)(a, c)), !0)
                    }, t
                }()
        },
        "IS+8": function(t, e, n) {
            ...
            function l(t, e, n) {
                var o;
                if (void 0 === n && (n = {}), Object(s.e)(t) && t.error) return t = t.error, o = Object(c.b)(Object(u.a)(t));
                if (Object(s.a)(t) || Object(s.b)(t)) {
                    var a = t,
                        p = a.name || (Object(s.a)(a) ? "DOMError" : "DOMException"),
                        f = a.message ? p + ": " + a.message : p;
                    return o = d(f, e, n), Object(i.b)(o, f), "code" in a && (o.tags = Object(r.a)(Object(r.a)({}, o.tags), {
                ...
                if (Object(s.h)(t) || Object(s.f)(t)) {
                    var l = t;
                    return o = Object(c.a)(l, e, n.rejection), Object(i.a)(o, {
                        synthetic: !0
                    }), o
                }
                return o = d(t, e, n), Object(i.b)(o, "" + t, void 0), Object(i.a)(o, {
                    synthetic: !0
                }), o
            }
        ...
        KRiW: function(t, e, n) {
            ...
            function i(t, e) {
                var n = t.tags || {},
                    ...
                    a = Object(r.b)(n, ["__sentry_samplingMethod", "__sentry_sampleRate"]);
                t.tags = a;
                ...
                a = function(t) {
                    ...
                    return Object(r.b)(e, t), e.prototype.sendEvent = function(t) {
                        ...
                        return this._isRateLimited(t.type) ? Promise.reject({
                            ...
                            reason: "Transport locked till " + this._disabledUntil(t.type) + " due to too many requests.",
                            status: 429
                        }) : this._buffer.add(new i.a((function(e, r) {
                ...
                var a = {
                    exception: {
                        values: [{
                            ...
                            value: "Non-Error " + (n ? "promise rejection" : "exception") + " captured with keys: " + Object(o.b)(t)
                        }]
                    },
                    extra: {
            ...
            var r = n("SDrh"),
                ...
                d = function(t) {
                    ...
                    return Object(r.b)(e, t), e.prototype.eventFromException = function(t, e) {
                        ...
                        return void 0 === e && (e = c.a.Info), Object(p.b)(this._options, t, e, n)
                        ...
                        return this._options.transport ? new this._options.transport(e) : Object(u.a)() ? new f.a(e) : new l.a(e)
                    }, e
                }(s.a),
                h = n("vzc1"),
                v = n("/ZhC"),
                ...
                b = function(t) {
                    ...
                    return Object(r.b)(e, t), e.prototype.showReportDialog = function(t) {
                        void 0 === t && (t = {}), Object(i.e)().document && (this._isEnabled() ? Object(h.a)(Object(r.a)(Object(r.a)({}, t), {
                ...
                return function(t) {
                    ...
                    if (Array.isArray(n)) {
                        ...
                        e.forEach((function(t) {
                            -1 === i.indexOf(t.name) && -1 === a.indexOf(t.name) && (o.push(t), a.push(t.name))
                        })), n.forEach((function(t) {
                            -1 === a.indexOf(t.name) && (o.push(t), a.push(t.name))
                        }))
                    } else "function" === typeof n ? (o = n(e), o = Array.isArray(o) ? o : [o]) : o = Object(r.c)(e);
                    var s = o.map((function(t) {
                            return t.name
                        })),
                        c = "Debug";
                    return -1 !== s.indexOf(c) && o.push.apply(o, Object(r.c)(o.splice(s.indexOf(c), 1))), o
                }(t).forEach((function(t) {
                    e[t.name] = t,
                        function(t) {
                            -1 === y.indexOf(t.name) && (t.setupOnce(o.b, v.b), y.push(t.name), c.a.log("Integration installed: " + t.name))
                        }(t)
                })), e
            }
            var m = function() {
                ...
                return t.prototype.captureException = function(t, e, n) {
                    ...
                    var o = this,
                        i = n && n.event_id,
                        a = Object(s.i)(t) ? this._getBackend().eventFromMessage(String(t), e, n) : this._getBackend().eventFromException(t, n);
                    ...
                    t.release ? this._sendSession(t) : c.a.warn("Discarded session because of missing release")
                    ...
                    if (u) {
                        c = !0;
                        try {
                            for (var p = Object(r.d)(u), f = p.next(); !f.done; f = p.next()) {
                    ...
                    var l = e;
                    n && n.captureContext && (l = o.a.clone(l).update(n.captureContext));
                    var d = u.a.resolve(c);
                    return l && (d = l.applyToEvent(c, n)), d.then((function(t) {
                        return "number" === typeof s && s > 0 ? i._normalizeEvent(t, s) : t
                    }))
                    ...
                    var e = this.getOptions(),
                        ...
                        i = e.maxValueLength,
                        a = void 0 === i ? 250 : i;
                    "environment" in t || (t.environment = "environment" in e ? n : "production"), void 0 === t.release && void 0 !== r && (t.release = r), void 0 === t.dist && void 0 !== o && (t.dist = o), t.message && (t.message = Object(d.d)(t.message, a));
                    ...
                    var r = this,
                        ...
                        i = o.beforeSend,
                        a = o.sampleRate;
                    if (!this._isEnabled()) return u.a.reject(new h.a("SDK not enabled, will not send event."));
                    var c = "transaction" === t.type;
                    return !c && "number" === typeof a && Math.random() > a ? u.a.reject(new h.a("Discarding event because it's not included in the random sample (sampling rate = " + a + ")")) : this._prepareEvent(t, n, e).then((function(t) {
                        if (null === t) throw new h.a("An event processor returned null, will not send event.");
                        if (e && e.data && !0 === e.data.__sentry__ || c || !i) return t;
                        var n = i(t, e);
                        if ("undefined" === typeof n) throw new h.a("`beforeSend` method has to return `null` or a valid event.");
                        return Object(s.m)(n) ? n.then((function(t) {
                            return t
                        }), (function(t) {
                            throw new h.a("beforeSend rejected with " + t)
                        })) : n
                    })).then((function(t) {
                        if (null === t) throw new h.a("`beforeSend` returned `null`, will not send event.");
            ...
            function f(t, e, n) {
                ...
                var i = function() {
                    ...
                    try {
                        ...
                        throw p(), Object(o.m)((function(t) {
                            t.addEventProcessor((function(t) {
                                var n = Object(r.a)({}, t);
                                return e.mechanism && (Object(a.b)(n, void 0, void 0), Object(a.a)(n, e.mechanism)), n.extra = Object(r.a)(Object(r.a)({}, n.extra), {
                                    arguments: i
                                }), n
                            })), Object(o.c)(c)
                        })), c
            ...
            function l(t) {
                if (void 0 === t && (t = {}), t.eventId)
                    if (t.dsn) {
                        ...
                        e.async = !0, e.src = new i.a(t.dsn).getReportDialogEndpoint(t), t.onLoad && (e.onload = t.onLoad), (document.head || document.body).appendChild(e)
            ...
            function f(t) {
                ...
                try {
                    if (e = function(t) {
                            ...
                            for (var e, n = t.stacktrace, r = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i, i = / line (\d+), column (\d+)\s*(?:in (?:<anonymous function: ([^>]+)>|([^)]+))\((.*)\))? in (.*):\s*$/i, a = n.split("\n"), s = [], c = 0; c < a.length; c += 2) {
                                var u = null;
                                (e = r.exec(a[c])) ? u = {
                                    url: e[2],
                                    func: e[3],
                ...
                try {
                    if (e = function(t) {
                            ...
                            for (var e, n, r, p = [], f = t.stack.split("\n"), l = 0; l < f.length; ++l) {
                                if (n = i.exec(f[l])) {
                                    ...
                                    n[3] && n[3].indexOf(" > eval") > -1 && (e = c.exec(n[3])) ? (n[1] = n[1] || "eval", n[3] = e[1], n[4] = e[2], n[5] = "") : 0 !== l || n[5] || void 0 === t.columnNumber || (p[0].column = t.columnNumber + 1), r = {
                                        url: n[3],
                                        func: n[1] || o,
                                        args: n[2] ? n[2].split(",") : [],
                                        line: n[4] ? +n[4] : null,
