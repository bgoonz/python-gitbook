    ...
    [21], {
        ...
        "34Ai": function(e, t, n) {
            ...
            var a, s = n("5+mB"),
                ...
                A = n("WP+z");
            ! function(e) {
                e.Intentional = "Intentional", e.Disconnected = "Disconnected", e.Error = "Error"
            }(a || (a = {}));
            var h = function() {
                var e = this;
                this.open = function(t, n) {
                    if (e.chan0Cb) {
                        var o = new Error("You must call `close` before opening the client again");
                        throw e.onUnrecoverableError(o), o
                    }
                    if (e.destroyed) throw o = new Error("Client has been destroyed and cannot be re-used"), e.onUnrecoverableError(o), o;
                    e.connectOptions = r({
                        timeout: 1e4,
                    ...
                    }), e.chan0Cb = n, e.connect({
                        tryCount: 0,
                        websocketFailureCount: 0
                    })
                }, this.openChannel = function(t, n) {
                    var r = t.name ? e.channelRequests.filter((function(e) {
                        return e.options.name === t.name
                    })) : [];
                    if (r.some((function(e) {
                            return !e.closeRequested
                        }))) {
                        var o = new Error("Channel with name " + t.name + " already opened");
                        throw e.onUnrecoverableError(o), o
                    }
                    if (e.destroyed) throw o = new Error("Client has been destroyed and is unusable"), e.onUnrecoverableError(o), o;
                    var i = {
                        options: t,
                        openChannelCb: n,
                        isOpen: !1,
                    ...
                    return e.channelRequests.push(i), e.connectionState !== A.ConnectionState.CONNECTED || r.length || e.requestOpenChannel(i),
                        function() {
                            i.closeRequested || (i.closeRequested = !0, i.isOpen ? e.requestCloseChannel(i) : e.connectionState !== A.ConnectionState.CONNECTED && (e.channelRequests = e.channelRequests.filter((function(e) {
                                return e !== i
                            })), i.openChannelCb({
                    ...
                    if (e.connectOptions) {
                        ...
                        if (!o || !o(e.connectOptions.context)) {
                            var i = n.action;
                            if (i || (i = null == n.name ? s.api.OpenChannel.Action.CREATE : s.api.OpenChannel.Action.ATTACH_OR_CREATE), t.channelId) e.onUnrecoverableError(new Error("Unexpected channelId"));
                            else {
                                var a = "string" === typeof n.service ? n.service : n.service(e.connectOptions.context);
                                e.debug({
                                    type: "breadcrumb",
                                ...
                                var u = e.getChannel(0),
                                    l = Number(Math.random().toString().split(".")[1]).toString(36);
                                u.send({
                                    ref: l,
                                    openChan: {
                                        name: n.name,
                                            ...
                                            if (e.debug({
                                                ...
                                                if (a !== s.api.OpenChannelRes.State.ERROR)
                                                    if ("number" === typeof i && "number" === typeof a) {
                                                        ...
                                                        e.channels[i] = h, t.channelId = i, t.isOpen = !0, t.closeRequested && e.requestCloseChannel(t), t.cleanupCb = r({
                                                            channel: h,
                                                            error: null,
                                                            context: e.connectOptions.context
                                                        })
                                                    } else e.onUnrecoverableError(new Error("Expected state and channel id"));
                                            else e.onUnrecoverableError(new Error("Channel open resulted with an error: " + (u || "with no message")));
                                            else e.onUnrecoverableError(new Error("Expected connectionOptions"))
                                        } else e.onUnrecoverableError(new Error("Expected openChanRes on command"))
                                }))
                            }
                        }
                    } else e.onUnrecoverableError(new Error("Expected connectionOptions"))
                    ...
                    return o(e, void 0, void 0, (function() {
                        ...
                        return i(this, (function(i) {
                            switch (i.label) {
                                case 0:
                                    return t.isOpen ? (e = t.channelId, (n = this.getChannel(t.channelId)).status = "closing", (r = this.getChannel(0)) ? (this.debug({
                                        type: "breadcrumb",
                                    ...
                                    })]) : (this.onUnrecoverableError(new Error("Tried to request a channel close but there was no chan0")), [2])) : (this.onUnrecoverableError(new Error("Tried to request a channel close before opening")), [2]);
                                case 1:
                                    if ((o = i.sent()).channelClosed) this.debug({
                                        type: "breadcrumb",
                                        ...
                                        if (null == o.closeChanRes) return this.onUnrecoverableError(new Error("Expected closeChanRes")), [2];
                                        if (null == (a = o.closeChanRes.id)) return this.onUnrecoverableError(new Error("Expected id, got " + a)), [2];
                                        if (a !== e) return this.onUnrecoverableError(new Error("Expected id from closeChanRes to be " + e + " got " + a)), [2];
                                        this.debug({
                                            type: "breadcrumb",
                                    ...
                                    return this.channelRequests = this.channelRequests.filter((function(e) {
                                        return e !== t
                                    })), delete this.channels[e], n.handleClose({
                                        initiator: "channel",
                                        willReconnect: !1
                                    }), t.cleanupCb && t.cleanupCb({
                                        initiator: "channel",
                                        willReconnect: !1
                                    }), t.options.name && this.connectionState === A.ConnectionState.CONNECTED && (c = this.channelRequests.find((function(e) {
                                        return e.options.name === t.options.name
                                    }))) ? (this.requestOpenChannel(c), [2]) : [2]
                            }
                        }))
                    }))
                }, this.close = function() {
                    ...
                    e.fetchTokenAbortController && (e.fetchTokenAbortController.abort(), e.fetchTokenAbortController = null), e.connectionMetadata = null, e.handleClose({
                        closeReason: a.Intentional
                    })
                }, this.destroy = function() {
                    e.destroyed = !0, e.debug({
                        type: "breadcrumb",
                        message: "destroy"
                    }), e.connectionState !== A.ConnectionState.DISCONNECTED && e.close(), e.debug = function() {}, e.userUnrecoverableErrorHandler = null, e.channelRequests = [], e.destroyed = !0
                    ...
                    e.legacyDebugFunc && e.legacyDebugFunc(t), e.debugFuncs.forEach((function(e) {
                        return e(t)
                    }))
                }, this.setDebugFunc = function(t) {
                    e.legacyDebugFunc = t
                }, this.addDebugFunc = function(t) {
                    return e.debugFuncs.push(t),
                        function() {
                    ...
                    return o(e, void 0, void 0, (function() {
                        var e, t, o, a, h, p, f, d, b, y, g, v, m, C, w, E, O, S, k, x = this;
                        return i(this, (function(i) {
                            switch (i.label) {
                                case 0:
                                    if (this.debug({
                                        ...
                                        }), this.connectionState !== A.ConnectionState.DISCONNECTED) throw e = new Error("Client must be disconnected to connect"), this.onUnrecoverableError(e), e;
                                    if (this.ws) throw e = new Error("Unexpected existing websocket instance"), this.onUnrecoverableError(e), e;
                                    if (!this.connectOptions) throw e = new Error("Expected connectionOptions"), this.onUnrecoverableError(e), e;
                                    if (!this.chan0Cb) return this.onUnrecoverableError(new Error("Expected chan0Cb")), [2];
                                    if (this.chan0CleanupCb) return this.onUnrecoverableError(new Error("Unexpected chan0CleanupCb, are you sure you closed")), [2];
                                    if (this.channelRequests.some((function(e) {
                                            return e.isOpen
                                        }))) return this.onUnrecoverableError(new Error("All channels should be closed when we connect")), [2];
                                    if (Object.keys(this.channels).length) return this.onUnrecoverableError(new Error("Found an an unexpected existing channels")), [2];
                                    if (this.connectionState = A.ConnectionState.CONNECTING, t = new c.Channel({
                                            id: 0,
                                            onUnrecoverableError: this.onUnrecoverableError,
                                            send: this.send
                                        }), this.channels[0] = t, this.connectOptions.reuseConnectionMetadata && null !== this.connectionMetadata) return [3, 5];
                                    if (this.fetchTokenAbortController) return this.onUnrecoverableError(new Error("Expected fetchTokenAbortController to be null")), [2];
                                    o = new AbortController, this.fetchTokenAbortController = o, a = void 0, i.label = 1;
                                case 1:
                                    return i.trys.push([1, 3, , 4]), [4, this.connectOptions.fetchConnectionMetadata(o.signal)];
                                case 2:
                                    return a = i.sent(), [3, 4];
                                case 3:
                                    return h = i.sent(), this.onUnrecoverableError(h), [2];
                                case 4:
                                    if (this.fetchTokenAbortController = null, f = (p = a).error === A.FetchConnectionMetadataError.Aborted, o.signal.aborted !== f) return o.signal.aborted ? (this.onUnrecoverableError(new Error("Expected abort returned from fetchConnectionMetadata to be truthy when the controller aborts")), [2]) : (this.onUnrecoverableError(new Error("Abort should only be truthy returned when the abort signal is triggered")), [2]);
                                    if (p.error === A.FetchConnectionMetadataError.Aborted) return [2];
                                    if (p.error === A.FetchConnectionMetadataError.Retriable) return this.retryConnect({
                                        tryCount: n + 1,
                                        websocketFailureCount: r,
                                        chan0: t,
                                        error: new Error("Retriable error")
                                    }), [2];
                                    if (this.connectionState !== A.ConnectionState.CONNECTING) return this.onUnrecoverableError(new Error("Client was closed before connecting")), [2];
                                    if (p.error) return this.onUnrecoverableError(p.error), [2];
                                    this.connectionMetadata = p, i.label = 5;
                                case 5:
                                    return 3 === r && this.debug({
                                        type: "breadcrumb",
                                        message: "polling fallback"
                                    }), b = (d = r >= 3) ? l.EIOCompat : u.getWebSocketClass(this.connectOptions.WebSocketClass), y = u.getConnectionStr(this.connectionMetadata, d), (g = new b(y)).binaryType = "arraybuffer", g.onmessage = this.onSocketMessage, this.ws = g, v = !1, m = !1, C = null, g.onerror = function() {
                                        C ? C(new Error("WebSocket errored")) : x.onUnrecoverableError(new Error("Got websocket error but no `onFailed` cb"))
                                    }, g.onclose = function(e) {
                                        C ? (b === l.EIOCompat ? m || (x.connectionMetadata = null) : "code" in e && 1008 === e.code && (x.connectionMetadata = null), C(new Error("WebSocket closed before we got READY"))) : x.onUnrecoverableError(new Error("Got websocket closure but no `onFailed` cb"))
                                    }, g.onopen = function() {
                                        b !== l.EIOCompat && (v = !0)
                                    }, w = function() {}, E = function() {}, null !== (O = this.connectOptions.timeout) && (E = function() {
                                        x.debug({
                                            type: "breadcrumb",
                                        ...
                                        x.debug({
                                            ...
                                            }), C ? C(new Error("timeout")) : x.onUnrecoverableError(new Error("Connecting timed out but there was no `onFailed` cb"))
                                        }), O)
                                        ...
                                        if (m = !0, w(), null != e.containerState)
                                            if (null != e.containerState.state) {
                                                ...
                                                switch (n) {
                                                    case r.READY:
                                                        if (k(), E(), !x.connectOptions) return void x.onUnrecoverableError(new Error("Expected connectionOptions"));
                                                        if (!t) return void x.onUnrecoverableError(new Error("Expected chan0 to be truthy"));
                                                        if (!x.chan0Cb) return void x.onUnrecoverableError(new Error("Expected chan0Cb to be truthy"));
                                                        x.handleConnect();
                                                        var o = x.close;
                                                        x.close = function() {
                                                        ...
                                                        break;
                                                    case r.SLEEP:
                                                        if (!C) return void x.onUnrecoverableError(new Error("Got SLEEP but there was no `onFailed` cb"));
                                                        C(new Error("Got SLEEP as container state"))
                                                }
                                            } else x.onUnrecoverableError(new Error("Got containterState but state was not defined"))
                                    })), C = function(e) {
                                        C = null, x.cleanupSocket(), E(), k(), x.retryConnect({
                                            tryCount: n + 1,
                    ...
                    var n = t.tryCount,
                        ...
                        o = t.chan0,
                        i = t.error;
                    e.retryTimeoutId ? e.onUnrecoverableError(new Error("unexpected existing retryTimeoutId")) : e.chan0Cb && (e.retryTimeoutId = setTimeout((function() {
                        e.chan0Cb ? (e.retryTimeoutId = null, e.debug({
                            type: "breadcrumb",
                            message: "retrying",
                            data: {
                            ...
                            initiator: "client",
                            willReconnect: !0
                        }), delete e.channels[0], e.connectionState = A.ConnectionState.DISCONNECTED, e.connect({
                            tryCount: n,
                            websocketFailureCount: r
                        })) : e.onUnrecoverableError(new Error("Scheduled retry is called after we closed?"))
                    ...
                    null != e.ws ? e.ws.send(r) : e.onUnrecoverableError(new Error("Calling send on a closed client"))
                    ...
                    if (e.connectionState = A.ConnectionState.CONNECTED, e.debug({
                            type: "breadcrumb",
                            message: "connected!"
                        }), e.ws) {
                        var t = function(t) {
                            e.connectionState !== A.ConnectionState.DISCONNECTED ? (e.debug({
                                type: "breadcrumb",
                                message: "wsclose",
                                data: {
                                    event: t
                                ...
                                wsEvent: t
                            })) : e.onUnrecoverableError(new Error("Got a close event on socket but client is in disconnected state"))
                        };
                        e.ws.onclose = t, e.ws.onerror = t, e.channelRequests.forEach((function(t) {
                            e.requestOpenChannel(t)
                        }))
                    } else e.onUnrecoverableError(new Error("Expected Websocket instance"))
                }, this.handleClose = function(t) {
                    if (t.closeReason !== a.Error) {
                        if (e.connectionState === A.ConnectionState.DISCONNECTED) return void e.onUnrecoverableError(new Error("handleClose is called but client already disconnected"));
                        if (e.ws && e.fetchTokenAbortController) return void e.onUnrecoverableError(new Error("fetchTokenAbortController and websocket exist simultaneously"))
                    }
                    e.cleanupSocket(), e.retryTimeoutId && clearTimeout(e.retryTimeoutId);
                    var n = t.closeReason === a.Disconnected;
                    if (e.channelRequests.forEach((function(t) {
                            var r = n && !t.closeRequested;
                            t.isOpen ? (e.getChannel(t.channelId).handleClose({
                                initiator: "client",
                                willReconnect: r
                            }), delete e.channels[t.channelId]) : r || t.openChannelCb({
                                channel: null,
                            ...
                            var o = t.cleanupCb,
                                i = t.closeRequested;
                            t.channelId = null, t.isOpen = !1, t.cleanupCb = null, t.closeRequested = !1, o && o({
                                initiator: "client",
                                willReconnect: r
                            }), (i || t.closeRequested) && (e.channelRequests = e.channelRequests.filter((function(e) {
                                return e !== t
                            })))
                        })), e.channels[0] && (e.channels[0].handleClose({
                            initiator: "client",
                            willReconnect: n
                        }), delete e.channels[0]), 0 === Object.keys(e.channels).length || (e.channels = {}, t.closeReason === a.Error)) {
                        if (e.chan0CleanupCb) e.chan0CleanupCb({
                            initiator: "client",
                            willReconnect: n
                        }), e.chan0CleanupCb = null;
                        else if (!n)
                            if (e.chan0Cb) e.chan0Cb({
                                channel: null,
                                error: new Error("Failed to open"),
                                context: e.connectOptions ? e.connectOptions.context : null
                            });
                            else if (t.closeReason !== a.Error) return void e.onUnrecoverableError(new Error("open should have been called before `handleClose`"));
                        if (e.connectionState = A.ConnectionState.DISCONNECTED, !n) return e.chan0Cb = null, void(e.connectOptions = null);
                        e.debug({
                            type: "breadcrumb",
                    ...
                    } else e.onUnrecoverableError(new Error("channels object should be empty after channelRequests and chan0 cleanup"))
                    ...
                    }), t && (e.ws = null, t.onmessage = null, t.onclose = null, t.onopen = null, t.onerror = function() {}, 0 !== t.readyState && 1 !== t.readyState || (e.debug({
                        type: "breadcrumb",
                        message: "wsclose"
                    }), t.close()))
                    ...
                    if (e.debug({
                        ...
                        }), e.connectionState !== A.ConnectionState.DISCONNECTED) try {
                        e.handleClose({
                            closeReason: a.Error,
                            error: t
                        })
                    } catch (n) {
                        console.error("handleClose errored during unrecoverable error"), console.error(n)
                    }
                    if (!e.userUnrecoverableErrorHandler) throw console.error("Please supply your own unrecoverable error handling function"), t;
                    e.userUnrecoverableErrorHandler(t)
                }, this.ws = null, this.channels = {}, this.connectOptions = null, this.chan0Cb = null, this.chan0CleanupCb = null, this.connectionState = A.ConnectionState.DISCONNECTED, this.debugFuncs = [], this.userUnrecoverableErrorHandler = null, this.channelRequests = [], this.retryTimeoutId = null, this.fetchTokenAbortController = null, this.destroyed = !1, this.connectionMetadata = null, this.debug({
                    type: "breadcrumb",
                    message: "constructor"
                })
            };
        ...
        "49PC": function(e, t, n) {
            ...
            if (e.exports = l, e.exports.Request = A, a(l, o), l.prototype.supportsBinary = !0, l.prototype.request = function(e) {
                ...
                }, i(A.prototype), A.prototype.create = function() {
                    var e = {
                        agent: this.agent,
                        xdomain: this.xd,
                        xscheme: this.xs,
                    ...
                    "undefined" !== typeof document && (this.index = A.requestsCount++, A.requests[this.index] = this)
                    ...
                    if ("undefined" !== typeof this.xhr && null !== this.xhr) {
                        ...
                        "undefined" !== typeof document && delete A.requests[this.index], this.xhr = null
                    }
                    ...
                    this.cleanup()
                }, A.requestsCount = 0, A.requests = {}, "undefined" !== typeof document)
        ...
        "4A0d": function(e, t, n) {
            ...
            function A(e, t) {
                return !window.navigator.clipboard || (Object(u.a)(t), "c" !== t.key.toLowerCase() || !t.ctrlKey || !t.shiftKey || ("keyup" === t.type && e.hasSelection() && window.navigator.clipboard.writeText(e.getSelection()).catch((function(e) {
                    a.m((function(t) {
                        t.setTag("xterm-clipboard", !0), t.setExtra("type", "copy"), a.c(e)
                    }))
            ...
            function h(e) {
                ...
                return i.useEffect((function() {
                    O && d && O.fit()
                }), [d, O]), i.useLayoutEffect((function() {
                    if (v && u) {
                        var e = u.xterm,
                            t = u.fitAddon,
                            n = u.searchAddon,
                            r = [];
                        return e.open(v), r.push((function() {
                                return e.dispose()
        ...
        Axi0: function(e, t, n) {
            (function(t) {
                ...
                function h(e) {
                    e && e.forceBase64 && (this.supportsBinary = !1), this.perMessageDeflate = e.perMessageDeflate, this.usingBrowserWebSocket = r && !e.forceNode, this.protocols = e.protocols, this.usingBrowserWebSocket || (A = o), i.call(this, e)
                }
                e.exports = h, c(h, i), h.prototype.name = "websocket", h.prototype.supportsBinary = !0, h.prototype.doOpen = function() {
                    if (this.check()) {
                        var e = this.uri(),
                            t = this.protocols,
                            n = {};
                        ...
                        try {
                            this.ws = this.usingBrowserWebSocket && !this.isReactNative ? t ? new A(e, t) : new A(e) : new A(e, t, n)
                        } catch (r) {
        ...
        "C/he": function(e, t, n) {
            ...
            function c(e) {
                return "undefined" !== typeof window ? new MessageEvent("message", {
                    data: e
                }) : {
                    type: "message",
                    data: e
            ...
            function u(e, t) {
                return "undefined" !== typeof window ? new Event(e, t) : r({
                    type: e
                }, t)
            }
            var l = function() {
                function e(e, t) {
                    var n = this;
                    if (this.CLOSED = 3, this.CLOSING = 2, this.OPEN = 1, this.CONNECTING = 0, t) throw new Error("Passing protocols is not implemented");
                    var i = a(e),
                        s = i.uri,
                        l = i.path;
                    this.onopen = null, this.onclose = null, this.onmessage = null, this.onerror = null, this.eioSocket = o(s, {
                        path: l,
                        transports: ["polling"]
                    }), this.url = e, this.extensions = "", this.protocol = "", this.bufferedAmount = 0, this.readyState = 0, this.incomingSequence = 0, this.outOfOrderQueue = {}, this.outgoingSequence = 0, this.setReadyState(), this.eioSocket.on("open", (function() {
                        ...
                        if (n.setReadyState(), null != n.onclose) {
                            var t = (o = {
                                ...
                                code: 1001,
                                wasClean: !1
                            }, "undefined" !== typeof window ? new CloseEvent("close", o) : r({
                                type: "close"
                            }, o));
                            n.onclose.call(n, t)
                        }
                        ...
                        if (n.setReadyState(), null != n.onmessage) {
                            if ("string" === typeof e) throw new Error("expected data to be ArrayBuffer not string");
                            ...
                            if (n.incomingSequence === t) {
                                ...
                                a.length > 0 && (a.sort().forEach((function(e) {
                                    i(c(n.outOfOrderQueue[+e])), n.incomingSequence = +e + 1
                                })), n.outOfOrderQueue = {})
                ...
                return e.prototype.setReadyState = function() {
                    ...
                    new Uint8Array(t).set(new Uint8Array(e), 4), new DataView(t).setUint32(0, this.outgoingSequence), this.outgoingSequence += 1, this.eioSocket.send(t), this.setReadyState()
                }, e.prototype.close = function() {
                    this.onmessage = null, this.eioSocket.close(), this.setReadyState()
                    ...
                    enumerable: !1,
                    configurable: !0
                }), e.CLOSED = 3, e.CLOSING = 2, e.OPEN = 1, e.CONNECTING = 0, e
            }();
            t.EIOCompat = l
        },
        F40I: function(e, t) {
        ...
        HADy: function(e, t, n) {
            ...
            n.d(t, "a", (function() {
                ...
                function(e) {
                    e.OFFLINE = "OFFLINE", e.IDLE = "IDLE", e.RUNNING = "RUNNING", e.STOPPING = "STOPPING"
                }(o || (o = {}))
        },
        Hc0W: function(e, t, n) {
            function r(e) {
        ...
        IUvJ: function(e, t, n) {
                ...
                return (A = Object(a.a)(o.a.mark((function e(t) {
                    return o.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            ...
                            case 4:
                                return e.next = 6, Promise.all([d("serif", t), d("sans-serif", t), d("monospace", t)]);
                            case 6:
                            case "end":
                                return e.stop()
                        }
            ...
            function f() {
                return (f = Object(a.a)(o.a.mark((function e(t, n) {
                    var r, i, a, s, l, A;
                    return o.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return r = n.fontInfo, i = n.characters, a = void 0 === i ? c : i, s = n.timeout, l = void 0 === s ? u : s, A = h(r), e.abrupt("return", new Promise((function(e, n) {
                                    var r = !1,
                                        o = setTimeout((function() {
                                            r = !0, n(new Error("Font loading timed out"))
                                        }), l);
                                    t.load(A, a).then((function() {
                                        r || (clearTimeout(o), e())
                                    })).catch((function(e) {
            ...
            function b() {
                return (b = Object(a.a)(o.a.mark((function e(t, n) {
                    var r, i, a, s, l, A, p, f, d;
                    return o.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                if (r = n.fontInfo, i = n.characters, a = void 0 === i ? c : i, s = n.timeout, l = void 0 === s ? u : s, A = h(r), (p = document.createElement("span")).innerText = a, p.style.font = "normal normal 100px ".concat(t), p.style.position = "absolute", p.style.left = "-9999px", p.style.top = "-9999px", document.body.appendChild(p), f = p.offsetWidth, p.style.font = A, !(d = function() {
                            ...
                            case 14:
                                return e.abrupt("return", new Promise((function(e, t) {
                                    var n = setInterval((function() {
                                            d() && (clearInterval(n), clearTimeout(o), document.body.removeChild(p), e())
                                        }), 50),
                                        o = setTimeout((function() {
                                            clearInterval(n), document.body.removeChild(p), d() ? e() : t(new Error("Font loading timed out " + r.family))
                                        }), l)
                                })));
                            case 15:
                            case "end":
            ...
            function E() {
                return (E = Object(a.a)(o.a.mark((function e(t) {
                    var r, a, s, c, u, A, h, p, f, d, b, w, E, O, k, x, B, N, T, P, R;
                    return o.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return r = t.loadFileParserAddon, a = t.onFileLinkClick, s = t.listFiles, c = t.replSlug, u = t.flagRuiTokenUpdate, S(), A = Promise.all([l({
                                    fontInfo: {
                                        family: "replit-icons"
                                    },
                                    characters: C
                                ...
                                }).catch(m)]), e.next = 5, Promise.all([n.e(349).then(n.t.bind(null, "/POA", 7)).then((function(e) {
                                    return e
                                })), n.e(345).then(n.t.bind(null, "R9As", 7)).then((function(e) {
                                    return e
                                })), n.e(346).then(n.t.bind(null, "0fl0", 7)).then((function(e) {
                                    return e
                                })), n.e(348).then(n.t.bind(null, "QIth", 7)).then((function(e) {
                                    return e
                                })), n.e(347).then(n.t.bind(null, "wpcW", 7)).then((function(e) {
                                    return e
                                })), n.e(343).then(n.bind(null, "Po+R")).then((function(e) {
                                    return e
                                })), A]);
                            case 5:
                                return h = e.sent, p = Object(i.a)(h, 6), f = p[0].Terminal, d = p[1].FitAddon, b = p[2].SearchAddon, w = p[3].WebLinksAddon, E = p[4].Unicode11Addon, O = p[5].FileParserAddon, k = {
                                    cursorBlink: !1,
                                    scrollback: 1e3,
                                    tabStopWidth: 4,
                                    fontFamily: '"IBM Plex Mono", replit-icons, Monaco, "Ubuntu Mono", Consolas, monospace',
                                    fontSize: 14,
                                    lineHeight: 1,
                                    fontWeight: g,
                                    fontWeightBold: v,
                                ...
                                }, x = new f(k), r && a && s && c && (B = new O(a, s, c), x.loadAddon(B)), N = new d, x.loadAddon(N), T = new w, x.loadAddon(T), P = new b, x.loadAddon(P), R = new E, x.loadAddon(R), x.unicode.activeVersion = "11", e.abrupt("return", {
                                    xterm: x,
                                    fitAddon: N,
                                    searchAddon: P
                                });
        ...
        NlaV: function(e, t, n) {
            ...
            t.encodePacket = function(e, n, r, o) {
                ...
                if ("undefined" !== typeof d && i instanceof d) return function(e, n, r) {
                    if (!n) return t.encodeBase64Packet(e, r);
                    if (A) return function(e, n, r) {
                        if (!n) return t.encodeBase64Packet(e, r);
                ...
                var o = i(e);
                if (n && o) return d && !A ? t.encodePayloadAsBlob(e, r) : t.encodePayloadAsArrayBuffer(e, r);
                ...
                for (var i, a, s = "", c = 0, u = e.length; c < u; c++) {
                    ...
                    if (":" === l) {
                        ...
                        if (a.length) {
                            if (o = t.decodePacket(a, n, !1), f.type === o.type && f.data === o.data) return r(f, 0, 1);
        ...
        O9If: function(e, t, n) {
            ...
            function o(e) {
                return ("object" === typeof e || "function" === typeof e) && (!!e && ("OPEN" in e && 1 === e.OPEN))
            }
            t.getNextRetryDelay = function(e) {
                ...
                if (e) {
                    if (!o(e)) throw new Error("Passed in WebSocket does not look like a standard WebSocket");
                    return e
                }
                if ("undefined" !== typeof WebSocket) {
                    if (!o(WebSocket)) throw new Error("Global WebSocket does not look like a standard WebSocket");
                    return WebSocket
                }
                throw new Error("Please pass in a WebSocket class or add it to global")
            }, t.getConnectionStr = function(e, t) {
                var n = r.parse(e.gurl);
                return t ? (n.hostname = "gp-v2.herokuapp.com", n.host = "gp-v2.herokuapp.com", n.pathname = "/wsv2/" + e.token + "/" + encodeURIComponent(e.gurl)) : n.pathname = "/wsv2/" + e.token, r.format(n)
            }
        },
        ONZI: function(e, t, n) {
            function r(e) {
            ...
            function o() {
                ...
                return !1
            }, t.humanize = n("FGiv"), t.instances = [], t.names = [], t.skips = [], t.formatters = {}
        },
        "Omg+": function(e, t) {
        ...
        P2Oe: function(e, t, n) {
            ...
            (function(e, r) {
                ...
                function A(e) {
                    var t = e.split(".");
                    if (4 !== t.length) throw new Error("Invalid token: should have exactly 4 parts: " + e);
                    for (var n = t[2].replace(/-/g, "+").replace(/_/g, "/"); n.length % 4;) n += "=";
                    var o = window.atob(n);
                    if (o.length < 64) throw new Error("Invalid token: signed part is too short: " + o.length);
                ...
                function h(e) {
                    var t = A(e).repl,
                        ...
                        o = t.id,
                        i = "".concat(r, "--").concat(n);
                    return i.length > 63 && (i = "".concat(o, ".id")), -1 !== l.indexOf("repl.localhost:8080") ? "ws://".concat(i, ".").concat(l) : "wss://".concat(i, ".").concat(l)
                }

                function p(e) {
                    var t = e.language;
                    return c.a.usesInterpreter(t) || c.a.usesRunProject(t) || !c.a.usesEval(t) ? {
                        name: "shellrunner",
                        service: "shellrun2"
                    } : {
                        name: "evaler",
                ...
                function b() {
                    return (b = Object(a.a)(i.a.mark((function e(t, n) {
            ...
            var i = n("5+mB"),
                a = function(e) {
                    ...
                    this.onCommand = function(e) {
                        if ("closed" === t.status) {
                            var n = new Error("Trying to listen to commands on a closed channel");
                            throw t.onUnrecoverableError(n), n
                        }
                        return t.onCommandListeners.push(e),
                            function() {
                                t.onCommandListeners = t.onCommandListeners.filter((function(t) {
                                    return t !== e
                                }))
                            }
                        ...
                        if ("closing" === t.status) throw n = new Error("Cannot send any more commands after a close request"), t.onUnrecoverableError(n), n;
                        e.channel = t.id, t.sendToContainer(i.api.Command.create(e))
                    }, this.request = function(e) {
                        return r(t, void 0, void 0, (function() {
                            var t, n = this;
                            return o(this, (function(r) {
                                return t = Number(Math.random().toString().split(".")[1]).toString(36), e.ref = t, [2, new Promise((function(r, o) {
                                    n.requestMap[t] = r;
                                    try {
                                        n.send(e)
                                    } catch (i) {
                        ...
                        t.onCommandListeners.forEach((function(t) {
                            return t(e)
                        })), e.ref && t.requestMap[e.ref] && (t.requestMap[e.ref](e), delete t.requestMap[e.ref])
        ...
        "WP+z": function(e, t, n) {
            ...
            Object.defineProperty(t, "__esModule", {
                ...
                function(e) {
                    e[e.CONNECTING = 0] = "CONNECTING", e[e.CONNECTED = 1] = "CONNECTED", e[e.DISCONNECTED = 2] = "DISCONNECTED"
                }(t.ConnectionState || (t.ConnectionState = {})),
                function(e) {
                    e.Aborted = "Aborted", e.Retriable = "Retriable"
                }(t.FetchConnectionMetadataError || (t.FetchConnectionMetadataError = {}))
        },
        ZAXB: function(e, t) {
            t.encode = function(e) {
                var t = "";
                ...
                void 0 === (i = "function" === typeof(o = function() {
                    ...
                    var p = function() {
                        ...
                        f = function(t) {
                            ...
                            function a() {
                                var t;
                                return e(this, a), (t = r.call(this)).listeners || p.call(c(t)), Object.defineProperty(c(t), "aborted", {
                                    value: !1,
                                    writable: !0,
                                    configurable: !0
                            ...
                            return n(a, [{
                                ...
                                key: "dispatchEvent",
                                value: function(e) {
                                    "abort" === e.type && (this.aborted = !0, "function" === typeof this.onabort && this.onabort.call(this, e)), h(i(a.prototype), "dispatchEvent", this).call(this, e)
                                }
                            }]), a
                        }(p),
                        d = function() {
        ...
        f3xt: function(e, t, n) {
            ...
            (function(e) {
                ...
                function g() {
                    return (g = Object(a.a)(o.a.mark((function e(t) {
                        var n, r, i, a, h, f, g, v, m, C, w, E;
                        return o.a.wrap((function(e) {
                            for (;;) switch (e.prev = e.next) {
                                case 0:
                                    if (n = t.replId, r = t.isLoggedIn, i = t.overrideClusterMetadata, a = t.retry, h = t.asViewer, c.a) {
                                        e.next = 3;
                                        break
                                    }
                                ...
                                case 3:
                                    ...
                                    }, g = Boolean(p.a.query.lite || p.a.query.embed), v = {
                                        url: "/data/repls/".concat(n, "/get_connection_metadata"),
                                ...
                                case 8:
                                    if (m = e.sent, C = m.data, w = Boolean(C.shouldBypassCaptcha), !(r || g && !b || w)) {
                                        e.next = 13;
                                        break
                                    }
                                ...
                                case 16:
                                    return E = e.sent, e.abrupt("return", Object(l.a)(d(d({}, v), {}, {
                                        captcha: E
                                    })));
                                case 20:
                                    return e.prev = 20, e.t0 = e.catch(13), f(e.t0), e.abrupt("return", y({
                                        replId: n,
                                        overrideClusterMetadata: i,
                                        retry: (a || 0) + 1,
                                        isLoggedIn: r
        ...
        fA4Q: function(e, t, n) {
            ...
            function A() {
                return (A = Object(a.a)(o.a.mark((function e(t) {
                    ...
                    return o.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return n = t.client, r = t.args, i = t.env, e.abrupt("return", new Promise((function(e) {
                                    var t = n.openChannel({
                                        service: "exec"
                                    }, (function(n) {
                                        var o = n.error,
            ...
            function v() {
                return (v = Object(a.a)(o.a.mark((function e(t) {
                    var n;
                    return o.a.wrap((function(e) {
                        for (;;) switch (e.prev = e.next) {
                            case 0:
                                return n = t.client, e.abrupt("return", new Promise((function(e) {
                                    var t = n.openChannel({
                                        service: "dotreplit"
                                    }, (function(n) {
                                        var r = n.error,
                                        ...
                                        if (r) e({
                                            ...
                                            o.request({
                                                ...
                                                var r;
                                                if (n.channelClosed) e({
                                                    error: "Channel closed",
                                                    dotReplit: null
                                                });
                                                else if ("open" === o.status && t(), n.error) e({
                                                    error: n.error,
                                                    dotReplit: null
                                                });
                                                else {
                                                    var i = null === (r = n.dotReplitGetResponse) || void 0 === r ? void 0 : r.dotReplit;
                                                    e(i ? {
                                                        dotReplit: i,
                                                        error: null
                                                    } : {
            ...
            function E(e) {
                ...
                return m && v.addDebugFunc((function(e) {
                    "log" === e.type && console.log("in" === e.log.direction ? "--\x3e" : "<--", e.log.cmd)
                })), {
                    onPortOpened: function(e) {
                        return n.on(w.PORT_OPEN, e),
                            function() {
                                n.removeListener(w.PORT_OPEN, e)
                            }
                    },
                    onConnectionStateChanged: function(e) {
                        return n.on(w.CONNECTION_STATE_CHANGE, e),
                            function() {
                    ...
                    connect: function(e) {
                        var l = e.context,
                            ...
                            E = Object(s.a)(e, ["context", "overrideClusterMetadata", "customConnectionMetadata", "fetchConnectionMetadataExtras"]);
                        ...
                        var O = null,
                            S = {
                                ...
                                fetchConnectionMetadata: function() {
                                    var e = Object(a.a)(o.a.mark((function e(t) {
                                        var n;
                                        return o.a.wrap((function(e) {
                                            for (;;) switch (e.prev = e.next) {
                                                case 0:
                                                ...
                                                case 4:
                                                    ...
                                                    return O = d.token, e.abrupt("return", C(C({}, d), {}, {
                                                        error: null
                                                    }));
                                                case 7:
                                                    if (e.prev = 7, !E.fetchConnectionMetadata) {
                                                        e.next = 14;
                                                        break
                                                    }
                                                    return e.next = 11, E.fetchConnectionMetadata();
                                                case 11:
                                                    n = e.sent, e.next = 17;
                                                    break;
                                                case 14:
                                                    return e.next = 16, Object(p.a)(C({
                                                        asViewer: l.asViewer,
                                                        replId: l.repl.id,
                                                ...
                                                case 17:
                                                    ...
                                                    break;
                                                case 19:
                                                    e.prev = 19, e.t0 = e.catch(7), e.t1 = e.t0 && e.t0.statusCode, e.next = 400 === e.t1 || 408 === e.t1 || 409 === e.t1 || 429 === e.t1 || 500 === e.t1 || 502 === e.t1 || 503 === e.t1 || 504 === e.t1 ? 24 : 25;
                                                    break;
                                                case 24:
                                                    return e.abrupt("return", {
                                                        error: c.FetchConnectionMetadataError.Retriable
                                                    });
                                                case 25:
                                                    throw e.t0;
                                                case 26:
                                                ...
                                                case 28:
                                                    return m && console.log("connecting", n), e.abrupt("return", C(C({}, n), {}, {
                                                        error: null
                                                    }));
                                                case 30:
                                                case "end":
                        ...
                        v.open(S, (function(e) {
                            ...
                            if (e.error) return A(h.DISCONNECTED),
                                function() {};
                            if (!o) throw new Error("Expected channel");
                            m && console.log("connected", {
                                replId: l.repl.id
                            });
                            var i = o.onCommand((function(e) {
                                switch (e.body) {
                                    case "portOpen":
                                        if (!e.portOpen) throw new Error("portOpen only handles portOpen commands");
                                    ...
                                    case "protocolError":
                                        var o, i;
                                        t(new y.a("goval panic").setExtra("message", null !== (o = null === (i = e.protocolError) || void 0 === i ? void 0 : i.text) && void 0 !== o ? o : "protocol error"))
                                }
                            }));
                            window.v6ws = v.ws;
                            var a = l.repl,
                    ...
                    openChannel: function(e, n) {
                        ...
                        return v.openChannel(e, (function(e) {
                            ...
                            Object(u.track)(u.events.OPEN_CHANNEL_CALLBACK_CALLED, {
                                ...
                                language: null === (l = r) || void 0 === l ? void 0 : l.repl.language,
                            ...
                            var p = null === e || void 0 === e || null === (h = e.channel) || void 0 === h ? void 0 : h.onCommand((function(e) {
                                    var n, r;
                                    "protocolError" === e.body && t(new y.a("goval panic").setExtra("message", null !== (n = null === (r = e.protocolError) || void 0 === r ? void 0 : r.text) && void 0 !== n ? n : "protocol error"))
                                })),
                                f = n(e);
                            return function(e) {
                    ...
                    exec: function() {
                        var e = Object(a.a)(o.a.mark((function e() {
                            ...
                            return o.a.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        for (t = i.length, n = new Array(t), r = 0; r < t; r++) n[r] = i[r];
                    ...
                    execWithEnv: function() {
                        var e = Object(a.a)(o.a.mark((function e(t) {
                            ...
                            return o.a.wrap((function(e) {
                                for (;;) switch (e.prev = e.next) {
                                    case 0:
                                        for (n = a.length, r = new Array(n > 1 ? n - 1 : 0), i = 1; i < n; i++) r[i - 1] = a[i];
                                        return e.abrupt("return", l({
                                            client: v,
                                            args: r,
                                            env: t
                    ...
                    getVncUrl: function() {
                        ...
                        if (!e || i !== h.CONNECTED) throw new Error("Cannot get vnc url when container is not connected");
                        return Object(d.c)(e.token)
                    },
                    unrecoverableError: function(e, r) {
                        v.destroy(), n.removeAllListeners(), t(r ? y.a.wrap(e).setExtras(r) : e)
                    }
                }
            }! function(e) {
                e.CONNECTION_STATE_CHANGE = "CONNECTION_STATE_CHANGE", e.PORT_OPEN = "PORT_OPEN"
            }(w || (w = {}))
        },
        lIbH: function(e, t, n) {
            var r = n("FmCS"),
            ...
            e.exports = l, l.priorWebsocketSuccess = !1, o(l.prototype), l.protocol = s.protocol, l.Socket = l, l.Transport = n("1swB"), l.transports = n("FmCS"), l.parser = n("NlaV"), l.prototype.createTransport = function(e) {
                ...
                function h() {
                    t.removeListener("open", o), t.removeListener("error", s), t.removeListener("close", c), r.removeListener("close", u), r.removeListener("upgrading", A)
                }
                l.priorWebsocketSuccess = !1, t.once("open", o), t.once("error", s), t.once("close", c), this.once("close", u), this.once("upgrading", A), t.open()
            ...
            ! function(e) {
                ...
                t.encode = function(t) {
                    ...
                    var l = new ArrayBuffer(s),
                        A = new Uint8Array(l);
                    for (n = 0; n < c; n += 4) r = e.indexOf(t[n]), o = e.indexOf(t[n + 1]), i = e.indexOf(t[n + 2]), a = e.indexOf(t[n + 3]), A[u++] = r << 2 | o >> 4, A[u++] = (15 & o) << 4 | i >> 2, A[u++] = (3 & i) << 6 | 63 & a;
                    return l
                }
                            ...
                            case 4:
                                return e.abrupt("return", new Promise((function(e) {
                                    document.addEventListener("visibilitychange", (function t() {
                                        document.hidden || (document.removeEventListener("visibilitychange", t), e())
                                    }))
                                })));
                            case 5:
                            case "end":
