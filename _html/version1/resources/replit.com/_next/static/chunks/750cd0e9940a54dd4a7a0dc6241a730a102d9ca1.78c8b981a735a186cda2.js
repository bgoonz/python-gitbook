            ...
            (function(t) {
                ...
                class h {
                    constructor(t, e, s, i, r, h, n, o, a, l = 0, c) {
                        this.p = t, this.stack = e, this.state = s, this.reducePos = i, this.pos = r, this.score = h, this.buffer = n, this.bufferBase = o, this.curContext = a, this.lookAhead = l, this.parent = c
                    }
                    toString() {
                    ...
                    static start(t, e, s = 0) {
                        ...
                        return new h(t, [], e, s, s, 0, [], 0, i ? new n(i, i.start) : null, 0, null)
                    }
                    get context() {
                    ...
                    reduce(t) {
                        ...
                        if (r && (this.score += r), 0 == e) return s < i.minRepeatTerm && this.storeNode(s, this.reducePos, this.reducePos, 4, !0), this.pushState(i.getGoto(this.state, s, !0), this.reducePos), void this.reduceContext(s, this.reducePos);
                    ...
                    storeNode(t, e, s, i = 4, r = !1) {
                        ...
                        if (r && this.pos != s) {
                            ...
                            if (r > 0 && 0 != this.buffer[r - 4])
                                for (; r > 0 && this.buffer[r - 2] > s;) this.buffer[r] = this.buffer[r - 4], this.buffer[r + 1] = this.buffer[r - 3], this.buffer[r + 2] = this.buffer[r - 2], this.buffer[r + 3] = this.buffer[r - 1], r -= 4, i > 4 && (i -= 4);
                    ...
                    shift(t, e, s) {
                        ...
                        if (131072 & t) this.pushState(65535 & t, this.pos);
                            ...
                            (s > this.pos || e <= h.maxNode) && (this.pos = s, h.stateFlag(r, 1) || (this.reducePos = s)), this.pushState(r, i), this.shiftContext(e, i), e <= h.maxNode && this.buffer.push(e, i, s, 4)
                    ...
                    split() {
                        ...
                        return new h(this.p, this.stack.slice(), this.state, this.reducePos, this.pos, this.score, s, i, this.curContext, this.lookAhead, t)
                    }
                    recoverByDelete(t, e) {
                    ...
                    recoverByInsert(t) {
                        ...
                        for (let i = 0; i < e.length && s.length < 4; i += 2) {
                            ...
                            let r = this.split();
                            r.storeNode(0, r.pos, r.pos, 4, !0), r.pushState(t, this.pos), r.shiftContext(e[i], this.pos), r.score -= 200, s.push(r)
                        }
                        return s
                    }
                    forceReduce() {
                        let t = this.p.parser.stateSlot(this.state, 5);
                        return 0 != (65536 & t) && (this.p.parser.validAction(this.state, t) || (this.storeNode(0, this.reducePos, this.reducePos, 4, !0), this.score -= 100), this.reduce(t), !0)
                    }
                    forceAll() {
                        for (; !this.p.parser.stateFlag(this.state, 2) && this.forceReduce(););
                        return this
                    }
                    get deadEnd() {
                ...
                class a {
                    constructor(t, e, s) {
                        this.stack = t, this.pos = e, this.index = s, this.buffer = t.buffer, 0 == this.index && this.maybeNext()
                    }
                ...
                class u {
                    ...
                    peek(t) {
                        ...
                        if (i >= 0 && i < this.chunk.length) e = this.pos + t, s = this.chunk.charCodeAt(i);
                            ...
                            if (e = i, e >= this.chunk2Pos && e < this.chunk2Pos + this.chunk2.length) s = this.chunk2.charCodeAt(e - this.chunk2Pos);
                                ...
                                this.chunk2 = this.input.chunk(this.chunk2Pos = e), e + this.chunk2.length > i.to && (this.chunk2 = this.chunk2.slice(0, i.to - e)), s = this.chunk2.charCodeAt(0)
                            }
                        }
                    ...
                    advance(t = 1) {
                        ...
                        return this.pos += t, this.pos > this.token.lookAhead && (this.token.lookAhead = this.pos), this.readNext()
                    }
                    setDone() {
                        return this.pos = this.chunkPos = this.end, this.range = this.ranges[this.rangeIndex = this.ranges.length - 1], this.chunk = "", this.next = -1
                    }
                    reset(t, e) {
                        if (e ? (this.token = e, e.start = e.lookAhead = t, e.value = e.extended = -1) : this.token = c, this.pos != t) {
                        ...
                        ! function(t, e, s, i) {
                            ...
                            t: for (; 0 != (h & t[r]);) {
                                ...
                                for (let i = r + 3; i < s; i += 2)
                                    if ((t[i + 1] & h) > 0) {
                                        let s = t[i];
                                        if (o.allows(s) && (-1 == e.token.value || e.token.value == s || n.overrides(s, e.token.value))) {
                                            e.acceptToken(s);
                                            break
                                        }
                                    }
                ...
                function x(t, e, s) {
                    ...
                    for (i.moveTo(e);;)
                        if (!(s < 0 ? i.childBefore(e) : i.childAfter(e)))
                            for (;;) {
                                if ((s < 0 ? i.to < e : i.from > e) && !i.type.isError) return s < 0 ? Math.max(0, Math.min(i.to - 1, e - 25)) : Math.min(t.length, Math.max(i.from + 1, e + 25));
                ...
                class b {
                    ...
                    nextFragment() {
                        ...
                        if (t) {
                            for (this.safeFrom = t.openStart ? x(t.tree, t.from + t.offset, 1) - t.offset : t.from, this.safeTo = t.openEnd ? x(t.tree, t.to + t.offset, -1) - t.offset : t.to; this.trees.length;) this.trees.pop(), this.start.pop(), this.index.pop();
                    ...
                    nodeAt(t) {
                        ...
                        for (;;) {
                            ...
                            if (h instanceof r.f) {
                                ...
                                this.index[e]++, n + h.length >= Math.max(this.safeFrom, t) && (this.trees.push(h), this.start.push(n), this.index.push(0))
                ...
                class P {
                    constructor(t, e) {
                        this.stream = e, this.tokens = [], this.mainToken = v, this.actions = [], this.tokens = t.tokenizers.map((t => new l))
                    }
                    getActions(t) {
                        let e = 0,
                            s = null,
                        ...
                        for (let a = 0; a < r.length; a++) {
                            ...
                            let i = r[a],
                                l = this.tokens[a];
                            if ((!s || i.fallback) && ((i.contextual || l.start != t.pos || l.mask != h || l.context != n) && (this.updateCachedToken(l, i, t), l.mask = h, l.context = n), l.lookAhead > l.end + 25 && (o = Math.max(l.lookAhead, o)), 0 != l.value)) {
                                let r = e;
                                if (l.extended > -1 && (e = this.addActions(t, l.extended, l.end, e)), e = this.addActions(t, l.value, l.end, e), !i.extend && (s = l, e > r)) break
                            }
                        }
                        for (; this.actions.length > e;) this.actions.pop();
                        return o && t.setLookAhead(o), s || (s = v, s.start = t.pos, t.pos == this.stream.end ? (s.value = t.p.parser.eofTerm, s.end = t.pos, e = this.addActions(t, s.value, s.end, e)) : (s.value = 0, s.end = t.pos + 1)), this.mainToken = s, this.actions
                    }
                        ...
                        if (e.token(this.stream.reset(s.pos, t), s), t.value > -1) {
                            ...
                            for (let i = 0; i < e.specialized.length; i++)
                                if (e.specialized[i] == t.value) {
                                    let r = e.specializers[i](this.stream.read(t.start, t.end), s);
                    ...
                    addActions(t, e, s, i) {
                        ...
                        for (let o = 0; o < 2; o++)
                            for (let t = h.stateSlot(r, o ? 2 : 1);; t += 3) {
                                if (65535 == n[t]) {
                                    if (1 != n[t + 1]) {
                                        0 == i && 2 == n[t + 1] && (i = this.putAction(D(n, t + 1), e, s, i));
                                        break
                                    }
                                    t = D(n, t + 2)
                                }
                ...
                var S;
                ! function(t) {
                    t[t.Distance = 5] = "Distance", t[t.MaxRemainingPerStep = 3] = "MaxRemainingPerStep", t[t.MinBufferLengthPrune = 200] = "MinBufferLengthPrune", t[t.ForceReduceLimit = 10] = "ForceReduceLimit"
                }(S || (S = {}));
                class A {
                    constructor(t, e, s, i) {
                        this.parser = t, this.input = e, this.ranges = i, this.recovering = 0, this.nextStackID = 9812, this.minStackPos = 0, this.reused = [], this.stoppedAt = null, this.stream = new u(e, i), this.tokens = new P(t, this.stream), this.topTerm = t.top[1];
                        let {
                            from: r
                        } = i[0];
                        this.stacks = [h.start(this, t.top[0], r)], this.fragments = s.length && this.stream.end - r > 4 * t.bufferLength ? new b(s, t.nodeSet) : null
                    }
                    get parsedPos() {
                        return this.minStackPos
                    }
                    advance() {
                        let t, e, s = this.stacks,
                            i = this.minStackPos,
                            r = this.stacks = [];
                        ...
                        if (!r.length) {
                            let e = t && function(t) {
                                ...
                                for (let s of t) {
                                    let t = s.p.stoppedAt;
                                    (s.pos == s.p.stream.end || null != t && s.pos > t) && s.p.parser.stateFlag(s.state, 2) && (!e || e.score < s.score) && (e = s)
                                }
                                return e
                            }(t);
                            if (e) return this.stackToTree(e);
                            if (this.parser.strict) throw k && t && console.log("Stuck with token " + this.parser.getName(this.tokens.mainToken.value)), new SyntaxError("No parse at " + i);
                        ...
                        } else if (r.length > 1) t: for (let h = 0; h < r.length - 1; h++) {
                            let t = r[h];
                            for (let e = h + 1; e < r.length; e++) {
                                let s = r[e];
                                if (t.sameState(s) || t.buffer.length > 200 && s.buffer.length > 200) {
                                    if (!((t.score - s.score || t.buffer.length - s.buffer.length) > 0)) {
                                        r.splice(h--, 1);
                                        continue t
                                    }
                                    r.splice(e--, 1)
                        ...
                        for (let h = 1; h < r.length; h++) r[h].pos < this.minStackPos && (this.minStackPos = r[h].pos);
                        return null
                    }
                    stopAt(t) {
                    ...
                    advanceStack(t, e, s) {
                        ...
                        if (this.fragments) {
                            ...
                            for (let o = this.fragments.nodeAt(i); o;) {
                                let i = this.parser.nodeSet.types[o.type.id] == o.type ? h.getGoto(t.state, o.type.id) : -1;
                                if (i > -1 && o.length && (!e || (o.prop(r.b.contextHash) || 0) == s)) return t.useNode(o, i), k && console.log(n + this.stackID(t) + ` (via reuse of ${h.getName(o.type.id)})`), !0;
                                if (!(o instanceof r.f) || 0 == o.children.length || o.positions[0] > 0) break;
                                let a = o.children[0];
                        ...
                        if (o > 0) return t.reduce(o), k && console.log(n + this.stackID(t) + ` (via always-reduce ${h.getName(65535&o)})`), !0;
                        ...
                        for (let r = 0; r < a.length;) {
                            let o = a[r++],
                                ...
                                u = r == a.length || !s,
                                f = u ? t : t.split();
                            if (f.apply(o, l, c), k && console.log(n + this.stackID(f) + ` (via ${0==(65536&o)?"shift":`reduce of ${h.getName(65535&o)}`} for ${h.getName(l)} @ ${i}${f==t?"":", split"})`), u) return !0;
                    ...
                    runRecovery(t, e, s) {
                        ...
                        for (let h = 0; h < t.length; h++) {
                            ...
                            if (n.deadEnd) {
                                if (r) continue;
                                if (r = !0, n.restart(), k && console.log(l + this.stackID(n) + " (restarted)"), this.advanceFully(n, s)) continue
                            }
                            let c = n.split(),
                                u = l;
                            for (let t = 0; c.forceReduce() && t < 10; t++) {
                                if (k && console.log(u + this.stackID(c) + " (via force-reduce)"), this.advanceFully(c, s)) break;
                                k && (u = this.stackID(c) + " -> ")
                            }
                            for (let t of n.recoverByInsert(o)) k && console.log(l + this.stackID(t) + " (via recover-insert)"), this.advanceFully(t, s);
                            this.stream.end > n.pos ? (a == n.pos && (a++, o = 0), n.recoverByDelete(o, a), k && console.log(l + this.stackID(n) + ` (via recover-delete ${this.parser.getName(o)})`), C(n, s)) : (!i || i.score < n.score) && (i = n)
                        }
                        return i
                    }
                    stackToTree(t) {
                        return t.close(), r.f.build({
                            buffer: a.create(t),
                    ...
                    stackID(t) {
                        ...
                        return e || g.set(t, e = String.fromCodePoint(this.nextStackID++)), e + t
                    }
                }
                ...
                function C(t, e) {
                    for (let s = 0; s < e.length; s++) {
                        let i = e[s];
                        if (i.pos == t.pos && i.sameState(t)) return void(e[s].score < t.score && (e[s] = t))
                    }
                    e.push(t)
                }
                class w {
                ...
                class N {
                    constructor(t) {
                        this.start = t.start, this.shift = t.shift || y, this.reduce = t.reduce || y, this.reuse = t.reuse || y, this.hash = t.hash || (() => 0), this.strict = !1 !== t.strict
                    }
                }
                class T extends r.e {
                    constructor(t) {
                        if (super(), this.wrappers = [], 13 != t.version) throw new RangeError(`Parser version (${t.version}) doesn't match runtime version (13)`);
                        ...
                        this.nodeSet = new r.c(e.map(((e, h) => r.d.define({
                        ...
                        })))), this.strict = !1, this.bufferLength = r.a;
                        let n = d(t.tokenData);
                        if (this.context = t.context, this.specialized = new Uint16Array(t.specialized ? t.specialized.length : 0), this.specializers = [], t.specialized)
                            for (let r = 0; r < t.specialized.length; r++) this.specialized[r] = t.specialized[r].term, this.specializers[r] = t.specialized[r].get;
                        this.states = d(t.states, Uint32Array), this.data = d(t.stateData), this.goto = d(t.goto), this.maxTerm = t.maxTerm, this.tokenizers = t.tokenizers.map((t => "number" == typeof t ? new f(n, t) : t)), this.topRules = t.topRules, this.dialects = t.dialects || {}, this.dynamicPrecedences = t.dynamicPrecedences || null, this.tokenPrecTable = t.tokenPrec, this.termNames = t.termNames || null, this.maxNode = this.nodeSet.types.length - 1, this.dialect = this.parseDialect(), this.top = this.topRules[Object.keys(this.topRules)[0]]
                    }
                    createParse(t, e, s) {
                    ...
                    parseDialect(t) {
                        ...
                        for (let r = 0; r < e.length; r++)
                            if (!s[r])
                                for (let t, s = this.dialects[e[r]]; 65535 != (t = this.data[s++]);)(i || (i = new Uint8Array(this.maxTerm + 1)))[t] = 1;
                        return new w(t, s, i)
                    }
