                ...
                return function(t, n, e) {
                    ...
                    var r = "OverlayScrollbars",
                        ...
                        f = function() {
                            ...
                            function m() {
                                ...
                                for (p(l) == i.b && (d = l, l = arguments[1] || {}, f = 2), p(l) != i.o && !p(l) == i.f && (l = {}), h === f && (l = T, --f); f < h; f++)
                                    if (null != (c = arguments[f]))
                                        for (a in c) t = l[a], l !== (r = c[a]) && (d && r && (x(r) || (n = s.isA(r))) ? (n ? (n = !1, u = t && s.isA(t) ? t : []) : u = t && x(t) ? t : {}, l[a] = m(d, u, r)) : r !== e && (l[a] = r));
                                return l
                            }
                            ...
                            function E(t, n) {
                                var e, r;
                                !1 !== n && t.q.splice(0, 1), t.q[o.l] > 0 ? (r = t.q[0], P(t.el, r.props, r.duration, r.easing, r.complete, !0)) : (e = _(t, d)) > -1 && d.splice(e, 1)
                            }
                            ...
                            function P(t, n, r, i, a, u) {
                                var p, v, m, w, g, O, S = x(r),
                                    C = {},
                                    A = {},
                                    z = 0;
                                for (S ? (i = r.easing, r.start, m = r.progress, w = r.step, g = r.specialEasing, a = r.complete, O = r.duration) : O = r, g = g || {}, O = O || 400, i = i || "swing", u = u || !1; z < d[o.l]; z++)
                                    if (d[z].el === t) {
                                        v = d[z];
                                        break
                                    }
                                ...
                                if (b(A)) u && E(v);
                                    ...
                                    var P, L, k, W, I, N, R, j, D, q = u ? 0 : _(F, v.q),
                                        F = {
                                            props: A,
                                            duration: S ? r : O,
                                            easing: i,
                                    ...
                                    if (-1 === q && (q = v.q[o.l], v.q.push(F)), 0 === q)
                                        if (O > 0) R = s.now(), j = function() {
                                            for (p in P = s.now(), D = P - R, L = F.stop || D >= O, k = 1 - (c.max(0, R + O - P) / O || 0), A) W = parseFloat(C[p]), I = parseFloat(A[p]), N = (I - W) * l[g[p] || i](k, k * O, 0, 1, O) + W, H(t, p, N), y(w) && w(N, {
                                                elem: t,
                                                prop: p,
                                                start: W,
                                                now: N,
                                            ...
                                            y(m) && m({}, k, c.max(0, O - D)), L ? (E(v), y(a) && a()) : F.frame = s.rAF()(j)
                                        }, F.frame = s.rAF()(j);
                                        else {
                            ...
                            function T(e) {
                                ...
                                if (c) {
                                    for (p(c) == i.s || g(c) && c !== t && c !== c.self || (c = [c]), u = 0; u < c[o.l]; u++) s[u] = c[u];
                                    s[o.l] = c[o.l]
                                }
                                return s
                            }
                        ...
                        d = function() {
                            var l, d, p, v = [],
                                m = function() {
                                    var n = s.type,
                                        ...
                                        p = [!1, i.b],
                                        v = [null, [i.z, i.f]],
                                        m = "v-h:visible-hidden v-s:visible-scroll s:scroll h:hidden",
                                        _ = {
                                                    ...
                                                    for (var m in u)
                                                        if (u[o.hOP](m) && t[o.hOP](m)) {
                                                            var x, w, g, O, S, C, A, z, E = !1,
                                                                ...
                                                                N = n(I),
                                                                R = v ? v + "." : "",
                                                                j = 'The option "' + R + m + "\" wasn't set, because",
                                                                D = [],
                                                                q = [];
                                                            if (W = W === e ? {} : W, k && N == i.o) d[m] = {}, p[m] = {}, b(I, P, W, d[m], p[m], R + m), f.each([t, d, p], (function(t, n) {
                                                                y(n[m]) && delete n[m]
                                                            }));
                                                            else if (!k) {
                                                                for (C = 0; C < T[o.l]; C++)
                                                                    if (S = T[C], g = (L = n(S)) == i.s && -1 === _(S, r))
                                                                        for (D.push(i.s), x = S.split(a), q = q.concat(x), A = 0; A < x[o.l]; A++) {
                                                                            for (O = (w = x[A].split(c))[0], z = 0; z < w[o.l]; z++)
                                                                                if (I === w[z]) {
                                                                                    E = !0;
                                                                                    break
                                                                                }
                                                                ...
                                                                E ? ((H = I !== W) && (d[m] = I), (g ? _(W, w) < 0 : H) && (p[m] = g ? O : I)) : h && console.warn(j + " it doesn't accept the type [ " + N.toUpperCase() + ' ] with the value of "' + I + '".\r\nAccepted types are: [ ' + D.join(", ").toUpperCase() + " ]." + (q[length] > 0 ? "\r\nValid strings are: [ " + q.join(", ").split(c).join(", ") + " ]." : "")), delete t[m]
                                                            }
                                                        }
                                                };
                                            return b(m, l, d || {}, p, v), !y(m) && h && console.warn("The following options are discarded due to invalidity:\r\n" + t.JSON.stringify(m, null, 2)), {
                                                _default: p,
                                                _prepared: v
                                            }
                                        }
                                            ...
                                            var n = c.abs,
                                                ...
                                                a = function() {
                                                    if (h().length > 0) {
                                                        ...
                                                        E && (l.append(d), _ = e.nativeScrollbarSize = b(d[0]), d.remove(), H.x === _.x && H.y === _.y || f.each(h(), (function() {
                            ...
                            function x(r, d, p, v, _) {
                                ...
                                if (mi(r)) {
                                    ...
                                    var S, C, A, z, E, H, P, L, k, T, W, I, N, R, j, D, q, F, B, M, U, V, X, Q, Y, $, J, K, G, Z, tt, nt, et, rt, it, ot, at, st, ct, ut, lt, ft, ht, dt, pt, vt, mt, _t, yt, bt, xt, wt, gt, Ot, St, Ct, At, zt, Et, Ht, Pt, Lt, kt, Tt, Wt, It, Nt, Rt, jt, Dt, qt, Ft, Bt, Mt, Ut, Vt, Xt, Qt, Yt, $t, Jt, Kt, Gt, Zt, tn, nn, en, rn, on, an, sn, cn, un, ln, fn, hn, dn, pn, vn, mn, _n, yn, bn, xn, wn, gn, On, Sn, Cn, An, zn, En, Hn, Pn, Ln, kn, Tn, Wn, In, Nn, Rn = {},
                                        jn = {},
                                        Dn = {},
                                        qn = {},
                                        Fn = {},
                                    ...
                                    return w.sleep = function() {
                                        ...
                                        })) : t === re ? gn ? (a = xn(yn.takeRecords()), s = wn(bn.takeRecords())) : a = w.update(ee) : "zoom" === t && $r({
                                            _hostSizeChanged: !0,
                                            _contentSizeChanged: !0
                                        }) : (t = G || t, G = !1, w.update(re) && !t || $r({
                                            _force: t
                                        })), Jr(), o || a || s
                                        ...
                                        if (!j) {
                                            for (var t in _.remove(w), Tr(), Pr(ft), Pr(lt), yr) w.removeExt(t);
                                            for (; zr[o.l] > 0;) zr.pop()();
                                            qr(!0), mt && ki(mt), vt && ki(vt), U && ki(lt), ti(!0), ci(!0), Gr(!0);
                                            for (var n = 0; n < Or[o.l]; n++) f(Or[n]).off(gr, Dr);
                                            Or = e, j = !0, G = !0, h(r, 0), li("onDestroyed")
                                        }
                                        ...
                                        if (0 === arguments.length || t === e) {
                                            var l = jn,
                                                ...
                                                _ = l._maxScroll;
                                            return m = d ? 1 - m : m, v = d ? _ - v : v, _ *= p ? -1 : 1, {
                                                position: {
                                                    x: v *= p ? -1 : 1,
                                                    y: h._currentScroll
                                                },
                                        ...
                                        function at(t, n) {
                                            var r, o, a, s, u = y(n) == i.s,
                                                ...
                                                m = "replace",
                                                _ = eval;
                                            if (u ? (n[Q] > 2 && (s = n.substr(0, 2), b(s, I) > -1 && (r = s)), n = (n = r ? n.substr(2) : n)[m](/min/g, 0)[m](/</g, 0)[m](/max/g, (v ? "-" : ne) + oe)[m](/>/g, (v ? "-" : ne) + oe)[m](/px/g, ne)[m](/%/g, d + h * (p && A.n ? -1 : 1) / 100)[m](/vw/g, d + qn.w)[m](/vh/g, d + qn.h), o = yi(isNaN(n) ? yi(_(n), !0).toFixed() : n)) : o = n, o !== e && !isNaN(o) && y(o) == i.n) {
                                                var x = L && p,
                                                    w = f * (x && A.n ? -1 : 1),
                                                    g = x && A.i,
                                                    O = x && A.n;
                                                ...
                                                a = g ? h - a : a, a *= O ? -1 : 1, a = p && A.n ? c.min(0, c.max(h, a)) : c.max(0, c.min(h, a))
                                            }
                                            return a === f ? e : a
                                        }
                                        ...
                                        if (tt || nt) {
                                            var ut, lt = G ? t.margin : 0,
                                                ...
                                                _t = y(lt);
                                            if ((P = tt ? Z : f(Z))[Q] > 0) {
                                                lt = _t == i.n || _t == i.b ? ct([lt, lt, lt, lt]) : _t == i.a ? 2 === (ut = lt[Q]) ? ct([lt[0], lt[1], lt[0], lt[1]]) : ut >= 4 ? ct(lt) : mt : _t == i.o ? ct([lt[Xn], lt[Qn], lt[Yn], lt[$n]]) : mt, C = it(ft, Y) ? ft : "xy", z = st(pt, i.s, U, J), E = st(vt, i.s, F, $), H = lt;
                                                var yt = {
                                                        l: jn._currentScroll,
                                                        t: Dn._currentScroll
                                                    },
                                                ...
                                                if (K && (A.n || A.i || (gt.x = c.round(bt[$n] - xt[$n] + yt.l)), A.n && L && (gt.x *= -1), A.i && L && (gt.x = c.round(bt[$n] - xt[$n] + (jn._maxScroll - yt.l)))), E.x != F || E.y != F || z.x == X || z.y == X || K) {
                                                    var Ot = P[0],
                                                        St = T ? Ot[o.bCR]() : {
                                                            width: Ot[o.oW],
                                                            height: Ot[o.oH]
                                                        ...
                                                        At = function(t) {
                                                            var n = si(t),
                                                                ...
                                                                m = f + l / 2,
                                                                _ = h <= l && d >= f && d + h <= f + l;
                                                            c ? wt[i] = !0 : wt[i] || ((s || u) && (wt[i] = !!u && _, o = h < l ? v > m : v < m), gt[i] -= o || a ? (l / p - h / p) * (t && K && L ? -1 : 1) : 0)
                                                        };
                                                    At(!0), At(!1)
                                                }
                                                wt.y && delete gt.y, wt.x && delete gt.x, t = gt
                                            }
                                        }
                                        j[de] = at(!0, ot(!0, t)), j[pe] = at(!1, ot(!1, t)), g = j[de] !== e, O = j[pe] !== e, (g || O) && (n > 0 || N) ? N ? (n.complete = rt, dt.animate(j, n)) : (S = {
                                            duration: n,
                                            complete: rt
                                        }, s.isA(r) || f.isPlainObject(r) ? (D[de] = r[0] || r.x, D[pe] = r[1] || r.y, S.specialEasing = D) : S.easing = r, dt.animate(j, S)) : (g && dt[de](j[de]), O && dt[pe](j[pe]), et())
                                        ...
                                        if (h) {
                                            ...
                                            if ((r = h.extensionFactory.call(w, Ei({}, h.defaultOptions), f, s)) && (c = r.contract, y(c) == i.f && (u = c(t), d = y(u) == i.b ? u : d), d)) return yr[n] = r, a = r.added, y(a) == i.f && a(e), w.ext(n)
                                ...
                                function Er(t, n, e, r, i) {
                                    var a = s.isA(n) && s.isA(e),
                                        ...
                                        f = 0;
                                    if (a)
                                        for (; f < n[o.l]; f++) Er(t, n[f], e[f], r);
                                    else
                                        for (; f < l[o.l]; f++) W ? t[0][c](l[f], e, {
                                            passive: i || !1
                                        }) : t[u](l[f], e)
                                }
                                ...
                                function Pr(t, n) {
                                    if (t) {
                                        ...
                                        if (n) {
                                            if (I)((j = t.addClass("observed").append(gi($e)).contents()[0])[Se] = new r(l)).observe(j);
                                            else if (E > 9 || !z) {
                                                t.prepend(gi($e, gi({
                                                    c: Je,
                                                    dir: "ltr"
                                                }, gi(Je, gi(Ke)) + gi(Je, gi({
                                                    c: Ke,
                                                    style: "width: 200%; height: 200%"
                                                })))));
                                                var h, d, p, m, _ = t[0][c][0][c][0],
                                                    y = f(_[c][1]),
                                                    b = f(_[c][0]),
                                                    x = f(b[0][c][0]),
                                                    w = _[o.oW],
                                                    ...
                                                    P = function(t) {
                                                        return p = _[o.oW], m = _[o.oH], h = p != w || m != g, t && h && !d ? (s.cAF()(d), d = s.rAF()(H)) : t || H(), C(), t && (s.prvD(t), s.stpP(t)), !1
                                                    },
                                                    L = {},
                                                    k = {};
                                                fi(k, ne, [-(S.y + 1) * O, S.x * -O, S.y * -O, -(S.x + 1) * O]), f(_).css(k), b.on(ie, P), y.on(ie, P), t.on(a, (function() {
                                                    P(!1)
                                                })), L[Gn] = u, L[Zn] = u, x.css(L), C()
                                            } else {
                                                var T = At.attachEvent,
                                                    W = E !== e;
                                                if (T) t.prepend(gi($e)), Ti(t, ce + $e)[0].attachEvent("onresize", l);
                                                else {
                                ...
                                function qr(t) {
                                    t || qr(!0), Er(ut, _e.split(ue)[0], Rr, !Hn || t, !0), Er(ut, [ye, be], [Ir, Nr], !Pn || t, !0), R || t || ut.one("mouseover", Ir)
                                }

                                function Fr() {
                                    var t = {};
                                    return q && vt && (t.w = yi(vt.css(Jn + Gn)), t.h = yi(vt.css(Jn + Zn)), t.c = zi(t, _n), t.f = !0), _n = t, !!t.c
                                }
                                ...
                                function Ur() {
                                    ...
                                    var t, n, e, r, i = wi(),
                                        ...
                                        s = !gn && Dt && !D,
                                        c = {};
                                    return s && (t = pt.css(te), c[te] = K ? Qn : $n, c[Gn] = ee, pt.css(c)), r = {
                                        w: i[o.sW] + a,
                                        h: i[o.sH] + a
                                    }, s && (c[te] = t, c[Gn] = oe, pt.css(c)), n = Fr(), e = zi(r, nn), nn = r, e || n
                                }
                                ...
                                function Xr(t) {
                                    ...
                                    var n = "flex-grow",
                                        e = "flex-shrink",
                                        r = "flex-basis",
                                        i = [Gn, Jn + Gn, Kn + Gn, Mn + $n, Mn + Qn, $n, Qn, "font-weight", "word-spacing", n, e, r],
                                        a = [Un + $n, Un + Qn, Vn + $n + Gn, Vn + Qn + Gn],
                                        s = [Zn, Jn + Zn, Kn + Zn, Mn + Xn, Mn + Yn, Xn, Yn, "line-height", n, e, r],
                                    ...
                                    return (Jt.y === u || Jt.y === l) && ((h = d(s, t)) || M || (h = d(c, t))), f && !h && ((h = d(i, t)) || M || (h = d(a, t))), h
                                }
                                ...
                                function Yr() {
                                    if (!G) {
                                        var t, n, e, r, i = !hn,
                                            ...
                                            u = {},
                                            l = Dt || i;
                                        return u[Jn + Gn] = ne, u[Jn + Zn] = ne, u[Gn] = ee, ct.css(u), t = zt[o.oW], n = l ? c.max(t, zt[o.sW] - 1) : 1, u[Gn] = Dt ? ee : oe, u[Jn + Gn] = oe, u[Zn] = ee, ct.css(u), e = zt[o.oH], r = c.max(e, zt[o.sH] - 1), u[Gn] = n, u[Zn] = r, _t.css(u), u[Jn + Gn] = a, u[Jn + Zn] = s, ct.css(u), {
                                            _originalWidth: t,
                                            _originalHeight: e,
                                            _dynamicWidth: n,
                                            _dynamicHeight: r
                                ...
                                function $r(t) {
                                    ...
                                    var n, r = s.now(),
                                        ...
                                        l = !!xr._force,
                                        h = t._changedOptions,
                                        d = wr > 0 && R && !j && !l && !h && r - et < wr && !qt && !Dt;
                                    if (d && (rt = setTimeout($r, wr)), !(j || d || G && !h || R && !l && (n = ut.is(":hidden")) || "inline" === ut.css("display"))) {
                                        et = r, xr = {}, !H || S.x && S.y ? L = Ei({}, v.nativeScrollbarSize) : (L.x = 0, L.y = 0), Fn = {
                                            x: 3 * (L.x + (S.x ? 0 : 3)),
                                            y: 3 * (L.y + (S.y ? 0 : 3))
                                        }, h = h || {};
                                        var p = function() {
                                            ...
                                            Pt = b.dynHeight,
                                            Xt = p(vn, Pt);
                                        if (zn = "n" === O, En = "s" === O, Hn = "m" === O, Pn = "l" === O, An = y.autoHideDelay, fn = ln, Tn = "n" === B, Wn = "b" === B, In = "h" === B, Nn = "v" === B, un = nt.normalizeRTL, xt = xt && S.x && S.y, rn = x, on = O, an = k, sn = W, ln = N, cn = B, Qt = tt, Yt = ot, tn = st, Gt = xt, Zt = gt, Jt = Ei({}, St), mn = At, vn = Pt, Rt = Rt || {
                                                x: !1,
                                                y: !1
                                            }, F && (Pi(ut, fn + ue + pr), Hi(ut, N !== e && null !== N && N.length > 0 ? N : pr)), Ot && (!0 === gt || null === gt && z ? (Tr(), _.add(w)) : (_.remove(w), kr())), bt)
                                            if (st)
                                                if (mt ? mt.show() : (mt = f(gi(Qe)), ht.before(mt)), U) lt.show();
                                                else {
                                        ...
                                        if (st && !Bn) {
                                            ...
                                            mt.css(Gn, ee);
                                            var se = Et[o.oW];
                                            mt.css(Gn, ae), (Dn = re !== se) || (mt.css(Gn, re + 1), se = Et[o.oW], mt.css(Gn, ae), Dn = re !== se)
                                        }
                                        var ce = (Bn || Dn) && st && !n,
                                            le = p(ce, Dt),
                                            fe = !ce && Dt,
                                            ...
                                            Oe = V = Ln.l + Ln.r,
                                            Se = X = Ln.t + Ln.b;
                                        if (Oe *= tt ? 1 : 0, Se *= tt ? 1 : 0, Ln.c = p(Ln, Bt), Q = _e.l + _e.r, Y = _e.t + _e.b, _e.c = p(_e, Mt), $ = ye.l + ye.r, J = ye.t + ye.b, ye.c = p(ye, Ut), hn = yn, Vt = xn, Ft = Sn, Dt = ce, qt = he, Bt = Ln, Mt = _e, Ut = ye, wn && U && lt.css(te, jn), Ln.c || wn || it || le || ve || Cn || bt) {
                                            var Ce = {},
                                                Ae = {},
                                                ze = [Ln.t, Ln.r, Ln.b, Ln.l];
                                            fi(xe, Mn, [-Ln.t, -Ln.r, -Ln.b, -Ln.l]), tt ? (fi(Ce, ne, ze), fi(D ? Ae : be, Un)) : (fi(Ce, ne), fi(D ? Ae : be, Un, ze)), ht.css(Ce), ct.css(Ae)
                                        }
                                        qn = ge();
                                        var Ee = !!D && Yr(),
                                            He = D && p(Ee, pn),
                                        ...
                                        if (pn = Ee, he && (ve || it || Cn || Ln.c || _e.c) ? be[Zn] = ee : (ve || it) && (be[Zn] = oe), ce && (le || it || Cn || Ln.c || _e.c || wn) ? (be[Gn] = ee, xe[Kn + Gn] = oe) : (le || it) && (be[Gn] = oe, be[te] = ne, xe[Kn + Gn] = ne), ce ? (xe[Gn] = ee, be[Gn] = a._cssPropertyValue(Gn, "max-content intrinsic") || ee, be[te] = jn) : xe[Gn] = ne, xe[Zn] = he ? Pe.h || Tt[o.cH] : ne, st && mt.css(xe), pt.css(be), be = {}, xe = {}, i || u || He || wn || Cn || it || le || ce || ve || he || wt || Ct || at || Z || g || E || I || T || zt || Xt || bn) {
                                            var Le = "overflow",
                                                ke = Le + "-x",
                                                De = Le + "-y",
                                                qe = "hidden",
                                            ...
                                            if (!H) {
                                                var Be = {},
                                                    Ue = Rt.y && jt.ys && !xt ? S.y ? dt.css(kn) : -L.y : 0,
                                                    Ve = Rt.x && jt.xs && !xt ? S.x ? dt.css(Yn) : -L.x : 0;
                                                fi(Be, ne), dt.css(Be)
                                            }
                                            var $e = wi(),
                                                Je = {
                                            ...
                                            H || (Be[Yn] = me ? ne : Ve, Be[kn] = fe ? ne : Ue, dt.css(Be)), qn = ge();
                                            var Ge = we(),
                                                Ze = {
                                                    w: Ge.w - $ - Q - (M ? 0 : V),
                                                    h: Ge.h - J - Y - (M ? 0 : X)
                                            ...
                                            if (tr.c = p(tr, $t), $t = tr, st) {
                                                (tr.c || he || ce) && (xe[Gn] = tr.w, xe[Zn] = tr.h, D || (Je = {
                                                    w: $e[o.cW],
                                                    h: $e[o.cH]
                                                }));
                                                var nr = {},
                                                    er = function(t) {
                                                        var n = si(t),
                                                            ...
                                                            s = t ? $ : J,
                                                            u = qn[e] - o - s - (M ? 0 : a);
                                                        (!i || !i && _e.c) && (xe[r] = Ze[e] - 1), !(i && Je[e] < u) || t && D && yn || (D && (nr[r] = yi(_t.css(r)) - 1), xe[r] -= 1), Je[e] > 0 && (xe[r] = c.max(1, xe[r]))
                                                    };
                                                er(!0), er(!1), D && _t.css(nr), mt.css(xe)
                                            }
                                            ce && (be[Gn] = oe), !ce || M || gn || (be[te] = "none"), pt.css(be), be = {};
                                            var rr = {
                                                w: $e[o.sW],
                                                h: $e[o.sH]
                                            };
                                            rr.c = u = p(rr, It), It = rr, qn = ge(), i = p(Ge = we(), Wt), Wt = Ge;
                                            var ir = D && (0 === qn.w || 0 === qn.h),
                                                ...
                                                br = function(t) {
                                                    var n = si(t),
                                                        ...
                                                        u = or && or[r] > 0 && 0 === kt[a];
                                                    ar[r] = "v-s" === St[r], fr[r] = "v-h" === St[r], hr[r] = "s" === St[r], dr[r] = c.max(0, c.round(100 * (rr[i] - qn[i])) / 100), dr[r] *= ir || u && s > 0 && s < 1 ? 0 : 1, vr[r] = dr[r] > 0, mr[r] = ar[r] || fr[r] ? vr[e] && !ar[e] && !fr[e] : vr[r], mr[r + "s"] = !!mr[r] && (hr[r] || ar[r]), _r[r] = vr[r] && mr[r + "s"]
                                                };
                                            if (br(!0), br(!1), dr.c = p(dr, Kt), Kt = dr, vr.c = p(vr, Rt), Rt = vr, mr.c = p(mr, jt), jt = mr, S.x || S.y) {
                                                var gr, Or = "px solid transparent",
                                                    Sr = {},
                                                    Cr = {},
                                                    Ar = l;
                                                (vr.x || vr.y) && (Cr.w = S.y && vr.y ? rr.w + C.y : ne, Cr.h = S.x && vr.x ? rr.h + C.x : ne, Ar = p(Cr, Nt), Nt = Cr), (vr.c || mr.c || rr.c || wn || le || ve || ce || he || wt) && (be[Mn + jn] = be[Vn + jn] = ne, gr = function(t) {
                                                    var n = si(t),
                                                        e = si(!t),
                                                        r = n._x_y,
                                                        i = t ? Yn : kn,
                                                        o = t ? he : ce;
                                                    S[r] && vr[r] && mr[r + "s"] ? (be[Mn + i] = o ? xt ? ne : C[r] : ne, be[Vn + i] = t && o || xt ? ne : C[r] + Or) : (Cr[e._w_h] = be[Mn + i] = be[Vn + i] = ne, Ar = !0)
                                                }, H ? Li(dt, Me, !xt) : (gr(!0), gr(!1))), xt && (Cr.w = Cr.h = ne, Ar = !0), Ar && !H && (Sr[Gn] = mr.y ? Cr.w : ne, Sr[Zn] = mr.x ? Cr.h : ne, vt || (vt = f(gi(Xe)), dt.prepend(vt)), vt.css(Sr)), pt.css(be)
                                            }
                                            var zr, Er = {};
                                            if (Ce = {}, (i || vr.c || mr.c || rr.c || Ct || Cn || wt || wn || at || ve) && (Er[jn] = ne, (zr = function(t) {
                                                    var n = si(t),
                                                        e = si(!t),
                                                        r = n._x_y,
                                                        i = n._X_Y,
                                                    ...
                                                    vr[r] && mr[r + "s"] ? (Er[Le + i] = ie, xt || H ? a() : (Er[o] = -(S[r] ? C[r] : L[r]), Rn[e._w_h] = S[r] ? C[e._x_y] : 0)) : (Er[Le + i] = ne, a())
                                                })(!0), zr(!1), !H && (qn.h < Fn.x || qn.w < Fn.y) && (vr.x && mr.x && !S.x || vr.y && mr.y && !S.y) ? (Er[Un + Xn] = Fn.x, Er[Mn + Xn] = -Fn.x, Er[Un + jn] = Fn.y, Er[Mn + jn] = -Fn.y) : Er[Un + Xn] = Er[Mn + Xn] = Er[Un + jn] = Er[Mn + jn] = ne, Er[Un + kn] = Er[Mn + kn] = ne, vr.x && mr.x || vr.y && mr.y || ir ? D && ir && (Ce[ke] = Ce[De] = qe) : (!ot || fr.x || ar.x || fr.y || ar.y) && (D && (Ce[ke] = Ce[De] = ne), Er[ke] = Er[De] = Fe), ht.css(Ce), dt.css(Er), Er = {}, (vr.c || Cn || le || ve) && (!S.x || !S.y))) {
                                                var Hr = Tt[o.s];
                                            ...
                                            if (be = {}, wn || le || ve)
                                                if (K && ce) {
                                                    ...
                                                    pt.css(te, Lr), Wr !== c.round(pt.position().left) && (be[$n] = Wr)
                                                } else be[$n] = ne;
                                            if (pt.css(be), D && u) {
                                                var Ir = bi();
                                                if (Ir) {
                                                    var Nr = dn === e || Ir._rows !== dn._rows,
                                                        ...
                                                        Vr = {
                                                            ...
                                                            y: (yn ? Ur || Nr && or && m.y === or.y : (Ur || Nr) && Rr === Br) ? Kt.y : -1
                                                        };
                                                    m.x = Vr.x > -1 ? K && un && A.i ? 0 : Vr.x : m.x, m.y = Vr.y > -1 ? Vr.y : m.y
                                                }
                                                dn = Ir
                                            }
                                            K && A.i && S.y && vr.x && un && (m.x += Rn.w || 0), ce && ut[de](0), he && ut[pe](0), dt[de](m.x)[pe](m.y);
                                            var Xr = "v" === x,
                                                Qr = "h" === x,
                                                Kr = "a" === x,
                                                Gr = function(t, n) {
                                                    n = n === e ? t : n, ei(!0, t, _r.x), ei(!1, n, _r.y)
                                                };
                                            Li(ut, Ne, mr.x || mr.y), Li(ut, Re, mr.x), Li(ut, je, mr.y), wn && Li(ut, Te, K), q && Hi(ut, We), Z && (Li(ut, We, Tn), Li(yt, sr, !Tn), Li(yt, cr, Wn), Li(yt, ur, In), Li(yt, lr, Nn)), (g || Ct || mr.c || vr.c || wt) && (xt ? wt && (Pi(ut, Ie), xt && Gr(!1)) : Kr ? Gr(_r.x, _r.y) : Xr ? Gr(!0) : Qr && Gr(!1)), (E || wt) && (qr(!Pn && !Hn), ri(zn, !zn)), (i || dr.c || ve || le || Z || Cn || it || wt || wn) && (ii(!0), oi(!0), ii(!1), oi(!1)), T && ai(!0, k), I && ai(!1, W), li("onDirectionChanged", {
                                                isRTL: K,
                                                dir: xn
                                            }, wn), li("onHostSizeChanged", {
                                                width: Wt.w,
                                                height: Wt.h
                                                ...
                                                yScrollable: mr.ys,
                                                clipped: mr.x || mr.y
                                            }, vr.c || mr.c), li("onOverflowAmountChanged", {
                                                x: dr.x,
                                                y: dr.y
                                            }, dr.c)
                                        }
                                        q && _n && (Rt.c || _n.c) && (_n.f || Fr(), S.y && Rt.x && pt.css(Jn + Gn, _n.w + C.y), S.x && Rt.y && pt.css(Jn + Zn, _n.h + C.x), _n.c = !1), R && h.updateOnLoad && Jr(), li("onUpdated", {
                                            forced: l
                                        })
                                    }
                                }
                                ...
                                function Jr() {
                                    D || Ai((function(t, n) {
                                        pt.find(n).each((function(t, n) {
                                            s.inA(n, Or) < 0 && (Or.push(n), f(n).off(gr, Dr).on(gr, Dr))
                                        }))
                                    }))
                                }
                                ...
                                function Gr(t) {
                                    var n = "parent",
                                        ...
                                        d = [ze, Ee, He, We, Te, Pe, Le, ke, Ie, Ne, Re, je, pr, De, Ge, ln].join(ue),
                                        p = {};
                                    ut = ut || (D ? B ? ct[n]()[n]()[n]()[n]() : f(gi(He)) : ct), pt = pt || Oi(Ve + c), dt = dt || Oi(Be + c), ht = ht || Oi(Fe + c), ft = ft || Oi(r), _t = _t || (D ? Oi(qe) : e), B && Hi(ut, Ee), t && Pi(ut, d), u = y(u) == i.s ? u.split(ue) : u, s.isA(u) && D && x(u, (function(n, e) {
                                        y(e) == i.s && (l[e] = t ? ut.attr(e) : ct.attr(e))
                                    })), t ? (B && R ? (ft.children().remove(), x([ht, dt, pt, _t], (function(t, n) {
                                        n && Pi(n.removeAttr(o.s), vr)
                                    })), Hi(ut, D ? He : ze)) : (ki(ft), pt.contents().unwrap().unwrap().unwrap(), D && (ct.unwrap(), ki(ut), ki(_t), h())), D && ct.removeAttr(o.s), q && Pi(at, Ae)) : (D && (nt.sizeAutoCapable || (p[Gn] = ct.css(Gn), p[Zn] = ct.css(Zn)), B || ct.addClass(Ge).wrap(ut), ut = ct[n]().css(p)), B || (Hi(ct, D ? a : ze), ut.wrapInner(pt).wrapInner(dt).wrapInner(ht).prepend(ft), pt = Ti(ut, ce + Ve), dt = Ti(ut, ce + Be), ht = Ti(ut, ce + Fe), D && (pt.prepend(_t), h())), H && Hi(dt, Me), S.x && S.y && Hi(dt, Ue), q && Hi(at, Ae), Pt = ft[0], Et = ut[0], Lt = ht[0], kt = dt[0], Tt = pt[0], Qr())
                                }
                                ...
                                function Zr() {
                                    ...
                                    function m(t) {
                                        !0 !== Zt && Xr((t = t.originalEvent || t).propertyName) && w.update(ee)
                                    }

                                    function _(t) {
                                        G || (n !== e ? clearTimeout(n) : ((En || Hn) && ri(!0), xi() || Hi(ut, Ie), li("onScrollStart", t)), kn || (oi(!0), oi(!1)), li("onScroll", t), n = setTimeout((function() {
                                            j || (clearTimeout(n), n = e, (En || Hn) && ri(!1), xi() || Pi(ut, Ie), li("onScrollStop", t))
                                        }), a))
                                    }
                                    D ? (E > 9 || !z ? Hr(ct, "input", u) : Hr(ct, [xe, we], [p, v]), Hr(ct, [ie, "drop", c, c + "out"], [l, f, h, d])) : Hr(pt, Oe, m), Hr(dt, ie, _, !0)
                                }
                                ...
                                function ti(t) {
                                    ...
                                    t ? (i(!0), i()) : (n = r(!0), e = r(), bt = n._scrollbar, xt = n._track, wt = n._handle, gt = e._scrollbar, Ot = e._track, St = e._handle, B || (ht.after(gt), ht.after(bt)))
                                }
                                ...
                                function ni(t) {
                                    ...
                                    function H(t) {
                                        ...
                                        return !(G || j || xi() || !sn || n && !g("touchSupport")) && (1 === s.mBtn(t) || n)
                                    }
                                    ...
                                    function P(n) {
                                        if (H(n)) {
                                            ...
                                            u = isFinite(u) ? u : 0, K && t && !A.i && (u *= -1), dt[p](c.round(r + u)), kn && oi(t, r + u), W || s.prvD(n)
                                        } else L(n)
                                    }

                                    function L(s) {
                                        if (s = s || s.originalEvent, Er(ot, [_e, me, xe, we, ge], [P, L, C, z, jr], !0), kn && oi(t, !0), kn = !1, Pi(st, dr), Pi(u._handle, v), Pi(u._track, v), Pi(u._scrollbar, v), r = e, i = e, a = 1, S(), n !== e && (w.scrollStop(), clearTimeout(n), n = e), s) {
                                            var c = Et[o.bCR]();
                                            s.clientX >= c.left && s.clientX <= c.right && s.clientY >= c.top && s.clientY <= c.bottom || Nr(), (En || Hn) && ri(!1)
                                        }
                                    }
                                    ...
                                    function I(n) {
                                        r = dt[p](), r = isNaN(r) ? 0 : r, (K && t && !A.n || !K) && (r = r < 0 ? 0 : r), a = vi()[h], i = x(n), kn = !g(m), Hi(st, dr), Hi(u._handle, v), Hi(u._scrollbar, v), Er(ot, [_e, me, ge], [P, L, jr]), !E && F || s.prvD(n), s.stpP(n)
                                    }

                                    function N(r) {
                                        if (H(r)) {
                                            var o, f = c.round(qn[u._w_h]),
                                                ...
                                                T = function() {
                                                    if (!j) {
                                                        ...
                                                        C = isFinite(C) ? C : 0, C = K && t && !A.i ? m - C : C, b ? (dt[p](C), x ? (C = dt[p](), dt[p](y), C = z && A.i ? m - C : C, C = z && A.n ? -C : C, L[h] = C, w.scroll(L, Ei(W, {
                                                            duration: 130,
                                                            complete: k
                                                        }))) : k()) : (o = S ? H : o, (z ? o ? s + v >= r : s <= r : o ? s <= r : s + v >= r) ? (clearTimeout(n), w.scrollStop(), n = e, P(!0)) : (n = setTimeout(T, O), L[h] = (o ? "-=" : "+=") + f, w.scroll(L, Ei(W, {
                                                            duration: g
                                                        }))), S = !1)
                                                    }
                                                };
                                            y && O(), a = vi()[h], i = s.page(r)[h], kn = !g(m), Hi(st, dr), Hi(u._track, v), Hi(u._scrollbar, v), Er(ot, [me, xe, we, ge], [L, C, z, jr]), T(), s.prvD(r), s.stpP(r)
                                        }
                                    }
                                    ...
                                    Hr(u._handle, ve, T), Hr(u._track, [ve, ye, be], [N, R, D]), Hr(u._scrollbar, ve, q), k && Hr(u._scrollbar, Oe, (function(n) {
                                ...
                                function ri(t, n) {
                                    if (clearTimeout(Sn), t) Pi(bt, or), Pi(gt, or);
                                        ...
                                        var e, r = "active",
                                            i = function() {
                                                Ln || j || (!(e = wt.hasClass(r) || St.hasClass(r)) && (En || Hn || Pn) && Hi(bt, or), !e && (En || Hn || Pn) && Hi(gt, or))
                                            };
                                ...
                                function ii(t) {
                                    var n = {},
                                        ...
                                        r = e._info,
                                        i = 1e6,
                                        o = c.min(1, (Wt[e._w_h] - (Qt ? t ? V : X : 0)) / It[e._w_h]);
                                ...
                                function oi(t, n) {
                                    var r, o, s = y(n) == i.b,
                                        ...
                                        w = x - b,
                                        g = {},
                                        O = (kt[ie + f._Width_Height] - kt["client" + f._Width_Height]) * (A.n && l ? -1 : 1),
                                        S = function(t) {
                                        ...
                                        E = C(S(_)),
                                        H = C(z);
                                    h._maxScroll = O, h._currentScroll = m, h._currentScrollRatio = z, T ? (r = l ? -(x - b - E) : E, o = t ? d + r + "px, 0)" : d + "0, " + r + "px)", g[p] = o, k && (g[v] = s && c.abs(E - h._handleOffset) > 1 ? di(f._handle) + ", " + (p + ue + u) + "ms" : ne)) : g[f._left_top] = E, xi() || (f._handle.css(g), T && k && s && f._handle.one(Oe, (function() {
                                ...
                                function ci(t) {
                                    yt = yt || Oi(ar, !0), t ? B && R ? Pi(yt.removeAttr(o.s), vr) : ki(yt) : B || ut.append(yt)
                                }
                                ...
                                function ui() {
                                    ...
                                    function c(t) {
                                        if (l(t)) {
                                            var n = f(t),
                                                e = {};
                                            (In || Wn) && (e[Gn] = i.w + (n.x - r.x) * a.x), (Nn || Wn) && (e[Zn] = i.h + (n.y - r.y) * a.y), ut.css(e), s.stpP(t)
                                        } else u(t)
                                    }

                                    function u(n) {
                                        var r = n !== e;
                                        Er(ot, [ge, _e, me], [jr, c, u], !0), Pi(st, dr), yt.releaseCapture && yt.releaseCapture(), r && (t && kr(), w.update(ee)), t = !1
                                    }
                                    ...
                                    Hr(yt, ve, (function(n) {
                                        l(n) && !Tn && (gn && (t = !0, Tr()), r = f(n), i.w = Et[o.oW] - (M ? 0 : V), i.h = Et[o.oH] - (M ? 0 : X), a = vi(), Er(ot, [ge, _e, me], [jr, c, u]), Hi(st, dr), yt.setCapture && yt.setCapture(), s.prvD(n), s.stpP(n))
                                    }))
                                }
                                    ...
                                    if (!1 !== e)
                                        if (R) {
                                            var r, o = nt.callbacks[t],
                                                a = t;
                                            "on" === a.substr(0, 2) && (a = a.substr(2, 1).toLowerCase() + a.substr(3)), y(o) == i.f && o.call(w, n), x(yr, (function() {
                                ...
                                function Oi(t, n) {
                                    var e = y(n) == i.b,
                                        r = e ? ut : n || ut;
                                    return B && !r[o.l] ? null : B ? r[e ? "children" : "find"](ce + t.replace(/\s/g, ce)).eq(0) : f(gi(t))
                                }
                            ...
                            return (l = t[r] = function(t, n, r) {
                                ...
                                var a, c, u = [],
                                    v = f.isPlainObject(n);
                                return t ? (t = t[o.l] != e ? t : [t[0] || t], _(), t[o.l] > 0 && (v ? f.each(t, (function(t, i) {
                                ...
                                d.defaultOptions = f.extend(!0, {}, n, m._validate(t, m._template, !0, n)._default)
                            }, l.valid = function(t) {
