(window.webpackJsonp_N_E = window.webpackJsonp_N_E || []).push([
    [272], {
        GSh6: function(t, e, s) {
            "use strict";
            s.r(e), s.d(e, "StreamLanguage", (function() {
                return l
            ...
            function h(t, e, s, i = 0, n = 0) {
                ...
                let r = n;
                for (let h = i; h < e; h++) 9 == t.charCodeAt(h) ? r += s - r % s : r++;
                return r
            }
            class a {
                constructor(t, e, s) {
                    this.string = t, this.tabSize = e, this.indentUnit = s, this.pos = 0, this.start = 0, this.lastColumnPos = 0, this.lastColumnValue = 0
                }
                eol() {
                ...
                eat(t) {
                    let e, s = this.string.charAt(this.pos);
                    if (e = "string" == typeof t ? s == t : s && (t instanceof RegExp ? t.test(s) : t(s)), e) return ++this.pos, s
                }
                eatWhile(t) {
                    let e = this.pos;
                    for (; this.eat(t););
                ...
                column() {
                    return this.lastColumnPos < this.start && (this.lastColumnValue = h(this.string, this.start, this.tabSize, this.lastColumnPos, this.lastColumnValue), this.lastColumnPos = this.start), this.lastColumnValue
                }
                indentation() {
                ...
                match(t, e, s) {
                    if ("string" == typeof t) {
                        ...
                        return i(this.string.substr(this.pos, t.length)) == i(t) ? (!1 !== e && (this.pos += t.length), !0) : null
                    } {
                        let s = this.string.slice(this.pos).match(t);
                        return s && s.index > 0 ? null : (s && !1 !== e && (this.pos += s[0].length), s)
                    }
                }
                current() {
            ...
            class l extends r.c {
                constructor(t) {
                    let e, s = Object(r.h)(t.languageData),
                        n = {
                            token: (h = t).token,
                    ...
                    super(s, new class extends i.e {
                        ...
                        return g.push(e), e
                    }(s), [r.r.of(((t, e) => this.getIndent(t, e)))]), e = this, this.streamParser = n, this.stateAfter = new i.b({
                        perNode: !0
                    })
                }
                static define(t) {
                ...
                getIndent(t, e) {
                    ...
                    if (!i) return null;
                    let n, h, o = u(this, s, 0, i.from, e);
                    if (o ? (h = o.state, n = o.pos + 1) : (h = this.streamParser.startState(t.unit), n = 0), e - n > 1e4) return null;
                    for (; n < e;) {
            ...
            function p(t, e, s, n, r) {
                ...
                for (let h = e.children.length - 1; h >= 0; h--) {
                    let a, o = e.positions[h] + s,
                        l = e.children[h];
                    if (o < n && l instanceof i.f) {
                        if (!(a = p(t, l, s - o, n - o, r))) break;
                        return r ? new i.f(e.type, e.children.slice(0, h).concat(a), e.positions.slice(0, h + 1), o + a.length) : a
                    }
                }
                return null
            }
            class f {
                constructor(t, e, s, n) {
                    this.lang = t, this.input = e, this.fragments = s, this.ranges = n, this.stoppedAt = null, this.chunks = [], this.chunkPos = [], this.chunk = [], this.chunkReused = void 0, this.rangeIndex = 0, this.to = n[n.length - 1].to;
                    let h = r.f.get(),
                        a = n[0].from,
                        {
                            state: o,
                            ...
                            for (let i of e) {
                                let e, n = i.from <= s && i.to > s && u(t, i.tree, 0 - i.offset, s, i.to);
                                if (n && (e = p(t, i.tree, s + i.offset, n.pos + i.offset, !1))) return {
                                    state: n.state,
                                    tree: e
                                }
                            }
                    ...
                    this.state = o, this.parsedPos = this.chunkStart = a + l.length, l.length && (this.chunks.push(l), this.chunkPos.push(0)), h && this.parsedPos < h.viewport.from - 1e5 && (this.state = this.lang.streamParser.startState(Object(r.n)(h.state)), h.skipUntilInView(this.parsedPos, h.viewport.from), this.parsedPos = h.viewport.from)
                }
                advance() {
                    let t = r.f.get(),
                        e = null == this.stoppedAt ? this.to : this.stoppedAt,
                        s = Math.min(e, this.chunkStart + 2048);
                    for (t && (s = Math.min(s, t.viewport.to)); this.parsedPos < s;) this.parseLine(t);
                ...
                nextLine() {
                    ...
                    for (let i = this.rangeIndex;;) {
                        ...
                        if (t >= s) break;
                        if (e = e.slice(0, t - (s - e.length)), i++, i == this.ranges.length) break;
                ...
                parseLine(t) {
                    let {
                        ...
                        streamParser: n
                    } = this.lang, h = new a(e, t ? t.state.tabSize : 4, t ? Object(r.n)(t.state) : 2);
                    if (h.eol()) n.blankLine(this.state, h.indentUnit);
                    else
                        for (; !h.eol();) {
                            let t = c(n.token, h, this.state);
                            t && (i = this.emitToken(b(t), this.parsedPos + h.start, this.parsedPos + h.pos, 4, i))
                        }
                ...
                finish() {
                    return new i.f(this.lang.topNode, this.chunks, this.chunkPos, this.parsedPos - this.ranges[0].from).balance()
                }
            }
            ...
            function b(t) {
                return t ? d[t] || (d[t] = function(t) {
                    let e = null;
                    for (let i of t.split(".")) {
                        let t = n.d[i];
                        t ? "function" == typeof t ? e ? e = t(e) : P(i, `Modifier ${i} used at start of tag`) : e ? P(i, `Tag ${i} used as modifier`) : e = t : P(i, `Unknown highlighting tag ${i}`)
                    }
                    if (!e) return 0;
                    let s = t.replace(/ /g, "_"),
                        r = i.d.define({
