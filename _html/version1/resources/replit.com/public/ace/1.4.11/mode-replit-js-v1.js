...
var version = 1;
window.ace.define('ace/mode/doc_comment_highlight_rules', ['ace/mode/text_highlight_rules'], function(require, exports, _module) {
...
window.ace.define('ace/mode/matching_brace_outdent', ['ace/range'], function(require, exports, _module) {
...
window.ace.define('ace/mode/folding/cstyle', ['ace/range', 'ace/mode/folding/fold_mode'], function(require, exports, _module) {
    var Range = require('ace/range').Range;
    ...
    var FoldMode = /** @class */ (function(_super) {
        ...
        function FoldMode(commentRegex) {
            ...
            if (commentRegex) {
                _this.foldingStartMarker = new RegExp(_this.foldingStartMarker.source.replace(/\|[^|]*?$/, "|" + commentRegex.start));
                _this.foldingStopMarker = new RegExp(_this.foldingStopMarker.source.replace(/\|[^|]*?$/, "|" + commentRegex.end));
            }
            return _this;
        }
        /**
...
window.ace.define("ace/mode/replit-js-v" + version + "_highlight_rules", [
    'require',
    'exports',
    'module',
            ...
            _this.$rules = {
                no_regex: [
                    ...
                    },
                    {
                        ...
                        regex: /0(?:[xX][0-9a-fA-F](?:_?[0-9a-fA-F]+)*|[oO][0-7](?:_?[0-7]+)*|[bB][01](?:_?[01]+)*)n?\b/,
                    },
                    {
                        token: 'constant.numeric',
                        regex: digits + "n\\b",
                    ...
                    {
                        token: 'constant.numeric',
                        regex: "(?:" + digits + "(?:\\." + digits + "?)?|\\." + digits + ")(?:[eE][+-]?" + digits + "\\b)?",
                    },
                    {
                        // arg => {...}
                        token: [
                    ...
                    },
                    {
                        ...
                        regex: "^(\\s*)(?!(?:if|while|function|for|switch|catch|constructor)\\b)(#?" + ident + ")(\\s*)(\\()(?=[^()]*\\)\\s*{)",
                    ...
                    },
                    {
                        ...
                        regex: "(this)(\\.)(prototype)(\\.)(" + ident + ")(\\s*)(=)(\\s*)(function)(\\s*)(\\()",
                        next: 'function_arguments',
                    },
                    {
                        ...
                        regex: "(" + ident + ")(\\.)(prototype)(\\.)(" + ident + ")(\\s*)(=)(\\s*)(function)(\\s*)(\\()",
                        next: 'function_arguments',
                    },
                    {
                        // this.play = function() {...}
                        ...
                        regex: "(this)(\\.)(" + ident + ")(\\s*)(=)(\\s*)(function)(\\s*)(\\()",
                        next: 'function_arguments',
                    },
                    {
                        // this.play = arg => {...}
                    ...
                    },
                    {
                        ...
                        regex: "(this)(\\.)(" + ident + ")(\\s*)(=)(\\s*)(\\()" + nextIsArrowFn,
                        next: 'function_arguments',
                    },
                    {
                        // Sound.play = function() {...}
                        ...
                        regex: "(" + ident + ")(\\.)(" + ident + ")(\\s*)(=)(\\s*)(function)(\\s*)(\\()",
                        next: 'function_arguments',
                    },
                    {
                        // Sound.play = arg => {...}
                    ...
                    },
                    {
                        ...
                        regex: "(" + ident + ")(\\.)(" + ident + ")(\\s*)(=)(\\s*)(\\()" + nextIsArrowFn,
                        next: 'function_arguments',
                    },
                    {
                        // play = function() {...}
                    ...
                    },
                    {
                        ...
                        regex: "(this)(\\.)(" + ident + ")(\\s*)(=)(\\s*)(function)(\\s+)(\\w+)(\\s*)(\\()",
                        next: 'function_arguments',
                    },
                    {
                        ...
                        regex: "(" + ident + ")(\\.)(" + ident + ")(\\s*)(=)(\\s*)(function)(\\s+)(\\w+)(\\s*)(\\()",
                        next: 'function_arguments',
                    },
                    {
                        ...
                        regex: "\\b(function|get|set|static)(\\s+)(#?" + ident + ")(\\s*)(\\()",
                        next: 'function_arguments',
                    },
                    {
                        // foobar: function() {...}
...
window.ace.define("ace/mode/replit-js-v" + version, [
    'require',
    'exports',
    'module',
    ...
    var JSHighlightRules = require("ace/mode/replit-js-v" + version + "_highlight_rules").JSHighlightRules;
