    ...
    ! function() {
        function e() {
            var e = n.timing,
                t = "";
            try {
                t = "function" == typeof n.getEntriesByType ? new URL(n.getEntriesByType("navigation")[0].name).pathname : h ? new URL(h).pathname : window.location.pathname
            } catch (e) {}
            var i = {
                referrer: document.referrer || "",
                eventType: u.EventType.WebVitalsV2,
                lcp: {
                    value: -1,
                    path: void 0
                },
                ...
                location: r(),
                landingPath: t,
                startTime: n.timeOrigin || (e ? e.navigationStart : 0)
            };
            return g && g.version && (i.versions.fl = g.version), T && (i.lcp = T.lcp && void 0 !== T.lcp.value ? T.lcp : i.lcp, i.fid = T.fid && void 0 !== T.fid.value ? T.fid : i.fid, i.cls = T.cls && void 0 !== T.cls.value ? T.cls : i.cls), g && (i.siteToken = g.token), i
        }
        ...
        function t(e) {
            var t = n.timing,
                ...
                p = {
                    ...
                    si: g ? g.si : 0,
                    startTime: n.timeOrigin || (t ? t.navigationStart : 0),
                    versions: {
                        fl: g ? g.version : "",
                        js: "2021.8.2",
                        timings: 1
            ...
            if (void 0 == y) {
                if ("function" == typeof n.getEntriesByType) {
                    var h = n.getEntriesByType("navigation");
                    h && Array.isArray(h) && h.length > 0 && (p.timingsV2 = {}, p.versions.timings = 2, delete p.timings, c(h[0], p.timingsV2))
                }
                1 === p.versions.timings && c(t, p.timings), c(s, p.memory)
            }
            if (p.documentWriteIntervention = o(), p.firstPaint = i("first-paint"), p.firstContentfulPaint = i("first-contentful-paint"), p.errorCount = window.__cfErrCount || 0, g && (p.siteToken = g.token, S = !0), "function" == typeof n.getEntriesByType) {
                var w = n.getEntriesByType("resource"),
                    T = 0,
                    E = 0;
                w.forEach(function(e) {
                    var t = {
                        ...
                        i: e.initiatorType,
                        p: e.nextHopProtocol,
                        rs: a(e.redirectStart),
                        re: a(e.redirectEnd),
                        fs: a(e.fetchStart),
                        ds: a(e.domainLookupStart),
                        de: a(e.domainLookupEnd),
                        cs: a(e.connectStart),
                        ce: a(e.connectEnd),
                        qs: a(e.requestStart),
                        ps: a(e.responseStart),
                        pe: a(e.responseEnd),
                        ws: a(e.workerStart),
                        ss: a(e.secureConnectionStart),
                        ts: e.transferSize,
                        ec: e.encodedBodySize,
                        dc: e.decodedBodySize
                    };
                    p.tempResources && void 0 === p.tempResources[E] && (p.tempResources[E] = []);
                    var n = JSON.stringify(t).length;
                    T + n < 62e3 && p.tempResources ? (T += n, p.tempResources[E].push(t)) : (E++, T = 0)
                })
            }
            return JSON.stringify(p).length >= 64e3 && (p.resources = []), void 0 !== y && (delete p.timings, delete p.memory, delete p.errorCount, delete p.documentWriteIntervention), p
        }
        ...
        if (!g || "single" !== g.load) {
            ...
            document.addEventListener("visibilitychange", function() {
                k && 0 === m.filter(function(e) {
                    return e.id === v
                }).length && j(), "hidden" === document.visibilityState && !w && S && (w = !0, I(k))
            });
            var T = {
                    lcp: void 0,
                    cls: void 0,
                ...
                L = function(e) {
                    ...
                    if ("CLS" === e.name) {
                        ...
                        var n = E(e.entries);
                        n && (T.cls.element = R(n.node), T.cls.currentRect = n.currentRect, T.cls.previousRect = n.previousRect)
                    } else if ("FID" === e.name) {
                        T.fid = {
                            value: e.value,
                            path: t
                        ...
                        var n = b(e.entries);
                        n && (T.fid.element = R(n.target), T.fid.name = n.name)
                    } else if ("LCP" === e.name) {
                        T.lcp = {
                            value: e.value,
                            path: t
                        ...
                        var n = b(e.entries);
                        n && (T.lcp.element = R(n.element), T.lcp.size = n.size, T.lcp.url = n.url)
                    }
                };
            if ("function" == typeof PerformanceObserver && (d.getLCP(L, !0), d.getFID(L), PerformanceObserver.supportedEntryTypes && PerformanceObserver.supportedEntryTypes.includes("layout-shift") && d.getCLS(L, !0)), p) {
                var _ = p.getAttribute("data-cf-beacon");
                if (_) try {
                    g = s(s({}, g), JSON.parse(_))
                } catch (e) {} else {
                    var O = p.getAttribute("src");
                    if (O && "function" == typeof URLSearchParams) {
                        var C = new URLSearchParams(O.replace(/^[^\?]+\??/, "")),
                            P = C.get("token");
                        P && (g.token = P);
                        var B = C.get("spa");
                        g.spa = null === B || "true" === B
            ...
            if (n && g && g.token) {
                var A = g.send && g.send.to ? g.send.to : void 0 === g.version ? "https://cloudflareinsights.com/cdn-cgi/rum" : null,
                    j = function(e) {
                        var n = function(e, t) {
                                r.resources = e, 0 != t && (r.bypassTiming = !0), g && (1 === g.r && (r.resources = []), k && 0 === t && (m.push({
                                    id: r.pageloadId,
                                    url: r.location
                                }), m.length > 3 && m.shift()), f.sendObjectBeacon("", r, function() {}, !1, A), void 0 !== g.forward && void 0 !== g.forward.url && f.sendObjectBeacon("", r, function() {}, !1, g.forward.url))
                            },
                            r = t(e);
                        if (r && g) {
                            var i = r.tempResources;
                            if (delete r.tempResources, k && i && 0 === i.length && n([], 0), !i) return;
                    ...
                    I = function(t) {
                        var n = e();
                        t || (n.resources = [], delete n.tempResources), g && f.sendObjectBeacon("", n, function() {}, !0, A)
                    },
                    N = function() {
                        S = !0;
                ...
                "complete" === window.document.readyState ? N() : window.addEventListener("load", function() {
                    ...
                    if (t) {
                        var i = function() {
                            v = l(), "function" == typeof n.clearResourceTimings && n.clearResourceTimings()
                        };
                        e.pushState = function(n, o, a) {
                            return y = r(a), 0 === m.filter(function(e) {
                                return e.id === v
                            }).length && j(r()), i(), t.apply(e, [n, o, a])
