...
exports.AB_TESTING_URL = /codesandbox\.io/.test(typeof window !== `undefined` ? (_a = window === null || window === void 0 ? void 0 : window.location) === null || _a === void 0 ? void 0 : _a.host : '') ?
...
exports.default = Object.keys(process.env)
    ...
    .reduce((env, key) => {
        ...
        'process.env.SANDPACK': Boolean(JSON.parse(process.env.SANDPACK || 'false')),
