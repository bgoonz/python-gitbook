...
exports.getModulePath = (modules, directories, id) => getPath(modules, modules, directories, id);
exports.getDirectoryPath = (modules, directories, id) => getPath(directories, modules, directories, id);
...
const inDirectoryMemoize = (directories, sourceShortid, destinationShortid) => sourceShortid +
    destinationShortid +
    directories.map(d => d.id + d.title + d.directoryShortid).join(',');
exports.inDirectory = memoize_1.default((directories, rootShortid, shortid) => {
