...
class BasePreview extends react_1.default.PureComponent {
    constructor(props) {
        ...
        this.testFallbackDomainIfNeeded = () => {
            ...
            const fallbackUrl = url_generator_1.frameUrl(this.props.sandbox, this.props.initialPath || '', {
                useFallbackDomain: true
            });
            const setFallbackDomain = () => {
                this.setState({
                    useFallbackDomain: true,
                    urlInAddressBar: url_generator_1.frameUrl(this.props.sandbox, this.props.initialPath || '', {
                        useFallbackDomain: true
                    }),
                }, () => {
        ...
        this.handleSandboxChange = () => {
            this.serverPreview = templates_1.default(this.props.sandbox.template).isServer;
                        ...
                        case 'action':
                            {
                                if (this.props.onAction) {
                                    this.props.onAction(Object.assign(Object.assign({}, data), {
        ...
        this.executeCodeImmediately = (initialRender = false, showScreen = true) => {
    ...
    render() {
        ...
        return (react_1.default.createElement(elements_1.Container, {
            ...
            showNavigation && (react_1.default.createElement(Navigator_1.default, {
                url: url,
            ...
            react_1.default.createElement(Wrapper, null,
                react_1.default.createElement(AnySpring, {
                    key: "preview",
                    from: {
                    ...
                    this.props.sandbox.screenshotUrl && style.opacity !== 1 && (react_1.default.createElement("div", {
                            style: {
                                overflow: 'hidden',
                                width: '100%',
                                position: 'absolute',
