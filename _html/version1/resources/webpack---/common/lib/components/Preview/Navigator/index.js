...
function Navigator({
    ...
    return (react_1.default.createElement(elements_1.Container, {
        ...
        react_1.default.createElement(elements_1.Icons, null,
            react_1.default.createElement(elements_1.Icon, {
                    "aria-label": "Go Back",
                    disabled: !onBack,
                    onClick: onBack
                },
        ...
        react_1.default.createElement(elements_1.AddressBarContainer, {
                onMouseDown: e => {
                    e.stopPropagation();
                }
            },
        ...
        createPreviewComment && (react_1.default.createElement(elements_1.IconWithBackground, {
                onClick: createPreviewComment,
                style: {
                    color: isPreviewCommentModeActive && !isScreenshotLoading ?
                        '#FF3B30' :
                        'currentColor',
                }
            },
            ...
            }, isScreenshotLoading ? (react_1.default.createElement(elements_1.SpinnerWrapper, null,
            ...
            }))))), !zenMode && toggleProjectView && (react_1.default.createElement(elements_1.IconWithBackground, {
            ...
            react_1.default.createElement(Tooltip_1.default, {
                ...
                placement: "left"
            }, isProjectView ? react_1.default.createElement(ProjectView_1.ProjectViewIcon, null) : react_1.default.createElement(ModuleView_1.ModuleViewIcon, null)))),
        toggleResponsiveView && (react_1.default.createElement(elements_1.IconWithBackground, {
        ...
        openNewWindow && (react_1.default.createElement(elements_1.IconWithBackground, {
