...
exports.ReakitButton = exports.AButton = exports.LinkButton = exports.styles = void 0;
...
`;
// @ts-ignore
exports.LinkButton = styled_components_1.default(utils_1.withoutProps(`small`)(react_router_dom_1.Link))
`
  ${exports.styles};
`;
// eslint-disable-next-line
exports.AButton = styled_components_1.default(utils_1.withoutProps(`small`)(props => react_1.default.createElement("a", Object.assign({}, props))))
`
  ${exports.styles};
`;
exports.ReakitButton = styled_components_1.default(utils_1.withoutProps(`small`)(Button_1.Button))
`
  ${exports.styles}
`;