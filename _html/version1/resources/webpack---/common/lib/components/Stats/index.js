...
const repo_forked_1 = __importDefault(require("react-icons/lib/go/repo-forked"));
...
function StatsComponent(_a) {
    var {
        ...
        text = false,
        style
    } = _a, props = __rest(_a, ["viewCount", "likeCount", "forkCount", "vertical", "text", "style"]);
    return (react_1.default.createElement(elements_1.Stats, Object.assign({
            vertical: vertical
        }, props),
