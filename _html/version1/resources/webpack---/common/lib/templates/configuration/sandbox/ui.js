...
exports.ConfigWizard = (props) => {
    ...
    const bindValue = react_1.useCallback((file, property, defaultValue) => ({
        value: getValue(file, property, defaultValue),
        setValue: (value) => {
            let code = JSON.stringify(Object.assign(Object.assign({}, file), {
                [property]: value
            }), null, 2);
            if (property.includes('.')) {
                const [parent, key] = property.split('.');
                code = JSON.stringify(Object.assign(Object.assign({}, file), {
    ...
    return (react_1.default.createElement("div", null,
        react_1.default.createElement(elements_1.PaddedConfig, null,
            react_1.default.createElement(elements_1.ConfigItem, null,
                react_1.default.createElement(elements_1.PaddedPreference, Object.assign({
        ...
        react_1.default.createElement(elements_1.PaddedConfig, null,
            ...
            react_1.default.createElement(elements_1.ConfigDescription, null, "Which template to use for this sandbox.")), !currentTemplate.isServer ? (react_1.default.createElement(elements_1.PaddedConfig, null,
            react_1.default.createElement(elements_1.ConfigItem, null,
                react_1.default.createElement(elements_1.PaddedPreference, Object.assign({
                    title: "Disable Console",
                    type: "boolean"
                }, bindValue(parsedFile, 'disableLogging')))),
            react_1.default.createElement(elements_1.ConfigDescription, null, "Disable the in-browser console to prevent slowing down of the page when there are many logs to the console."))) : null,
        currentTemplate.isServer ? (react_1.default.createElement(react_1.default.Fragment, null,
            react_1.default.createElement(elements_1.PaddedConfig, null,
                react_1.default.createElement(elements_1.PaddedPreference, Object.assign({
                    title: "Port",
                    type: "number",
                ...
                react_1.default.createElement(elements_1.ConfigDescription, null, "What is the main port of your application. Values from 1024 to 65535")),
            react_1.default.createElement(elements_1.PaddedConfig, null,
                react_1.default.createElement(elements_1.PaddedPreference, Object.assign({
                    title: "Node Version",
                    type: "dropdown",
                ...
                react_1.default.createElement(elements_1.ConfigDescription, null, "Which node version to use for this sandbox. Please restart the server after changing.")))) : null));
};
exports.default = {
