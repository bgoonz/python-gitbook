...
exports.setGroup = exports.track = exports.resetUserId = exports.setUserId = exports.identifyOnce = exports.identify = void 0;
...
const getAmplitude = () => __awaiter(void 0, void 0, void 0, function*() {
    if (process.env.NODE_ENV !== 'production') {
        return false;
    }
    for (let i = 0; i < 10; i++) {
        if (typeof utils_1.global.amplitude !== 'undefined' &&
...
exports.identify = (key, value) => __awaiter(void 0, void 0, void 0, function*() {
    ...
    if (amplitude) {
        ...
        utils_1.debug('[Amplitude] NOT identifying because Amplitude is not loaded');
    }
});
exports.identifyOnce = (key, value) => __awaiter(void 0, void 0, void 0, function*() {
    const amplitude = yield getAmplitude();
    if (amplitude) {
        const identity = new amplitude.Identify();
...
exports.setUserId = (userId) => __awaiter(void 0, void 0, void 0, function*() {
    const amplitude = yield getAmplitude();
    if (amplitude) {
        ...
        utils_1.debug('[Amplitude] NOT setting userid because Amplitude is not loaded');
    }
});
exports.resetUserId = () => __awaiter(void 0, void 0, void 0, function*() {
    const amplitude = yield getAmplitude();
    if (amplitude) {
        ...
        utils_1.debug('[Amplitude] NOT resetting user id because Amplitude is not loaded');
    }
});
exports.track = (eventName, data) => __awaiter(void 0, void 0, void 0, function*() {
    const amplitude = yield getAmplitude();
    if (amplitude) {
        ...
        utils_1.debug('[Amplitude] NOT tracking because Amplitude is not loaded', eventName);
    }
});
exports.setGroup = (group, value) => __awaiter(void 0, void 0, void 0, function*() {
    const amplitude = yield getAmplitude();
    if (amplitude) {
