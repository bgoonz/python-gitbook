...
exports.resetUserId = exports.setUserId = exports.configureScope = exports.captureException = exports.logBreadcrumb = exports.initialize = void 0;
        ...
        if (!utils_1.DO_NOT_TRACK_ENABLED) {
            ...
            return _Sentry.init({
                ...
                beforeSend: (event, hint) => {
                    var _a, _b, _c, _d, _e;
                    const exception = (_b = (_a = event === null || event === void 0 ? void 0 : event.exception) === null || _a === void 0 ? void 0 : _a.values) === null || _b === void 0 ? void 0 : _b[0];
                    const exceptionFrame = (_d = (_c = exception === null || exception === void 0 ? void 0 : exception.stacktrace) === null || _c === void 0 ? void 0 : _c.frames) === null || _d === void 0 ? void 0 : _d[0];
                    const filename = exceptionFrame === null || exceptionFrame === void 0 ? void 0 : exceptionFrame.filename;
                    let errorMessage = typeof hint.originalException === 'string' ?
                        hint.originalException :
                        ((_e = hint.originalException) === null || _e === void 0 ? void 0 : _e.message) || exception.value;
                    if (typeof errorMessage !== 'string') {
                        errorMessage = '';
                    }
                    if (filename) {
                        if (filename.includes('typescript-worker') &&
                        ...
                        if (filename.endsWith('codesandbox.editor.main.js') ||
