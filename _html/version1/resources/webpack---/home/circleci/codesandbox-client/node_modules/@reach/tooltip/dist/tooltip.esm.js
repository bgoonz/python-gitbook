...
function useTooltip(_temp) {
    ...
    var _React$useState = useState(DEBUG_STYLE ? true : id === null ? false : context.id === id && state === VISIBLE),
...
var Tooltip = /*#__PURE__*/ forwardRefWithAs(function(_ref2, forwardedRef) {
    ...
    return createElement(Fragment, null, cloneElement(child, trigger), createElement(TooltipPopup, Object.assign({
        ref: forwardedRef,
        label: label,
...
var TooltipPopup = /*#__PURE__*/ forwardRefWithAs(function TooltipPopup(_ref3, forwardRef) {
    ...
    return isVisible ? createElement(Portal, null, createElement(TooltipContent, Object.assign({
        ref: forwardRef,
        label: label,
        "aria-label": DEPRECATED_ariaLabel,
        isVisible: isVisible
...
var TooltipContent = /*#__PURE__*/ forwardRefWithAs(function TooltipContent(_ref4, forwardedRef) {
    ...
    return createElement(Fragment, null, createElement(Comp, Object.assign({
    ...
    }), label), hasAriaLabel && createElement(VisuallyHidden, {
        role: "tooltip",
        id: id
