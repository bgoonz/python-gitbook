...
const night_owl_json_1 = __importDefault(require("./night-owl.json"));
const nightOwlNoItalics_json_1 = __importDefault(require("./nightOwlNoItalics.json"));
const atom_dark_json_1 = __importDefault(require("./atom-dark.json"));
const atom_light_json_1 = __importDefault(require("./atom-light.json"));
const cobalt2_1 = __importDefault(require("./cobalt2"));
const lucy_json_1 = __importDefault(require("./lucy.json"));
const palenight_json_1 = __importDefault(require("./palenight.json"));
const solarized_light_json_1 = __importDefault(require("./solarized-light.json"));
const shades_of_purple_1 = __importDefault(require("./shades-of-purple"));
const palenight_italic_json_1 = __importDefault(require("./palenight-italic.json"));
const high_contrast_json_1 = __importDefault(require("./high-contrast.json"));
const vscode_light_1 = __importDefault(require("./vscode-light"));
exports.default = [{
        name: 'CodeSandbox',
        id: 'codesandbox',
