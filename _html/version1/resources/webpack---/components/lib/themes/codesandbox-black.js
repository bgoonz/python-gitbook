...
const colors_1 = require("../design-language/colors");
/*
...
*/
const colors = {
    contrastBorder: colors_1.colors.grays[600],
    contrastActiveBorder: null,
    errorForeground: colors_1.colors.reds[500],
    focusBorder: colors_1.colors.grays[600],
    foreground: colors_1.colors.grays[200],
    activityBar: {
        background: colors_1.colors.grays[700],
        border: colors_1.colors.grays[600],
    },
    activityBarBadge: {
        background: colors_1.colors.grays[500],
    },
    button: {
        background: colors_1.colors.blues[600],
        foreground: colors_1.colors.white,
        border: colors_1.colors.blues[600],
    },
    dropdown: {
        background: colors_1.colors.grays[700],
        border: colors_1.colors.grays[600],
    ...
    editor: {
        background: colors_1.colors.grays[700],
        foreground: colors_1.colors.grays[300],
        hoverHighlightBackground: colors_1.colors.grays[500],
        inactiveSelectionBackground: colors_1.colors.grays[500],
        lineHighlightBackground: colors_1.colors.grays[600],
        lineHighlightBorder: colors_1.colors.grays[600],
        rangeHighlightBackground: colors_1.colors.grays[600],
        selectionBackground: colors_1.colors.blues[500] + '33',
        selectionHighlightBackground: colors_1.colors.grays[600],
        wordHighlightStrongBackground: colors_1.colors.grays[600],
        wordHighlightBackground: colors_1.colors.grays[600],
    },
    editorBracketMatch: {
        background: colors_1.colors.grays[600],
    },
    editorCodeLens: {
        foreground: colors_1.colors.grays[600],
    },
    editorCursor: {
        background: colors_1.colors.grays[700],
        foreground: colors_1.colors.white,
    ...
    editorError: {
        border: colors_1.colors.grays[600],
        foreground: colors_1.colors.reds[500],
    },
    editorGroup: {
        background: colors_1.colors.grays[700],
        border: colors_1.colors.grays[600],
        dropBackground: colors_1.colors.blues[500] + '1a',
    },
    editorGroupHeader: {
        noTabsBackground: null,
        tabsBackground: colors_1.colors.grays[700],
        tabsBorder: colors_1.colors.grays[600],
    },
    editorGutter: {
        background: colors_1.colors.grays[700],
        deletedBackground: colors_1.colors.reds[500],
        modifiedBackground: colors_1.colors.grays[700],
    },
    editorHoverWidget: {
        background: colors_1.colors.grays[700],
        border: colors_1.colors.grays[600],
    ...
    editorLink: {
        activeForeground: colors_1.colors.grays[300],
    },
    editorLineNumber: {
        foreground: colors_1.colors.grays[600],
        activeForeground: colors_1.colors.grays[400],
    },
    editorRuler: {
        foreground: colors_1.colors.white,
    },
    ...
    editorOverviewRuler: {
        border: colors_1.colors.grays[600],
        commonContentForeground: colors_1.colors.grays[600],
        currentContentForeground: colors_1.colors.reds[500],
        incomingContentForeground: colors_1.colors.green,
    },
    editorSuggestWidget: {
        background: colors_1.colors.grays[700],
        border: colors_1.colors.grays[600],
        foreground: colors_1.colors.grays[300],
        selectedBackground: colors_1.colors.grays[600],
    },
    editorWarning: {
        border: colors_1.colors.grays[600],
        foreground: colors_1.colors.reds[300],
    },
    editorWhitespace: {
        foreground: colors_1.colors.grays[500],
    },
    editorWidget: {
        background: colors_1.colors.grays[700],
        border: colors_1.colors.grays[600],
    ...
    extensionButton: {
        prominentBackground: colors_1.colors.grays[600],
        prominentForeground: colors_1.colors.white,
        prominentHoverBackground: colors_1.colors.grays[600],
    },
    input: {
        background: colors_1.colors.grays[600],
        foreground: colors_1.colors.white,
        border: colors_1.colors.grays[500],
        placeholderForeground: colors_1.colors.grays[300],
    },
    inputOption: {
        activeBorder: colors_1.colors.grays[400],
    },
    inputValidation: {
        infoForeground: null,
        infoBackground: null,
        infoBorder: colors_1.colors.purple,
        warningForeground: null,
        warningBackground: null,
        warningBorder: colors_1.colors.yellow,
        errorForeground: null,
        errorBackground: null,
        errorBorder: colors_1.colors.reds[300],
    },
    list: {
        dropBackground: colors_1.colors.grays[700],
        highlightForeground: colors_1.colors.blues[300],
        hoverBackground: colors_1.colors.grays[600],
        focusBackground: colors_1.colors.grays[600],
        activeSelectionBackground: colors_1.colors.grays[600],
        activeSelectionForeground: colors_1.colors.white,
        inactiveSelectionBackground: colors_1.colors.grays[600],
        inactiveSelectionForeground: colors_1.colors.white,
        warningForeground: colors_1.colors.yellow,
        errorForeground: colors_1.colors.reds[500],
    ...
    menu: {
        background: colors_1.colors.grays[700],
        selectionBackground: colors_1.colors.grays[600],
    },
    peekView: {
        border: colors_1.colors.grays[500],
    },
    peekViewEditor: {
        background: colors_1.colors.grays[600],
        matchHighlightBackground: colors_1.colors.blues[500] + '33',
    },
    ...
    peekViewResult: {
        background: colors_1.colors.grays[600],
        fileForeground: colors_1.colors.white,
        lineForeground: colors_1.colors.white,
        matchHighlightBackground: colors_1.colors.blues[500] + '33',
        selectionBackground: colors_1.colors.grays[600],
        selectionForeground: colors_1.colors.white,
    },
    peekViewTitle: {
        background: colors_1.colors.grays[600],
    },
    peekViewTitleDescription: {
        foreground: colors_1.colors.blues[700],
    },
    peekViewTitleLabel: {
        foreground: colors_1.colors.white,
    },
    scrollbarSlider: {
        activeBackground: colors_1.colors.white,
        border: colors_1.colors.grays[600],
        background: null,
        hoverBackground: null,
    },
    selection: {
        background: colors_1.colors.blues[500] + '40',
    },
    separator: {
        background: colors_1.colors.grays[900],
        foreground: colors_1.colors.white,
    },
    sideBar: {
        background: colors_1.colors.grays[700],
    ...
    statusBar: {
        background: colors_1.colors.grays[600],
        foreground: colors_1.colors.white,
        debuggingBackground: colors_1.colors.reds[500],
        debuggingForeground: colors_1.colors.grays[600],
        noFolderBackground: colors_1.colors.grays[600],
        noFolderForeground: colors_1.colors.white,
        border: colors_1.colors.grays[600],
    },
    statusBarItem: {
        activeBackground: null,
        hoverBackground: null,
        prominentBackground: colors_1.colors.reds[500],
        prominentHoverBackground: colors_1.colors.yellow,
        remoteForeground: colors_1.colors.grays[100],
        remoteBackground: colors_1.colors.purple,
    },
    tab: {
        activeBackground: colors_1.colors.grays[700],
        activeForeground: colors_1.colors.white,
        border: colors_1.colors.grays[600],
        activeBorder: colors_1.colors.blues[300],
        unfocusedActiveBorder: null,
        inactiveBackground: colors_1.colors.grays[700],
        inactiveForeground: colors_1.colors.grays[400],
        unfocusedActiveForeground: colors_1.colors.white,
        unfocusedInactiveForeground: colors_1.colors.grays[400],
    },
    terminal: {
        background: colors_1.colors.grays[700],
        foreground: colors_1.colors.white,
        ansiBrightBlack: colors_1.colors.blues[700],
        ansiBrightRed: colors_1.colors.reds[500],
        ansiBrightGreen: colors_1.colors.green,
        ansiBrightYellow: colors_1.colors.yellow,
        ansiBlack: colors_1.colors.grays[600],
        ansiRed: colors_1.colors.reds[500],
        ansiGreen: colors_1.colors.green,
        ansiYellow: colors_1.colors.yellow,
        ansiBlue: colors_1.colors.blues[700],
        ansiMagenta: colors_1.colors.purple,
        ansiCyan: colors_1.colors.blues[300],
        ansiWhite: colors_1.colors.white,
    },
    titleBar: {
        background: colors_1.colors.grays[700],
        activeBackground: colors_1.colors.grays[700],
        ...
        border: colors_1.colors.grays[600],
        inactiveBackground: colors_1.colors.grays[700],
        inactiveForeground: colors_1.colors.grays[300],
    },
};
const theme = {
    ...
    colors: dot_object_1.default.dot(colors),
    tokenColors: [{
            name: 'Comment',
            scope: ['comment'],
            settings: {
