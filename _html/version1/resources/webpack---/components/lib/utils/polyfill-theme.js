...
const codesandbox_black_1 = __importDefault(require("../themes/codesandbox-black"));
const codesandbox_light_json_1 = __importDefault(require("../themes/codesandbox-light.json"));
const polyfillTheme = vsCodeTheme => {
    ...
    const addedColors = {
        ...
        switch: {
            ...
            toggle: design_language_1.default.colors.white,
        },
        dialog: {
        ...
        menuList: {
            ...
            border: uiColors.sideBar.border,
            hoverBackground: uiColors.sideBar.border,
            hoverForeground: design_language_1.default.colors.white,
        },
    };
    ...
    if (uiColors.switch.toggle === uiColors.switch.backgroundOff) {
        ...
        uiColors.switch.toggle = design_language_1.default.colors.grays[200];
    }
