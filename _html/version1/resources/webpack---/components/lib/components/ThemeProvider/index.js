...
exports.getThemes = () => {
    const results = themes_1.default.map(theme => (Object.assign({
        name: theme.name
    }, theme.content)));
...
exports.ThemeProvider = ({
    theme = codesandbox_black_1.default,
    children,
}) => {
    const usableTheme = react_1.default.useMemo(() => exports.makeTheme(theme), [theme]);
