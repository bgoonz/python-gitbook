...
exports.Textarea = react_1.default.forwardRef((_a, ref) => {
    var {
        ...
        onKeyPress,
        autosize
    } = _a, props = __rest(_a, ["maxLength", "defaultValue", "value", "onChange", "onKeyPress", "autosize"]);
     ...
     */
    react_1.default.useEffect(function syncValue() {
    ...
    const Wrapper = react_1.useCallback(({
        children
    }) => maxLength ? (react_1.default.createElement(__1.Stack, {
        direction: "vertical",
        css: {
            width: '100%'
        }
    }, children)) : (children), [maxLength]);
    return (react_1.default.createElement(Wrapper, null,
        autosize ? (react_1.default.createElement(Autosize, {
            value: innerValue,
            style: props.style
        }, (height) => (react_1.default.createElement(exports.TextareaComponent, Object.assign({
            value: innerValue,
        ...
        }))))) : (react_1.default.createElement(exports.TextareaComponent, Object.assign({
            value: innerValue,
            onChange: internalOnChange,
            maxLength: maxLength,
            ref: ref
        }, props))),
        maxLength ? (react_1.default.createElement(Count, {
...
const Autosize = (_a) => {
    var {
        value,
        style = {}
    } = _a, props = __rest(_a, ["value", "style"]);
    return (react_1.default.createElement(rect_1.default, null, ({
        rect,
        ref
        ...
        react_1.default.createElement("span", {
            ...
            react_1.default.createElement(__1.Text, {
                block: true,
                ref: ref,
                size: 3,
                style: Object.assign({
