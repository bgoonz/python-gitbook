...
exports.Stats = exports.formatNumber = exports.ForkIcon = exports.ViewIcon = exports.HeartIcon = void 0;
const react_1 = __importDefault(require("react"));
const Text_1 = require("../Text");
const Stack_1 = require("../Stack");
const Icon_1 = require("../Icon");
exports.HeartIcon = props => (react_1.default.createElement("svg", Object.assign({
        width: 16,
        height: 16,
        fill: "none",
        viewBox: "0 0 16 16"
...
exports.ViewIcon = props => (react_1.default.createElement("svg", Object.assign({
        width: 16,
        height: 16,
        fill: "none",
        viewBox: "0 0 16 16"
...
exports.ForkIcon = props => (react_1.default.createElement("svg", Object.assign({
        width: 16,
        height: 16,
        fill: "none",
        viewBox: "0 0 16 16"
...
exports.Stats = (_a) => {
    var {
        sandbox
    } = _a, props = __rest(_a, ["sandbox"]);
    return (react_1.default.createElement(Stack_1.Stack, Object.assign({
            gap: 4
        }, props),
        typeof sandbox.likeCount !== 'undefined' && (react_1.default.createElement(Stack_1.Stack, {
                gap: 2,
                align: "center"
            },
        ...
        typeof sandbox.viewCount !== 'undefined' && (react_1.default.createElement(Stack_1.Stack, {
                gap: 2,
                align: "center"
            },
            react_1.default.createElement(Text_1.Text, {
        ...
        typeof sandbox.forkCount !== 'undefined' && (react_1.default.createElement(Stack_1.Stack, {
                gap: 2,
                align: "center"
            },
            react_1.default.createElement(Text_1.Text, {
