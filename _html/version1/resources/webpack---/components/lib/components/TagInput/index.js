...
exports.TagInput = ({
    ...
    renderInput: props => react_1.default.createElement(AutosizeInput, Object.assign({
        id: "tags-input"
    }, props)),
    renderLayout: (tagsComponent, inputComponent) => (react_1.default.createElement(Layout, null,
        tagsComponent,
        inputComponent))
}));