...
exports.Button = react_1.default.forwardRef(function Button(_a, ref) {
    var {
        variant = 'primary', loading, css = {}, autoWidth, as: pAs
    } = _a, props = __rest(_a, ["variant", "loading", "css", "autoWidth", "as"]);
    const styles = deepmerge_1.default.all([variantStyles[variant], commonStyles, css]);
    ...
    return (react_1.default.createElement(Element_1.Element, Object.assign({
        as: usedAs,
        type: type,
        css: styles,
        ref: ref,
    ...
    }, props), loading ? react_1.default.createElement(AnimatingDots, null) : props.children));
});
...
`;
const AnimatingDots = () => (react_1.default.createElement(react_1.default.Fragment, null,
    react_1.default.createElement(visually_hidden_1.default, null, "Loading"),
    react_1.default.createElement("span", {
            role: "presentation"
        },
        react_1.default.createElement(Dot, null, "\u00B7"),
        react_1.default.createElement(Dot, {
            style: {
