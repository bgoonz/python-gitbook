...
const Icon = styled_components_1.default.svg(props => css_1.default({
    transform: props.open ? 'rotate(0)' : 'rotate(-90deg)',
    transition: 'transform',
    transitionDuration: theme => theme.speeds[1],
    opacity: 0.25,
}));
exports.Body = styled_components_1.default(Element_1.Element)(props => css_1.default({
...
const ToggleIcon = props => (react_1.default.createElement(Icon, Object.assign({
        width: "9",
        height: "6",
        viewBox: "0 0 9 6",
...
exports.Collapsible = (_a) => {
    var {
        ...
        title,
        children
    } = _a, props = __rest(_a, ["defaultOpen", "title", "children"]);
    const [open, setOpen] = react_1.default.useState(defaultOpen || false);
    const toggle = () => setOpen(!open);
    return (react_1.default.createElement(Section, Object.assign({}, props),
        react_1.default.createElement(exports.Header, {
            ...
            react_1.default.createElement(visually_hidden_1.default, null,
                react_1.default.createElement("input", {
                    type: "checkbox",
                    checked: open,
                    readOnly: true
                }))),
        react_1.default.createElement(exports.Body, {
            open: open
        }, open ? children : null)));
};