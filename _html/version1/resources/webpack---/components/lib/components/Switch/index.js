...
const SwitchBackground = styled_components_1.default.div(css_1.default({
    width: 7,
    height: 4,
...
const SwitchToggle = styled_components_1.default.span(css_1.default({
    width: 3,
    height: 3,
...
const SwitchInput = styled_components_1.default.input(css_1.default({
    width: 0,
    opacity: 0,
    position: 'absolute',
    left: -100,
}));
const SwitchContainer = styled_components_1.default(Element_1.Element)(css_1.default({
...
exports.Switch = (_a) => {
    var {
        ...
        defaultOn,
        disabled
    } = _a, props = __rest(_a, ["on", "defaultOn", "disabled"]);
    return (react_1.default.createElement(SwitchContainer, {
            as: "label",
            "data-disabled": disabled ? true : null
        },
        react_1.default.createElement(SwitchInput, Object.assign({
            type: "checkbox",
            checked: on,
            defaultChecked: defaultOn,
            disabled: disabled
        }, props)),
        react_1.default.createElement(SwitchBackground, {
