...
exports.Avatar = exports.Pro = exports.AvatarImage = exports.AvatarContainer = void 0;
...
exports.AvatarImage = styled_components_1.default.img(css_1.default({
    height: '100%',
    width: '100%',
...
exports.Avatar = (_a) => {
    var {
        user,
        file
    } = _a, props = __rest(_a, ["user", "file"]);
    return user && (react_1.default.createElement(exports.AvatarContainer, Object.assign({}, props),
        react_1.default.createElement(exports.AvatarImage, {
            src: file !== null && file !== void 0 ? file : user.avatarUrl,
            alt: user.username
        }),
        user.subscriptionSince ? react_1.default.createElement(exports.Pro, null, "Pro") : null));
};