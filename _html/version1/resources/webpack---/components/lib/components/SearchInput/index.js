...
const SearchInputComponent = styled_components_1.default(Input_1.Input)(css_1.default({
    paddingLeft: 7,
    '::-ms-clear, ::-ms-reveal': {
        display: 'none',
        width: 0,
...
const SearchIconBase = props => (react_1.default.createElement("svg", Object.assign({
        fill: "none",
        width: "12",
        height: "12"
    }, props),
...
exports.SearchIcon = styled_components_1.default(SearchIconBase)(css_1.default({
    position: 'absolute',
    top: '50%',
...
exports.SearchInput = react_1.default.forwardRef((props, ref) => (react_1.default.createElement(Element_1.Element, {
        css: {
            position: 'relative'
        }
    },
    react_1.default.createElement(exports.SearchIcon, null),
    react_1.default.createElement(SearchInputComponent, Object.assign({
        type: "search",
        ref: ref
    }, props)))));