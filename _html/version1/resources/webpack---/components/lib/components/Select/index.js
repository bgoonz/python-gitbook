...
const SelectComponent = styled_components_1.default(Input_1.Input).attrs(() => ({
    as: 'select'
}))(({
    variant = 'default'
}) => css_1.default(deepmerge_1.default(variantStyles[variant], {
    appearance: 'none',
    ...
    ':hover, :focus': {
        ...
        backgroundImage: theme => theme && `url(${getSVG(variant, theme.colors.input.foreground)})`,
    },
})));
const SelectWithIcon = styled_components_1.default(Element_1.Element)(({
    ...
    ':hover, :focus-within': {
        ...
        select: {
            color: 'input.foreground',
            backgroundImage: theme => `url(${getSVG(variant, theme.colors.input.foreground)})`,
        },
    },
}));
exports.Select = (_a) => {
    var {
        icon = null, placeholder = null
    } = _a, props = __rest(_a, ["icon", "placeholder"]);
    const PrefixIcon = icon;
    if (icon)
        return (react_1.default.createElement(SelectWithIcon, {
                variant: props.variant
            },
            react_1.default.createElement(PrefixIcon, null),
            react_1.default.createElement(SelectComponent, Object.assign({}, props),
                placeholder ? react_1.default.createElement("option", {
                    value: ""
                }, placeholder) : null,
                props.children)));
    return (react_1.default.createElement(SelectComponent, Object.assign({}, props),
        placeholder ? react_1.default.createElement("option", {
            value: ""
        }, placeholder) : null,
        props.children));
