...
exports.useMenuButtonContext = exports.MenuPopover = exports.MenuList = exports.MenuLink = exports.MenuItems = exports.MenuItem = exports.MenuButton = exports.Menu = void 0;
/**
...
const MenuDescendantContext = descendants_1.createDescendantContext('MenuDescendantContext');
...
exports.Menu = ({
    ...
    let [state, dispatch] = react_1.useReducer(reducer, Object.assign(Object.assign({}, initialState), {
    ...
    return (react_1.default.createElement(descendants_1.DescendantProvider, {
            context: MenuDescendantContext,
            items: descendants,
            set: setDescendants
        },
        react_1.default.createElement(MenuContext.Provider, {
                value: context
 ...
 */
exports.MenuButton = utils_1.forwardRefWithAs(function MenuButton(_a, forwardedRef) {
    var {
        as: Comp = 'button',
        onKeyDown,
        onMouseDown,
        id
    } = _a, props = __rest(_a, ["as", "onKeyDown", "onMouseDown", "id"]);
    let {
        buttonRef,
        buttonClickedRef,
        menuId,
 ...
 */
const MenuItemImpl = utils_1.forwardRefWithAs(function MenuItemImpl(_a, forwardedRef) {
    var {
        as: Comp,
        index: indexProp,
        isLink = false,
    ...
    } = _a, props = __rest(_a, ["as", "index", "isLink", "onClick", "onDragStart", "onMouseDown", "onMouseEnter", "onMouseLeave", "onMouseMove", "onMouseUp", "onSelect", "valueText"]);
    let {
        buttonRef,
        dispatch,
        readyToSelect,
    ...
    let setValueTextFromDom = react_1.useCallback(node => {
        if (node) {
            ownRef.current = node;
            if (!valueTextProp ||
    ...
    return (react_1.default.createElement(Comp, Object.assign({
        role: "menuitem",
 ...
 */
exports.MenuItem = utils_1.forwardRefWithAs(function MenuItem(_a, forwardedRef) {
    var {
        as = 'div'
    } = _a, props = __rest(_a, ["as"]);
    return react_1.default.createElement(MenuItemImpl, Object.assign({}, props, {
        ref: forwardedRef,
        as: as
    }));
});
 ...
 */
exports.MenuItems = utils_1.forwardRefWithAs(function MenuItems(_a, forwardedRef) {
    var {
        as: Comp = 'div',
        children,
        id,
        onKeyDown
    } = _a, props = __rest(_a, ["as", "children", "id", "onKeyDown"]);
    const {
        menuId,
        dispatch,
        buttonRef,
    ...
    let handleKeyDown = utils_1.wrapEvent(function handleKeyDown(event) {
        let {
            key
        } = event;
        if (!isExpanded) {
    ...
    return (
        ...
        react_1.default.createElement(Comp
 ...
 */
exports.MenuLink = utils_1.forwardRefWithAs(function MenuLink(_a, forwardedRef) {
    var {
        as = 'a', component, onSelect
    } = _a, props = __rest(_a, ["as", "component", "onSelect"]);
    if (component) {
    ...
    return (react_1.default.createElement("div", {
        ...
        react_1.default.createElement(MenuItemImpl, Object.assign({}, props, {
            ref: forwardedRef,
...
exports.MenuList = react_1.forwardRef(function MenuList(_a, forwardedRef) {
    var {
        portal = true
    } = _a, props = __rest(_a, ["portal"]);
    return (react_1.default.createElement(exports.MenuPopover, {
            portal: portal
        },
        react_1.default.createElement(exports.MenuItems, Object.assign({}, props, {
            ref: forwardedRef,
 ...
 */
exports.MenuPopover = react_1.forwardRef(function MenuPopover(_a, forwardedRef) {
    var {
        children,
        portal = true,
        position
    } = _a, props = __rest(_a, ["children", "portal", "position"]);
    const {
        buttonRef,
        buttonClickedRef,
        dispatch,
        ...
        function listener(event) {
            ...
            if (buttonClickedRef.current) {
                ...
                if (isExpanded && popoverRef.current) {
                    if (!((_a = popoverRef.current) === null || _a === void 0 ? void 0 : _a.contains((relatedTarget || target)))) {
                        dispatch({
                            type: CLOSE_MENU,
                            payload: {
                                buttonRef
    ...
    return portal ? (react_1.default.createElement(popover_1.default, Object.assign({}, commonProps, {
        targetRef: buttonRef,
        position: position
...
function findItemFromTypeahead(items, string = '') {
    ...
    const found = items.find(({
        ...
        var _a, _b;
        return (_b = (_a = element === null || element === void 0 ? void 0 : element.dataset) === null || _a === void 0 ? void 0 : _a.valuetext) === null || _b === void 0 ? void 0 : _b.toLowerCase().startsWith(string);
    });
    ...
    switch (action.type) {
        ...
        case SELECT_ITEM_AT_INDEX:
            if (action.payload.index >= 0) {
                return Object.assign(Object.assign({}, state), {
                    selectionIndex: action.payload.max != null ?
