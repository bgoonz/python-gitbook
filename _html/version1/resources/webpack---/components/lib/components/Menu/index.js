...
exports.MenuStyles = styled_components_1.createGlobalStyle(css_1.default({
    '[data-reach-menu]': {
        zIndex: 11,
...
const Menu = (_a) => {
    ...
    return (react_1.default.createElement(__1.Element, Object.assign({
            as: ReachMenu.Menu
        }, props),
...
const ContextMenu = (_a) => {
    var {
        ...
        setVisibility,
        position
    } = _a, props = __rest(_a, ["visible", "setVisibility", "position"]);
    ...
    const [computedMenuHeight, setComputedMenuHeight] = react_1.default.useState(0);
    const [computedMenuWidth, setComputedMenuWidth] = react_1.default.useState(0);
    const [menuIsReadyToShow, setMenuIsReadyToShow] = react_1.default.useState(false);
    ...
    return (react_1.default.createElement(__1.Element, Object.assign({
        ...
        return (react_1.default.createElement(MenuContext.Provider, {
                value: {
                    trigger: null,
                    portal: false
                }
            },
            react_1.default.createElement(ReachMenu.MenuPopover, {
                    position: (targetRect, popoverRect) => ({
                        position: 'fixed',
                        left: Math.min(position.x, window.innerWidth -
                            (popoverRect.width || computedMenuWidth) -
                            16),
                        top: Math.min(position.y, window.innerHeight -
                            (popoverRect.height || computedMenuHeight) -
                            16),
                    })
                },
                react_1.default.createElement(Menu.List, {
                    style: {
...
const MenuButton = props => (react_1.default.createElement(__1.Button, Object.assign({
...
const MenuIconButton = props => (react_1.default.createElement(__1.IconButton, Object.assign({
    as: ReachMenu.MenuButton
}, props)));
const MenuList = react_1.default.forwardRef((_a, ref) => {
    var {
        style,
        children
    } = _a, props = __rest(_a, ["style", "children"]);
    const {
        trigger,
        portal
    } = react_1.default.useContext(MenuContext);
    return (react_1.default.createElement(ReachMenu.MenuList, Object.assign({
        style: style,
        ref: ref,
...
const MenuItem = props => (react_1.default.createElement(__1.Element, Object.assign({
...
const MenuLink = ({
    ...
    if (to) {
        return (react_1.default.createElement(ReachMenu.MenuLink, {
...
const MenuDivider = props => (react_1.default.createElement(__1.Element, Object.assign({
    as: "hr",
    "data-component": "MenuDivider",
    style: {
        margin: '0.25rem 0'
