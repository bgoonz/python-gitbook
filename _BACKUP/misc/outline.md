...
- **Type Casting** : The process of converting one number to another.
  ...
  print(17) # => 17 print(float(17)) # => 17.0# Using Int print(17.0) # => 17.0 print(int(17.0)) # => 17# Using Str print(str(17.0) + ' and ' + str(17)) # => 17.0 and 17
...
- The end range is exclusive just like `slice` in JS.
  ...
  print("Spaghetti"[:4]) # => Spag print("Spaghetti"[:-1]) # => Spaghett# Shortcut to get from a certain index to the end of a string. print("Spaghetti"[1:]) # => paghetti print("Spaghetti"[-4:]) # => etti
...
- Using duck typing to check to see if some value is able to use a certain method.
  ...
  a = 321 if hasattr(a, '**len**'): print(len(a))# Try a string - the length will print out (4 in this case) b = "5555" if hasattr(b, '**len**'): print(len(b))
...
- **You can use default parameters just like in JS**
  ...
  def greeting(name, saying="Hello"): print(saying, name)greeting("Monica")
...
- _You can specify arguments by name without destructuring in Python._
  ...
  def greeting(name, saying="Hello"): print(saying, name)# name has no default value, so just provide the value
