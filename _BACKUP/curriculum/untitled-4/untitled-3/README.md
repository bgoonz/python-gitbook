...
#### Basic Properties of a Linked List <span id="basic-properties-of-a-linked-list"></span>
...
#### Strengths of a Linked List <span id="strengths-of-a-linked-list"></span>
...
#### Weaknesses of a Linked List <span id="weaknesses-of-a-linked-list"></span>
...
#### What data structures are built on linked lists? <span id="what-data-structures-are-built-on-linked-lists"></span>
...
#### Why is a linked list different than an array? What problem does it solve? <span id="why-is-a-linked-list-different-than-an-array-what-problem-does-it-solve"></span>
...
#### How do you represent a linked list graphically and in Python code? <span id="how-do-you-represent-a-linked-list-graphically-and-in-python-code"></span>
