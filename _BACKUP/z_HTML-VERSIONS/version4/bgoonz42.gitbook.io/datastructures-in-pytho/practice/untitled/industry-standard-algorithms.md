...
<span class="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span data-key="916267b570634855a47065027ccd756f"><span data-offset-key="916267b570634855a47065027ccd756f:0"><span data-slate-zero-width="n">​</span></span></span></span>
...
<span class="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span data-key="384e5ec56a6243b5842554b2a98b3b2c"><span data-offset-key="384e5ec56a6243b5842554b2a98b3b2c:0"><span data-slate-zero-width="n">​</span></span></span></span>

<span class="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span data-key="e5bc7f4a78c745ae89de66df643ea36c"><span data-offset-key="e5bc7f4a78c745ae89de66df643ea36c:0"><span data-slate-zero-width="n">​</span></span></span></span>

<span class="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span data-key="2a2dbd19fd6545c1b5d81a7ec2d1060f"><span data-offset-key="2a2dbd19fd6545c1b5d81a7ec2d1060f:0"><span data-slate-zero-width="n">​</span></span></span></span>

<span class="text-4505230f--HeadingH700-04e1a2a3--textContentFamily-49a318e1"><span data-key="032813313fea4a70915227d9861b150b"><span data-offset-key="032813313fea4a70915227d9861b150b:0">Is Subsequence:</span></span></span>
...
<span class="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span data-key="c3a3560079414409aa7080963cf0be60"><span data-offset-key="c3a3560079414409aa7080963cf0be60:0"><span data-slate-zero-width="n">​</span></span></span></span>

<span class="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span data-key="4393c37d6dac48a5a4e9f3b40c26da1a"><span data-offset-key="4393c37d6dac48a5a4e9f3b40c26da1a:0"><span data-slate-zero-width="n">​</span></span></span></span>

<span class="text-4505230f--HeadingH700-04e1a2a3--textContentFamily-49a318e1"><span data-key="e191fb06ff32455a9797d54d0e6d5b5c"><span data-offset-key="e191fb06ff32455a9797d54d0e6d5b5c:0">Reverse String:</span></span></span>

    def reverse(lines):    return "Reverse order: " + lines[::-1] + "\n" + "Normal Order: " + linesprint(reverse("I am printing a sentence in reverse order"))print(reverse("printing strings in reverse order using python"))

<span class="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span data-key="81e707a7cdb3427ab68b049d9e15d1cf"><span data-offset-key="81e707a7cdb3427ab68b049d9e15d1cf:0"><span data-slate-zero-width="n">​</span></span></span></span>

<span class="text-4505230f--HeadingH600-23f228db--textContentFamily-49a318e1"><span data-key="e14265c862724d9d81ca5fb89e2c09b5"><span data-offset-key="e14265c862724d9d81ca5fb89e2c09b5:0">Implement a function recursively to get the desired Fibonacci sequence value. Your code should have the same input/output as the iterative code in the instructions.</span></span></span>

<span class="text-4505230f--TextH400-3033861f--textContentFamily-49a318e1"><span data-key="3eeeb3bd3ab44961a6c276afde1ae002"><span data-offset-key="3eeeb3bd3ab44961a6c276afde1ae002:0"><span data-slate-zero-width="n">​</span></span></span></span>

    def get_fib(position):​    output = 0    if(position==0):        return output​    if(position==1):        return position    else:        output += get_fib(position-1)+get_fib(position-2)        return output​# Test casesprint get_fib(9)print get_fib(11)print get_fib(0)​
...
<a href="interview-practice-resources.html" class="reset-3c756112--card-6570f064--whiteCard-fff091a4--cardNext-19241c42"></a>
...
<a href="https://github.com/bgoonz/python-gitbook/blob/master/practice/supplemental-practice/industry-standard-algorithms/README.md" class="reset-3c756112--menuItem-aa02f6ec--menuItemLight-757d5235--menuItemInline-173bdf97--pageSideMenuItem-22949732"></a>
...
<a href="industry-standard-algorithms.html#is-subsequence" class="reset-3c756112--menuItem-aa02f6ec--menuItemLight-757d5235--menuItemInline-173bdf97--pageTocItem-f4427024"></a>

<span class="text-4505230f--UIH300-2063425d--textContentFamily-49a318e1"><span class="text-4505230f--UIH200-50ead35f--textContentFamily-49a318e1">Is Subsequence:</span></span>

<a href="industry-standard-algorithms.html#reverse-string" class="reset-3c756112--menuItem-aa02f6ec--menuItemLight-757d5235--menuItemInline-173bdf97--pageTocItem-f4427024"></a>

<span class="text-4505230f--UIH300-2063425d--textContentFamily-49a318e1"><span class="text-4505230f--UIH200-50ead35f--textContentFamily-49a318e1">Reverse String:</span></span>

<a href="industry-standard-algorithms.html#implement-a-function-recursively-to-get-the-desired-fibonacci-sequence-value-your-code-should-have-the-same-input-output-as-the-iterative-code-in-the-instructions" class="reset-3c756112--menuItem-aa02f6ec--menuItemLight-757d5235--menuItemInline-173bdf97--pageTocItem-f4427024"></a>

<span class="text-4505230f--UIH300-2063425d--textContentFamily-49a318e1"><span class="text-4505230f--UIH200-50ead35f--textContentFamily-49a318e1--pageTocLinkH2-2294976c">Implement a function recursively to get the desired Fibonacci sequence value. Your code should have the same input/output as the iterative code in the instructions.</span></span>
