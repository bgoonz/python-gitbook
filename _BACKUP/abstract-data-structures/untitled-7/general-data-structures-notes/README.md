...
#### Linear Probing <span id="linear-probing"></span>
...
- A **_deque_**, also known as a double-ended queue, is an ordered collection of items similar to the queue.
...
- **_Parse tree_** can be used to represent real-world constructions like sentences or mathematical expressions.
...
- **_AVL Tree_**: a balanced binary tree. the AVL is named for its inventors G.M. Adelson-Velskii and E.M. Landis.
...
- **_Binary Index Tree (Fenwick Tree)_**
...
- Graph Algorithms:
  - Shortest Path:
    - Dijkstra’s Algorithm (Single source point)
      - **_Essentially, this is a BFS using priority queue instead of queue_**
